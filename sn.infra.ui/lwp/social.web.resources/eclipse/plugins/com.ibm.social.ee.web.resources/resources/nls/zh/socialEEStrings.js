...
({
   ...
   file: {
      ...
      about: {
         CREATE_TIMESTAMP: "${date_long} ${time_long} 由 ${user}",
         UPDATE_TIMESTAMP: "${date_long} ${time_long} 由 ${user}",
   ...
   REPLIES: {
      ...
      ERROR_CREATE_NOT_FOUND: "未能保存您的回复，这是因为主题已被删除或者不再可供查看。",
      ERROR_CREATE_ACCESS_DENIED: "未能保存您的回复，这是因为主题已被删除或者不再可供查看。",
   ...
   COMMENTS: {
      ...
      ERROR_CREATE_NOT_FOUND: "您的评论无法保存，因为项目已被删除或者不再可供您查看。",
      ERROR_CREATE_ACCESS_DENIED: "您的评论无法保存，因为项目已被删除或者不再可供您查看。",
      ...
      ERROR_DELETE_NOT_FOUND: "您的评论无法删除，因为评论或项目已被删除或者不再可供您查看。",
      ERROR_DELETE_ACCESS_DENIED: "您的评论无法删除，因为项目已被删除或者不再可供您查看。",
      ...
      ERROR_EDIT_ACCESS_DENIED: "您的评论无法更新，因为项目已被删除或者不再可供您查看。",
      ERROR_EDIT_NOT_FOUND: "您的评论无法更新，因为项目已被删除或者不再可供您查看。",
   ...
   COMMENTS_SHORTEN: {
      CANCEL: "取消",
      CONFIRM: "缩短操作将除去超出评论限制的文本。  单击“确定”以缩短，或单击“取消”自行编辑评论。",
      DIALOG_TITLE: "简化评论",
      NAME: "简化评论",
      OK: "确定",
      TOOLTIP: "简化评论"
   ...
   DATE: {
      ...
      UPDATED: { DAY: "更新于${EEee} ${time}",
         FULL: "${EEEE}，${date_long} ${time_long}",
         MONTH: "更新时间为 ${date_long}",
         TODAY: "更新时间为今天 ${time}",
         YEAR: "更新时间为 ${date_long}",
         YESTERDAY: "更新时间为昨天 ${time}"
      }
   },
   VERSIONS: {
      ...
      DATE: {
        ...
        UPDATED: { DAY: "更新于${EEee} ${time}",
            YEAR: "更新时间为 ${date_short} 日",
            FULL: "${EEEE}，${date_long} ${time_long}",
            MONTH: "更新时间为 ${date_short} 日",
            TODAY: "更新时间为今天 ${time}",
            YESTERDAY: "更新时间为昨天 ${time}"
        }
      },
      ...
      DELETE: {
         ...
         ERROR_TIMEOUT: "由于联系不到服务器，未删除此版本。  请再次单击“删除”以重试您的请求。",
         ERROR_CANCEL: "未删除该版本，因为已取消请求。  请再次单击“删除”以重试您的请求。",
         ERROR_NOT_LOGGED_IN: "您必须登录才能删除此版本。  单击“删除”后，系统将提示您登录。",
         GENERIC_ERROR: "由于发生未知错误，无法删除该版本。  请再次单击“删除”以重试您的请求。",
         FULL: "删除",
         A11Y: "此按钮将打开一个对话框，该对话框允许用户确认删除此版本。 确认此操作将刷新页面上的内容。"
      },

      REVERT: {
         ERROR_NOT_FOUND: "无法恢复版本，因为它已删除或您无法再查看。",
         ERROR_ACCESS_DENIED: "无法复原版本，因为您不是编辑者。",
         ERROR_NAME_EXISTS: "无法恢复版本，因为另一文件与其具有相同的名称。",
         ERROR_TIMEOUT: "由于联系不到服务器，因此未恢复版本。  再次单击“恢复”以重试您的请求。",
         ERROR_CANCEL: "未复原版本，因为已取消请求。  再次单击“恢复”以重试您的请求。",
         ERROR_QUOTA_VIOLATION: "无法恢复版本，因为已达到空间限制。",
         ERROR_MAX_CONTENT_SIZE: "无法恢复版本，因为该版本大于允许的最大文件大小 ${0}",
         GENERIC_ERROR: "由于发生未知错误，无法恢复版本。  再次单击“恢复”以重试您的请求。"
      }
   },
   ...
   FILE_SHARE_INFO: {
      ...
      SHARE_COMMUNITY_WARN: "与公共社区“${0}”共享将使此文件公开。",
      SELECT_USER_ERROR: "您必须选择至少一个人或一个社区作为共享对象",
      WARN_LONG_MESSAGE: "消息过长。",
      TRIM_LONG_MESSAGE: "是否缩短消息？",
