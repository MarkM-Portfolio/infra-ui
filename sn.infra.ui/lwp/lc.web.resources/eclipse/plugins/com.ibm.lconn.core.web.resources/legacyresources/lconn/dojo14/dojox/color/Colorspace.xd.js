...
return {depends: [["provide", "dojox.color.Colorspace"],
["require", "dojox.math.matrix"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.Colorspace"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
