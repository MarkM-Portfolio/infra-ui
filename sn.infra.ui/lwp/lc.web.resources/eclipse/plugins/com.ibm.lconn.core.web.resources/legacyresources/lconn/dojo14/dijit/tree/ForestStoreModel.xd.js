...
return {depends: [["provide", "dijit.tree.ForestStoreModel"],
["require", "dijit.tree.TreeStoreModel"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tree.ForestStoreModel"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
