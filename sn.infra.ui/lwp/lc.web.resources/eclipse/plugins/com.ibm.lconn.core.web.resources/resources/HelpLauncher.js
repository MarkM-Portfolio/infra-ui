...
dojo.declare("lconn.core.HelpLauncher", lconn.core.widget.MenuLauncher, {
   openDelay: 250,
   hideDelay: 400,
...
dojo.declare("lconn.core.HelpLauncher.ToolTip", dijit.TooltipDialog, {
   ...
   buildRendering: function() {
      ...
      var el = d.createElement("div");
         ...
         var div = d.createElement("div");
            ...
            dojo.attr(div, "aria-labelledby", this.id + "_heading");
 ...
 */
lconn.core.HelpLauncher.createHelpLink = function(/* DomNode? */a, /* String? */ heading, /* String | DomNode */ message, /* Object */ strings, /* Boolean */ preserveLink) {
   var d = document;
   this.strings = strings || lconn.core.HelpLauncher.strings;
   
   a = a || document.createElement("a");
   try {
      var newsUrl = lconn.core.url.getServiceUrl(lconn.core.config.services.news);
      if ((window.ui && ("function" === typeof ui._check_ui_enabled) && ui._check_ui_enabled()) && (newsUrl && newsUrl.path && window.location.pathname.indexOf(newsUrl.path) === 0)) {
         a.title = '';
      } else {
         a.title = this.strings.HELP;
      }
   } catch (e) {
      // noi need to do anything here
   }
   ...
   if (!preserveLink) {
      ...
      var appBlogs = d.getElementsByClassName('app-blogs');
      if(window.ui && typeof window.ui._check_ui_enabled === 'function' && window.ui._check_ui_enabled() && appBlogs.length) {
         var img = d.createElement("span");
         img.className = (lconn.core.locale.getLanguage() === "ar") ?
           "blogs-helpIcon-ar" :
           "blogs-helpIcon";
...
lconn.core.HelpLauncher.strings = {
   HELP: "Help",
   CLOSE: "Close"
};
