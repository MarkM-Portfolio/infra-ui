...
return {depends: [["provide", "dojox.secure.capability"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.secure.capability"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
