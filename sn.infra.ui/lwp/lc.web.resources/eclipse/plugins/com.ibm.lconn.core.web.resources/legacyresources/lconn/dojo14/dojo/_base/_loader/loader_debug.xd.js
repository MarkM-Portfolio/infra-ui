...
return {depends: [["provide", "dojo._base._loader.loader_debug"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo._base._loader.loader_debug"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
