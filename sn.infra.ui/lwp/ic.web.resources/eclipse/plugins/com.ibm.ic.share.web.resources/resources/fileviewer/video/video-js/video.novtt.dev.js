...
vjs.Button.prototype.createEl = function(type, props){
  ...
  props = vjs.obj.merge({
    ...
    title: this.localize(this.buttonText) || '',
    tabIndex: 0
  }, props);
...
vjs.PlayToggle.prototype.onClick = function(){
  if (this.player_.paused()) {
	if (this.player_.remainingTime() < 0.25 && this.player_.techName == 'Flash') { //add a end time tolerance to the flash player
...
vjs.PlayToggle.prototype.onPlay = function(){
  ...
  this.el_.title = this.localize('Pause'); // change the button title to "Pause"
};
...
vjs.PlayToggle.prototype.onPause = function(){
  ...
  this.el_.title = this.localize('Play'); // change the button title to "Pause"
...
vjs.SeekBar.prototype.onMouseMove = function(event){
  ...
  if (newTime == this.player_.duration()) { newTime = newTime - 0.25; }
...
vjs.SeekBar.prototype.stepForward = function(){
  if (this.player_.currentTime() + 5 > this.player_.duration()) {
    this.player_.currentTime(this.player_.duration() - 0.25);  // Don't let video end while scrubbing.
  } else {
...
vjs.SeekBar.prototype.stepBack = function(){
  if(this.player_.currentTime() - 5 < 0) {
    this.player_.currentTime(0); //don't let video to scrub in the negative
  } else {
...
vjs.MuteToggle.prototype.update = function(){
  ...
  if(this.player_.muted()){
      if(this.el_.children[0].children[0].innerHTML!=this.localize('Unmute')){
          ...
          this.el_.title = this.localize('Unmute'); // change the button title to "Unmute"
      }
  } else {
      if(this.el_.children[0].children[0].innerHTML!=this.localize('Mute')){
          this.el_.children[0].children[0].innerHTML = this.localize('Mute'); // change the button text to "Mute"
          this.el_.title = this.localize('Mute'); // change the button text to "Mute"
      }
  }
