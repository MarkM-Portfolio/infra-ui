...
return {depends: [["provide", "dojox.highlight.languages.cpp"],
["require", "dojox.highlight._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.highlight.languages.cpp"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
