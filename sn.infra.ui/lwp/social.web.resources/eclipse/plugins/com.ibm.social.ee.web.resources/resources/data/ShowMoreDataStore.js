...
dojo.declare("com.ibm.social.ee.data.ShowMoreDataStore", null, {
   ...
   fetch: function(keywordArgs, refetch) {
      ...
      var fetchArgs = {
         onBegin: dojo.hitch(this, this.onBegin, keywordArgs),
         onComplete: dojo.hitch(this, this.onComplete, keywordArgs),
         onError: dojo.hitch(this, this.onError, keywordArgs),
         scope: this            
      };
   ...
   _getUniqueItems: function (items) {
      var result = [];
      for (var i = 0; i < items.length; i++) {
         var id = com.ibm.social.ee.util.misc.getItemId(this.ds.getValue(items[i], this.idAttr));
