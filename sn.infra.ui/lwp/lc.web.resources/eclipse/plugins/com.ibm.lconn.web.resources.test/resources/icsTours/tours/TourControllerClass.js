...
define([
  ...
  './guided/homepageGT',
  './examples/example1'
  //'lconn/test/icsTours/tours/hopscotch.css'
], function(declare,
	kernel,
	lang,
	has,
  ...
  var TourControllerClass = declare(null, {
    ...
    _i18n: {
      stepNums: null,
      nextBtn: nls.root.nextBtn,
      prevBtn: nls.root.prevBtn,
      doneBtn: nls.root.doneBtn,
      skipBtn: nls.root.skipBtn,
      closeTooltip: nls.root.closeTooltip,
      nextBtnDisabled: nls.root.nextBtnDisabled,
      prevBtnDisabled: nls.root.prevBtnDisabled,
      tourAriaLabel: nls.root.tourAriaLabel,
      tourThisStepAriaLabel: nls.root.tourThisStepAriaLabel
    },
...
//      try {
//        var storageAdaptorInst = new StorageAdaptor();
//        this._toursManager = new ToursManagerClass({ storageAdaptor: storageAdaptorInst});
////        var topicHandler = topic.subscribe('clear-seen-tours', lang.hitch(this, function() {
...
//    },
    ...
    registerTours: function() {
      ...
      // Guided tours
      ex1 && tours.push(ex1);
      commsGT && tours.push(commsGT);
      filesGT && tours.push(filesGT);
      homepageGT && tours.push(homepageGT);
      this.addTours(tours);
    },
