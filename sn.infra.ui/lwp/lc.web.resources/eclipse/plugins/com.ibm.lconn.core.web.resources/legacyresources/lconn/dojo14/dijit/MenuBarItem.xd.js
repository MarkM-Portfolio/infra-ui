...
return {depends: [["provide", "dijit.MenuBarItem"],
["require", "dijit.MenuItem"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.MenuBarItem"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
