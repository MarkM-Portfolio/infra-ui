		...
		*/
		   common: {
		      more: {
		       ...
		       like_error: "Vaše sviđanje se nije moglo spremiti. Molimo pokušajte ponovno kasnije.",
		       vote_error: "Vaš glas se nije mogao spremiti. Molimo pokušajte ponovno kasnije."
		   },
		   generic: {
		      ...
		      error: "Ne mogu se dohvatiti podaci.",
		      timestamp: {
		         created: {
		   ...
		   network : {
		      friendsInviteUpdatesDescription: "Primite ažuriranja o osobama koje pratite na početnu stranicu i u sažetku e-mailova.",
		      profile_title: "Otvorite profil od ${user}.",
		      profile_a11y: "Aktiviranje ove veze će otvoriti profil od ${user} u novom prozoru.",
		      error: "Dogodila se greška.  ${again}.",
		      error_again: "Molimo pokušajte ponovno",
		      ...
		      messages: {
		         success: {
		            ...
		            ignore: {
		            	nofollow: "Zanemarili ste pozivnicu.",
		            	follow: "Zanemarili ste pozivnicu, ali sada pratite ${user}."
		            }
		         },
		         error: {
		            accept: "Dogodila se greška prilikom prihvata zahtjeva.",
		            ignore: "Dogodila se greška zanemarivanja zahtjeva."
		         }
		      },
		      timestamp: {
		          created: {
		   ...
		   file: {
		      a11y_help: "Aktiviranje ove veze otvara ${name} u novom prozoru.",
		      ...
		      timestamp: {
		         ...
		         createdOther: {
		            ...
		            TODAY: "${user} je kreirao danas u ${time}",
		         ...
		         updatedOther: {
		            ...
		            TODAY: "${user} je ažurirao danas u ${time}",
		            YEAR: "${user} ažurirao ${MMM} ${d}, ${YYYY}",
		            YESTERDAY: "${user} je ažurirao jučer u ${time}",
		      ...
		      PREVIEW: {
		         LINK: "Pregled",
		         TITLE: "Pregledajte ovu datoteku u novom prozoru."
		      },
		      TAGS: "Oznake:",
		      error: "Dogodila se greška.  ${again}.",
		      error_again: "Molimo pokušajte ponovno",
		      ...
		      notifications: {
		         ...
		         CHANGE_SUMMARY: "${user} je naveo sažetak promjene",
		         NO_CHANGE_SUMMARY: "${user} nije naveo sažetak promjene",
		         COMMENTED: "${user} je komentirao"
		      }
		   },
		   ecm_file: {
		      checkedout_you: "Vi ste odjavili",
		      checkedout_other: "Odjavio ${user}",
		      tooltip: "Otvorite datoteku ${name} u knjižnici",
		      draft_404_info: "Skica je izbrisana ili se više s vama ne dijeli. Objavljena verzija je sada zadnja verzije ove datoteke.",
		      error_404: "Datoteka je izbrisana ili se više s vama ne dijeli.",
		      error_403: "Datoteka je izbrisana ili se više s vama ne dijeli.",
		      error_preview: "Datoteka više nije dostupna za pregled.",
		      draft_review_canceled: "Pregled je opozvan i skica više nije dijeljena s vama. Od vas se više ne traži pregled.",
		      switch_ee: "Pregled skice",
		      switch_ee_tooltip: "Pregled zadnje skice za ovu datoteku"
		   },
		   ecm_draft: {
		      tooltip: "Otvorite skicu ${name} u knjižnici",
		      ...
		      draft_review_404_general_info: "Jedan od pregledavatelja je već glasao. Od vas se više ne traži da pregledate ovu skicu.",
		      ...
		      error_404: "Skica je izbrisana ili se više s vama ne dijeli.",
		      ...
		      review: "Pregled",
		      reviewers: "Pregledavatelji",
		      reviwers_addtl: "Dodatni pregledavatelji",
		      in_review: "Skica na pregledu",
		      in_review_tooltip: "Pregledavanje skice u pregledu",
		      review_required_any: "Vlasnici zajednice zahtijevaju jednog pregledavatelja za pregled ove skice.",
		      review_required_all: "Vlasnici zajednice zahtijevaju sve pregledavatelje za pregled ove skice.",
		      review_required_generic: "Vlasnici zajednice zahtijevaju ove pregledavatelje za pregled ove skice.",
		      review_additional_required: "Za pregled ove skice su potrebni svi pregledavatelji koje je dodao podnositelj skice.",
		      ...
		      accept_error: "Dogodila se greška prilikom odobravanja ove skice. Pokušajte ponovno.",
		      accept_info: "Odobrili ste ovu skicu.",
		      reject: "Odbij",
		      rejected: "Odbijeno",
		      reject_tooltip: "Odbij ovu skicu",
		      reject_success: "Odbili ste ovu skicu.",
		      reject_error: "Dogodila se greška prilikom odbijanja ove skice. Pokušajte ponovno.",
		      reject_info: "Odbili ste ovu skicu."
		   },
		   authUser: {
		      error: "Dogodila se greška prilikom dohvata trenutnog korisnika.  ${again}.",
		      error_again: "Molimo pokušajte ponovno",
		      error_404: "Ne može se naći ovlašteni korisnik.",
		      error_403: "Nemate dozvolu za dohvat korisničkih informacija."
		   },
		   forum: {
		      error: "Dogodila se greška.  ${again}.",
		      error_again: "Molimo pokušajte ponovno",
		      error_404: "Forum više ne postoji ili nemate dovoljno dozvola da mu pristupite.",
		      error_403: "Nema dozvolu za gledanje ovog foruma. Forum nije javan i nije dijeljen s vama.",
		      readMore: "Pregled svih tema...",
		      readMore_tooltip: "Otvorite teme ${name} foruma.",
		      readMore_a11y: "Aktiviranje ove veze će otvoriti teme ${name} foruma u novom prozoru.",
		   ...
		   blog: {
		      ...
		      error_403: "Nemate dozvolu za pregled ovog bloga. Blog nije javan i nije dijeljen s vama.",
		      readMore: " Pročitaj više ...",
		      readMore_tooltip: "Otvorite unos u ${name} blog.",
		      readMore_a11y: "Aktiviranje ove veze će otvoriti unos u ${name} blog u novom prozoru.",
		   ...
		   idea: {
			  error_404: "Vaše glasanje nije moglo biti spremljeno jer ste ili dosegli vaše ograničenje za glasanje ili vam ideja više nije dostupna.",
		      readMore_tooltip: "Otvorite ideju ${name}.",
		      readMore_a11y: "Aktiviranje ove veze će otvoriti ${name} ideju u novom prozoru."
		   },
		   size: {
		      B: "${0} B",
		      KB: "${0} KB",
		   ...
		   REPLIES: {
		      ...
		      ERROR: "Dogodila se greška prilikom dohvata odgovora. ${again}",
		      ERROR_CREATE: "Vaš odgovor se nije mogao spremiti.  Pokušajte ponovno kasnije.",
		      ERROR_CREATE_NOT_FOUND: "Vaš odgovor se nije mogao spremiti zato što je tema izbrisana ili vam više nije vidljiva.",
		      ERROR_CREATE_ACCESS_DENIED: "Vaš odgovor se nije mogao spremiti zato što je tema izbrisana ili vam više nije vidljiva.",
		      ERROR_CREATE_TIMEOUT: "Vaš odgovor se nije mogao spremiti jer se nije mogao kontaktirati poslužitelj.  Kliknite 'Spremi' za ponovni pokušaj.",
		      ERROR_CREATE_CANCEL: "Vaš odgovor se nije mogao spremiti jer je zahtjev opozvan.  Kliknite 'Spremi' za ponovni pokušaj.",
		      ERROR_CREATE_NOT_LOGGED_IN: "Morate biti prijavljeni za kreiranje ovog odgovora.  Kliknite 'Spremi' za prompt za prijavu.",
		      ERROR_NO_CONTENT: "Unesite vaš odgovor i kliknite 'Spremi.'  Ako ne želite ostaviti odgovor kliknite 'Opoziv'.",
		      ERROR_UNAUTHORIZED: "Vaš odgovor se nije mogao spremiti jer niste ovlašteni da možete ostaviti odgovor.",
		      COMMENT_DELETED: {
		   ...
		   REPLIES_SUBMITTED: {
		      CONFIRM: "Vaš odgovor je poslan na pregled i bit će dostupan nakon odobrenja."
		   },
		   COMMENTS: {
		      ...
		      ERROR_CREATE: "Vaš komentar se nije mogao spremiti.  Pokušajte ponovno kasnije.",
		      ERROR_CREATE_NOT_FOUND: "Vaš komentar se nije mogao spremiti zato što je stavka izbrisana ili vam više nije vidljiva.",
		      ERROR_CREATE_ACCESS_DENIED: "Vaš komentar se nije mogao spremiti zato što je stavka izbrisana ili vam više nije vidljiva.",
		      ERROR_CREATE_TIMEOUT: "Vaš komentar se nije mogao spremiti zato što se nije mogao kontaktirati poslužitelj.  Kliknite 'Postavi' za ponovni pokušaj.",
		      ERROR_CREATE_CANCEL: "Vaš komentar se nije mogao spremiti zato što je zahtjev opozvan.  Kliknite 'Postavi' za ponovni pokušaj.",
		      ERROR_CREATE_NOT_LOGGED_IN: "Morate biti prijavljeni za kreiranje ovog komentara.  Kliknite 'Postavi' za prompt za prijavu.",
		      ERROR_DELETE: "Vaš komentar se nije mogao izbrisati.  Pokušajte ponovno kasnije.",
		      ERROR_DELETE_TIMEOUT: "Vaš komentar se nije mogao izbrisati zato što se nije mogao kontaktirati poslužitelj.  Kliknite 'Izbriši' za ponovni pokušaj.",
		      ERROR_DELETE_NOT_FOUND: "Vaš komentar se nije mogao izbrisati jer je komentar ili stavka izbrisan ili vam više nije vidljiva.",
		      ERROR_DELETE_ACCESS_DENIED: "Vaš komentar se nije mogao izbrisati jer je stavka izbrisana ili vam više nije vidljiva.",
		      ERROR_DELETE_CANCEL: "Vaš komentar se nije mogao izbrisati zato što je zahtjev opozvan.  Kliknite 'Izbriši' za ponovni pokušaj.",
		      ERROR_DELETE_NOT_LOGGED_IN: "Morate biti prijavljeni za brisanje ovog komentara.  Kliknite 'Izbriši' za prompt za prijavu.",
		      ERROR_EDIT: "Vaš komentar se nije mogao ažurirati.  Pokušajte ponovno kasnije.",
		      ERROR_EDIT_ACCESS_DENIED: "Vaš komentar se nije mogao ažurirati zato što je stavka izbrisana ili vam više nije vidljiva.",
		      ERROR_EDIT_NOT_FOUND: "Vaš komentar se nije mogao ažurirati zato što je stavka izbrisana ili vam više nije vidljiva.",
		      ERROR_EDIT_TIMEOUT: "Vaš komentar se nije mogao ažurirati zato što se nije mogao kontaktirati poslužitelj.  Kliknite 'Postavi' za ponovni pokušaj.",
		      ERROR_EDIT_CANCEL: "Vaš komentar se nije mogao ažurirati zato što je zahtjev opozvan.  Kliknite 'Postavi' za ponovni pokušaj.",
		      ERROR_EDIT_NOT_LOGGED_IN: "Morate biti prijavljeni za uređivanje ovog komentara.  Kliknite 'Postavi' za prompt za prijavu.",
		      ERROR_NO_CONTENT: "Unesite vaš komentar i kliknite 'Postavi'.  Ako ne želite ostaviti komentar kliknite 'Opoziv'.",
		      ERROR_NO_CONTENT_EDIT: "Unesite vaš komentar i kliknite 'Postavi'.  Ako više ne želite uređivati vaš komentar kliknite 'Opoziv.'",
		      ...
		      SUBSCRIBE_TO_COMMENTS: "Pretplati se na ove komentare",
		      SUBSCRIBE_TO_COMMENTS_TOOLTIP: "Pratite promjene ovih komentara kroz čitač tekućih informacija",
		      PROFILE_TITLE: "Otvorite profil od ${user}.",
		      PROFILE_A11Y: "Aktiviranje ove veze će otvoriti profil od ${user} u novom prozoru.",
		      ...
		      PREV_COMMENTS: "Pokaži prethodne komentare",
		      EMPTY: "Nema komentara.",
		      ERROR_ALT: "Greška",
		      ERROR: "Dogodila se greška prilikom dohvata komentara. ${again}",
		      ERROR_ADDTL: "Dogodila se greška prilikom dohvata dodatnih komentara. ${again}",
		      ERROR_AGAIN: "Pokušajte ponovno.",
		      ERROR_AGAIN_TITLE: "Pokušajte zahtjev ponovno za još komentara.",
		      COMMENT_CREATED: {
		      ...
		      FLAG_ITEM: {
		         ...
		         OK: "Spremi",
		         ERROR_SAVING: "Dogodila se greška prilikom obrade zahtjeva. Pokušajte ponovno kasnije.",
		         SUCCESS_SAVING: "Vaša oznaka je poslana. Moderator će uskoro izvesti istraživanje.",
		         TITLE: "Označite ovu stavku kao neodgovarajuću",
		         COMMENT: {
		            TITLE: "Označi ovaj komentar kao neodgovarajući",
		            A11Y: "Ovaj gumb otvara dijalog koji korisniku omogućuje da označi ovaj komentar kao neodgovarajući."
		         }
		      }
		   },
		   COMMENTS_DELETE: {
		   ...
		   COMMENTS_SHORTEN: {
		      CANCEL: "Opoziv",
		      CONFIRM: "Skraćivanje će ukloniti tekst iza ograničenja komentara.  Kliknite 'OK' za skraćivanje ili 'Opoziv' da sami uredite komentar.",
		      DIALOG_TITLE: "Skraćeni komentar",
		      NAME: "Skraćeni komentar",
		      OK: "OK",
		      TOOLTIP: "Skraćeni komentar"
		   ...
		   COMMENTS_SUBMITTED: {
		      ...
		      CONFIRM: "Vaš komentar je submitiran za pregled i bit će dostupan kada se odobri.",
		      OK: "OK"
		   },
		   DATE: {
		      AM: "AM",
		      ...
		      ADDED: { DAY: "Dodano ${EEee} u ${time}",
		         ...
		         TODAY: "Dodano danas u ${time}",
		         YEAR: "Dodano ${date_long}",
		         YESTERDAY: "Dodano jučer u ${time}"
		      },
		      ...
		      UPDATED: { DAY: "Ažurirano ${EEee} u ${time}",
		         FULL: "${EEEE}, ${date_long} ${time_long}",
		   ...
		   VERSIONS: {
		      ERROR: "Ne može se učitati informacije o verziji.",
		      ERROR_REQUEST_CANCELLED: "Zahtjev je opozvan.",
		      ERROR_REQUEST_TIMEOUT: "Poslužitelj se nije mogao kontaktirati.",
		      ERROR_REQUEST_UNKNOWN: "Dogodila se nepoznata greška.",
		      LOADING: "Učitavanje ..",
		      NO_VERSIONS: "Nema verzija",
		      INFO: "Verzija ${0} kreirao ${1} ",
		      VERSION_NUMBER: "Verzija ${0}",
		      DELETED: "Izbrisano",
		      DELETE_ALL: "Izbrišite sve verzije prije verzije",
		      ...
		      CONTENT: {
		         ...
		         REVERT: {
		            A11Y: "Ovaj gumb otvara dijalog na kojem korisnik može potvrditi vraćanje datoteke iz prethodne verzije. Potvrda ove akcije će rezultirati osvježavanjem sadržaja na stranici.",
		            FULL: "Vrati",
		      ...
		      DELETE: {
		         ...
		         ERROR_ACCESS_DENIED: "Verzija se nije mogla izbrisati jer vi niste urednik.",
		         ERROR_TIMEOUT: "Verzija nije izbrisana zato što se nije moglo kontaktirati poslužitelj.  Kliknite 'Brisanje' za ponovni pokušaj zahtjeva.",
		         ERROR_CANCEL: "Verzija nije izbrisana zato što je zahtjev opozvan.  Kliknite 'Brisanje' za ponovni pokušaj zahtjeva.",
		         ERROR_NOT_LOGGED_IN: "Morate biti prijavljeni da biste izbrisali ovu verziju.  Kliknite 'Izbriši' za prompt za prijavu.",
		         GENERIC_ERROR: "Verzija se nije mogla izbrisati zbog nepoznate greške.  Kliknite 'Brisanje' za ponovni pokušaj zahtjeva.",
		         FULL: "Izbriši",
		         A11Y: "Ovaj gumb otvara dijalog na kojem korisnik može potvrditi brisanje ove verzije. Potvrda ove akcije će rezultirati osvježavanjem sadržaja na stranici."
		      },
		      REVERT: {
		         ERROR_NOT_FOUND: "Verzija se ne može vratiti jer je izbrisana ili vam više nije vidljiva.",
		         ERROR_ACCESS_DENIED: "Verzija se nije mogla vratiti jer vi niste urednik.",
		         ERROR_NAME_EXISTS: "Verzija se nije mogla vratiti zato što neka druga datoteka ima isto ime.",
		         ERROR_TIMEOUT: "Verzija nije vraćena zato što se nije mogao kontaktirati poslužitelj.  Kliknite 'Vrati' za ponovni pokušaj zahtjeva.",
		         ERROR_CANCEL: "Verzija nije vraćena zato što je zahtjev opozvan.  Kliknite 'Vrati' za ponovni pokušaj zahtjeva.",
		         ERROR_QUOTA_VIOLATION: "Verzija se nije mogla vratiti zbog ograničenja prostora.",
		         ERROR_MAX_CONTENT_SIZE: "Verzija se nije mogla vratiti zato što je veća od najveće dozvoljene veličine datoteke od ${0}",
		         GENERIC_ERROR: "Verzija se nije mogla vratiti zbog nepoznate greške.  Kliknite 'Vrati' za ponovni pokušaj zahtjeva."
		      }
		   },
		   DOWNLOAD_INFO: {
		      SHOW_PEOPLE: "Pogledajte tko je preuzeo",
		      PREVIOUS: "Prethodno",
		      PREVIOUS_TOOLTIP: "Prethodna stranica",
		      ELLIPSIS: "...",
		      NEXT: "Sljedeće",
		      ...
		      FILE: {
		         V_LATEST: "Preuzeli ste posljednju verziju ove datoteke.",
		   ...
		   EE_DIALOG: {
		      ...
		      ERROR_MSG_GENERIC: "Dogodilo se nešto pogrešno.  Molim, pokušajte ponovno.",
		      ...
		      CONFIRM_CLOSE_MESSAGE: "Da li ste sigurni da želite zanemariti vaše promjene? Pritisnite OK za nastavak ili Opoziv za povratak",
		      OK: "OK",
		      CANCEL: "Opoziv"
		   },
		   MESSAGE: {
		   ...
		   statusUpdate: {
		      ...
		      notifications: {
		         ...
		         USER_BOARD_POST: "${user} je pisao na vašu ploču",
		         POST_COMMENT: "${user} je napisao:"
		      }
		   },
		   login: {
		      error: "Vaše ime i/ili lozinka korisnika ne odgovaraju nijednom postojećem računu. Molim, pokušajte ponovno.",
		      logIn: "Prijava",
		      password: "Lozinka:",
		      user: "Ime korisnika:",
		   ...
		   repost: {
		      name: "Ponovi objavu",
		      title: "Ponovno objavi ovo ažuriranje mojim sljedbenicima ili zajednici",
		      msg_success: "Ažuriranje je uspješno ponovno objavljeno vašim sljedbenicima.",
		      msg_generic: "Dogodilo se nešto pogrešno.  Molim, pokušajte ponovno."
		   },
		   FILE_SHARE_INFO: {
		      ADD: "Zbrajanje",
		      ADD_TXT: "Dodaj osobe ili zajednice kao čitače",
		      SHOW_MORE: "Pokaži još...",
		      READER_IF_PUBLIC: "Svi (javno)",
		      READER_IF_PUBLIC_TOOLTIP: "Ova datoteka je javna i svima vidljiva",
		      EMPTY_READERS: "Ništa",
		      READERS_LABEL: "Čitači:\u00a0",
		      EDITORS_LABEL: "Urednici:\u00a0",
		      OWNER_LABEL: "Vlasnik:\u00a0",
		      ERROR: "Ne može se učitati informacije o dijeljenju",
		      ERROR_NOT_FOUND: "Datoteka koju ste zahtijevali je izbrisana ili premještena. Ako vam je netko poslao ovu vezu provjerite da li je ispravna.",
		      ...
		      MESSAGE: "Poruka:",
		      MESSAGE_TXT: "Dodavanje opcijske poruke",
		      REMOVE_ITEM_ALT: "Ukloni ${0}",
		      NO_MEMBERS: "Ništa",
		      A11Y_READER_ADDED: "Izabrano ${0} kao čitač",
		      A11Y_READER_REMOVED: "Uklonjen je ${0} kao čitač",
		      ...
		      ERROR_SHARING: "Datoteka se nije mogla dijeliti.  Molimo pokušajte ponovno kasnije.",
		      INFO_SUCCESS: "Datoteka je uspješno dijeljena.",
		      MAX_SHARES_ERROR: "Premašen je maksimalan broj dijeljenja.",
		      NOT_LOGGED_IN_ERROR: "Datoteka nije dijeljena zato što niste bili prijavljeni.  Kliknite 'Podijeli' za podjelu datoteke.",
		      TIMEOUT_ERROR: "Datoteka nije dijeljena zato što se nije moglo kontaktirati poslužitelj.  Kliknite 'Podijeli' za ponovni pokušaj.",
		      CANCEL_ERROR: "Datoteka nije dijeljena zato što je zahtjev opozvan.  Kliknite 'Podijeli' za ponovni pokušaj.",
		   ...
		   HISTORY: {
		      ...
		      EMPTY: "Ne mogu se dohvatiti nedavna ažuriranja za ovu stavku. Stavka je izbrisana ili vi više nemate pristup ovoj stavci.",
		      MORE: "Prikaz prethodnih ažuriranja",
		      ERROR_ALT: "Greška",
		      ERROR: "Dogodila se greška prilikom dohvata ažuriranja. ${again}",
		      ERROR_ADDTL: "Dogodila se greška prilikom dohvata dodatnih ažuriranja. ${again}",
		      ERROR_AGAIN: "Pokušajte ponovno.",
		      ERROR_AGAIN_TITLE: "Pokušajte zahtjev ponovno za još ažuriranja.",
		      PROFILE_TITLE: "Otvorite profil od ${user}.",
		      SORT_BY: "Sortiraj po\\:",
		      SORTS: {
		         DATE: "Datum",
		   ...
		   OAUTH: {
		      ...
		      continueBtnA11y: "Aktivacija ove veze će otvoriti novi prozor koji će vam omogućiti ovlaštenje pristupa u Connections.",
		   ...
		   OAUTH_FILENET: {
		      continueBtnA11y: "Aktivacija ove veze će otvoriti novi prozor koji će vam omogućiti da ovlastite pristup u Connections spremište knjižnice.",
		      infoMsg: "Connections spremište knjižnice treba vaše ovlaštenje za pristup vašim podacima.",
		      authorizeGadget: "${clickHere} da ovlastite ovu aplikaciju za pristup vašim informacijama u Connections spremištu knjižnice.",
		      confirmAuthorization: "${clickHere} da potvrdite da ste ovlastili ovu aplikaciju za pristup vašim informacijama u Connections spremištu knjižnice."
		   },
		   UNSAVEDCHANGES: {
		      CANCEL: "Opoziv",
		      CONFIRM: "Da li ste sigurni da želite zanemariti vaše promjene?  Pritisnite OK za nastavak ili Opoziv za povratak.",
