...
({
   ...
   file: {
      ...
      error_403: "No tiene permiso para ver este archivo. El archivo no es público y no se comparte con usted.",
      notifications: {
   ...
   COMMENTS: {
      ...
      ERROR_DELETE_TIMEOUT: "No se ha podido suprimir su comentario porque no se ha podido contactar con el servidor.  Pulse 'Suprimir' para intentarlo de nuevo.",
      ...
      ERROR_EDIT: "Su comentario no se ha podido actualizar.  Inténtelo más adelante.",
   ...
   FILE_SHARE_INFO: {
      ...
      ERROR_NOT_FOUND: "El archivo que ha solicitado se ha suprimido o movido. Si alguien le ha enviado este enlace, compruebe que es correcto.",
      ERROR_ACCESS_DENIED: "No tiene permiso para ver este archivo.  El archivo no es público y no se comparte con usted.",
      SHARE: "Compartir",
      CANCEL: "Cancelar",
   ...
   UNSAVEDCHANGES: {
      CANCEL: "Cancelar",
      CONFIRM: "¿Está seguro de que desea dejar los cambios?  Pulse Aceptar para continuar o Cancelar para volver.",
