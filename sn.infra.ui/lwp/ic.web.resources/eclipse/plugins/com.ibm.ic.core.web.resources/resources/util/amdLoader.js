define([
	...
	/* Portions Copyright IBM Corp. 2011, 2015  All Rights Reserved.     */
	 ...
	 * In order to make l
	 */
	lconn.core.util.amdLoader = 
	(function(global){
	
		var require, define, requirejs; // AhernM: moved from global scope 	
		...
		function newContext(contextName) {
		    var config = {
		            waitSeconds: 60, /* Adjusted by AhernM */
		            baseUrl: './',
		            paths: {},
		            pkgs: {},
		            shim: {}
