...
dojo.provide("com.ibm.lconn.layout.test.jasmine.track.communityfilesSpec");

dojo.require("com.ibm.lconn.layout.track.communityfiles");
...
(function(tracker, coreTracker, array, lang, generateRandomUuid) {
   ...
   // Note that the communityfiles tracker overrides the files tracker
