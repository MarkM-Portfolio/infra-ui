...
return {depends: [["provide", "dijit._editor.plugins.Print"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._editor.plugins.Print"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
