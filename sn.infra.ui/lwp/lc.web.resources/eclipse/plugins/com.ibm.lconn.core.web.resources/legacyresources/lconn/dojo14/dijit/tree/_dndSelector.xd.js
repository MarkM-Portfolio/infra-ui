...
return {depends: [["provide", "dijit.tree._dndSelector"],
["require", "dojo.dnd.common"],
["require", "dijit.tree._dndContainer"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tree._dndSelector"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
