...
return {depends: [["provide", "dojox.charting.Theme"],
["require", "dojox.color"],
["require", "dojox.color.Palette"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.charting.Theme"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
