...
return {depends: [["provide", "dojox.drawing.tools.Path"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.tools.Path"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
