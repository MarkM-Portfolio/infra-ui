...
return {depends: [["provide", "dojox.grid.enhanced.dnd._DndFocusManager"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.enhanced.dnd._DndFocusManager"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
