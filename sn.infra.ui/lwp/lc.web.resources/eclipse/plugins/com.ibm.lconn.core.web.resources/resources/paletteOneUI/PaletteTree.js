...
dojo.provide("lconn.core.paletteOneUI.PaletteTree");
...
// properties and methods
{
   ...
   getIconClass: function( /*dojo.data.Item*/ item, /*Boolean*/ opened) {
      ...
      if ((item != null) && (item.css != null)) {
         customClass = dojo.trim(item.css[0]) + " lotusIconSprite lotusSprite";
         return customClass;
      }
   ...
   onClick: function( /* dojo.data */ item, /*TreeNode*/ node) {
      ...
      if (item.type[0] == this.WIDGET_CATEGORY) {
         dojo.publish(this.CATEGORY_SELECTED_EVENT, [item]);
      } else {
         dojo.publish(this.WIDGET_SELECTED_EVENT, [item]);
      }
   },
   ...
   _onExpandoClick: function( /*Object*/ message) {
      ...
      dojo.addClass(labelNode, this.PERSIST_LABEL_CSS);
   },
   ...
   blurNode: function() {
      ...
      dojo.removeClass(labelNode, this.PERSIST_LABEL_CSS);
