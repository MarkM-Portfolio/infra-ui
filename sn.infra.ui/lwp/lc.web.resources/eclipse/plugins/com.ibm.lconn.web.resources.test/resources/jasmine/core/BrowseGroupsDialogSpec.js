...
dojo.provide("lconn.test.jasmine.core.BrowseGroupsDialogSpec");
...
(function(array, keys, Dialog, BrowseGroupsDialog) {
    ...
    * 
    * @module lconn.test.jasmine.core.BrowseGroupsDialogSpec
    */
...
}(dojo, dojo.keys, dijit.Dialog, lconn.core.BrowseGroupsDialog));
