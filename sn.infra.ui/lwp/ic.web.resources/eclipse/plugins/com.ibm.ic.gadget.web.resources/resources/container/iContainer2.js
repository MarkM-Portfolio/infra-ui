...
define([
      ...
      "../services/ViewContainer",
      "../util/trace"
], function(dojo, declare, kernel, lang, Accessor, Container, ICActions, Views, _Accessor, _Container, ICActionsContainer, ViewContainer, trace) {

   var iContainer2 = lang.getObject("com.ibm.lconn.gadget.container.iContainer2", true);
   /**
    ...
    * <li>
    * </ul>
    * See those interfaces for API details. In addition this object provides a
    * '.views' property which exposes the singleton instance of
    * {@link om.ibm.lconn.gadget.container.Views}. You may use the object
    * directly and it will transparently instantiate. To immediately start
    * instantiation call the <code>init()</code> method. This will cause
    * resources to be downloaded in the background.
    *
   ...
   (function init_com_ibm_lconn_gadget_container_iContainer2() {
      var com_ibm_lconn_gadget_container_iContainer = iContainer2,
      /* Interfaces */
      __ContainerCls = Container, __AccessorCls = Accessor,
      /* singleton objects */
      __accessor = null, __container = null,
      /* tracing utilities */
      __trace = trace,
      /* helper method to apply interface methods */
      __subIFaceMethods = null, __skipDojoMethods = new (declare('', null, {
      ...
      __subIFaceMethods = function(clsProtoArr, methodReplacer) {
         var methodName, clsProto, iContainer = com_ibm_lconn_gadget_container_iContainer;

         for (var i = 0, len = clsProtoArr.length; i < len; i++) {
            clsProto = clsProtoArr[i];
            for (methodName in clsProto) {
               if (!__skipDojoMethods[methodName] && lang.isFunction(clsProto[methodName])) {
       ...
       */
      __subIFaceMethods([
            __AccessorCls.prototype,
            __ContainerCls.prototype
      ], function(methodName) {
         return function() {
            var args = arguments, iContainer = com_ibm_lconn_gadget_container_iContainer.init();

            return iContainer[methodName].apply(null, args); // iContainer
            // uses global
            // scope
         };
      });
       ...
       */
      lang.mixin(com_ibm_lconn_gadget_container_iContainer, {
         /**
         ...
         init : function(config) {
            ...
            __subIFaceMethods([ __AccessorCls.prototype
            ], function(methodName) {
               return lang.hitch(__accessor, methodName);
            });

            __subIFaceMethods([ __ContainerCls.prototype
            ], function(methodName) {
               return lang.hitch(__container, methodName);
            });
          ...
          * Accessor for
          *
          * @see com.ibm.lconn.gadget.container.Views singleton.
          * @memberOf com.ibm.lconn.gadget.container.iContainer
          * @name views
          * @property
          * @type {com.ibm.lconn.gadget.container.Views}
          */
         views : Views.__instance__(),

         /**
          * Accessor for
          *
          * @see com.ibm.lconn.gadget.container.ICActions singleton.
          * @memberOf com.ibm.lconn.gadget.container.iContainer
          * @name ICActions
          * @property
          * @type {com.ibm.lconn.gadget.container.ICActions}
          */
         ICactions : ICActions.__instance__()
      });

      /* Complete the initialization of iContainer */
      if (kernel.global.__iContainer_skip_init__) {
         __trace.debug('Defering iContainer init.');
      }
      else {
         require([ 'dojo/domReady!'
         ], function() {
            var prom = kernel.global.__iContainer_defer_init__;
            if(prom && prom.then) {
              var self = this;
