...
({
   ...
   ecm_draft: {
      ...
      review_required_any: "Vlasnici zajednice zahtijevaju da jedan pregledavatelj pregleda ovu skicu.",
      review_required_all: "Vlasnici zajednice zahtijevaju da svi pregledavatelji pregledaju ovu skicu.",
      review_required_generic: "Vlasnici zajednice zahtijevaju da ovi pregledavatelji pregledaju ovu skicu.",
      review_additional_required: "Od svih pregledavatelja koje je dodao kreator skice se zahtijeva da pregledaju ovu skicu.",
   ...
   COMMENTS: {
      ...
      ERROR_DELETE_TIMEOUT: "Vaš komentar se nije mogao izbrisati zato što se nije mogao kontaktirati poslužitelj.  Kliknite 'Obriši' za ponovni pokušaj.",
      ...
      ERROR_DELETE_CANCEL: "Vaš komentar se nije mogao izbrisati zato što je zahtjev opozvan.  Kliknite 'Obriši' za ponovni pokušaj.",
   ...
   VERSIONS: {
      ...
      DELETE: {
         ...
         ERROR_TIMEOUT: "Verzija nije izbrisana zato što se nije moglo kontaktirati poslužitelj.  Kliknite 'Obriši' za ponovni pokušaj zahtjeva.",
      ...
      REVERT: {
         ...
         ERROR_CANCEL: "Verzija nije vraćena zato što je zahtjev opozvan.  Kliknite 'Vraćanje' za ponovni pokušaj zahtjeva.",
   ...
   EE_DIALOG: {
      ...
      ERROR_MSG_GENERIC: "Dogodilo se nešto pogrešno.  Molimo pokušajte ponovno.",
   ...
   login: {
      error: "Vaše ime i/ili lozinka korisnika ne odgovaraju nijednom postojećem računu. Molimo pokušajte ponovno.",
      logIn: "Prijava",
      password: "Lozinka:",
      user: "Ime korisnika:",
   ...
   repost: {
      ...
      msg_generic: "Dogodilo se nešto pogrešno.  Molimo pokušajte ponovno."
   },
   FILE_SHARE_INFO: {
      ADD: "Dodaj",
      ADD_TXT: "Dodaj osobe ili zajednice kao čitače",
      SHOW_MORE: "Prikaži više...",
      READER_IF_PUBLIC: "Svatko (javno)",
