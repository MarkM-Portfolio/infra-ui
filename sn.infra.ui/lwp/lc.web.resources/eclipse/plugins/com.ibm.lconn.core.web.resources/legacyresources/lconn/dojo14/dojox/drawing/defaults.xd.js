...
return {depends: [["provide", "dojox.drawing.defaults"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.defaults"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
