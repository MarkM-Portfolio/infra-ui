 ...
 * @class lconn.core.paletteOneUI.WidgetButton
...
"lconn.core.paletteOneUI.WidgetButton", // superclass
 [dijit._Widget, dijit._Templated, dijit._Contained], // properties and methods
 /** @lends lconn.core.paletteOneUI.WidgetButton.prototype */
{
   ...
   templatePath: dojo.moduleUrl("lconn.core", "paletteOneUI/templates/WidgetButton.html"),
   ...
   disableButton: function(){
      if (this._isEnabled) {
         ...
         var addedTitle = dojo.string.substitute(this._resourceBundle.WIDGET_ADDED, [this.title]);
         ...
         dojo.attr(this.domNode, "aria-label", addedTitle);
   ...
   _buildIconNode: function(/* String */imgUrl, /* String */ altText){
      ...
      dojo.attr(imgNode, "src", imgUrl.toString());
   ...
   _updateTitle: function(){
      if (this.widgetItem != null) {
         ...
         var addedTitle = dojo.string.substitute(this._resourceBundle.WIDGET_ADDED, [this.title]);
         dojo.attr(this.titleNodeSpan, "title", addedTitle);
         //dojo.attr(this.titleNodeSpan, "alt", this.title);
       
         var ariaLabel = dojo.string.substitute(this._resourceBundle.ADD_INFO_2, [this.title]);
         dojo.attr(this.domNode, "aria-label", ariaLabel);
      }
   },
