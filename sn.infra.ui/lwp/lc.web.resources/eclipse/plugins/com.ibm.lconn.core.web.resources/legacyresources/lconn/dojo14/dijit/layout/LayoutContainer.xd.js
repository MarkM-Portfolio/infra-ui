...
return {depends: [["provide", "dijit.layout.LayoutContainer"],
["require", "dijit.layout._LayoutWidget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.LayoutContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
