...
dojo.provide("com.ibm.social.incontext.util.xsl");

dojo.declare("com.ibm.social.incontext.util.xsl.IEProcessor", null, {
   IS_XML: /^<\?xml /,
...
dojo.declare("com.ibm.social.incontext.util.xsl.Processor", null, {
   IS_XML: /^<\?xml /,
...
com.ibm.social.incontext.util.xsl.createProcessor = function(uri) {
   return (dojo.isIE) ? new com.ibm.social.incontext.util.xsl.IEProcessor(uri) : new com.ibm.social.incontext.util.xsl.Processor(uri);
}
