...
return {depends: [["provide", "dojox.grid.enhanced.dnd._DndMovingManager"],
["require", "dojox.grid.enhanced.dnd._DndSelectingManager"],
["require", "dojox.grid.enhanced.dnd._DndMover"],
["require", "dojo.dnd.move"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.enhanced.dnd._DndMovingManager"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
