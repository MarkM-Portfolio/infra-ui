...
/**
 * Jasmine spec for {@link lconn.core.widget.mentions.MentionsUtils}
 * 
 * @module lconn.test.jasmine.mentions.MentionsUtilsSpec
 */
dojo.provide("lconn.test.jasmine.mentions.MentionsUtilsSpec");
...
(function(MentionsUtils) {
   ...
   beforeEach(function() {
      ...
      utils.activatorChar = '@';
      // UT are LTR so bidiActivatorChar doesn't change
      utils.bidiActivatorChar = function() {return '@';};
   });
   var htmlEx = '<div class="lotusText lotusMentionsDiv bidiAware" contenteditable="true" id="mentionstextAreaNode_0" aria-labelledby="mentionstextAreaNode_0" data-notopenee="true" data-commentinput="true" role="textbox" aria-multiline="true" style="color: rgb(0, 0, 0); -webkit-user-select: auto;">'+
                   ...
                   ' asda '+
                   '</div>';
   var domNode = dojo.toDom(htmlEx);

   describe("the lconn.core.widget.mentions.MentionsUtils class", function() {
   ...
   describe("the lconn.core.widget.mentions.MentionsUtils.setAriaLabel method", function() {
   ...
   describe("the lconn.core.widget.mentions.MentionsUtils.removeSelection method", function() {
      var foo;
      var SEL = {
            selection: {collapseToStart: function(){}, removeAllRanges: function(){}, addRange: function(){}},
            range: {startContainer: {}, extractContents: function(){return {childNodes: []}}}
      };
      beforeEach(function() {
         foo = utils;
   ...
   describe("the lconn.core.widget.mentions.MentionsUtils.getNodeText method", function() {
      ...
      it("returns the text from the input node in plain mode with mentions formatted @{{uid|name|notify}}", function() {
         expect(utils.getNodeText(domNode, true)).toBe('sadsad @{{50730340-0101-102e-88e8-f78755f7e0ed|Amy Jones13|notify}} asdsad @{{51a43040-0101-102e-8950-f78755f7e0ed|Amy Jones119}} asda ');
      });
   });

   describe("the lconn.core.widget.mentions.MentionsUtils.getPlainMention method", function() {
      var nodeToTest = dojo.query('.vcard', domNode)[0];
...
}(lconn.core.widget.mentions.MentionsUtils));
