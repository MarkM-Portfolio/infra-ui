...
return {depends: [["provide", "dojox.io.xhrMultiPart"],
["require", "dojox.uuid.generateRandomUuid"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.io.xhrMultiPart"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
