...
define([
	...
	var DataStore = declare("com.ibm.social.incontext.typeahead.data.DataStore", null, {
	    ...
	    getJson: function(keywordArgs, params, cache, cacheKey) {
	       ...
	       this.net.getJson({
	          ...
	          handle: lang.hitch(this, this.handleResponse, keywordArgs, cache, cacheKey, params)
	       });
	   },
