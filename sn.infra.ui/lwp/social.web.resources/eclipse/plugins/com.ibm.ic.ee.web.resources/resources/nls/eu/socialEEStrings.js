		...
		*/
		   common: {
		      more: {
		       ...
		       like_error: "Ezin izan da zure atsegitea gorde. Saiatu berriro geroago.",
		   ...
		   generic: {
		      ...
		      timestamp: {
		         created: {
		            ...
		            MONTH: "${MMM}ren ${d}(e)an sortua",
		            TODAY: "Gaur ${time}e(t)an sortua",
		            YEAR: "${YYYY}(e)ko ${MMM}ren ${d}(e)an sortua",
		            YESTERDAY: "Atzo ${time}e(t)an sortua",
		            TOMORROW: "${YYYY}(e)ko ${MMM}ren ${d}(e)an sortua"
		         },
		         updated: {
		            DAY: "${EEEE}(e)an, ${time}e(t)an sortua",
		   ...
		   network : {
		      ...
		      error: "Errore bat gertatu da.  ${again}.",
		   ...
		   file: {
		      ...
		      timestamp: {
		         ...
		         createdOther: {
		            DAY: "${user}(e)k ${EEEE}(e)an ${time}e(t)an sortua",
		            MONTH: "${user}(e)k sortua ${MMM}-aren ${d}(e)an",
		            TODAY: "${user}(e)k gaur ${time}e(t)an sortua",
		            YEAR: "${user}(e)k sortua ${YYYY}(e)ko ${MMM}-aren ${d}(e)an",
		            YESTERDAY: "${user}(e)k atzo ${time}e(t)an sortua",
		      ...
		      about: {
		         ...
		         UPDATE_TIMESTAMP: "${date_long} ${time_long} honek eguneratua: ${user}",
		      ...
		      error_403: "Ez duzu baimenik fitxategi hau ikusteko. Fitxategia ez da publikoa eta ez dute zurekin partekatu.",
		      notifications: {
		   ...
		   REPLIES: {
		      ...
		      ERROR_CREATE: "Ezin izan da erantzuna gorde.  Saiatu berriro beranduago.",
		   ...
		   COMMENTS: {
		      ...
		      ADD_COMMENT: "Gehitu iruzkin bat",
		      ...
		      ERROR_CREATE: "Ezin izan da iruzkina gorde.  Saiatu berriro beranduago.",
		      ...
		      ERROR_CREATE_TIMEOUT: "Ezin izan da zure iruzkina gorde, ezin izan baita zerbitzariarekin kontaktatu.  Sakatu 'Argitaratu' berriro saiatzeko.",
		      ERROR_CREATE_CANCEL: "Eskaera bertan behera utzi da eta ezin izan da iruzkina gorde.  Sakatu 'Argitaratu' berriro saiatzeko.",
		      ERROR_CREATE_NOT_LOGGED_IN: "Iruzkina egin ahal izateko, saioa hasi behar duzu.  Sakatu 'Argitaratu' saioa hasteko.",
		      ERROR_DELETE: "Ezin izan da iruzkina ezabatu.  Saiatu berriro beranduago.",
		      ERROR_DELETE_TIMEOUT: "Ezin izan da zure iruzkina ezabatu, ezin izan baita zerbitzariarekin kontaktatu.  Sakatu 'Ezabatu' berriro saiatzeko.",
		      ...
		      ERROR_EDIT: "Ezin izan da iruzkina eguneratu.  Saiatu berriro beranduago.",
		      ...
		      ERROR_EDIT_TIMEOUT: "Ezin izan da zure iruzkina eguneratu, ezin izan baita zerbitzariarekin kontaktatu.  Sakatu 'Argitaratu' berriro saiatzeko.",
		      ERROR_EDIT_CANCEL: "Eskaera bertan behera utzi da eta ezin izan da iruzkina eguneratu.  Sakatu 'Argitaratu' berriro saiatzeko.",
		      ERROR_EDIT_NOT_LOGGED_IN: "Iruzkin hau editatu ahal izateko, saioa hasi behar duzu.  Sakatu 'Argitaratu' saioa hasteko.",
		      ...
		      ERROR_GENERAL: "Errore bat gertatu da.",
		      OK: "Ados",
		      YES: "Bai",
		      ...
		      COMMENT_CREATED: {
		         ...
		         MONTH: "${user}(e)k ${MMM}ren ${d}(e)an (${version}. bertsioa)",
		         TODAY: "${user}(e)k gaur ${time}e(t)an (${version}. bertsioa)",
		         YEAR: "${user}(e)k ${YYYY}(e)ko ${MMM}ren ${d}(e)an (${version}. bertsioa)",
		         YESTERDAY: "${user}(e)k atzo ${time}e(t)an (${version}. bertsioa)",
		         TOMORROW: "${user}(e)k ${YYYY}(e)ko ${MMM}ren ${d}(e)an (${version}. bertsioa)"
		      },
		      ...
		      COMMENT_EDITED: {
		         ...
		         MONTH: "${user}(e)k editatua ${MMM}ren ${d}(e)an (${version}. bertsioa)",
		         TODAY: "${user}(e)k editatua gaur ${time}e(t)an (${version}. bertsioa)",
		         YEAR: "${user}(e)k editatua ${YYYY}(e)ko ${MMM}ren ${d}(e)an (${version}. bertsioa)",
		         YESTERDAY: "${user}(e)k editatua atzo ${time}e(t)an (${version}. bertsioa)",
		         TOMORROW: "${user}(e)k editatua ${YYYY}(e)ko ${MMM}ren ${d}(e)an (${version}. bertsioa)"
		      },
		      ...
		      DELETE_CONFIRM: "Ziur zaude iruzkin hau ezabatu nahi duzula?",
		      FLAG_ITEM: {
		         BUSY: "Gordetzen...",
		         CANCEL: "Utzi",
		         ...
		         OK: "Gorde",
		         ERROR_SAVING: "Errorea gertatu da eskaera prozesatzean. Saiatu berriro beranduago.",
		   ...
		   COMMENTS_SHORTEN: {
		      CANCEL: "Utzi",
		      CONFIRM: "Laburtuz gero, iruzkinaren mugatik haragoko testua kendu egingo da.  Sakatu 'Ados' laburtzeko edo 'Utzi' iruzkina editatzeko.",
		      DIALOG_TITLE: "Laburtu iruzkina",
		      NAME: "Laburtu iruzkina",
		      OK: "Ados",
		      TOOLTIP: "Laburtu iruzkina"
		   ...
		   VERSIONS: {
		      ...
		      ERROR_REQUEST_UNKNOWN: "Errore ezezagun bat gertatu da.",
		      LOADING: "Kargatzen ..",
		      ...
		      CONTENT: {
		         ...
		         REVERT: {
		            A11Y: "Botoi hau sakatuz gero, elkarrizketa bat irekiko da, erabiltzaileak fitxategi bat aurreko bertsiotik lehenera dezan. Ekintza hau berrestean, orriaren edukia freskatuko da.",
		            FULL: "Leheneratu",
		      ...
		      DELETE: {
		         ...
		         ERROR_TIMEOUT: "Bertsioa ez da kendu ezin izan delako zerbitzariarekin kontaktatu.  Sakatu 'Ezabatu' berriro saiatzeko.",
		         ...
		         FULL: "Ezabatu",
		         A11Y: "Botoi hau sakatuz gero, elkarrizketa bat irekiko da, erabiltzaileak bertsio hau ezabatu nahi duen berrets dezan. Ekintza hau berrestean, orriaren edukia freskatuko da."
		      },
		      REVERT: {
		         ...
		         ERROR_TIMEOUT: "Bertsioa ez da leheneratu ezin izan delako zerbitzaria aurkitu.  Sakatu 'Leheneratu' berriro saiatzeko.",
		         ERROR_CANCEL: "Eskaera bertan behera utzi da eta ez da bertsioa leheneratu.  Sakatu 'Leheneratu' berriro saiatzeko.",
		   ...
		   DOWNLOAD_INFO: {
		      ...
		      VERSION: {
		         ...
		         TODAY: "${version}. bertsioa ${time}e(t)an",
		   ...
		   EE_DIALOG: {
		      ...
		      ERROR_MSG_GENERIC: "Errorea gertatu da.  Mesedez, saiatu berriro.",
		   ...
		   statusUpdate: {
		       createdCompact: {
		           DAY: "Sortze-data: ${EEEE}(e)an ${time}e(t)an",
		           MONTH: "Sortze-data: ${MMM}ren ${d}(e)an",
		           TODAY: "Sortze-data: Gaur ${time}e(t)an",
		           YEAR: "Sortze-data: ${YYYY}(e)ko ${MMM}-aren ${d}(e)an",
		           YESTERDAY: "Sortze-data: Atzo ${time}e(t)an",
		           TOMORROW: "Sortze-data: ${YYYY}(e)ko ${MMM}-aren ${d}(e)an"
		   ...
		   login: {
		      error: "Zure erabiltzaile-izena edota pasahitza ez dator bat dauden kontuekin. Mesedez, saiatu berriro.",
		      logIn: "Hasi saioa",
		      password: "Pasahitza:",
		   ...
		   repost: {
		      ...
		      msg_generic: "Errorea gertatu da.  Mesedez, saiatu berriro."
		   },
		   FILE_SHARE_INFO: {
		      ADD: "Gehitu",
		      ...
		      ERROR_ACCESS_DENIED: "Ez duzu baimenik fitxategi hau ikusteko.  Fitxategia ez da publikoa eta ez dute zurekin partekatu.",
		      SHARE: "Partekatu",
		      CANCEL: "Utzi",
		      SHARE_WITH: "Partekatu ondokoarekin:",
		      PERSON: "pertsona bat",
		      COMMUNITY: "komunitate bat",
		      PLACEHOLDER: "Pertsonaren izena edo helbide elektronikoa...",
		      MESSAGE: "Mezua:",
