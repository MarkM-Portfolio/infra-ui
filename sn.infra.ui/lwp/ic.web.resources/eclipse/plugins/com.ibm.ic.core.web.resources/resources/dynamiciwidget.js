...
define([
      ...
      "dojo/query",
      "dijit/_Widget"
], function(lang, query, _Widget) {

   /**
    * @namespace ic-core.dynamiciwidget
   ...
   var dynamiciwidget = lang.getObject("lconn.core.dynamiciwidget", true);
    ...
    * implementation methods on the object: dojo.extend(&lt;name&gt;, { onLoad:
    * function() { // new implementation of onLoad } // other implementation
    * methods... }); As a convenience, the dynamic loader updates any
    * lotusLoading IMG tags in the contents to have the standard blank.gif
    * location since it is difficult to calculate that path in the iwidget
    * definition. To use this in an iWidget definition, set your iScope to:
    ...
    * 
    * @function create
    * @memberof ic-core.dynamiciwidget
    * @param {String}
    ...
    */
   dynamiciwidget.create = function(name, impl) {
      var implClass = lang.getObject(name);
      ...
      if (!implClass)
         implClass = dojo.declare(name, null, {
            ...
            onLoad : function() {
               ...
               query("img.lotusLoading", contentsNode).forEach(setBlankGif);
               ...
               net.jazz.ajax.xdloader.load_layer_async(module, [].concat(excludes), lang.hitch(this, "_onModuleLoaded", this.onLoad));
            },
             ...
             * promise completes. The implemented method can be named "onsearch"
             * or "onSearch", so this method will be assigned as null to direct
             * CRE code to the real method if it's "onSearch".
             */
            onsearch : function() {
             ...
             * implemented method in specific widgets will be invoked when load
             * promise completes. The implemented method can be named "onview"
             * or "onView", so this method will be assigned as null to direct
             * CRE code to the real method if it's "onView".
             */
            onview : function() {
             ...
             * implemented method in specific widgets will be invoked when load
             * promise completes. The implemented method can be named "onedit"
             * or "onEdit", so this method will be assigned as null to direct
             * CRE code to the real method if it's "onEdit".
             */
            onedit : function() {
   ...
   return lconn.core.dynamiciwidget;
});
