...
define([
   ...
   "dojo/_base/lang",
   "dojo/data/api/Read"
], function (dojo, declare, lang, Read) {
    ...
    * @class ic-ui.AutocompleteDataStore
    * @author Clayton Coleman <claycole@us.ibm.com>
    */
   var AutocompleteDataStore = declare("com.ibm.oneui.AutocompleteDataStore", Read, /** @lends ic-ui.AutocompleteDataStore.prototype */ {
      ...
      fetch: function(kwArgs) {
         kwArgs.abort = abort;
         kwArgs._store = {timer: setTimeout(lang.hitch(this, "dispatch", kwArgs), this.getDelay(kwArgs))};
         return kwArgs;
      },
      ...
      wait: function(kwArgs, results) {
         ...
         if (info.requests > 1) {
            ...
            info.timer = setTimeout(lang.hitch(this, "handle", kwArgs, []), this.maximumLocalResultsDelay);
         }
         else {
      ...
      getDelay: function(kwArgs) {
         ...
         if (this.cache && (typeof this.cache[this.getCacheKey(kwArgs)] == "object")) {
