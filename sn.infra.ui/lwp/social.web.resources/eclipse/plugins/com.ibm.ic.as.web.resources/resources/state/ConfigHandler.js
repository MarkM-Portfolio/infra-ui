/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	...
	], function (declare, lang, ConfigManager, ConfigObjectUtil) {
	
		/**
		 * Handler that updates the configuration object's selected state.
		 */
		
		var ConfigHandler = declare("com.ibm.social.as.state.ConfigHandler", null,
		{
			...
			constructor: function(){
				...
				this.configObject = ConfigManager.getConfigObject();
			...
			updateConfigState: function(stateArr){
				...
				stateArr = lang.clone(stateArr); // don't damage someone else's array
