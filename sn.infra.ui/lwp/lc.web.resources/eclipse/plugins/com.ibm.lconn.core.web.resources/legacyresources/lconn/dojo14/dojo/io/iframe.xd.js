...
return {depends: [["provide", "dojo.io.iframe"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.io.iframe"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
