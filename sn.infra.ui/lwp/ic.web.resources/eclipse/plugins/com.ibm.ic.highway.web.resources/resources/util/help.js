...
define([
   ...
   function(dojo, dom, lang) {

      var help = lang.getObject("lconn.highway.util.help", true);

      lang.setObject("resetSettingsHelp", function() {
         var strings = i18nstrings;
         var helpNode = dom.byId("configHelpNode");
         var text = "<span class=\"lotusBold\">" + strings.helpOverviewTitle + "</span><p>" + strings.helpOverviewMessage1 + "</p>" + "<p>"
               + strings.helpOverviewMessage2 + "</p>";
         helpNode.innerHTML = text;
      }, lconn.highway.util.help);

      lang.setObject("updateSimpleHelp", function(title, message) {
         var helpNode = dom.byId("configHelpNode");
      ...
      lang
            .setObject("updateSettingHelp",
               function(details, roleNames) {
                  var strings = i18nstrings;
                  var helpNode = dom.byId("configHelpNode");
      ...
      lang.setObject("_getBooleanFromInput", function(inputValue) {
         if (inputValue != null) {
