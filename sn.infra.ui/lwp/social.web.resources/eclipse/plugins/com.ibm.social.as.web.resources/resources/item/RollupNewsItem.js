...
dojo.provide("com.ibm.social.as.item.RollupNewsItem");
...
dojo.declare("com.ibm.social.as.item.RollupNewsItem", 
[com.ibm.social.as.item.NewsItem],
{
	// An template extension to be used inside the NewsItem dijit
	rollupExtension: dojo.cache("com.ibm.social.as", "item/templates/rollupNewsItem.html"),
	...
	postCreate: function(){
        ...
        if (this.newsData.getActivityType() !== "file"){
            dojo.addClass(this.contentNode, "lotusTitle");
        }
	},
	...
	setupRollup: function(newsData){		
		...
		if(summary){
			...
			if(activityAuthorId && activityAuthorName && activityAuthorId !== actorId){
				...
				var bundleStrings = dojo.i18n.getLocalization("com.ibm.social.as", "activitystream");
				this.rollupUser.photoOfText = dojo.string.substitute(bundleStrings.photoOfText, [activityAuthorName]);
	...
	uninitialize: function() {
		...
		this.summary = null;
		dojo.destroy(this.rollupContent);
...
dojo.declare("com.ibm.social.as.item.DummyRollupNewsItem",null,
{
	templatePath: dojo.moduleUrl("com.ibm.social.as", "item/templates/rollupNewsItem.html")
});
