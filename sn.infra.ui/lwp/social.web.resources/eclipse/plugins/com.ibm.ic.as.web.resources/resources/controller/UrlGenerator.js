/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	...
	define([
		...
		var UrlGenerator = declare("com.ibm.social.as.controller.UrlGenerator", null,
		{
			...
			constructor: function(options){
				...
				this.currentState.params = lang.clone(this.getUrlParams());
			...
			attachUrlPart: function(urlObj){
				...
				lang.mixin(this.currentState.params, urlObj.params);
			},
