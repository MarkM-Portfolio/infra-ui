...
dojo.declare("com.ibm.mm.enabler.iw.iWidgetWrapperImpl",com.ibm.mm.enabler.iw.iWidgetWrapper,{
...
dojo.declare("com.ibm.mm.enabler.iw.iWidgetMetadataImpl",com.ibm.mm.enabler.iw.iWidgetMetadata,{
    constructor:function(id){
	...
	_loadData:function(itemName){
		...
		if (instanceData != null && typeof (instanceData[itemName]) != "undefined" && instanceData[itemName]!=null){
			var anItemStr = dojo.toJson(instanceData[itemName]);
			anItem.isDirty = true;
...
dojo.declare( "com.ibm.mm.enabler.iw.WidgetStub",null,
{
...
dojo.declare( "com.ibm.mm.enabler.iw.WidgetDefinition",null, 
{
...
dojo.declare( "com.ibm.mm.enabler.iw.standardWidgetDefinition",null, 
{
