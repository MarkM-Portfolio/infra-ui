...
var includeModules = [
      ...
      'lconn.test.jasmine.specSuite',
      'com.ibm.oneui.test.jasmine.specSuite'
...
function getURLs(urlParams) {
   return [
         urlParams.protocol + '://' + urlParams.hostname + urlParams.webResourcesPathSuffix + '/lconn.test/jasmine/dojoConfig.js?dojo.preventcache='
...
module.exports = function(config) {
   config.set({
      ...
      basePath : 'http://localhost:52450/web/lconn.test/',
      // frameworks to use
      frameworks : [ 'jasmine'
      ],
      ...
      proxies : {
         '/data' : 'http://localhost:52450/web/lconn.test/jasmine/data',
         '/tagcloud' : 'http://localhost:52450/web/lconn.test/tagcloud',
         '/paletteOneUI' : 'http://localhost:52450/web/lconn.test/paletteOneUI',
         '/widget' : 'http://localhost:52450/web/lconn.test/jasmine/widget',
