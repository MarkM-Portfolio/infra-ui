...
define([
...
], function (declare, lang, query, ItemSet) {

	// dojo.require( "com.ibm.mm.enabler.model.internal" );
	declare("com.ibm.mm.enabler.iw.Item", null, {
	...
	declare("com.ibm.mm.enabler.iw.DefaultItemSetImpl", ItemSet, {    
	            ...
	            clone: function (){
	                 ...
	                 for (anItem in arr){   
	                     ...
	                     newItem = lang.mixin(newItem,this.items[anItem]);           
	            ...
	            _handleOnItemSetChanged:function(iEvent){  
	                 for (var i=0; i<this.listeners;i++) {
	                     ...
	                     if (fn != null && this.scope) {
	                         lang.hitch(this.scope,fn)(iEvent);
	                     }
	                 }
	            }
	});
	
	declare("com.ibm.mm.enabler.iw.iDescriptor",com.ibm.mm.enabler.iw.ManagedItemSet,{
	...
	declare("com.ibm.mm.enabler.iw.InternalPersistentAttributesToPreferenceModelAdapter", com.ibm.mm.enabler.iw.ManagedItemSet, {
	    ...
	    constructor: function(widget, serverless) {
	        ...
	        this.modes = ItemSet._internalIbmModes;
	        this.widget = widget; 
	...
	*/        
	    ...
	    _saveMicroformat: function(){
	        ...
	        attributeItemSets = query('span.' + ns + 'ItemSet[title="' + iwConstants.ATTRIBUTES + '"]', root);
	...
	*/    
	...
	declare("com.ibm.mm.enabler.iw.PersistentAttributes",com.ibm.mm.enabler.iw.ManagedItemSet,{
	...
	declare("com.ibm.mm.enabler.iw.UserProfile",com.ibm.mm.enabler.iw.ManagedItemSet,{
	...
	return com.ibm.mm.enabler.iw.ItemSetImpl;
});
