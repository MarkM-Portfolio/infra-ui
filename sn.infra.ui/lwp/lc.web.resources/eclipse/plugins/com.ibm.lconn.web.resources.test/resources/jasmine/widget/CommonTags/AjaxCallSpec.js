...
dojo.provide("lconn.test.jasmine.widget.CommonTags.AjaxCallSpec");

dojo.require("lconn.core.CommonTags.AjaxCall");

(function(AjaxCall) {

   var JSON_TAGS_URL = '../tagcloud/tags.json', JSON_TAGCOUNT_URL = '../tagcloud/tagcount.json', JSON_TAGCOUNT_FLAT_URL = '../tagcloud/tagcount_flat.json';
...
}(lconn.core.CommonTags.AjaxCall));
