...
dojo.declare("com.ibm.social.ee.bean.Bean", null, {
   isFullyLoaded: false,
   setBase: function(entry, base) {      
      if(base)
         this.base = base;
      else if(entry)
         this.base = com.ibm.social.incontext.util.dom.getAttributeNS(entry, "base", com.ibm.social.incontext.util.dom.XML_NAMESPACE);      
   },
