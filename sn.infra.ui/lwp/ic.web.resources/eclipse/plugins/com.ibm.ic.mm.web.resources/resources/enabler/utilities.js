...
define([
      ...
      "dojox/data/dom",
      "./iw/services"
], function(declare, langModule, has, domModule, services) {

   var utilities = {

      rewriteURL : function(/* String */targetUrl) {
         var _targetURL = new HttpUrl(targetUrl);
      ...
      getLocale : function(/* com.ibm.mashups.enabler.Localized */localized, aLocale, defaultLocale) {
         ...
         if (typeof localeArr == "undefined" || localeArr === null || !langModule.isArray(localeArr))
            return null;
         ...
         if (returnLocale === null) {
            // get browser locale
            var browserLocale = (has("ie") ? navigator.userLanguage : navigator.language).toLowerCase();
   ...
   com.ibm.mm.enabler.dom = {
      ...
      createDocument : function(/* string? */str, /* string? */mimetype) {
         return domModule.createDocument(str, mimetype);
      },
      replaceChildren : function(/* Element */node, /* Node || array */newChildren) {
         return domModule.replaceChildren(node, newChildren);
      },
      innerXML : function(node) {
         return domModule.innerXML(node);
      },
      removeChildren : function(node) {
         return domModule.removeChildren(node);
      },
   ...
   var HttpUrl = utilities.HttpUrl = declare("com.ibm.mm.enabler.utilities.HttpUrl", null, {
      ...
      toProxifiedString : function() {
         ...
         var extension = (new services.loadService)._getExtension(this.toString());
      ...
      _extractScheme : function(/* String */urlString) {
         ...
         if (indexOfScheme == -1)
            return window.location.protocol; // location.protocol returns the
   ...
   var ArrayMap = utilities.ArrayMap = declare("com.ibm.mm.enabler.ArrayMap", null, {
