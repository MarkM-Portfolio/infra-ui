...
return {depends: [["provide", "dojo.data.api.Read"],
["require", "dojo.data.api.Request"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.data.api.Read"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
