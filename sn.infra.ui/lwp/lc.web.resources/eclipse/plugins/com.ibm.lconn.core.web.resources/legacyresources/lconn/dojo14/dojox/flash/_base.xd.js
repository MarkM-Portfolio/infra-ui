...
return {depends: [["provide", "dojox.flash._base"],
["require", "dijit._base.place"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.flash._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
