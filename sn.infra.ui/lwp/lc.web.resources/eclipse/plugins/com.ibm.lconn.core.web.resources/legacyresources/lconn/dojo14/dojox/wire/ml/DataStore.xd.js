...
return {depends: [["provide", "dojox.wire.ml.DataStore"],
["require", "dijit._Widget"],
["require", "dojox.wire._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.ml.DataStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
