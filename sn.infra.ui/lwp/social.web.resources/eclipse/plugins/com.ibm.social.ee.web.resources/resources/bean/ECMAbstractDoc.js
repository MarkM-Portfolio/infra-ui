...
(function () {
   ...
   dojo.declare("com.ibm.social.ee.bean.ECMAbstractDoc", [com.ibm.social.ee.bean.AtomBean], {
      getName: function() {
         if (!this.name) {
...
//      },
      ...
      getModifier: function() {
         if (!this.modifier)
            this.modifier = new com.ibm.social.ee.bean.ECMUser(util.dom.getElementsByTagNameNS(this.e, "modifier", util.dom.DOCUMENTS_ATOM_NAMESPACE)[0]);
