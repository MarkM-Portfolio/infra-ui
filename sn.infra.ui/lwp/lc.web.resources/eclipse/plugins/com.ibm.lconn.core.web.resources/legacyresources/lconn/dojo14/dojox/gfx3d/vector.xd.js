...
return {depends: [["provide", "dojox.gfx3d.vector"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.gfx3d.vector"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
