...
dojo.declare("com.ibm.mm.enabler.iw.services.loadService",null, {
...
dojo.declare( "com.ibm.mm.enabler.iw.services.widgetLoadService",
			  null,
			  { 
			  	getWidgetXML: function ( /*String*/ widgetUrl,/*String*/ widgetId) {
                    ...
                    var args = {
                        ...
                        error : function(data, ioArgs){
                                ...
                                dojo.publish( "/enabler/inlineMessage/"+me.widgetId , ["error", dojo.string.substitute(iwMessages.E_IWIDGETDEF_NOTAVAILABLE_1, [contentUrl]), data.message]);    
                            }, 
                ...
                handleLoad: function(data,xhr){   
                     var parser = com.ibm.mm.enabler.iw.parser.WidgetParserFactory.getWidgetParser(xhr.responseText);
				...
				_fireIndividualWidgetStateChange: function( /*WidgetInfo*/wInfo){
					...
					dojo.publish("/enabler/widgetXmlRetrieved/" + this.widgetId, [wInfo]);
				}
