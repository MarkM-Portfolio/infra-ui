...
({
   ...
   REPLIES_SUBMITTED: {
      CONFIRM: "La vostra resposta s'ha enviat a revisió i estarà disponible quan s'aprovi."
   },
   COMMENTS: {
      ...
      ERROR_CREATE_TIMEOUT: "No s'ha pogut desar el comentari perquè no s'ha pogut establir contacte amb el servidor.  Feu clic a 'Publica' per tornar-ho a provar.",
      ...
      ERROR_DELETE_TIMEOUT: "No s'ha pogut suprimir el comentari perquè no s'ha pogut establir contacte amb el servidor.  Feu clic a 'Suprimeix' per tornar a provar-ho.",
      ...
      ERROR_EDIT_TIMEOUT: "No s'ha pogut actualitzar el comentari perquè no s'ha pogut establir contacte amb el servidor.  Feu clic a 'Publica' per tornar-ho a provar.",
   ...
   VERSIONS: {
      ...
      REVERT: {
         ...
         GENERIC_ERROR: "No s'ha pogut restaurar la versió degut a un error desconegut.  Torneu a fer clic a 'Restaura' per tornar a intentar la sol·licitud."
      }
   },
