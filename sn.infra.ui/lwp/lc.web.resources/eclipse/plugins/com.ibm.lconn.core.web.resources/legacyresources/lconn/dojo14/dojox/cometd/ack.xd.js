...
return {depends: [["provide", "dojox.cometd.ack"],
["require", "dojox.cometd._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.cometd.ack"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
