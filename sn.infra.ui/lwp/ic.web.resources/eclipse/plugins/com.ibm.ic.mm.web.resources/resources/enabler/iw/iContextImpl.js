...
define([
	...
	"ic-mm/enabler/iw/event",
	"ic-mm/enabler/iw/iContext",
	"ic-mm/enabler/iw/io",
	"ic-mm/enabler/iw/utils"
], function (declare, topic, ItemSet, event, iContextModule, io, utils) {

	var iContextImpl = declare("com.ibm.mm.enabler.iw.iContextImpl", iContextModule, {
	    ...
	    getElementById: function(/*String*/id,root){
	         ...
	         var element=[];
	         var rc = utils.findElementByAttribute("id",id,root,element,false);
	    ...
	    processiWidgets:function(/*domnode*/root){
	         topic.publish("/com/ibm/mashups/livetext/livetextchanged", root, true);
	    },
	    getElementByClass:function(classname,root){
	        ...
	        //todo: use dojo.query
	        var element=[];
	        var rc = utils.findElementByAttribute("class",classname,root,element,true);
	...
	declare("com.ibm.mm.enabler.iw.iContextImpl.mmExtension", null, {
