define([
	...
	"dojo/dom-construct",
	"dojo/topic",
	"com/ibm/oneui/controls/AutocompleteMenu"
], function (dojo, declare, domConstruct, topic, AutocompleteMenu) {

	/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	
	var InlineAutocompleteMenu = declare("com.ibm.oneui.InlineAutocompleteMenu", AutocompleteMenu, {
		showing: true,
		...
		postCreate: function() {
			...
			domConstruct.place(infoNode, this.emptyNode, "before");
