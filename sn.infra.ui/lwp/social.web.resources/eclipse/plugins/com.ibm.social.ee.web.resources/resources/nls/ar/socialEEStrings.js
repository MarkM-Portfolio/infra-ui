...
({
   ...
   ecm_draft: {
      ...
      community_owners: "مالكي المجتمع",
      draft: "المسودة",
  	  ...
  	  vote: {
  		  INLINE: {
  				...
  				RECOMMENDED: {
  					...
  					TEXT: 		"<span class='lotusLikeDescription'>تم التصويت</span> <span class='lotusDivider' role='presentation'>-</span> <a class='lotusLikeActions' role='button' aria-label='تم التصويت - تراجع' href='javascript:;' id='TOGGLE_${id}'>تراجع</a>",
