define(
	...
	({
	   ...
	   goBack: {label: "בחזרה לראש. ", a11y: "הפעלת קישור זה יחזיר את המיקוד לראש הדו-שיח הצץ. "},
	   STATUS: {
	   ...
	   COMMUNITYUPLOADFILE: {
		   ...
		   SHARE_WITH_COMMUNITY: {
			   ...
			   ERROR_X: "לא ניתן לשתף את הקבצים. נא לנסות שוב מאוחר יותר.",
	           MAX_SHARES_ERROR: "היתה חריגה ממספר השיתופים המרבי.",
	           EXTERNAL_SHARES_ERROR: "אפשר לשתף את הקובץ רק בתוך הארגון.",
	           EXTERNAL_SHARES_ERROR_X: "אפשר לשתף את הקובץ רק בתוך הארגון.",
	           ...
	           VISIBILITY_RESTRICTION: {
	        	   ...
	        	   ERROR_SHARE_X: "לא ניתן להגדיר קבצים מוגבלים כציבוריים."
	           }
	         },
		   UPLOAD_TO_COMMUNITY: {
			   ...
			   ERROR_X: "לא ניתן לטעון את ${0} could not be uploaded.  נא לנסות שוב מאוחר יותר.",
			   INFO_SUCCESS_PRE_MODERATION: "הקובץ ${0} הוגש לסקירה ויהיה זמין לאחר שיאושר.",
			   MULTI_INFO_SUCCESS_PRE_MODERATION: "${0} קבצים הוגשו לסקירה ויהיה זמינים לאחר שיאושרו."
		   }
	      },
	   UPLOADFILE: {
