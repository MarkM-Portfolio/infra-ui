    ...
    null,
{
    ...
    constructor:function( /*HttpUrl*/feedlocation, /*HTMLFormElement?*/formNode, /*Function?*/formFilter, /*boolean?*/textOnly, /*boolean?*/sync ) {
        ...
        create: function ( /*ibm.atom.Feed*/feed, /*Function*/callbackfn, /*Object?*/addtlCallbackFnArguments ) {
            ...
            var args = {
                url: this._feedURI,
                headers: { "If-Modified-Since": "Thu, 1 Jan 1970 00:00:00 GMT","Content-Type":"text/xml"}, //temporary to force the browser to ignore cached requests
        ...
        update: function ( /*ibm.atom.Feed*/feed, /*Function*/callbackfn, /*Object?*/addtlCallbackFnArguments ) {
			...
			var requestHeaders = { "If-Modified-Since": "Thu, 1 Jan 1970 00:00:00 GMT","Content-Type":"text/xml"};
            ...
            var args = {
                ...
                load: function( response, ioArgs ) {
                    ...
                    if ( loc ) {
                        ...
                        //refresh.
                        if ( loc.indexOf( "/myportal") >= 0 && me._feedURI.indexOf( "/portal") >= 0 ) {
