...
return {depends: [["provide", "dojox.date.buddhist"],
["require", "dojox.date.buddhist.Date"],
["require", "dojo.date"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.buddhist"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
