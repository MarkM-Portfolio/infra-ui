...
dojo.declare("com.ibm.social.incontext.typeahead.data.PeopleDataStore", null, {
    ...
    minChars: dojo.getObject("com.ibm.social.incontext.typeahead.config.minChars") || 2,
    searchDelay: dojo.getObject("com.ibm.social.incontext.typeahead.config.searchDelay") || 400,
    ...
    fetch: function(keywordArgs) {
        ...
        var isServerQuery = (com.ibm.social.incontext.util.text.lengthUtf8(keywordArgs.query) >= this.minChars); // If we are searching on 0 or 1 characters, we check the local people store
        ...
        var url = isServerQuery ? (this.url || this.getUrl()) : this.networkUrl;
		  ...
		  url = com.ibm.social.incontext.util.uri.rewriteUri(url, params);
