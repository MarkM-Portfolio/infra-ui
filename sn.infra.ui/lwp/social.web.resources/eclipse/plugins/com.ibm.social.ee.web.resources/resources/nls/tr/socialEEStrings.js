...
({
   ...
   VERSIONS: {
      ...
      INFO: "${0} sürümünün oluşturulma zamanı: ${1}, oluşturan: ",
   ...
   login: {
      error: "Kullanıcı adınız ve/veya parolanız, var olan hesapların hiçbiriyle eşleşmiyor. Lütfen yeniden deneyin.",
      logIn: "Oturum Aç",
      password: "Parola:",
      user: "Kullanıcı adı:",
