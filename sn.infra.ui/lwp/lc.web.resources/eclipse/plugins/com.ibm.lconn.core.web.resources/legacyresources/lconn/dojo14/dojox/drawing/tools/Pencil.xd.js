...
return {depends: [["provide", "dojox.drawing.tools.Pencil"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.tools.Pencil"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
