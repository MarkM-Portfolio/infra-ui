...
return {depends: [["provide", "dojox.xmpp.RosterService"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.RosterService"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
