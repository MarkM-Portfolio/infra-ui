  ...
  /* The placeholders for date formatting strings are as follows:
		...
		*/
		   ...
		   file: {
		      ...
		      profile_title: "${user} のプロフィールを開きます。",
		      profile_a11y: "このリンクをアクティブにすると、${user} のプロフィールが新しいウィンドウで開きます。",
		      download_tooltip: "このファイルをダウンロード (${0})",
		      following: {
		         add: "ファイルのフォロー",
		         remove: "フォローの停止",
		  	  ...
		  	  vote: {
		  		  INLINE: {
		  				...
		  				RECOMMENDED: {
		  					...
		  					TEXT: 		"<span class='lotusLikeDescription'>投票済みです</span> <span class='lotusDivider' role='presentation'>-</span> <a class='lotusLikeActions' role='button' aria-label='Voted - Undo' href='javascript:;' id='TOGGLE_${id}'>取り消す</a>",
		  					TOOLTIP: 	"これへの投票を取り消す"
		  				},
		  				RECOMMENDED_BYNONE:  {
