...
dojo.declare("com.ibm.mm.enabler.iw.iEventImpl",com.ibm.mm.enabler.iw.iEvent,
{
...
dojo.declare("com.ibm.mm.enabler.iw.iEventDescriptionImpl",com.ibm.mm.enabler.iw.iEventDescription,
{
    ...
    constructor:function (/*String*/name,/*function*/handlingFn,/*String*/type,/*[]*/description,/*String[]*/aliases,defaultLang,/*[]*/descriptions) {
        ...
        else this.handlingFn = null; 

        this.lang = defaultLang;

        //each description is saved in following format {lang,description,descriptionURI}
   ...
   _getLocalizedAttribute:function(attributeName,locale){
       ...
       var finalLocale = com.ibm.mm.enabler.utilities.getLocale(this,locale,this.lang);
...
dojo.declare("com.ibm.mm.enabler.iw.iEventsImpl",com.ibm.mm.enabler.iw.iEvents,
{
    ...
    publishEvent:function(/*String*/eventName,payload,payloadType){
        ...
        var aEvent = new com.ibm.mm.enabler.iw.iEventImpl(eventName,payloadType,payload,null);  
...
dojo.declare("com.ibm.mm.enabler.iw.eventHolder",null,
{
