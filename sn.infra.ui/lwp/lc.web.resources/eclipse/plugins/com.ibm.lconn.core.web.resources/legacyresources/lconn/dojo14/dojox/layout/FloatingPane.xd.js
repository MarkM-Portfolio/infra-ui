...
return {depends: [["provide", "dojox.layout.FloatingPane"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.FloatingPane"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
