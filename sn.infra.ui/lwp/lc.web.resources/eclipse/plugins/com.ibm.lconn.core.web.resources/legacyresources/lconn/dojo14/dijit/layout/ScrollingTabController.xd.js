...
return {depends: [["provide", "dijit.layout.ScrollingTabController"],
["require", "dijit.layout.TabController"],
["require", "dijit.Menu"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.ScrollingTabController"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
