...
return {depends: [["provide", "dojox.lang.docs"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.lang.docs"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
