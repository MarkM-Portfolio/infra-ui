...
dojo.provide("lconn.test.jasmine.ckeditor.TypeAheadMenuSpec");

dojo.require("lconn.core.ckplugins.mentions.TypeAheadMenu");
dojo.require("lconn.test.mocks.ckeditor");

(function(typeAhead, mocks) {
   var typeAhead = new lconn.core.ckplugins.mentions.TypeAheadMenu,
      _typeAhead;
   var testDiv = dojo.create('div');
   var tempPrevious = dojo.create('div', {
      innerHTML : '<p>Previous Button</p>',
      type : 1,
            }, testDiv);
   var testNode1 = dojo.create('div', {
      innerHTML : '<a class="fn" href="">@Amy Jones1</a><span class="x-lconn-userid">523cc6c0</span>',
      className : 'dijitMenuItemSelected',
      type : 1
            }, testDiv);
   var testNode2 = dojo.create('div', {
      innerHTML : '<a class="fn" href="">@Amy Jones2</a><span class="x-lconn-userid">523cc6c2</span>',
      className : 'vcard',
      type : 1,
            }, testDiv);
   var tempSearch = dojo.create('div', {
   ...
   describe('the lconn.core.ckplugins.mentions.TypeAheadMenu.createMenu', function() {
   ...
   describe('the lconn.core.ckplugins.mentions.TypeAheadMenu.focusPrevious', function() {
   ...
   describe('the lconn.core.ckplugins.mentions.TypeAheadMenu.focusNext', function() {
...
}(lconn.core.ckplugins.mentions.TypeAheadMenu, lconn.test.mocks.ckeditor));
