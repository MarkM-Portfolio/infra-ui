...
return {depends: [["provide", "dijit.layout.BorderContainer"],
["require", "dijit.layout._LayoutWidget"],
["require", "dojo.cookie"],
["require", "dijit._Templated"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.BorderContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
