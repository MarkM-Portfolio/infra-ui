...
return {depends: [["provide", "dojox.highlight.languages._dynamic"],
["require", "dojox.highlight.languages.python"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.highlight.languages._dynamic"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
