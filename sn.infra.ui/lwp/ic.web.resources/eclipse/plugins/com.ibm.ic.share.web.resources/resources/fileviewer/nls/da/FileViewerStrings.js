...
define({
      ...
      FILE_MALICIOUS: "Scanning afslørede skadeligt indhold",
      SHARED_EXTERNALLY: "Delt eksternt",
      FILE_SYNCED: "Tilføjet til synkronisering",
      MY_DRIVE: {
         TITLE: "I Mit drev",
         ROOT_FOLDER: "/Mit drev",
         FOLDER: "/Mit drev/.../${0}"
      },
      MORE_ACTIONS: {
         ...
         A11Y: "Åbner en rullemenu med en liste over flere handlinger, der kan udføres for filen.",
            PANELS: {
               TITLE: "Mere",
               A11Y: "Åbner en rullemenu med en liste over skjulte skærmbilleder"
            }
      },
      WELCOME: {
      ...
      SPLIT_ACTION: {
         MENU: {
            TITLE: "Flere redigeringsmuligheder",
            A11Y: "Brug denne knap til at åbne en menu med flere redigeringsmuligheder."
         },
         BUTTON: {
            EDIT: {
               TITLE: "Redigér"
      ...
      ACTION: {
         RESIZE: {
           RESIZE_BAR: "Tilpas størrelse på panel",
           USAGE: "Tryk på tasterne med venstre eller højre parentes for at tilpasse størrelsen på panelet."
       },
         CLOSE: {
            TOOLTIP: "Luk",
            A11Y: "Brug denne knap til at lukke filfremviseren.",
            WARNING_DIALOG: {
              DIALOG_TITLE: "Din fil er stadig ved at blive uploadet.",
              PROMPT: "Din fil er stadig ved at blive uploadet. Hvis du lukker, før den er færdig, vil uploadningen blive annulleret.",
              OK: "Luk alligevel",
              CANCEL: "Vent på uploadning"
            }
         },
         ADD_TO_FILES: {
           TOOLTIP: "Tilføj til Filer",
           A11Y: "Brug denne knap til at tilføje vedhæftningen til Filer.",
           VIEW_NOW: "Vis nu"
         },
         TEAR_OFF: {
           TOOLTIP: "Åbn i nyt vindue",
           A11Y: "Åbn i nyt vindue",
           ERROR_TEARING_OFF: "Der er opstået en fejl under åbning af det nye vindue.",
           DIALOG_TITLE: "Bekræft",
           UNSAVED_CHANGES_WARNING: "Du har ikke-gemte ændringer, som vil gå tabt. Vil du åbne det nye vindue alligevel?",
           OK: "Ja",
           CANCEL: "Nej",
           OPEN: "Åbn",
           OPEN_ANYWAY: "Åbn alligevel",
           CANCEL_ALT: "Annullér"
         },
         ...
         DOWNLOAD_AS_PDF: {
            ...
            DOCS_ERRORS: {
               NO_PUBLISHED_OR_EMPTY: "Der er ingen publiceret version af denne fil, der kan downloades.  Versioner kan publiceres fra Docs-editoren."
            }
         },
         DOWNLOAD_DOCS_FILE: {
            EMPTY_FILE_EDITOR: {
               ...
               CANCEL: "Luk",
               PROMPT: "Der er ingen publiceret version af denne fil, der kan downloades.",
         ...
         TOGGLE_PANEL: {
            ...
            RESET_A11Y: "Denne knap ændrer sidepanelet tilbage til standardstørrelse. Sidepanelet er i øjeblikket udvidet."
         },
         VIEW_DOC: {
         ...
         EDIT_DOC: {
            NAME: "Redigér i Docs",
            TOOLTIP: "Brug HCL Docs til at redigere filen",
            A11Y: "Knappen åbner filen i redigeringstilstand i et nyt vindue."
         },
         EDIT_OFFICE: {
            TITLE: "Redigeringsmuligheder.",
            NAME: "Redigér i Microsoft Office Online",
            TOOLTIP: "Brug Microsoft Office Online til at redigere filen",
            A11Y: "Knappen åbner filen i redigeringstilstand i Microsoft Office Online i et nyt vindue."
         },
         EDIT_OFFICE_WORD: {
           NAME: "Redigér i Microsoft Word Online",
           TOOLTIP: "Brug Microsoft Word Online til at redigere filen",
           A11Y: "Knappen åbner filen i redigeringstilstand i Microsoft Word Online i et nyt vindue."
         },
         EDIT_OFFICE_EXCEL: {
             NAME: "Redigér i Microsoft Excel Online",
             TOOLTIP: "Brug Microsoft Excel Online til at redigere filen",
             A11Y: "Knappen åbner filen i redigeringstilstand i Microsoft Excel Online i et nyt vindue."
         },
         EDIT_OFFICE_POWERPOINT: {
             NAME: "Redigér i Microsoft PowerPoint Online",
             TOOLTIP: "Brug Microsoft PowerPoint Online til at redigere filen",
             A11Y: "Knappen åbner filen i redigeringstilstand i Microsoft PowerPoint Online i et nyt vindue."
         },
         OFFICE_EDITED: {
             SUCCESS: "Filen gemmes."
         },
         ROUNDTRIP_EDIT: {
            NAME: "Redigér på skrivebord",
            DIALOG_TITLE: "Redigér på skrivebord",
            TOOLTIP: "Redigér dette dokument",
            A11Y: "Denne knap åbner en fil, så den kan redigeres lokalt.",
            PROMPT: "Denne funktion giver dig mulighed for at redigere med software, der er installeret på din computer.",
            INSTALL: "Før du fortsætter, skal du ${startLink}installere desktop connector-funktioner til filer${endLink}.", // The text between the start/end link tags will be a link to download an installer
            IMPORTANT: "Vigtigt:",
            REMINDER: "Når du er færdig med at redigere, kan du publicere en kladde ved hjælp af desktop connector-funktioner til filer.",
         ...
         STOP_SHARING: {
            ...
            EFSS: {
              DIALOG_TITLE: "Bekræft",
              REMOVE_EVERYONE: "Er du sikker på, at du vil fjerne din organisations adgang til denne fil? Hvis adgangen fjernes, bliver filen fjernet fra foldere, der tillader adgang på organisationsniveau, og kun ejeren og de personer, som den har været delt med, kan se og arbejde med den.",
              REMOVE_USER: "Er du sikker på, at du vil stoppe deling med ${user}? Hvis du stopper deling, har ${user} kun adgang til filen via foldere, eller hvis den deles med alle i organisationen.",
              REMOVE_COMMUNITY: "Er du sikker på, at du vil fjerne denne fil fra fællesskabet ${communityName}?",
              REMOVE_FOLDER: "Er du sikker på, at du vil fjerne denne fil fra folderen ${folderName}?",
              REMOVE_EVERYONE_TOOLTIP: "Fjern din organisations adgang",
         ...
         TOGGLE_SYNC: {
            ...
            MYDRIVE: {
                NAME: "Tilføj til Mit drev",
                TOOLTIP: "Tilføj denne fil til Mit drev",
                A11Y: "Brug denne knap til at tilføje filen til Mit drev.",
                SUCCESS: "Du har tilføjet denne fil til Mit drev.",
                ERROR: {
                   DEFAULT: "Der er opstået en fejl under forsøg på at tilføje filen til Mit drev. Prøv igen senere.",
                   UNAUTHENTICATED: "Tidsfristen for din session er udløbet. Du skal logge på igen, før du kan tilføje filen til Mit drev.",
                   NOT_FOUND: "Du kan ikke tilføje filen til Mit drev, fordi den er slettet eller ikke længere deles med dig.",
                   ACCESS_DENIED: "Du kan ikke tilføje filen til Mit drev, fordi den er slettet eller ikke længere deles med dig."
                }
             },
             REMOVE_MYDRIVE: {
                NAME: "Fjern fra Mit drev",
                TOOLTIP: "Fjern denne fil fra Mit drev",
                A11Y: "Brug denne knap til at fjerne filen fra Mit drev.",
                SUCCESS: "Du har fjernet denne fil fra Mit drev.",
                ERROR: {
                   DEFAULT: "Der er opstået en fejl under forsøg på at fjerne filen fra Mit drev. Prøv igen senere.",
                   UNAUTHENTICATED: "Tidsfristen for din session er udløbet. Du skal logge på igen, før du kan fjerne filen fra Mit drev.",
                   NOT_FOUND: "Du kan ikke fjerne filen fra Mit drev, fordi den er slettet eller ikke længere deles med dig.",
                   ACCESS_DENIED: "Du kan ikke fjerne filen fra Mit drev, fordi den er slettet eller ikke længere deles med dig."
                }
             }
         },
         TOGGLE_FAVORITE: {
         ...
         TRASH: {
            ...
            DIALOG_TITLE: "Bekræft",
            PROMPT: "Er du sikker på, at du vil flytte denne fil til papirkurven? Hvis du flytter denne fil til papirkurven, bliver den utilgængelig for alle de personer, den i øjeblikket er delt med.",
         ...
         TRANSFER_FILE: {
            NAME: "Overfør ejerskab ...",
            DIALOG_TITLE: "Overfør ejerskab",
            TOOLTIP: "Overfør denne fil til en ny ejer",
            A11Y: "Brug denne knap til at åbne en dialogboks, hvor du kan overføre denne fil til en ny bruger.",
            EMPTY: "Tom"
         },
         UPLOAD_VERSION: {
            ...
            TOOLTIP: "Upload en ny version af denne fil",
            A11Y: "Brug denne knap til at åbne en dialog, hvor du kan uploade en ny version af denne fil."
         },
         LOG_IN: {
            NAME: "Log på",
            TOOLTIP: "Log på for at uploade og dele filer, kommentere og oprette mapper."
         },
         LOCK: {
            NAME: "Lås fil",
            TITLE: "Lås denne fil",
            ...
            ERROR: "Filen kan ikke låses, fordi den er slettet eller ikke længere deles med dig."
         },
         UNLOCK: {
            NAME: "Lås fil op",
            ...
            ERROR: "Filen kan ikke låses op, fordi den er slettet eller ikke længere deles med dig."
         },
         EDIT_ON_DESKTOP: {
            NAME: "Redigér på skrivebord",
         ...
         FLAG: {
            FILE: {
               ...
               ERROR: "Fejl under markering af filen. Prøv igen senere."
            },
            FILE_DIALOG: {
               DIALOG_TITLE: "Udført",
               PROMPT: "Filen er markeret og sendt til gennemgang.",
               CANCEL: "OK"
            },
            COMMENT: {
               NAME: "Markér som upassende",
               ...
               ERROR: "Fejl under markering af kommentaren. Prøv igen senere."
            }
         },
         MODERATION: {
            DIALOG_TITLE: "Udført",
            PROMPT: "Ændringerne er sendt til gennemgang. Filen vil ikke være tilgængelig, før ændringerne er godkendt.",
            CANCEL: "OK"
         },
         DROPDOWN_BUTTON: "Knap til rullemenu"
      },
      SECTION: {
         ABOUT: {
            NAME: "Om denne fil",
            VIEW_FILE_DETAILS: "Vis fildetaljer",
            A11Y: "Når dette link aktiveres, lukkes filfremviseren, og du dirigeres til siden med oplysninger om denne fil."
         }
      },
      PREVIEW: {
         ICON: {
            PREVIEW_NOT_AVAILABLE: "Der er ikke nogen tilgængelig forhåndsvisning af denne fil."
         },
         IMAGE: {
            ZOOM_IN: "Zoom ind",
            ZOOM_OUT: "Zoom ud",
            ...
            UNSAFE_PREVIEW: "Filen kan ikke forhåndsvises, fordi den ikke scannet for virus."
         },
         VIEWER: {
            LOADING: "Indlæser...",
            ...
            AUTOPUBLISH_TIMEOUT: "Serveren er for lang tid om at svare.  De seneste ændringer er muligvis ikke blivet publiceret."
         },
         VIDEO: {
            UNSAFE_PREVIEW: "Filen kan ikke forhåndsvises, fordi den ikke scannet for virus."
         }
      ...
      TYPEAHEAD_BOX: {
         ...
         SHARE: "Del",
         SHARE_ALT: "Del med denne person",
         ...
         PERSON_ARIA: "Skriv for at søge efter en person.  Tryk på Skift+tabulatortast for at skifte mellem personer, fællesskaber og alle i organisationen.",
         COMMUNITY_ARIA: "Skriv for at søge efter et fællesskab.  Tryk på Skift+tabulatortast for at skifte mellem personer, fællesskaber og alle i organisationen.",
      ...
      VALIDATION: {
         A11Y_TEXT: "Afkort teksten automatisk",
         COMMENT: {
      ...
      DOCS_STATUS_MESSAGE: {
         NO_ENTITLEMENT: "Denne fil kan være redigeret online af personer, som bruger HCL Docs.",
         NO_ENTITLEMENT_LINK: "Denne fil kan være redigeret online af personer, som bruger ${startLink}HCL Docs${endLink}.", // When configured, "HCL Docs" will be a link to more information about the product
         ...
         AUTOPUBLISH: {
            ...
            IN_PROGRESS: "Dine ændringer bliver publiceret. ${startLink}Opfrisk for at få dine ændringer vist.${endLink}",
            GENERIC: "Du skal muligvis opfriske siden for at se de seneste ændringer.  ${startLink}Opfrisk${endLink}"
         }
      },
      COMMENTS: {
      ...
      SHARE_OPTIONS: {
         ...
         MAKE_INTERNAL_DIALOG: {
            ...
            EFSS: {
               DIALOG_TITLE: "Gør den intern?",
               PROMPT: "Hvis du gør denne fil intern, betyder det, at den ikke længere kan deles med andre uden for din organisation. ${br}${br}" +
               "Delinger med eksterne personer eller foldere bliver fjernet.${br}${br}Hvis du gør en fil intern, er det permanent, og det kan ikke fortrydes."
            }
         },
         MAKE_PRIVATE_DIALOG: {
      ...
      PANEL: {
         LOAD_ERROR: "Der er opstået en fejl under læsning af filens metadata.",
         ABOUT: {
            TITLE: "Om",
            ...
            DOWNLOADS_EXPAND_ICON: "Udvid ikonen for at se, hvem der har få filen vist.",
            ...
            DOWNLOADS_LAST_VERSION: "Du har sidst fået version ${0} af denne fil vist",
            TAGS_HEADER: "Emneord",
         ...
         SHARING: {
            ...
            COMMUNITY_FILE: "Filer, som ejes af et fællesskab, kan ikke deles med personer eller andre fællesskaber.",
            SHARED_WITH_COMMUNITY: "Delt med medlemmer af fællesskabet '${0}'",
            LOGIN: "Log på",
            NO_SHARE: "Filen er endnu ikke blevet tilføjet til nogen foldere.",
            ONE_SHARE: "Denne fil findes i 1 folder eller fællesskab, som du ikke har adgang til.",
      ...
      UPLOAD_VERSION: {
         ...
         UPLOAD: "Upload",
         UPLOAD_AND_CHANGE_EXTENSION: "Upload og redigér filtype",
         CANCEL: "Annullér",
         TOO_LARGE: "${file} er større end den maksimale tilladte filstørrelse på ${size}.",
         PROGRESS_BAR_TITLE: "Uploader ny version (${uploaded} af ${total} udført)",
         CANCEL_UPLOAD: "Annullér uploadning"
      },
      OPEN_BY_ID_ERROR: {
      ...
      NOTFOUND_FILE_DIALOG: {
         DIALOG_TITLE: "Fejl",
         PROMPT: "Den fil, du har anmodet om, er slettet eller flyttet.",
         CANCEL: "OK"
      },
      LOST_AUTHENTICATION_DIALOG: {
        DIALOG_TITLE: "Bekræft",
        PROMPT: "Tidsfristen for din HCL Connections-session er udløbet.${lineBreaks}Klik på OK for at logge på igen eller på Annullér for at lukke denne dialogboks.",
        OK: "OK",
        CANCEL: "Annullér"
      },
      ERROR_VALIDATING_FILES_FILE: {
        DIALOG_TITLE: "Kan ikke få adgang til link",
        PROMPT: "Der gik noget galt under forsøget på at oprette forbindelse til linket.${lineBreaks}Klik på OK for at blive omdirigeret til siden.",
        OK: "OK",
        CANCEL: "Annullér"
      },
      LOAD_ERROR: {
         DEFAULT: "Beklager. Der er opstået en fejl under forsøg på at oprette adgang til linket.",
         ACCESS_DENIED: "Kontakt filejeren for at anmode om tilladelse til at få filen vist."
      },
      WINDOW_TITLE: {
         FILE: "${fileName} - Fil",
      ...
      SHARE_WITH_LINK: {
         TITLE: "Del med link",
         EMPTY_DESCRIPTION: "Du har endnu ikke oprettet et link til denne fil. Opret et delt link, som du kan sende til andre, så de kan vise og downloade filen.",
         CREATE_LINK: "Opret et link",
         COPY_LINK: "Kopiér link",
         DELETE_LINK: "Slet link",
         ACCESS_TYPE_1: "Alle med linket kan få denne fil vist",
         ACCESS_TYPE_2: "Personer i min organisation kan få denne fil vist",
         ACCESS_TYPE_1_DESCRIPTION: "Personer, som modtager linket, kan forhåndsvise og downloade denne fil, når de er logget på Connections.",
         ACCESS_TYPE_2_DESCRIPTION: "Personer i min organisation, som modtager linket, kan forhåndsvise og downloade denne fil, når de er logget på Connections.",
         CHANGE_TYPE_SUCCESS: "Linktilladelse opdateres, når adgangstypen ændres.",
         CHANGE_TYPE_ERROR: "Linktilladelse opdateres ikke, når adgangstypen ændres.",
         COPY_LINK_SUCCESS: "Link kopieret til udklipsholderen",
         CREATE_SHARELINK_SUCCESS:"Link oprettet.",
         CREATE_SHARELINK_ERROR:"Kan ikke oprette et link på grund af en fejl.",
         DELETE_SHARELINK_SUCCESS: "Slet det delte link til \"${file}.\"",
         DELETE_SHARELINK_ERROR: "Det delte link blev ikke slettet. Prøv igen senere.",
         CONFIRM_DIALOG: {
            OK: "Slet",
            DIALOG_TITLE: "Slet det delte link",
            PROMPT: "Filen vil blive utilgængelig for dem, der har linket. Er du sikker på, at du vil slette det delte link?"
         },
         COPY_LINK_ACTION_TOOLTIP_TYPE_1: "Delt link er aktivt. Alle med linket kan få denne fil vist. Klik for at kopiere linket.",
         COPY_LINK_ACTION_TOOLTIP_TYPE_2: "Delt link er aktivt. Personer i min organisation kan få denne fil vist. Klik for at kopiere linket."
      }
});
