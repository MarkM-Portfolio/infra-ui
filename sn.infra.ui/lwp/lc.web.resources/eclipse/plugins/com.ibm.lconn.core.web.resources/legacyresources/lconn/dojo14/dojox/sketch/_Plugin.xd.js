...
return {depends: [["provide", "dojox.sketch._Plugin"],
["require", "dijit.form.Button"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.sketch._Plugin"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
