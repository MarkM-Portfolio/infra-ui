...
return {depends: [["provide", "dojox.jsonPath.query"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.jsonPath.query"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
