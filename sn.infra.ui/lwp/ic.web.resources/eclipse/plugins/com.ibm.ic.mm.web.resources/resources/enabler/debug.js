...
define([
      ...
      "dojo/topic",
      "../enabler/status"
], function(lang, topic, status) {

   lang.setObject("com.ibm.mm.enabler.debug", {});

   lang.setObject("com.ibm.mm.enabler.debug", "Constants", {
   ...
   com.ibm.mm.enabler.debug.log = function(/* string */functionName) {
      ...
      // description:
      // This can be used to write tracing statement to firebug console or
      // publish to another page components
      // You may pass as many arguments you may like.
      // functionName: function name with class, for example
      // com.ibm.mm.enabler.iw.WidgetStub.getItemSet
   ...
   com.ibm.mm.enabler.debug.entry = function(functionName) {
      ...
      // You may pass as many arguments you may like.
      // functionName: function name within the class, for example
      // com.ibm.mm.enabler.iw.WidgetStub.getItemSet
      if (com.ibm.mm.enabler.debug.isLogging) {
         if (arguments.length > 1) {
   ...
   com.ibm.mm.enabler.debug.info = function(functionName) {
      ...
      // description:
      // This can be used to write a message as "info" to firebug console or
      // publish to another page components
      // You may pass as many arguments you may like.
      // functionName: function name within the class, for example
      // com.ibm.mm.enabler.iw.WidgetStub.getItemSet
   ...
   com.ibm.mm.enabler.debug.warn = function(functionName) {
      ...
      // description:
      // This can be used to write a message as "warning" to firebug console or
      // publish to another page components
      // You may pass as many arguments you may like.
      // functionName: function name within the class, for example
      // com.ibm.mm.enabler.iw.WidgetStub.getItemSet
   ...
   com.ibm.mm.enabler.debug.error = function(functionName) {
      ...
      // description:
      // This can be used to write a message as "error" to firebug console or
      // publish to another page components
      // You may pass as many arguments you may like.
      // functionName: function name within the class, for example
      // com.ibm.mm.enabler.iw.WidgetStub.getItemSet
   ...
   com.ibm.mm.enabler.debug._log = function(type, args) {
      if (com.ibm.mm.enabler.debug.isLogging) {
         if (args.length >= 2 && lang.isString(args[1])) {
            var arr = [];
   ...
   com.ibm.mm.enabler.debug._publishTracing = function(type, args) {
      if (typeof ibmConfig != "undefined" && ibmConfig !== null && ibmConfig.allowPublishTracing === true) {
         ...
         topic.publish(com.ibm.mm.enabler.debug.Constants.MMTracing, arguments);
      }
   };
   com.ibm.mm.enabler.debug._publishLogging = function(type, args) {
      if (typeof ibmConfig != "undefined" && ibmConfig !== null && ibmConfig.allowPublishLogging === true) {
         ...
         topic.publish(com.ibm.mm.enabler.debug.Constants.MMLogging, arguments);
      }
   };
   ...
   com.ibm.mm.enabler.debug.logInlineMessage = function(containerNode, type, message, details, component) {
      ...
      var statusMsg = new status.StatusMessage(type, message, details);
      if (containerNode) {
   ...
   com.ibm.mm.enabler.debug._publishStatusMsg = function(type, message, details, args, component) {
      if (typeof ibmConfig != "undefined" && ibmConfig !== null && ibmConfig.allowPublishStatusMsg === true) {
         ...
         topic.publish(com.ibm.mm.enabler.debug.Constants.MMStatusMsg, arguments);
      }
   };

   return com.ibm.mm.enabler.debug;
});
