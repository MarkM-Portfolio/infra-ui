...
return {depends: [["provide", "dijit.tree.TreeStoreModel"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tree.TreeStoreModel"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
