...
dojo.provide("lconn.test.jasmine.mentions.MentionsKeyHandlersSpec");

dojo.require("lconn.core.widget.mentions.MentionsKeyHandlers");

(function(MentionsKeyHandlers) {
   ...
   describe("the mixin lconn.core.widget.mentions.MentionsKeyHandlers", function() {
   ...
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.hasNoKeyModifiers() method", function() {   
      var e = {
            shiftKey : true,
            ctrlKey : true,
            altKey : true,
   ...
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.canActivate() method", function() {
   ...
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isLeftArrow() method", function() {
      it("returns the left arrow keyCode", function() {
         expect(m.isLeftArrow({keyCode: dojo.keys.LEFT_ARROW, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isRightArrow() method", function() {
      it("returns the right arrow keyCode", function() {
         expect(m.isRightArrow({keyCode: dojo.keys.RIGHT_ARROW, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isEscape() method", function() {
      it("returns the escape keyCode", function() {
         expect(m.isEscape({keyCode: dojo.keys.ESCAPE, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isTab() method", function() {
      it("returns the tab keyCode", function() {
         expect(m.isTab({keyCode: dojo.keys.TAB, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isBoldHotkey() method", function() {
      it("returns the bold hotkey keyCode", function() {
         expect(m.isBoldHotkey({keyCode: 66})).toBeFalsy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isItalicsHotkey() method", function() {
      it("returns the italics hotkey keyCode", function() {
         expect(m.isItalicsHotkey({keyCode: 73})).toBeFalsy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isUnderlineHotkey() method", function() {
      it("returns the underline hotkey keyCode", function() {
         expect(m.isUnderlineHotkey({keyCode: 85})).toBeFalsy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isBackspace() method", function() {
      it("returns the backspace keyCode", function() {
         expect(m.isBackspace({keyCode: dojo.keys.BACKSPACE, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isDelete() method", function() {
      it("returns the delete keyCode", function() {
         expect(m.isDelete({keyCode: dojo.keys.DELETE, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isSpace() method", function() {
      it("returns the space keyCode", function() {
         expect(m.isSpace({keyCode: dojo.keys.SPACE})).toBeFalsy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isCtrlEnter() method", function() {
      it("returns the ctrl+enter keyCode", function() {
         expect(m.isCtrlEnter({keyCode: 10})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isEnter() method", function() {
      it("returns the enter keyCode", function() {
         expect(m.isEnter({keyCode: dojo.keys.ENTER, charCode: 0})).toBeTruthy();
      });
   });
   
   describe("the lconn.core.widget.mentions.MentionsKeyHandlers.isUpDownArrow() method", function() {
      it("returns the up arrow keyCode", function() {
         expect(m.isUpDownArrow({keyCode: dojo.keys.UP_ARROW, charCode: 0})).toBeTruthy();
      });
      
      it("returns the down arrow keyCode", function() {
         expect(m.isUpDownArrow({keyCode: dojo.keys.DOWN_ARROW, charCode: 0})).toBeTruthy();
      });
   });
   
}(lconn.core.widget.mentions.MentionsKeyHandlers));
