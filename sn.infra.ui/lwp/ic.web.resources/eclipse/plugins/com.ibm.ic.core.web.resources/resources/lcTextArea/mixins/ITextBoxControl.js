...
define([
   ...
   "ic-core/util/text"
], function (declare, lang, domStyle, has, query, topic, keys, ITextBoxUtils, text) {
    ...
    * @mixin ic-core.lcTextArea.mixins.ITextBoxControl
    * @author Jim J Antill <antillj@ie.ibm.com>
    * @mixin ic-core.lcTextArea.mixins.ITextBoxControl
    */

   var ITextBoxControl = declare("lconn.core.lcTextArea.mixins.ITextBoxControl", ITextBoxUtils,
         /** @lends ic-core.lcTextArea.mixins.ITextBoxControl.prototype */ {
      ...
      _setInitialState: function() {
         ...
         if (this.charRemainingDisplay) {
            var displayFields = query(".charDisplay", this.charRemainingDisplay);
            this._charRemainingDisplayNode = (displayFields && displayFields.length > 0) ? displayFields[0] : this.charRemainingDisplay;

            var ariaFields = query(".ariaCharLabel", this.charRemainingDisplay);
      ...
      _showCharsRemaining: function(noChars) {
         if (noChars > this.showRemainingLimit) {
            if (this._showingCharsRemaining) {
               domStyle.set(this.charRemainingDisplay, "display", "none");
            ...
            if (!(this._showingCharsRemaining)) {
               domStyle.set(this.charRemainingDisplay, "display", "inline");
               this._showingCharsRemaining = true;
            }
      ...
      _calculateRemainingChars: function() {
         ...
         var noCharsInTextArea = text.trim(textInEditor).length ? text.length(textInEditor) : 0;
      ...
      _onKeyDown: function(ev) {
         ...
         if(this.keyDownCallback && lang.isFunction(this.keyDownCallback)){
      ...
      _onKeyPress: function() {
         ...
         // comment in the EE
         if (has("chrome") && this._showingShadowText) {
            this._hideShadowText();
         }
      ...
      _onResize: function(editor) {
         topic.publish("lconn/core/basictextbox/resized", {
            height : editor.container.$.clientHeight,
            editor : editor
         });
      }
   });
   return ITextBoxControl;
});
