...
return {depends: [["provide", "dijit.MenuBar"],
["require", "dijit.Menu"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.MenuBar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
