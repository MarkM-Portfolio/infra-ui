...
function getURLs(urlParams) {
   return [
         urlParams.protocol + '://' + urlParams.hostname + urlParams.webResourcesPathSuffix + '/ic-test/dojoConfig.js?dojo.preventcache='
...
module.exports = function(config) {
   config.set({
      ...
      basePath : 'http://localhost:52450/web/ic-test/',
      // frameworks to use
      frameworks : [ 'jasmine'
      ],
      ...
      proxies : {
         '/data' : 'http://localhost:52450/web/ic-test/data',
         '/tagcloud' : 'http://localhost:52450/web/ic-test/tagcloud',
         '/paletteOneUI' : 'http://localhost:52450/web/ic-test/paletteOneUI',
         '/widget' : 'http://localhost:52450/web/ic-test/widget',
