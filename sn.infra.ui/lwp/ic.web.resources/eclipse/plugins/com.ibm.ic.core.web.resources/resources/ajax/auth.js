...
define([
    ...
    * </pre>
    */
   lang.setObject("com.ibm.ajax.auth", {
      ...
      interceptDojoXhr: function(isUrlSecure) {
         ...
         dojo.xhr = lang.hitch(dojo, this.xhrIntercept, this, dojo.xhr);
         if (lang.getObject("dojo.io.iframe")) {
            dojo.io.iframe.send = lang.hitch(dojo.io.iframe, this.ioIntercept, this, dojo.io.iframe.send);
         }
      },
