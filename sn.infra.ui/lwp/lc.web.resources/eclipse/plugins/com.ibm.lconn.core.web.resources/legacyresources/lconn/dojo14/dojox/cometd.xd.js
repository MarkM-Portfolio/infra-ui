...
return {depends: [["provide", "dojox.cometd"],
["require", "dojox.cometd._base"],
["require", "dojox.cometd.longPollTransport"],
["require", "dojox.cometd.callbackPollTransport"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.cometd"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
