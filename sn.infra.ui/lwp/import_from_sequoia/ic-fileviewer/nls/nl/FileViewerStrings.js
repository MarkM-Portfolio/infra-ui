...
define ({
  root: {
     ...
     SPLIT_ACTION: {
       MENU: {
         TITLE: "Meer opties",
         A11Y: "Met deze knop opent u een menu voor meer opties."
       },
       BUTTON: {
         EDIT: {
           TITLE: "Bewerken"
     ...
     ACTION: {
       ...
       EDIT_DOC: {
         ...
         TOOLTIP: "Bestand bewerken in Docs",
       ...
       ROUNDTRIP_EDIT: {
         ...
         PROMPT: "Met deze functie kunt u het bestand lokaal bewerken.",
         IMPORTANT: "Let op:",
         REMINDER: "Wanneer u klaar bent met uw wijzigingen, moet u een conceptversie publiceren met behulp van de desktop-bestandsconnectors. Als het bestand niet kan worden geopend, kan het zijn dat u de desktopplugins moet installeren.",
       ...
       UPLOAD_VERSION: {
         ...
         TOOLTIP: "Een nieuwe versie van dit bestand uploaden",
         A11Y: "Met deze knop opent u een venster waarin u een nieuwe versie van dit bestand kunt uploaden."
       },
       LOG_IN: {
    	   NAME: "Aanmelden",
    	   TOOLTIP: "Meld u aan om bestanden en reacties te uploaden en te delen en mappen te maken."
       },
       LOCK: {
     ...
     SECTION: {
      ABOUT: {
       ...
       A11Y: "Als u deze link activeert, sluit u de bestandsviewer en gaat u naar de pagina met bestandsgegevens."
      }
     },
     PREVIEW: {
      ICON: {
     ...
     EDIT_BOX: {
       CANCEL: {
         TOOLTIP: "Annuleren",
         A11Y: "Met deze knop annuleert u de actie voor het wijzigen van de bestandsnaam."
       },
     ...
     TYPEAHEAD_BOX: {
       ...
       COMMUNITY: "Community",
       SHARE: "Delen",
       SHARE_ALT: "Delen met deze gebruiker",
       MEMBER_TYPE: "Type lid",
       PERSON_SHADOW: "Typ om een persoon te zoeken",
       COMMUNITY_SHADOW: "Typ om een community te zoeken",
     ...
     DOCS_STATUS_MESSAGE: {
       NO_ENTITLEMENT: "Het bestand kan alleen online worden bewerkt als u gerechtigd bent tot het gebruik van Docs. ",
     ...
     SHARE: {
	     ...
	     PUBLIC: {
	        ...
	        LONG: {
	           GENERIC: "Iedereen binnen uw organisatie",
	           ORG: "Iedereen in ${org}."
	        }
	     },
	     SHARE_FAIL: {
	     ...
	     PROVISION_EXTERNAL_USER_DIALOG: {
	       ...
	       ABSTRACT: {
            ...
            DIALOG_TITLE: "Content is niet gedeeld",
            PROMPT: {
              NO_ACCOUNT: "Sommige gebruikers hebben geen account. Er is daarom geen content met hen gedeeld.",
              INVITE: "Nodig deze gebruikers uit als gast om content met hen te delen."
            },
            SUBMIT: "Doorgaan met uitnodigingen",
            CANCEL: "Annuleren",
      ...
      SHARE_OPTIONS: {
	   ...
	   PANEL: {
	     ...
	     ABOUT: {
	       ...
	       DOWNLOADS_EXPAND_ICON: "Vouw dit pictogram uit om te zien wie het bestand heeft gedownload",
	       ...
	       DOWNLOADS_LAST_VERSION: "De laatste keer hebt u versie ${0} van het bestand gedownload.",
	       TAGS_HEADER: "Tags",
     ...
     LOAD_ERROR: {
       DEFAULT: "Er is een fout opgetreden bij het openen van de link.",
