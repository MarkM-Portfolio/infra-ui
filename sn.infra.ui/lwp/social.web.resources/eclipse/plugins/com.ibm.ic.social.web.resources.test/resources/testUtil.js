define([
	...
	"dojo/aspect",
	"dojo/topic"
], function (dojo, array, lang, aspect, topic) {
	...
	var util = lang.getObject("com.ibm.social.test.testUtil");
	...
	util.registerGroup = function(/*String*/ group, 
		...
		testTemplate = lang.mixin(testTemplate || {}, util.spyTemplate)
	...
	util.spyTemplate = {
		spyOn :  function(/*Object*/ obj,
			...
			aspect.after(this, "tearDown", lang.hitch(null, function(){
			...
			obj[funcName].calledWith = function(){
				...
				return array.some(savedArgs, function(args){
					return array.every(testArgs, function(testArg, ind){
		...
		subscribe: function(topic, func){
			var subscription = topic.subscribe(topic, func);
			this.own(aspect.after(this, "tearDown", lang.hitch(null, function(){subscription.remove();}), true));
			return subscription;
		},
		connect: function(){
			var connections = [];
	...
	return com.ibm.social.test.testUtil;
});
