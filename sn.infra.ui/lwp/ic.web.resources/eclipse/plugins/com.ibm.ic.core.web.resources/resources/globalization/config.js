...
define([
...
], function (lang, config, properties) {
	 ...
	 * @namespace ic-core.globalization.config
	 */
	return /** @lends ic-core.globalization.config */ {
	   /**
	   ...
	   areSettingsEnabled: function() {
	      return properties[this.SETTINGS_ENABLED_PROPERTY_NAME] !== false;
	   },
	   /**
	   ...
	   /**
	    * @memberof ic-core.globalization.config
	    */
	   defaults: _DEFAULTS
	};
});
