...
define([
   "dojo",
   "dojo/text!ic-core/templates/AddGroups.html",
   "dojo/aspect",
   "dojo/dom-construct",
   "dojo/_base/lang",
   "dojo/dom-class",
   ...
   "./PeopleTypeAhead",
   "./aria/Listbox"
], function (dojo, template, aspect, domConstruct, lang, domClass, dom, declare, topic, i18nstrings, _Templated, _Widget, BrowseGroups, GroupsDataStore, NameUtil, PeopleTypeAhead, Listbox) {
   ...
   */
   ...
   w.postMixInProperties =  function() {
       ...
       this.rs_browseGroups      = i18nstrings.rs_group_browse_groups;
       this.rs_groups            = i18nstrings.rs_member_groups;
       this.rs_members           = i18nstrings.rs_member_members;
       this.rs_addMember_title   = i18nstrings.rs_member_add_to_community;
       this.rs_removeMember_title = i18nstrings.rs_member_remove_group;
       this.rs_addGroup_title    = i18nstrings.rs_group_add_to_community;
       this.rs_removeGroup_title = i18nstrings.rs_group_remove_name;
       this.rs_group_typeahead     = i18nstrings.rs_group_name;
       this.rs_group_select      = i18nstrings.rs_group_role;

       if(this.NoResultsMessage){
           this.rs_noResults = this.NoResultsMessage;
       }else{
           this.rs_noResults = i18nstrings.rs_member_no_results;
       }
   ...
   w.postCreate=function(){
       ...
       this.memberStore = new GroupsDataStore({ url: url, queryParam: "member", orgId: this.orgId }, this.memberStore_AP );
       ...
       this.typeAhead_W = new PeopleTypeAhead( argsTA, this.membersCombo_AP );

       aspect.after(this.typeAhead_W, "_selectOption", lang.hitch(this, 'newMember'), true);
       ...
       this.browseGroups_W = new BrowseGroups( argsBG, this.browseGroups_AP );
       ...
       if (this.showRoleSelector == false)
       {
         ...
         domConstruct.destroy(this.groupSelect1_AP);
         domConstruct.destroy(this.groupSelect2_AP);
       }
   ...
   w.addNewGroup=function (aclLevel, personId, personName, personEmail) {
       ...
       domClass.add(newName, 'lotusFilter filterSpacing');
       ...
       this.connect(newName,'ondijitclick',
               lang.hitch(this, "removeMember", personId, type, aclLevel, newName)
       );
   ...
   //    content.innerHTML += currNameHtml;
       ...
       if (this.howManyMembers() >= this.scrollThreshold) {
           ...
           domClass.add(this.groupList_AP, "scroll");
       }
       ...
       if (w.cellContainer != null) {
           var cellElm = dom.byId(w.cellContainer);
           if (cellElm != null) {
   ...
   w.updateListbox = function(){
      ...
      this.listboxNavigation = new Listbox('groupList');
   };
   ...
   w.announceAdd = function(containerNode, aclLevel, personName) {
      var message = null;
      if (aclLevel == 'authors') {
         message = i18nstrings.rs_member_added;
         if (message == null)
   ...
   w.announceRemove = function(containerNode, aclLevel, personName) {
      var message = null;
      if (aclLevel == 'authors') {
         message = i18nstrings.rs_member_removed;
         if (message == null)
   ...
   var AddGroups = declare("lconn.core.AddGroups", [_Widget, _Templated], w);
