...
({
   ...
   ecm_draft: {
      tooltip: "Otvorite skicu ${name} u biblioteci",
      ...
      draft_review_404_request_info: "Prethodna skica više ne postoji i zadnja skica je poslata na pregled. Traži se vaš pregled.",
      draft_review_404_require_info: "Prethodna skica više ne postoji i zadnja skica je poslata na pregled. Traži se vaš pregled.",
   ...
   forum: {
      ...
      error_403: "Nemate dozvolu za gledanje ovog foruma. Forum nije javan i nije dijeljen s vama.",

      readMore: "Pregled svih tema...",
      readMore_tooltip: "Otvorite teme ${name} foruma.",
      readMore_a11y: "Aktiviranje ovog linka će otvoriti teme ${name} foruma u novom prozoru.",
   ...
   REPLIES: {
      ...
      ERROR: "Došlo je do greške prilikom pristupa odgovoru. ${again}",
      ERROR_CREATE: "Vaš odgovor nije mogao da se spremiti.  Pokušajte ponovo kasnije.",
      ERROR_CREATE_NOT_FOUND: "Vaš odgovor nije mogao da se spremiti zato sta je tema izbrisana ili vam više nije vidljiva.",
      ERROR_CREATE_ACCESS_DENIED: "Vaš odgovor nije mogao da se spremiti zato sta je tema izbrisana ili vam više nije vidljiva.",
   ...
   COMMENTS: {
      ...
      ERROR_CREATE_NOT_FOUND: "Vaš komentar nije mogao da se spremiti zato sta je stavka izbrisana ili vam više nije vidljiva.",
      ERROR_CREATE_ACCESS_DENIED: "Vaš komentar nije mogao da se spremiti zato sta je stavka izbrisana ili vam više nije vidljiva.",
      ERROR_CREATE_TIMEOUT: "Vaš komentar nije mogao da se spremiti zato sta nije mogao da se kontaktirati server.  Kliknite 'Postavi' za ponovni pokušaj.",
      ERROR_CREATE_CANCEL: "Vaš komentar nije mogao da se spremiti zato sta je zahtjev poništen.  Kliknite 'Postavi' za ponovni pokušaj.",
      ...
      ERROR_DELETE_TIMEOUT: "Vaš komentar nije mogao da se izbrisati zato sta nije mogao da se kontaktirati server.  Kliknite 'Obriši' za ponovni pokušaj.",
      ...
      ERROR_DELETE_CANCEL: "Vaš komentar nije mogao da se izbrisati zato sta je zahtjev poništen.  Kliknite 'Obriši' za ponovni pokušaj.",
      ...
      ERROR_EDIT_ACCESS_DENIED: "Vaš komentar nije mogao da se ažurira zato sta je stavka izbrisana ili vam više nije vidljiva.",
      ERROR_EDIT_NOT_FOUND: "Vaš komentar nije mogao da se ažurira zato sta je stavka izbrisana ili vam više nije vidljiva.",
      ERROR_EDIT_TIMEOUT: "Vaš komentar nije mogao da se ažurira zato sta nije mogao da se kontaktirati server.  Kliknite 'Postavi' za ponovni pokušaj.",
      ERROR_EDIT_CANCEL: "Vaš komentar nije mogao da se ažurira zato sta je zahtjev poništen.  Kliknite 'Postavi' za ponovni pokušaj.",
      ...
      FLAG_ITEM: {
         ...
         COMMENT: {
            ...
            A11Y: "Ovo dugme otvara dijalog koji korisniku omogućuje da označi ovaj komentar kao neodgovarajući."
         }
      }
   },
   ...
   COMMENTS_SUBMITTED: {
      ...
      CONFIRM: "Vaš komentar je poslat na pregled i bit će dostupan nakon odobrenja.",
      OK: "OK"
   },
   ...
   VERSIONS: {
      ERROR: "Ne mogu se učitati informacije o verziji.",
      ...
      CONTENT: {
         ...
         REVERT: {
            A11Y: "Ovo dugme otvara dijalog u kojem korisnik može potvrditi vraćanje datoteke iz ranije verzije. Potvrda ove akcije će rezultirati osvježavanjem sadržaja na stranici.",
            FULL: "Vraćanje",
      ...
      DELETE: {
         ...
         ERROR_TIMEOUT: "Verzija nije izbrisana zato sta nije mogao da se kontaktirati server.  Kliknite 'Obriši' za ponovni pokušaj zahtjeva.",
         ERROR_CANCEL: "Verzija nije izbrisana zato sta je zahtjev poništen.  Kliknite 'Brisanje' za ponovni pokušaj zahtjeva.",
         ...
         FULL: "Obriši",
         A11Y: "Ovo dugme otvara dijalog u kojem korisnik može potvrditi brisanje ove verzije. Potvrda ove akcije će rezultirati osvježavanjem sadržaja na stranici."
      },
      ...
      REVERT: {
         ...
         ERROR_NAME_EXISTS: "Verzija se nije mogla vratiti zato sta neka druga datoteka ima isto ime.",
         ERROR_TIMEOUT: "Verzija nije vraćena zato sta nije mogao da se kontaktirati server.  Kliknite 'Vraćanje' za ponovni pokušaj zahtjeva.",
         ERROR_CANCEL: "Verzija nije vraćena zato sta je zahtjev poništen.  Kliknite 'Vraćanje' za ponovni pokušaj zahtjeva.",
         ERROR_QUOTA_VIOLATION: "Verzija se nije mogla vratiti zbog ograničenja prostora.",
         ERROR_MAX_CONTENT_SIZE: "Verzija se nije mogla vratiti zato sta je veća od najveće dozvoljene veličine datoteke od ${0}",
   ...
   FILE_SHARE_INFO: {
      ...
      ERROR_NOT_FOUND: "Datoteka koju ste tražili je izbrisana ili premještena. Ako vam je neko poslao ovu vezu provjerite da li je ispravna.",
      ...
      TIMEOUT_ERROR: "Datoteka nije dijeljena zato sta nije mogao da se kontaktirati server.  Kliknite 'Podijeli' za ponovni pokušaj.",
      CANCEL_ERROR: "Datoteka nije dijeljena zato sta je zahtjev poništen.  Kliknite 'Dijeli' za ponovni pokušaj.",
      ...
      VISIBILITY_RESTRICTION_ERROR_SHARE: "Datoteka koja je ograničena, ne može se napraviti javnom.",
   ...
   HISTORY: {
      ...
      ERROR_ALT: "Greška",
      ERROR: "Došlo je do greške prilikom pristupa ažuriranjima. ${again}",
      ...
      SORTS: {
         DATE: "Datum",
         DATE_TOOLTIP: "Sortiraj od najnovije istorije do najstarijih ažuriranja",
         DATE_TOOLTIP_REVERSE: "Sortiraj od najstarije istorije do najnovijih ažuriranja"
      },
      TIMESTAMP: {
         CREATED: {
             DAY: "${EEEE} u ${time}",
   ...
   OAUTH: {
      ...
      continueBtnA11y: "Aktivacija ovog linka će otvoriti novi prozor koji će vam omogućiti ovlaštenje pristupa u Connections.",
   ...
   OAUTH_FILENET: {
      continueBtnA11y: "Aktivacija ovog linka će otvoriti novi prozor koji će vam omogućiti da ovlastite pristup u Connections repozitorij biblioteke.",
      infoMsg: "Connections repozitorij biblioteke treba vaše ovlaštenje za pristup vašim podacima.",
      authorizeGadget: "${clickHere} da ovlastite ovu aplikaciju za pristup vašim informacijama u Connections repozitorij biblioteke.",
      confirmAuthorization: "${clickHere} da potvrdite da ste ovlastili ovu aplikaciju za pristup vašim informacijama u Connections repozitorij biblioteke."
   },
   UNSAVEDCHANGES: {
      CANCEL: "Odustani",
