...
return {depends: [["provide", "dojox.uuid.Uuid"],
["require", "dojox.uuid"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.uuid.Uuid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
