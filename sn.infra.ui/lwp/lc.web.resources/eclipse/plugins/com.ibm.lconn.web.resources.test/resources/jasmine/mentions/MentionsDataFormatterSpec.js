...
/**
 * Jasmine spec for {@link lconn.core.widget.mentions.MentionsDataFormatter}
 * 
 * @module lconn.test.jasmine.mentions.MentionsDataFormatterSpec
 */
dojo.provide("lconn.test.jasmine.mentions.MentionsDataFormatterSpec");

dojo.require("lconn.core.widget.mentions.MentionsDataFormatter");

(function(MentionsDataFormatter) {
   var TEXT_DATA = {
      textData: [{
         type: "text",
         value: "foo"
   ...
   describe("the lconn.core.widget.mentions.MentionsDataFormatter class", function() {
   ...
   describe("the lconn.core.widget.mentions.MentionsDataFormatter.formatData() method", function() {
...
}(lconn.core.widget.mentions.MentionsDataFormatter));
