...
({
    prefixAgo: null,
    prefixFromNow: null,
    timeAgo: "пред %d",  // %d is a number with a unit, e.g., 17h ago meaning 17 hours ago
    now: "Сега",
    minutes: "%d минути",  // %d is a number, e.g., 17m meaning 17 minutes
    hours: "%d часа",    // %d is a number, e.g., 17h meaning 17 hours
    numbers: [],
    timeYesterday: "Вчера",
