/* Copyright IBM Corp. 2013, 2015  All Rights Reserved.              */
	...
	define([
		 ...
		 */
		var configNormalizer = declare("com.ibm.social.as.util.configNormalizer", [], {
			...
			constructor: function(args){
				...
				if(activityStreamConfig && activityStreamConfig.views && !activityStreamConfig.filters) {
					activityStreamConfig.filters = {"options":activityStreamConfig.views};												
					
					findSelected(activityStreamConfig.filters);
					
				} else if(activityStreamConfig && activityStreamConfig.filters && !activityStreamConfig.views) {
