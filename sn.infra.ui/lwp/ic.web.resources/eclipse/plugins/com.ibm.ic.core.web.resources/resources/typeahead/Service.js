		...
		_Widget, /** @lends ic-core.typeahead.Service.prototype */
	{
		...
		executeQuery: function(query) {
			...
			if(this._checkBeforeQueryExec(promise)) {
				...
				dataReaderPromise.then(lang.hitch(this, "_handleResults", promise, query));
				dataReaderPromise.otherwise(lang.hitch(this, "_handleError", promise));
			}
		...
		getNextPage: function() {
			...
			if(this._checkBeforeQueryExec(promise)) {
				...
				dataReaderPromise.then(lang.hitch(this, "_handleResults", promise, this._dataReader.lastQuery.query));
				dataReaderPromise.otherwise(lang.hitch(this, "_handleError", promise));
			}
