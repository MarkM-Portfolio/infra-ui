...
({
   ...
   COMMUNITYUPLOADFILE: {
	   ...
	   SHARE_WITH_COMMUNITY: {
           ...
           EXTERNAL_SHARES_ERROR: "A fájlt csak a szervezeten belül lehet megosztani.",
   ...
   UNSAVEDCHANGES: {
	   CANCEL: "Mégse",
	   CONFIRM_OTHER_TAB: "A többi lapon megadott információk elvesznek, ha folytatja az aktuális műveletet.  Kattintson az OK gombra a folytatáshoz vagy a Mégse gombra a visszalépéshez.",
