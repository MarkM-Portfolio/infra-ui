...
return {depends: [["provide", "dijit.layout._TabContainerBase"],
["require", "dijit.layout.StackContainer"],
["require", "dijit._Templated"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout._TabContainerBase"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
