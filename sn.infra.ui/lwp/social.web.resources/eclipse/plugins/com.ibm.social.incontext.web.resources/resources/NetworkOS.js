...
dojo.declare("com.ibm.social.incontext.NetworkOS", null,{
   oAuthDefaults: {},   
   ...
   _setDefaults: function(verb, opts) {
      ...
      opts.headers["Accept-Language"] = dojo.locale;
   ...
   head: function(opts) {
      ...
      this._decorateHandler(opts, dojo.hitch(this, "_doHead"));
   ...
   getXml: function(opts) {
      ...
      this._setupDeferred(opts);
      this._decorateHandler(opts, dojo.hitch(this, "_doGet"));
   ...
   postXml: function(opts) {
      ...
      this._setupDeferred(opts);
      this._decorateHandler(opts, dojo.hitch(this, "_doPost"));
   ...
   _textToJsonEmbedded: function(content) {
      ...
      json = com.ibm.social.incontext.util.atom.getJsonResponseFromHtml(content);
   ...
   _textToXML: function(content) {
      return com.ibm.social.incontext.util.dom.xmlDocumentFromString(content);
   },
    ...
    _multiPartPost: function(opt) {
      if (this.multiPartPostOverride) {
         return this.multiPartPostOverride(opt);     
    	  ...
    	  var form = opt.form || dojo.doc.createElement('form');
...
com.ibm.social.incontext.NetworkOS.getInstance = function(opts) {
   if(!com.ibm.social.incontext.NetworkOS._instance)
      com.ibm.social.incontext.NetworkOS._instance = new com.ibm.social.incontext.NetworkOS(opts);
