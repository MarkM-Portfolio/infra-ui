...
return {depends: [["provide", "dojox.form.DateTextBox"],
["require", "dojox.widget.Calendar"],
["require", "dojox.widget.CalendarViews"],
["require", "dijit.form._DateTimeTextBox"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.DateTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
