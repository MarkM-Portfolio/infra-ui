...
dojo.provide("lconn.test.jasmine.typeahead.peopleFinder.PeopleFinderSearchBoxSpec");

dojo.require("lconn.core.peopleFinder.PeopleFinderSearchBox");

(function(PeopleFinderSearchBox) {

	describe("the widget lconn.core.peopleFinder.PeopleFinderSearchBox", function() {
		var pfSearchBox;
		beforeEach(function() {
