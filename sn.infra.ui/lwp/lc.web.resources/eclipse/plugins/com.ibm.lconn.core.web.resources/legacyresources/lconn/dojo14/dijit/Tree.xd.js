...
return {depends: [["provide", "dijit.Tree"],
["require", "dojo.fx"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.Tree"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
