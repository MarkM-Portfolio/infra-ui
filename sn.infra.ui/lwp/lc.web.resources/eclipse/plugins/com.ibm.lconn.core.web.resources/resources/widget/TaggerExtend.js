...
dojo.provide("lconn.core.widget.TaggerExtend");
 ...
 * @namespace lconn.core.widget.TaggerExtend
 */
lconn.core.widget.TaggerCore.extend(/** @lends lconn.core.widget.TaggerCore.prototype */ {
   ...
   setErrors: function(errors) {
      ...
      for (var i=0,l=errors.length; i<l; i++) {
         ...
         dojo.html.set(div, errors[i].message);
