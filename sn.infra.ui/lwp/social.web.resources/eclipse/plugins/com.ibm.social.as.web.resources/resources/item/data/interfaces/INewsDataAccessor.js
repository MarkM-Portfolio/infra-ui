...
dojo.provide("com.ibm.social.as.item.data.interfaces.INewsDataAccessor");
...
dojo.declare("com.ibm.social.as.item.data.interfaces.INewsDataAccessor", null,
{
	/**
	 * Get the event's id
	 * @return {String} id
	 ...
	 * @return {string} containing the MediaLink object image url
	 */
