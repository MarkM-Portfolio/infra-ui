...
return {depends: [["provide", "dojox.grid.DataGrid"],
["require", "dojox.grid._Grid"],
["require", "dojox.grid.DataSelection"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.DataGrid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
