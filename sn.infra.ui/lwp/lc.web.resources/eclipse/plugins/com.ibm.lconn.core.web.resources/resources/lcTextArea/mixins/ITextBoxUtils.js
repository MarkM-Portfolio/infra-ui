 ...
 * </dl>
 * 
 * @mixin lconn.core.lcTextArea.mixins.ITextBoxUtils
...
dojo.declare("lconn.core.lcTextArea.mixins.ITextBoxUtils", null, /** @lends lconn.core.lcTextArea.mixins.ITextBoxUtils.prototype */ {
   ...
   getTextOutput: function(truncate) {
      ...
      if (truncate) {
         ...
         if ((this.getUtfLength(text) > this.maxByteLength) && this.maxByteLength != 0) {
            truncatePoint = lconn.core.util.text.getCharIndexForUtf8Index(text, this.maxByteLength);
         }
