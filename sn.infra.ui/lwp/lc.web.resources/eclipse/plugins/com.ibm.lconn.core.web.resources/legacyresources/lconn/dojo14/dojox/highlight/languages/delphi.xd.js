...
return {depends: [["provide", "dojox.highlight.languages.delphi"],
["require", "dojox.highlight._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.highlight.languages.delphi"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
