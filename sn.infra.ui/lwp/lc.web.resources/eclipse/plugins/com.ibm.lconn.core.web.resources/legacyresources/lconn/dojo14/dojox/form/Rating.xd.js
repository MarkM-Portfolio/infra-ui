...
return {depends: [["provide", "dojox.form.Rating"],
["require", "dijit.form._FormWidget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.Rating"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
