...
public class ToolbarTest extends AbstractARIATest
{
  ...
  public void testFocusIn()
  {
    ...
    WebElement button = driver.findElement(By.cssSelector("div#tb1 button"));
  ...
  public void testFocusOut()
  {
    ...
    WebElement button2 = driver.findElement(By.cssSelector("div#tb2 button"));
    // assertTrue(button2 has focus?)
  }
  ...
  {
    List<WebElement> buttons = driver.findElements(By.cssSelector("div#tb1 button"));
  ...
  {
    List<WebElement> buttons = driver.findElements(By.cssSelector("div#tb3 button"));
    buttons.get(0).sendKeys(Keys.RIGHT);
    // assertTrue(buttons.get(1) has focus?)
    buttons.get(1).sendKeys(Keys.RIGHT);
    // assertTrue(buttons.get(2) has focus?)
  ...
  {
    WebElement link = driver.findElement(By.linkText("Toolbar"));
    assertNotNull(link);
    link.click();
  }
}
