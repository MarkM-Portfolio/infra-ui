...
dojo.provide("com.ibm.social.as.item.manager.interfaces.INewsItemFactory");
...
dojo.declare("com.ibm.social.as.item.manager.interfaces.INewsItemFactory", null,
{
	...
	createNewsItem: function(type, props, domNode){
		...
		var functionName = dojo.string.substitute(this.createTypeNewsItem, [type]);
