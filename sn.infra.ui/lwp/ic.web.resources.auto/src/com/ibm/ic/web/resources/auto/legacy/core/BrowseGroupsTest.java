...
public class BrowseGroupsTest extends AbstractLegacyTest
{
  private com.ibm.ic.web.resources.auto.ui.BrowseGroupsTest amdTest;

  @BeforeMethod(groups = { "eclipse", "_current_" })
  public void setup()
  {
    super.setup();
    get(testHost + "/web/lconn.test/core/browseGroups.html?render=test");

    amdTest = new com.ibm.ic.web.resources.auto.ui.BrowseGroupsTest();
  ...
  {
    amdTest.testFindGroupsWithResults();
  }

  @Test(groups = { "eclipse", "legacy", "functional" })
  public void testFindGroupsNoResults()
  {
    amdTest.testFindGroupsNoResults();
  }
