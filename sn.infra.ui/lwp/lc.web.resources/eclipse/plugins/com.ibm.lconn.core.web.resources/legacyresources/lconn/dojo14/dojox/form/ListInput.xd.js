...
return {depends: [["provide", "dojox.form.ListInput"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.ListInput"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
