...
], function(array, lang, domClass, topic, has, URLPreviewNode, properties) {
   ...
   describe("the URLPreviewNode widget", function() {
      ...
      describe("the renderData method", function() {
         ...
         it("shows the play button when there's at least one video", function() {
            ...
            expect(domClass.contains(widget.playBtn, "lotusHidden")).toBeFalsy();
         });
         it("hides the play button when there is no video", function() {
            widget.renderData(DATA_NO_VIDEO);
            expect(domClass.contains(widget.playBtn, "lotusHidden")).toBeTruthy();
         });
      });
      ...
      describe("the toggleImage method", function() {
         it("toggles the visibility of the thumbnail and image controls", function() {
            ...
            widget.toggleImage();
            expect(domClass.contains(widget.leftPane, "lconnPreviewHidden")).toBeTruthy();
            expect(domClass.contains(widget.imageChooser, "lconnPreviewHidden")).toBeTruthy();

            widget.checkBox.checked = false;
            widget.toggleImage();
            expect(domClass.contains(widget.leftPane, "lconnPreviewHidden")).toBeFalsy();
            expect(domClass.contains(widget.imageChooser, "lconnPreviewHidden")).toBeTruthy();
            ...
            widget.toggleImage();
            expect(domClass.contains(widget.leftPane, "lconnPreviewHidden")).toBeFalsy();
            expect(domClass.contains(widget.imageChooser, "lconnPreviewHidden")).toBeFalsy();
         });
      });
