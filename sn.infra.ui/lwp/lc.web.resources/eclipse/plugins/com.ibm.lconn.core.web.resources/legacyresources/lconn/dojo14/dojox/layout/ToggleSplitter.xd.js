...
return {depends: [["provide", "dojox.layout.ToggleSplitter"],
["require", "dijit.layout.BorderContainer"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.ToggleSplitter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
