/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	...
	], function (array, dom, has, query, OAuthHelper, NetworkOS) {
			...
			initOSXhrHander: function() {
				...
				this.network = new NetworkOS({   
					...
					onAuthApproval: function(oauthApprovalUrl, retryFunction, retryOpts) {
			            ...
			            array.forEach(query(".eeOAuthImg"), function(imgEl) { helper.addImgSrc(imgEl); });
			            array.forEach(query(".eeOAuthInfo"), function(infoEl) { helper.createInfoNode(infoEl); });
