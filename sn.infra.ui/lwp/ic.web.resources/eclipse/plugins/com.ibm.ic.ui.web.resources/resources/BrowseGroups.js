...
define([
   ...
   "dojo/_base/window",
   "dojo/query",
   "dojo/text!ic-core/templates/BrowseGroups.html",
   "dojo/topic",
   "dijit/_Templated",
   "dijit/_Widget",
   ...
   "ic-core/Res"
], function (dojo, on, declare, has, domClass, domConstruct, i18nstrings, lang, domStyle, windowModule, queryModule, template, topic, _Templated, _Widget, BrowseGroupsDialog, BrowseGroupsList, Res) {

   /**
    * Legacy widget to pick user groups from a dialog
    *
    * @class ic-ui.BrowseGroups
    * @extends dijit._Widget
    * @extends dijit._Templated
    * @extends ic-core.Res
    */
   var BrowseGroups = declare("lconn.core.BrowseGroups", [_Widget, _Templated, Res], /** @lends ic-ui.BrowseGroups.prototype */ {
      pageSize: 25,
      memberStore: null,
      item: null,
      query: '',
      ...
      postMixInProperties: function() {
         ...
         this.stringResources = i18nstrings;
      ...
      postCreate: function() {
         ...
         this.browseGroupsList_W = new BrowseGroupsList(args, this.groupBrowseList_AP);
         this.browseGroupsList_W.parentWidget = this;

         this.browseGroupsDlg = new BrowseGroupsDialog();
      ...
      _startSearch: function( /*String*/ key, opt) {
         ...
         this.searchTimer = this.defer(lang.hitch(this, function(query, _this) {
            var dataObject = this.memberStore.fetch({
               ...
               query: query,
               onBegin: lang.hitch(this, "_setMaxOptions"),
               onComplete: lang.hitch(this, "_openResultList"),
               onError: function(err) {
                  console.error(err);
                  lang.hitch(_this, "_openResultList")([], dataObject); //if there is an error, show no results
               },
               start: 0,
               totalItemCount: -1,
               count: this.pageSize
            ...
            this._nextSearch = this.browseGroupsList_W.onPage = lang.hitch(this, nextSearch, dataObject);
      ...
      _openResultList: function( /*Object*/ results, /*Object*/ dataObject) {
         ...
         results, dataObject, this.findGroupSearch, lang.hitch(this, "_getMenuLabelFromItem"));
      ...
      _announceOption: function( /*Node*/ node) {
         ...
         if (!this.multipleValues) this.set('item', node.item, false, newValue);
      ...
      _arrowPressed: function() {
         if (!this.disabled && !this.readOnly && this.hasDownArrow) {
            domClass.add(this.downArrowNode, "dijitArrowButtonActive");
         }
      },

      _arrowIdle: function() {
         if (!this.disabled && !this.readOnly && this.hasDownArrow) {
            domClass.remove(this.downArrowNode, "dojoArrowButtonPushed");
         }
      },
      ...
      displayBrowseGroupsDialog: function() {
         ...
         if (this.browseGroupsPopupDlg) {
            ...
            this.browseGroupsPopupDlg = this.browseGroupsDlg.popupDialog(this.rs_browseGroupsDialogTitle, dialogObj, this.rs_browseAddButton, this.rs_browseCancelButton, lang.hitch(this, this.executeBrowseGroups), lang.hitch(this, this.cancelBrowseGroups));
            ...
            if (domClass.contains(windowModule.body(), "lotusImagesOff")) domClass.add(this.browseGroupsExp_AP, "lotusImagesOff");
      ...
      setBreadcrumbLiveRegion: function() {
         try {
            ...
            for (var ii = 0; ii < this.breadcrumbItems.length; ii++) {
               if (ii == 0) {
                  domConstruct.place(windowModule.doc.createTextNode(this.rs_browseParentName), this.groupListLiveRegion_AP);
               } else {
                  domConstruct.place(windowModule.doc.createTextNode(">"), this.groupListLiveRegion_AP);
               }
               domConstruct.place(windowModule.doc.createTextNode(this.breadcrumbItems[ii].name), this.groupListLiveRegion_AP);
            }
      ...
      findGroupChildList: function(item) {
         ...
         on(bcLinkNode, "click", lang.hitch(this, "navigateGroupsList", this.query, this.groupLevel));
         on(bcLinkNode, "keypress", lang.hitch(this, "breadCrumbKeyListener", this.query, this.groupLevel));
         ...
         domStyle.set(bcLinkDesc, "display", "none");
         ...
         if (lang.isFunction(this.enableAddButton))
         ...
         if (this.groupListBreadcrumb_AP.hasChildNodes) {
            ...
            if (level == -1) {
               ...
               if (this.groupLevel == -1) {
                  ...
                  var children = queryModule("a", this.groupListBreadcrumb_AP);
