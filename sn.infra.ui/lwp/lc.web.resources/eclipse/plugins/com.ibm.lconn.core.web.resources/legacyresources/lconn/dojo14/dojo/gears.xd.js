...
return {depends: [["provide", "dojo.gears"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.gears"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
