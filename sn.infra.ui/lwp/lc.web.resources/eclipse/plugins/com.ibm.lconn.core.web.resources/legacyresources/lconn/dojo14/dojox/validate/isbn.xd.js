...
return {depends: [["provide", "dojox.validate.isbn"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.validate.isbn"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
