...
return {depends: [["provide", "dojox.encoding.base64"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.base64"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
