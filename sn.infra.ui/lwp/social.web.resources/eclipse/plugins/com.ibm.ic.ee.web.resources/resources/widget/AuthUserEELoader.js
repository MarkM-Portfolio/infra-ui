define([
...
], function (declare, lang, domConstruct, OpenSocialRoutes, EELoader) {
	...
	var AuthUserEELoader = declare("com.ibm.social.ee.widget.AuthUserEELoader", EELoader, {
	   ...
	   getGadgetOpts: function (div) {
	      var opts = {
	         ...
	         onDataError: lang.hitch(this, this.onDataError),
	         onLoaded: lang.hitch(this, this._onLoaded, div)         
	      }
	      return opts;
	   },
	   initializeGadget: function () {
	      var div = domConstruct.create("div", { style: { display: "none"} }, this.domNode);
	      var gadgetDiv = domConstruct.create("div", { }, div);
	      var clz = lang.getObject(this.gadgetClass);      
