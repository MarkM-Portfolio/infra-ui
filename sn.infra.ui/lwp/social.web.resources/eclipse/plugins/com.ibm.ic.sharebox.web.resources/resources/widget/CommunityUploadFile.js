...
], function (dojo, has, declare, i18n, domConstruct, array, i18nsocialShareboxStrings, domClass, lang, windowModule, aspect, on, string, _Widget, services, filepickerwidget, filesutil, ConnectionManager, MessageContainer) {

	var CommunityUploadFile = declare("com.ibm.social.sharebox.widget.CommunityUploadFile", _Widget, {
	   _connManager: null,
	   communityId: null,
	   filesWidget: null,
	   msgContainer: null,
	   postMixInProperties: function() {
		   ...
		   this.connect = lang.hitch(this._connManager, this._connManager.cmconnect, "cuf");
		   this.own(aspect.after(this, "setCommunity", lang.hitch(this, "update"), true));
	   },
	   buildRendering: function(){
	      var d = windowModule.doc, filesDiv, div, divp, contentDiv, shareButton, cancelButton, uploadButton;
	      contentDiv = this.contentDiv = domConstruct.create("div", null, this.domNode);
	      ...
	      filesDiv = domConstruct.create("div", {className: "filesDiv"}, contentDiv);
	      //Create Footer area
	      div = domConstruct.create("div", {className: "lotusDialogFooter lotusBorderTop"}, contentDiv);
	         divp = this.progressNode = domConstruct.create("div", {className: "lotusLeft"}, div);         
	         shareButton = this.shareButton = domConstruct.create("button", {className: "lotusFormButton"}, div);
	            shareButton.style.display = "none";
	            shareButton.appendChild(d.createTextNode(this.nls.COMMUNITYUPLOADFILE.SHARE));
	            this.own(on(shareButton, "click", lang.hitch(this, "submitShare")));
	         uploadButton = this.uploadButton = domConstruct.create("button", {className: "lotusFormButton"}, div);
	            uploadButton.style.display = "none";
	            uploadButton.appendChild(d.createTextNode(this.nls.COMMUNITYUPLOADFILE.UPLOAD));
	            this.own(on(uploadButton, "click", lang.hitch(this, "submitUpload")));
	         
	         cancelButton = this.cancelButton = domConstruct.create("button", {className: "lotusFormButton"}, div); 
	            cancelButton.appendChild(d.createTextNode(this.nls.COMMUNITYUPLOADFILE.CANCEL));
	            this.own(on(cancelButton, "click", lang.hitch(this, "cancel")));
	      //Create Files widget
	      filepickerwidget.create({
	         ...
	         onSourceChange: lang.hitch(this, "onSizeChange"),
	         onSourceLoaded: lang.hitch(this, "setMode"),
	         onUploadComplete: lang.hitch(this, "onUploadComplete"),
	         setMessage: lang.hitch(this, "setMessage"),
	         postCreate: lang.hitch(this, function(widget){
	               this.filesWidget = widget;
	               this.updateMsgContainer();
	               domClass.add(this.domNode, "lotusDialog");
	               this.own(on(widget, "resize", lang.hitch(this, "onSizeChange")));
	               this.own(on(widget, "SelectionChange", lang.hitch(this, "setMode")));
	               this.setMode();
	   ...
	   update: function() {
	      ...
	      if(this.filesWidget && (this.filesWidget.getSelectedItems().length > 0) && this.communityId) {
	         ...
	         domClass.remove(this.submitButton, "lotusBtnDisabled");
	      }
	      else {
	         this.submitButton.disabled = "disabled";		   
	         domClass.add(this.submitButton, "lotusBtnDisabled");
	      }
	      this.cancelButton.disabled = "";
		  domClass.remove(this.cancelButton, "lotusBtnDisabled");
	   ...
	   updateMsgContainer: function() {
		   ...
		   if(this.msgContainer) {
			   ...
			   this.msgContainer =  new MessageContainer({
		        	 ...
		        	 isScrollAllowed: lang.hitch(this, this.isScrollToMessageAllowed)
		        	 }, 
		    		  this.msgNode.appendChild(windowModule.doc.createElement("div")));
			   this.own(aspect.after(this.msgContainer, "remove", lang.hitch(this, "onSizeChange"), true));
		   }
	   ...
	   handleShareWithComplete: function(files, response, ioArgs) {
	      ...
	      if((status == "204") || (has("ie") && status == "1223")) {
	         if(isSingleFile) {
	            this.setMessage({type: "success", message: string.substitute(this.shareNls.SUCCESS_ONE, [files[0].getName(), this.communityTitle])});   
	    	 } else {
	            this.setMessage({type: "success", message: string.substitute(this.shareNls.SUCCESS_PLURAL, [files.length, this.communityTitle])});    		   
	         }
	         this.clear();
	    	 this.close();
	       }
	   ...
	   submitShare: function() {
	      ...
	      if(this.communityId && (files.length > 0)) {
	          opts = {file: files, 
	      	        ...
	      	        callback: lang.hitch(this, this.handleShareWithComplete, files)};
	          if(this.usesPublicCommunity())
	          	  opts.visibility = "public";    	  
	    	  filesutil.shareWithCommunity(opts);
	      }
	   },
	   ...
	   prepareForSubmit: function(allowCancel) {
	       ...
	       if(allowCancel && this.filesWidget.cancel){
	    	   ...
	    	   domClass.add(this.cancelButton, "lotusBtnDisabled");
	       }
	   },
