...
return {depends: [["provide", "dijit._editor.plugins.FullScreen"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._editor.plugins.FullScreen"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
