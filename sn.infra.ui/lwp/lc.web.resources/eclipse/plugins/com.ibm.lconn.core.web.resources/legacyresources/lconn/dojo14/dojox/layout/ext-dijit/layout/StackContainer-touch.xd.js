...
return {depends: [["provide", "dojox.layout.ext-dijit.layout.StackContainer-touch"],
["require", "dijit.layout.StackContainer"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.ext-dijit.layout.StackContainer-touch"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
