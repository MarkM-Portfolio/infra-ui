...
return {depends: [["provide", "dojox.layout.DragPane"],
["require", "dijit._Widget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.DragPane"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
