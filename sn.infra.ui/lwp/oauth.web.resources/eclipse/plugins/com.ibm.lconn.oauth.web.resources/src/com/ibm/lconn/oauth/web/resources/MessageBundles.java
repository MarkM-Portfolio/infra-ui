...
package com.ibm.lconn.oauth.web.resources;
...
public class MessageBundles extends ResourceProvider
{
  private static class UI extends GeneratedDojoMessageBundle
  {
    public UI(String id)
    {
      super("lconn.oauth", id, "com/ibm/lconn/oauth/strings/ui.properties", Activator.getContext().getBundle(), Level.ALL);
    }
  ...
  private static class Help extends GeneratedDojoMessageBundle
  {
    ...
    {
      super("lconn.oauth", id, "com/ibm/lconn/oauth/strings/uihelp.properties", Activator.getContext().getBundle(), Level.ALL);
    }
