...
define([
      ...
      "./Site",
      "./WidgetAdapter"
], function(declare, domConstruct, _Container, _Widget, iContainer2, Site, WidgetAdapter) {

   /**
    * Concrete Dijit class for painting the main widget chrome and converting
    * site calls
    * 
    * @class
    */

   var WidgetSite = declare('com.ibm.lconn.gadget.support.WidgetSite', [
         _Widget,
         _Container,
         Site
   ], {
      ...
      /**
       * This is a plug point for component applications to add functionality to
       * the behavior of the Gadget site.
       * 
       * @example var WidgetSite_ = com.ibm.lconn.gadget.support.WidgetSite;
       *          dojo.declare('...HomepageWidgetSite', [WidgetSite_] {
       *          GadgetAdapter : dojo.declare('',
       *          [WidgetSite_.prototype.GadgetAdapter], { edit : function() { //
      ...
      /**
       * This is a t point for component applications to add functionality to
       * the behavior of the iWidget site.
       * 
       * @example var WidgetSite_ = com.ibm.lconn.gadget.support.WidgetSite;
       *          dojo.declare('...HomepageWidgetSite', [WidgetSite_] {
       *          GadgetAdapter : dojo.declare('',
       *          [WidgetSite_.prototype.IWidgetAdapter], { edit : function() { //
       *          invoke homepage edit UI } }), ... });
       * @memberOf com.ibm.lconn.gadget.support.WidgetSite.prototype
       * @name IWidgetAdapter
       * @field
      ...
      /**
       * @see dijit._Widget.prototype.buildRendering Creates
       *      dijit._Widget.domNode
       */
      buildRendering : function() {
         this.containerNode = this.domNode = domConstruct.create('div');
      },
       ...
       */
      postCreate : function() {
         var spec = this.widgetSpec, adapter = null;

         switch (spec.componentType) {
            case 'gadget':
               adapter = new this.GadgetAdapter({
                  widgetSpec : spec
               });
               break;
            case 'iWidget':
            default: /* default consistent with CRE */
               adapter = new this.IWidgetAdapter({
                  widgetSpec : spec
               });
               break;
         }
