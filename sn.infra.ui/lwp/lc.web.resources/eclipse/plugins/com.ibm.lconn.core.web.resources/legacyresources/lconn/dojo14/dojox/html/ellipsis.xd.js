...
return {depends: [["provide", "dojox.html.ellipsis"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.html.ellipsis"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
