...
return {depends: [["provide", "dojox.json.ref"],
["require", "dojo.date.stamp"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.ref"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
