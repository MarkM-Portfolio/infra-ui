...
dojo.provide("com.ibm.social.incontext.util.OperationMonitor");

dojo.declare("com.ibm.social.incontext.util.OperationMonitor", null, {
   ...
   isFailure: function(response, ioArgs) {
      if (ioArgs.xhr && dojo.indexOf(this.validStatusCodes, ioArgs.xhr.status) != -1)
         return false;
   ...
   _connect: function() {
      if (this.monitorStarted) {
         ...
         var opts = {
            ...
            hideLoadingMsg: true,
            handle: dojo.hitch(this, this._complete)
         };            
