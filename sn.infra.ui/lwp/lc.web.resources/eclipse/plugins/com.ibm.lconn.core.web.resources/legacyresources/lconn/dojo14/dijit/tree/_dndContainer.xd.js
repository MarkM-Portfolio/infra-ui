...
return {depends: [["provide", "dijit.tree._dndContainer"],
["require", "dojo.dnd.common"],
["require", "dojo.dnd.Container"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tree._dndContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
