...
dojo.provide("com.ibm.social.incontext.util.auth");
   ...
   isUrlSecure: function(url) {
    ...
    parseUser: function(user){
        if ( user && user.id && user.displayName ) {
            ...
            var orgId = dojo.getObject("appData.connections.organizationId", false, user);
            ...
            var isExternal = dojo.getObject("appData.connections.isExternal", false, user);
