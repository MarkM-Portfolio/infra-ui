...
return {depends: [["provide", "dojox.date.posix"],
["require", "dojo.date"],
["require", "dojo.date.locale"],
["require", "dojo.string"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.posix"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
