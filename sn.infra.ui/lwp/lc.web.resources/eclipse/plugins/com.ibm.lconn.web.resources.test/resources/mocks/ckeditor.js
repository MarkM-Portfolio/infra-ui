 ...
 * 
 * @namespace lconn.test.mocks.ckeditor
 * @author Claudio Procida <procidac@ie.ibm.com>
 */

var mocks = dojo.provide('lconn.test.mocks.ckeditor');

(function(domConstruct, lang, mocks) {
...
}(dojo, dojo, lconn.test.mocks.ckeditor));
