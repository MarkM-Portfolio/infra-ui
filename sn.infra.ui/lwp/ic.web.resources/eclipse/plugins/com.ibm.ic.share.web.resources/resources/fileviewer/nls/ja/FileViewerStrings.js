...
define({
      ...
      ERROR: "エラーが発生しました。",
      FILE_MALICIOUS: "スキャンにより、悪意のあるコンテンツが見つかりました",
      ...
      MORE_ACTIONS: {
         ...
         A11Y: "ファイル上で実行する他のアクションのリストを含むドロップダウン・メニューを開きます。",
            PANELS: {
               TITLE: "詳細",
               A11Y: "非表示パネルのリストを含むドロップダウン・メニューを開きます"
            }
      },
      WELCOME: {
      ...
      SPLIT_ACTION: {
         MENU: {
            TITLE: "その他の編集オプション",
            A11Y: "このボタンは他の編集オプションのメニューを開きます。"
         },
         BUTTON: {
            EDIT: {
               TITLE: "編集"
      ...
      ACTION: {
         RESIZE: {
           RESIZE_BAR: "パネルのサイズ変更",
           USAGE: "左大括弧キーまたは右大括弧キーを押して、パネルをサイズ変更します。"
       },
         CLOSE: {
            TOOLTIP: "閉じる",
            A11Y: "このボタンをクリックすると、ファイル・ビューアーが閉じます。",
            WARNING_DIALOG: {
              DIALOG_TITLE: "ファイルはまだアップロード中です。",
              PROMPT: "ファイルはまだアップロード中です。 完了する前に閉じると、アップロードはキャンセルされます。",
              OK: "閉じる",
              CANCEL: "アップロードの完了を待機"
            }
         },
         ADD_TO_FILES: {
           TOOLTIP: "ファイルに追加",
           A11Y: "このボタンは添付ファイルをファイルに追加します。",
           VIEW_NOW: "今すぐ表示"
         },
         TEAR_OFF: {
           TOOLTIP: "新規ウィンドウで開く",
           A11Y: "新規ウィンドウで開く",
           ERROR_TEARING_OFF: "新規ウィンドウを開く時にエラーが発生しました。",
           DIALOG_TITLE: "確認",
           UNSAVED_CHANGES_WARNING: "変更内容が失われることになる未保存の変更があります。 それでも新規ウィンドウで開きますか?",
           OK: "はい",
           CANCEL: "いいえ",
           OPEN: "開く",
           OPEN_ANYWAY: "それでも開く",
         ...
         CREATE_FROM_TEMPLATE: {
            ...
            ERRORS: {
               ...
               SESSION_TIMEOUT: "セッションの有効期限が切れました。再度ログインしてもう一度実行してください。",
               DUPLICATE_NAME: "重複するファイル名が見つかりました。 新しい名前を入力してください。",
               SERVER_ERROR: "Connections サーバーを使用できません。 サーバー管理者に連絡し、後でもう一度実行してください。"
            }
         },
         DOWNLOAD: {
            TOOLTIP: "ファイルのダウンロード",
         ...
         DOWNLOAD_AS_PDF: {
            ...
            ERROR: {
               DEFAULT: "ファイルを PDF として正常にダウンロードできませんでした。  後でもう一度実行してください。",
         ...
         TOGGLE_PANEL: {
            ...
            RESET_A11Y: "このボタンをクリックすると、サイド・パネルがデフォルト・サイズにリセットされます。 このサイド･パネルは現在展開されています。"
         },
         VIEW_DOC: {
         ...
         EDIT_DOC: {
            NAME: "Docs で編集",
            TOOLTIP: "HCL Docs を使用してこのファイルを編集",
            A11Y: "このボタンは、新規ブラウザー・ウィンドウ内でファイルを編集用に開きます。"
         },
         EDIT_OFFICE: {
            TITLE: "編集オプション。",
            NAME: "Microsoft Office Online で編集",
            TOOLTIP: "Microsoft Office Online を使用してこのファイルを編集",
            A11Y: "このボタンは、新規ブラウザー・ウィンドウ内の Microsoft Office Online で編集するようにファイルを開きます。"
         },
         EDIT_OFFICE_WORD: {
           NAME: "Microsoft Word Online で編集",
           TOOLTIP: "Microsoft Word Online を使用してこのファイルを編集",
           A11Y: "このボタンは、新規ブラウザー・ウィンドウ内の Microsoft Word Online で編集するようにファイルを開きます。"
         },
         EDIT_OFFICE_EXCEL: {
             NAME: "Microsoft Excel Online で編集",
             TOOLTIP: "Microsoft Excel Online を使用してこのファイルを編集",
             A11Y: "このボタンは、新規ブラウザー・ウィンドウ内の Microsoft Excel Online で編集するようにファイルを開きます。"
         },
         EDIT_OFFICE_POWERPOINT: {
             NAME: "Microsoft PowerPoint Online で編集",
             TOOLTIP: "Microsoft PowerPoint Online を使用してこのファイルを編集",
             A11Y: "このボタンは、新規ブラウザー・ウィンドウ内の Microsoft PowerPoint Online で編集するようにファイルを開きます。"
         },
         OFFICE_EDITED: {
             SUCCESS: "ファイルは保存中です。"
         },
         ROUNDTRIP_EDIT: {
            ...
            PROMPT: "この機能により、自分のコンピューターにインストールされたソフトウェアを使用して編集できるようになります。",
            INSTALL: "続行する前に、${startLink}デスクトップ・ファイル・コネクターをインストールします${endLink}。", // The text between the start/end link tags will be a link to download an installer
            IMPORTANT: "重要:",
            REMINDER: "編集が完了したら、デスクトップ・ファイル・コネクターを使用してドラフトを公開してください。",
         ...
         STOP_SHARING: {
            ...
            EFSS: {
              DIALOG_TITLE: "確認",
              REMOVE_EVERYONE: "このファイルへの組織からのアクセス権を削除しますか? アクセスが削除された場合、ファイルは組織レベルのアクセスが許可されているフォルダーから削除され、所有者と共有されているユーザーのみがそのファイルを表示および操作できます。",
              REMOVE_USER: "${user} との共有を停止しますか? 共有を停止すると、${user}  がこのファイルにアクセスできるのは、フォルダーを使用した場合か、このファイルが組織内のすべてのユーザーに共有されている場合だけです。",
              REMOVE_COMMUNITY: "このファイルをコミュニティー ${communityName} から削除しますか?",
              REMOVE_FOLDER: "このファイルをフォルダー ${folderName} から削除しますか?",
              REMOVE_EVERYONE_TOOLTIP: "組織のアクセス権を削除します",
         ...
         TOGGLE_SYNC: {
            ...
            MYDRIVE: {
                NAME: "マイ・ドライブに追加",
                TOOLTIP: "このファイルをマイ・ドライブに追加",
                A11Y: "このボタンはファイルをマイ・ドライブに追加します。",
                SUCCESS: "このファイルをマイ・ドライブに追加しました。",
                ERROR: {
                   DEFAULT: "このファイルをマイ・ドライブに追加中にエラーが発生しました。 後でもう一度実行してください。",
                   UNAUTHENTICATED: "セッションがタイムアウトになりました。 このファイルをマイ・ドライブに追加する前に、再度ログインする必要があります。",
                   NOT_FOUND: "ファイルが削除されたか、あなたとの共有が解除されたため、このファイルをマイ・ドライブに追加できません。",
                   ACCESS_DENIED: "ファイルが削除されたか、あなたとの共有が解除されたため、このファイルをマイ・ドライブに追加できません。"
                }
             },
             REMOVE_MYDRIVE: {
                NAME: "マイ・ドライブから削除",
                TOOLTIP: "このファイルをマイ・ドライブから削除",
                A11Y: "このボタンはファイルをマイ・ドライブから削除します。",
                SUCCESS: "このファイルをマイ・ドライブから削除しました。",
                ERROR: {
                   DEFAULT: "このファイルをマイ・ドライブから削除中にエラーが発生しました。 後でもう一度実行してください。",
                   UNAUTHENTICATED: "セッションがタイムアウトになりました。 このファイルをマイ・ドライブから削除する前に、再度ログインする必要があります。",
                   NOT_FOUND: "ファイルが削除されたか、あなたとの共有が解除されたため、このファイルをマイ・ドライブから削除できません。",
                   ACCESS_DENIED: "ファイルが削除されたか、あなたとの共有が解除されたため、このファイルをマイ・ドライブから削除できません。"
                }
             }
         },
         TOGGLE_FAVORITE: {
         ...
         TRANSFER_FILE: {
            NAME: "\u6240\u6709\u6a29\u306e\u79fb\u8ee2...",
            DIALOG_TITLE: "\u6240\u6709\u6a29\u306e\u79fb\u8ee2",
            TOOLTIP: "このファイルの所有権を別のユーザに移転します",
            A11Y: "このボタンは、このファイルを新しい所有者に転送するためのダイアログを開きます。",
            EMPTY: "空"
         },
         UPLOAD_VERSION: {
            NAME: "新規バージョンのアップロード",
            ...
            A11Y: "このボタンは、このファイルの新しいバージョンをアップロードするためのダイアログを開きます。"
         },
         LOG_IN: {
            NAME: "ログイン",
         ...
         LOCK: {
            ...
            ERROR: "ファイルは既に削除されたか、あなたとの共有が解除されたため、ロックできませんでした。"
         },
         UNLOCK: {
            NAME: "ファイルのロック解除",
            TITLE: "このファイルのロック解除",
            ...
            ERROR: "ファイルは削除されたか、あなたとの共有が解除されたため、ロック解除できませんでした。"
         },
         EDIT_ON_DESKTOP: {
            NAME: "デスクトップで編集",
            TITLE: "デスクトップで編集",
         ...
         FLAG: {
            FILE: {
               ...
               ERROR: "このファイルにフラグを立てようとしてエラーが発生しました。後でもう一度実行してください。"
            },
            FILE_DIALOG: {
               DIALOG_TITLE: "成功",
               PROMPT: "このファイルにフラグが立てられ、レビュー用に送信されました。",
               CANCEL: "OK"
            },
            COMMENT: {
               NAME: "不適切フラグを立てる",
               ...
               ERROR: "このコメントにフラグを立てようとしてエラーが発生しました。後でもう一度実行してください。"
            }
         },
         MODERATION: {
            DIALOG_TITLE: "成功",
            PROMPT: "変更がレビュー用に送信されました。 変更が承認されるまで、このファイルは使用可能になりません。",
            CANCEL: "OK"
         },
         DROPDOWN_BUTTON: "ドロップダウン・ボタン"
      },
      SECTION: {
         ABOUT: {
            NAME: "このファイルについて",
            VIEW_FILE_DETAILS: "ファイル詳細の表示",
            A11Y: "このリンクをアクティブ化すると、ビューアーが閉じてこのファイルのファイル詳細ページに移動します。"
         }
      },
      PREVIEW: {
         ICON: {
         ...
         IMAGE: {
            ...
            UNSAFE_PREVIEW: "ウィルス・スキャンされていないため、このファイルはプレビューできません。"
         },
         VIEWER: {
            LOADING: "ロード中...",
            PUBLISHING: "公開中...",
            ...
            AUTOPUBLISH_TIMEOUT: "サーバーの応答に時間がかかりすぎています。  最新の変更は公開されていません。"
         },
         VIDEO: {
            UNSAFE_PREVIEW: "ウィルス・スキャンされていないため、このファイルはプレビューできません。"
         }
      ...
      DATE: {
         ...
         LONG: {
            TODAY: "${EEEE}、${date_long} 日、${time_long}",
            YESTERDAY: "${EEEE}、${date_long} 日、${time_long}",
            DAY: "${EEEE}、${date_long} 日、${time_long}",
            MONTH: "${date_long} 日, ${time_long}",
            YEAR: "${date_long} 日, ${time_long}"
         },
         SHORT: {
            TODAY: "${time} - 今日",
            YESTERDAY: "${time} - 昨日",
      ...
      EDIT_BOX: {
         ...
         CANCEL: {
            TOOLTIP: "キャンセル",
            A11Y: "このボタンは、ファイル名の編集操作をキャンセルします。"
         },
      ...
      TYPEAHEAD_BOX: {
         ...
         PERSON_SHADOW: "入力してユーザーを検索",
         COMMUNITY_SHADOW: "入力してコミュニティーを検索",
         PERSON_ARIA: "入力してユーザーを検索します。  「Shift」+「Tab」を押して、ユーザー、コミュニティー、組織の全員の間で変更します。",
         COMMUNITY_ARIA: "入力してコミュニティーを検索します。  「Shift」+「Tab」を押して、ユーザー、コミュニティー、組織の全員の間で変更します。",
      ...
      FILE_STATE: {
         DOCS_FILE: "これは Docs ファイルです。 すべての編集はオンラインで行う必要があります。",
         LOCKED_BY_YOU: {
      ...
      DOCS_STATUS_MESSAGE: {
         NO_ENTITLEMENT: "HCL Docs を使用しているユーザーは、このファイルはオンラインで編集できます。",
         NO_ENTITLEMENT_LINK: "${startLink}HCL Docs${endLink} を使用しているユーザーは、このファイルはオンラインで編集できます。", // When configured, "HCL Docs" will be a link to more information about the product
         ...
         AUTOPUBLISH: {
            ...
            IN_PROGRESS: "あなたの編集は公開されようとしています。 ${startLink}変更を見るには最新表示します。${endLink}",
            GENERIC: "最新の変更を確認するためにページの最新表示が必要な場合もあります。  ${startLink}最新表示${endLink}"
         }
      },
      COMMENTS: {
         EMPTY: "コメントがありません。",
      ...
      SHARE_OPTIONS: {
         ...
         MAKE_INTERNAL_DIALOG: {
            ...
            EFSS: {
               DIALOG_TITLE: "内部に設定しますか?",
               PROMPT: "このファイルを内部に設定すると、組織外部のユーザーに共有できなくなります。 ${br}${br}" +
               "外部ユーザーまたは外部フォルダーとの共有は解除されます。${br}${br}ファイルをいったん内部にすると、元に戻すことはできません。"
            }
         },
         MAKE_PRIVATE_DIALOG: {
      ...
      PANEL: {
         ...
         ABOUT: {
            ...
            DOWNLOADS_HEADER: "表示",
            DOWNLOADS_HEADER_MORE: "表示 (${0})",
            DOWNLOADS_EXPAND_ICON: "このアイコンを展開すると、ファイルを表示したユーザーが表示されます",
            DOWNLOADS_COUNT: "${downloads}",
            DOWNLOADS_COUNT_FULL: "${downloads} - ${anonymousDownloads} 匿名",
            DOWNLOADS_LATEST_VERSION: "このファイルは最新バージョンです",
            DOWNLOADS_LAST_VERSION: "前回表示したこのファイルのバージョンは ${0} です",
            TAGS_HEADER: "タグ",
         ...
         COMMENTS: {
            ...
            FEED_TITLE: "フィード・リーダーでこれらのコメントに対する変更をフォローします"
         },
         SHARING: {
            TITLE: "共有",
         ...
         VERSIONS: {
            ...
            FEED_TITLE: "フィード・リーダーでこのファイルに対する変更をフォローします"
         }
      },
      CONFIRMATION_DIALOG: {
         NAME: "アクションの確認",
      ...
      UPLOAD_VERSION: {
         ...
         CANCEL: "キャンセル",
         TOO_LARGE: "${file} は許可されるファイル・サイズ ${size} より大きくなっています。",
         PROGRESS_BAR_TITLE: "新規バージョンのアップロード中 (${total} 中 ${uploaded} が完了)",
      ...
      NOTFOUND_FILE_DIALOG: {
         DIALOG_TITLE: "エラー",
         PROMPT: "要求したファイルは削除または移動されました。",
         CANCEL: "OK"
      },
      LOST_AUTHENTICATION_DIALOG: {
        DIALOG_TITLE: "確認",
        PROMPT: "HCL Connections セッションがタイムアウトになりました。${lineBreaks}もう一度ログインする場合は「OK」をクリックし、このダイアログを閉じる場合は「キャンセル」をクリックしてください。",
        OK: "OK",
        CANCEL: "キャンセル"
      },
      ERROR_VALIDATING_FILES_FILE: {
        DIALOG_TITLE: "リンクにアクセスできません",
        PROMPT: "リンクにアクセス中に問題が発生しました。${lineBreaks}「OK」をクリックするとページにリダイレクトされます。",
        OK: "OK",
        CANCEL: "キャンセル"
      },
      LOAD_ERROR: {
         DEFAULT: "ここには リンクにアクセス中にエラーが発生しました。",
      ...
      SHARE_WITH_LINK: {
         TITLE: "リンクで共有",
         EMPTY_DESCRIPTION: "このファイルにまだリンクを作成していません。 ファイルのプレビューとダウンロードを可能にする他のユーザーに送信する共有リンクを作成してください。",
         CREATE_LINK: "リンクの作成",
         COPY_LINK: "リンクのコピー",
         DELETE_LINK: "リンクの削除",
         ACCESS_TYPE_1: "リンクを持つすべてのユーザーがこのファイルを表示できます",
         ACCESS_TYPE_2: "自分の組織のユーザーがこのファイルを表示できます",
         ACCESS_TYPE_1_DESCRIPTION: "リンクを取得したユーザーは、Connections にログインしてこのファイルをプレビューおよびダウンロードできます。",
         ACCESS_TYPE_2_DESCRIPTION: "リンクを取得した自分の組織のユーザーは、Connections にログインしてこのファイルをプレビューおよびダウンロードできます。",
         CHANGE_TYPE_SUCCESS: "アクセス・タイプの変更時にリンク許可が更新されます。",
         CHANGE_TYPE_ERROR: "アクセス・タイプの変更時にリンク許可の更新が失敗しました。",
         COPY_LINK_SUCCESS: "リンクがクリップボードにコピーされました",
         CREATE_SHARELINK_SUCCESS:"リンクが正常に作成されました。",
         CREATE_SHARELINK_ERROR:"エラーが原因でリンクを作成できません。",
         DELETE_SHARELINK_SUCCESS: "\"${file}\" の共有リンクを削除しました。",
         DELETE_SHARELINK_ERROR: "共有リンクは削除されませんでした。後でもう一度実行してください。",
         CONFIRM_DIALOG: {
            OK: "削除",
            DIALOG_TITLE: "共有リンクの削除",
            PROMPT: "このファイルはこのリンクを持つすべてのユーザーからアクセスできなくなります。 共有リンクを削除してもよろしいですか。"
         },
         COPY_LINK_ACTION_TOOLTIP_TYPE_1: "共有リンクはアクティブです。 リンクを持つすべてのユーザーがこのファイルを表示できます。 クリックしてこのリンクをコピーします。",
         COPY_LINK_ACTION_TOOLTIP_TYPE_2: "共有リンクはアクティブです。 自分の組織のユーザーがこのファイルを表示できます。 クリックしてこのリンクをコピーします。"
      }
});
