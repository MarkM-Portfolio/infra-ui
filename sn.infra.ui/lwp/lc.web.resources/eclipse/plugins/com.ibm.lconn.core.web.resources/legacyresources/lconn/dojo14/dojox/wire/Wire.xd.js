...
return {depends: [["provide", "dojox.wire.Wire"],
["require", "dojox.wire._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.Wire"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
