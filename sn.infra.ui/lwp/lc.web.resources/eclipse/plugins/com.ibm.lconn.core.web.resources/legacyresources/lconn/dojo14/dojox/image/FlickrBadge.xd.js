...
return {depends: [["provide", "dojox.image.FlickrBadge"],
["require", "dojox.image.Badge"],
["require", "dojox.data.FlickrRestStore"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.image.FlickrBadge"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
