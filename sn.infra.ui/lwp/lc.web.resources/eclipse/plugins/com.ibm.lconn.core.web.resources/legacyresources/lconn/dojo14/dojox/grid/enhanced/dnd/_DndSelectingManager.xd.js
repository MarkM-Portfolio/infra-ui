...
return {depends: [["provide", "dojox.grid.enhanced.dnd._DndSelectingManager"],
["require", "dojox.grid.util"],
["require", "dojox.grid._Builder"],
["require", "dojox.grid.enhanced.dnd._DndGrid"],
["require", "dojox.grid.enhanced.dnd._DndBuilder"],
["require", "dojox.grid.enhanced.dnd._DndRowSelector"],
["require", "dojox.grid.enhanced.dnd._DndFocusManager"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.enhanced.dnd._DndSelectingManager"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
