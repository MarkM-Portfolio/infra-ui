...
return {depends: [["provide", "dijit.tree.dndSource"],
["require", "dijit.tree._dndSelector"],
["require", "dojo.dnd.Manager"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.tree.dndSource"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
