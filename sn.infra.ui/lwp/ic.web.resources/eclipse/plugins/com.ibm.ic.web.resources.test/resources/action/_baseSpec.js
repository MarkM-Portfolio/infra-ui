...
define([
...
], function(topic, _base) {

   /**
    * Jasmine spec suite for the base action class.
    * <p>
    * This test suite covers the ic-core/action/_base class.
    * 
    * @module ic-test.action._baseSpec
   ...
   describe('the base action class', function() {
      ...
      it('emits a topic when the execute() method is invoked', function() {
         var emitted = false;
         sub = topic.subscribe("ic-core/action/completed", function() {
            emitted = true;
         });
         action.execute();
