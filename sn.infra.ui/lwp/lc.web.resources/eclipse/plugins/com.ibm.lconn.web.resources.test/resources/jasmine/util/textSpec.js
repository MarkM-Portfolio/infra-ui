...
dojo.provide("lconn.test.jasmine.util.textSpec");
...
(function(text, MentionsUtils) {
   var templates = [
         {
            templatePath : dojo.moduleUrl('lconn.core', 'templates/bizcard.html')
         },
         {
            templatePath : dojo.moduleUrl('lconn.core', 'widget/mentions/templates/plaintext.html')
         }
   ];

   describe("the interface of lconn.core.util.text", function() {
   ...
   describe("the method lconn.core.util.text.trimToByteLength()", function() {
   ...
   describe("the method lconn.core.util.text.getByteLength()", function() {
      it("returns the lengt of a string", function() {
         expect(text.getByteLength("text")).toBe(4);
      });
   });

   describe("the method lconn.core.util.text.possessive()", function() {
   ...
   describe("the method lconn.core.util.text.getExtension()", function() {
   ...
   describe("the method lconn.core.util.text.trimExtension()", function() {
   ...
   describe("the method lconn.core.util.text.getFilename()", function() {
   ...
   describe("the method lconn.core.util.text.trimToLength()", function() {
   ...
   describe("the method lconn.core.util.text.trim()", function() {
   ...
   describe("the method lconn.core.util.text.trimEnd()", function() {
   ...
   describe("the method lconn.core.util.text.parseInt()", function() {
   ...
   describe("the method lconn.core.util.text.parseFloat()", function() {
   ...
   describe("the method lconn.core.util.text.length()", function() {
      it("returns the length of a string", function() {
         expect(text.length('\u0152\u017D\u2122\xDF\u0409')).toBe(5);
      });
   });

   describe("the method lconn.core.util.text.lengthUtf8()", function() {
      it("returns the length of a string in UTF8", function() {
         expect(text.lengthUtf8('\u0152\u017D\u2122\xDF\u0409')).toBe(11);
      });
   });

   describe("the method lconn.core.util.text.getCharIndexForUtf8Index()", function() {
   ...
   describe("the method lconn.core.util.text.encodeHeaderUtf8()", function() {
   ...
   describe("the method lconn.core.util.text.uniquifyStringList()", function() {
   ...
   describe("the method lconn.core.util.text.htmlify()",
      function() {
         var USER1 = {
            name : 'Amy Jones6',
         ...
         it("correctly linkifies single URLs",
            function() {
         ...
         it("correctly renders plain text mentions", function() {
            var m1 = dojo.string.substitute(dojo.cache('lconn.core', 'templates/bizcard.html'), {
               name : '@' + USER1.name,
               userid : USER1.userid,
               url : com.ibm.lconn.layout.people.getProfileUrl({
                  userid : USER1.userid
               }),
               displayName : USER1.name,
               hasSymbol: true
            }), m2 = dojo.string.substitute(dojo.cache('lconn.core', 'templates/bizcard.html'), {
               name : USER2.name,
               userid : USER2.userid,
               url : com.ibm.lconn.layout.people.getProfileUrl({
                  userid : USER2.userid
            ...
            var p1 = dojo.string.substitute(dojo.cache('lconn.core', 'widget/mentions/templates/plaintext.html'), {
               name : USER1.name,
               userid : USER1.userid,
               notify : '|notify'
            }), p2 = dojo.string.substitute(dojo.cache('lconn.core', 'widget/mentions/templates/plaintext.html'), {
               name : USER2.name,
               userid : USER2.userid,
               notify : ''
            });

            var TEMPLATE = 'mention to ${0} and ${1}', INPUT = dojo.string.substitute(TEMPLATE, [
                  p1,
                  p2
            ]), OUTPUT = dojo.string.substitute(TEMPLATE, [
                  m1,
                  m2
            ]);
            expect(text.htmlify(INPUT)).toBe(OUTPUT);
            var TEMPLATE2 = '${0}', INPUT2 = dojo.string.substitute(TEMPLATE2, [ p1
            ]);
            var tempNode = dojo.create("div");
            tempNode.innerHTML = text.htmlify(INPUT2);
            var utils = new MentionsUtils();
            expect(utils.isAnyMentionsDomNode(tempNode.childNodes[0])).toBeTruthy();
         ...
         it("correctly renders HTML mentions", function() {
            ...
            var p1 = dojo.string.substitute(dojo.cache('lconn.core', 'widget/mentions/templates/microformat.html'), {
               name : USER1.name,
               userid : USER1.userid
            }), p2 = dojo.string.substitute(dojo.cache('lconn.core', 'widget/mentions/templates/microformat.html'), {
               name : USER2.name,
               userid : USER2.userid
            });
...
}(lconn.core.util.text, lconn.core.widget.mentions.MentionsUtils));
