 ...
 * @namespace lconn.core.lcTextArea
 */
/**
 * Mixins for textbox controls for Connections microblogging.
 * @namespace lconn.core.lcTextArea.mixins
 */
/**
 ...
 * 
 * @mixin lconn.core.lcTextArea.mixins.IMentionsSupport
...
(function() {
   ...
   function check() {
      if (!this._mentionsHelper) {
         console
               .warn('IMentionsSupport requires that the mixed-in class has a _mentionsHelper member');
         return false;
      }
      return true;
   }

   dojo.declare("lconn.core.lcTextArea.mixins.IMentionsSupport", null, /** @lends lconn.core.lcTextArea.mixins.IMentionsSupport.prototype */ {
      /**
       * A mentions helper associated to this text box
       * 
       * @type {lconn.core.widget.mentions.MentionsHelper}
       */
      ...
      getTrackedMentions : function() {
         return check.apply(this) ? this._mentionsHelper.getTextAsJson()
               : null;
      },
       ...
       */
      getText : function() {
         return check.apply(this) ? this._mentionsHelper.getText()
               .replace(/^\s*/, "") : null;
      },
      ...
      /**
       * Sets the header on the typeahead menu. Useful if the user must be
       * informed of restrictions on selection
       * 
       * @param {String}
