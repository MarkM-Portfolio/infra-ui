...
({
   ...
   title: {global: "Udostępnianie treści", community: "Współużytkowanie ze społecznością"},
   STATUS: {
   ...
   COMMUNITYUPLOADFILE: {
	   ...
	   UPLOAD: "Prześlij",
	   CANCEL: "Anuluj",
	   VISIBILITY_WARNING: "Pliki udostępnione do współużytkowania dla tej społeczności staną się publiczne.",
	   SHARE_WITH_COMMUNITY: {
		   ...
		   ERROR: "Nie można udostępnić tego pliku.  Spróbuj ponownie później.",
           ...
           NOT_LOGGED_IN_ERROR_X: "Nie udostępniono plików do współużytkowania, ponieważ użytkownik nie był zalogowany.  Kliknij przycisk Udostępnij, aby udostępnić te pliki do współużytkowania.",
           ...
           TIMEOUT_ERROR_X: "Nie udostępniono plików do współużytkowania, ponieważ nie można nawiązać kontaktu z serwerem.  Kliknij przycisk Udostępnij, aby spróbować ponownie.",
           ...
           CANCEL_ERROR_X: "Nie udostępniono plików do współużytkowania, ponieważ żądanie zostało anulowane.  Kliknij przycisk Udostępnij, aby spróbować ponownie.",
           ...
           VISIBILITY_RESTRICTION: {
        	   ERROR_SHARE: "Zastrzeżonego pliku nie można ustawić jako pliku publicznego.",
        	   ERROR_SHARE_X: "Zastrzeżonego pliku nie można ustawić jako pliku publicznego."
           }
         },
	   UPLOAD_TO_COMMUNITY: {
		   ...
		   INFO_SUCCESS_PRE_MODERATION: "Plik ${0} został wysłany do przejrzenia i będzie dostępny po zatwierdzeniu.",
		   MULTI_INFO_SUCCESS_PRE_MODERATION: "Liczba plików wysłanych do przejrzenia, które staną się dostępne po zatwierdzeniu: ${0}."
	   }
      },
   UPLOADFILE: {
      DESCRIPTION: "Prześlij i udostępnij pliki"
   },
   UNSAVEDCHANGES: {
	   CANCEL: "Anuluj",
