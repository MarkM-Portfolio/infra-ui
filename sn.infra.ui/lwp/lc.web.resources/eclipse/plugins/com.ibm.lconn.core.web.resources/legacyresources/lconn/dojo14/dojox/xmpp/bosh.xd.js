...
return {depends: [["provide", "dojox.xmpp.bosh"],
["require", "dojo.io.script"],
["require", "dojo.io.iframe"],
["require", "dojox.xml.parser"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.bosh"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
