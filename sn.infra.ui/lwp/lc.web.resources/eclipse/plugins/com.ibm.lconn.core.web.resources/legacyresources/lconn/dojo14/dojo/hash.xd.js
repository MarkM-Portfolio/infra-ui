...
return {depends: [["provide", "dojo.hash"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.hash"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
