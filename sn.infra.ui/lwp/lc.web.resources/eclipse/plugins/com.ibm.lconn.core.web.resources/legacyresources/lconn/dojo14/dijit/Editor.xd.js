...
return {depends: [["provide", "dijit.Editor"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.Editor"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
