...
return {depends: [["provide", "dojox.form.FilePickerTextBox"],
["require", "dojox.widget.FilePicker"],
["require", "dijit.form.ValidationTextBox"],
["require", "dijit._HasDropDown"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.FilePickerTextBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
