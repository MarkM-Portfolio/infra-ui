...
return {depends: [["provide", "dojox.form.BusyButton"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.BusyButton"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
