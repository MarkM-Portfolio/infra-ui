...
return {depends: [["provide", "dojox.lang.aspect"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.lang.aspect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
