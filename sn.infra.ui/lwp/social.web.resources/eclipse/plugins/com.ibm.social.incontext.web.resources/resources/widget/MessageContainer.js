...
dojo.declare("com.ibm.social.incontext.widget.MessageContainer", [dijit._Widget], {
   ...
   buildRendering: function() {
      ...
      //dijit.setWaiRole(this.domNode, "alert");
      ...
      var div = d.createElement("div");
         ...
         if(msg && msg.nodeType && (msg.nodeName.toLowerCase() == "span")) {
            ...
            if (msg) {
               ...
               if (typeof msg == "string")
            	   com.ibm.social.incontext.util.text.breakString(item.message, d, span, 15);
         ...
         if (item.canClose) {
            var a = d.createElement("a");
               ...
               dojo.connect(a, "onclick", dojo.hitch(this, "remove", item));
   ...
   remove: function(id, e) {
      ...
      for (var i=0; i<nodes.length; i++)
         if (nodes[i]._id == id) {
            com.ibm.social.incontext.util.html.removeChildren(nodes[i]);
   ...
   replace: function(newMessage, oldMessage) {
      ...
      // Destroy the old
      com.ibm.social.incontext.util.html.removeChildren(oldNode);
      this.onDisplayChange();
   },
   ...
   clear: function(exceptions) {
      ...
      for (var i=0; i<items.length; i++) {
         var value = items[i];
         if (!value.refId || !exceptions || dojo.indexOf(exceptions, value.refId) == -1)
            this.remove(value);
      }
      this.onDisplayChange();
   },
