...
dojo.provide("com.ibm.social.as.controller.Controller");
...
dojo.require("com.ibm.social.as.controller.DynamicUnloadController");
dojo.require("com.ibm.social.as.controller.UrlGenerator");
dojo.require("com.ibm.social.as.controller.XhrController");
dojo.require("com.ibm.social.as.extension.ExtensionHelper");
...
dojo.declare("com.ibm.social.as.controller.Controller", 
[com.ibm.social.as.controller.XhrController,
 com.ibm.social.as.controller.DynamicLoadController,
 com.ibm.social.as.controller.DynamicUnloadController,
 com.ibm.social.as.util.configNormalizer],
{
	...
	populateFeedInitEventName: com.ibm.social.as.constants.events.INIT,
	...
	constructor: function(options){
		...
		this.eventListener = new com.ibm.social.as.listener.EventListener({
			controller: this
		});
		
		// Create the external event listener to listen to events outside the AS
		this.extEventListener = new com.ibm.social.as.listener.ExternalEventListener({
			controller: this
		});
		
		// Create the util object
		this.util = com.ibm.social.as.util.ConfigObjectUtil;
		
		// Create the UrlGenerator
		this.urlGen = new com.ibm.social.as.controller.UrlGenerator({
		...
		this.extensionHelper = new com.ibm.social.as.extension.ExtensionHelper();
	...
	onUpdateState: function(stateArr){
		...
		dojo.forEach(this.configHandler.getSelectedObjects(), function(option){
	...
	resetUrlAttachParts: function(resetCount){
		...
		dojo.forEach(this.configHandler.getSelectedObjects(), function(part){
	...
	fetchFeed: function(url, dontRefreshFilters, destroyNewsFeed, dynamicAdd, clickEvent, scrollTop){
		...
		dojo.publish(this.populateFeedInitEventName, [dontRefreshFilters, destroyNewsFeed, dynamicAdd, clickEvent]);
