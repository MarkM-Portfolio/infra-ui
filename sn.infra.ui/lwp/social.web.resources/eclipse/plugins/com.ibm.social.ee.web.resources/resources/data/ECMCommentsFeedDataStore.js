...
dojo.require("com.ibm.social.ee.bean.ECMComment");

dojo.declare("com.ibm.social.ee.data.ECMCommentsFeedDataStore", com.ibm.social.ee.data.CommentFeedDataStore, {
   /**
   ...
   itemFromDocEl: function(el, base) {
      return new com.ibm.social.ee.bean.ECMComment(el, base);
   },
