...
return {depends: [["provide", "dijit._editor.range"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._editor.range"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
