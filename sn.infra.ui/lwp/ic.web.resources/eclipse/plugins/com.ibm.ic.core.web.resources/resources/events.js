...
define([
   ...
   /**
    * Miscellaneous event utilities
    */
   // Adapted from https://gist.github.com/termi/4654819

   var events = {}, _initKeyboardEvent_type = (function( e ) {
         try {
            e.initKeyboardEvent(
      ...
      // Play nice with WebKit. Function.prototype.bind() is unavailable in PhantomJS, see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/bind
      , own = Function.prototype.call.bind ? Function.prototype.call.bind(Object.prototype.hasOwnProperty) : lang.hitch(Object.prototype.hasOwnProperty, Function.prototype.call)
   ...
   //export
   events.createKeyboardEvent = crossBrowser_initKeyboardEvent;
