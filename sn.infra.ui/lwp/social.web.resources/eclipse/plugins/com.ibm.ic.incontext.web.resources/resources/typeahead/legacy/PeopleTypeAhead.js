...
define([
	...
	"dojo/dom-geometry",
	"dojo/string",
	"dojo/text!ic-incontext/typeahead/legacy/templates/ComboBox.html",
	"dojo/topic",
	"dijit/form",
	"dijit/Tooltip",
	"ic-incontext/typeahead/legacy/TypeAhead"
], function (dojo, array, declare, lang, domAttr, domClass, domGeometry, stringUtils, template, topic, form, Tooltip, TypeAhead) {
	...
	var PeopleTypeAhead = declare(
	    ...
	    TypeAhead,
	    {
	        ...
	        postMixInProperties: function() {
	           ...
	           this._strings = this._strings || i18nsocialInContextCoreStrings.USERSEARCH;
	        },
	        ...
	        formatItem: function(item, html) {
	            ...
	            if ( item.member ){
	                var dirChar = (domGeometry._isBodyLtr() ? "" : "\u200F"); // prepend the text with a Unicode directional cue when RTL 
	                if (html) {
	        ...
	        _startSearch: function(/*String*/ key, opt) {
	            ...
	            if(!this._popupWidget){
	                ...
	                this.focusNode.setAttribute("aria-activedescendant");
	...
	declare(
	...
	
	    {
	        ...
	        createOptions: function(results, dataObject, labelFunc){
	            ...
	            if (results.length == 0) {
	               var noResultsMsg = stringUtils.substitute(this._strings.NO_RESULTS, [dataObject.query]);
	            ...
	            if(this._highlighted_option != node){
	                ...
	                if ( userid && window.lconn && lconn.profiles && lconn.profiles.bizCard.bizCard.renderMiniBizCard ) {
	                    this.tooltipTimeout = setTimeout(
	                        lang.hitch(this, "renderBizCard", userid, lang.hitch(this, "showTooltip", this.tooltipId, node)),
	                        this.tooltipDelay
	                    );
	                }
	            }
	        ...
	        showTooltip: function(id,node,html){
	            ...
	            if ( id == this.tooltipId && !this.popupClosed) {
	                ...
	                Tooltip.show(html, node, ['after', 'before']);
	            }
	        },
	        ...
	        closeTooltip: function() {
	            ...
	            if ( this.tooltipAroundNode ) {
	                Tooltip.hide(this.tooltipAroundNode);
