...
define([
   ...
   function(lang, array, string, xslt) {
      ...
      function c(n) {
         return array.filter(n.childNodes, function(c) {
            return c.nodeType === 1;
         });
      }

      describe('the interface of ic-core/xslt', function() {
         it('implements the expected methods', function() {
            expect(lang.isFunction(xslt.loadXmlString)).toBeTruthy();
            expect(lang.isFunction(xslt.getXmlHttpRequest)).toBeTruthy();
            expect(lang.isFunction(xslt.loadXml)).toBeTruthy();
            expect(lang.isFunction(xslt.loadXsl)).toBeTruthy();
            expect(lang.isFunction(xslt.loadXslString)).toBeTruthy();
            expect(lang.isFunction(xslt.transform)).toBeTruthy();
            expect(lang.isFunction(xslt.transformDocument)).toBeTruthy();
            expect(lang.isFunction(xslt.transformAndUpdate)).toBeTruthy();
         });
      });

      describe('the method ic-core/xslt::loadXmlString()',
         function() {
            var sXml;
      ...
      describe('the method ic-core/xslt::loadXml()',
         function() {
