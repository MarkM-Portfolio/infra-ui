...
(function() {
	 ...
	 */
	dojo.provide("com.ibm.social.personcard.card");
	...
	window.showTab = function(arg, e) {
		...
		net.jazz.ajax.xdloader.batch_load_async(window.modules, dojo.partial(dojo.publish, "/card/section/change", [el]));
	}
