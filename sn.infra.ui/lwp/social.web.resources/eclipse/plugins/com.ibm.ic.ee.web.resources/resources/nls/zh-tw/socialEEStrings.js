  ...
  /* The placeholders for date formatting strings are as follows:
		...
		*/
		   ...
		   file: {
		      ...
		      timestamp: {
		         ...
		         createdOther: {
		            ...
		            TODAY: "${user} 已於今天 ${time} 建立",
		            YEAR: "${user} 於 ${YYYY} ${MMM} ${d} 建立",
		            YESTERDAY: "${user} 已於昨天 ${time} 建立",
		      ...
		      about: {
		         CREATE_TIMESTAMP: "${user} 於 ${date_long} ${time_long}",
		         UPDATE_TIMESTAMP: "${user} 於 ${date_long} ${time_long}",
		      ...
		      error_403: "您沒有檢視此檔案的權限。 該檔案非公用，且未與您共用。",
		      notifications: {
		         USER_SHARED: "${user} 寫入：",
		   ...
		   ecm_draft: {
		      ...
		      draft_review_404_general_info: "其中一個檢閱人員已投票。 您不再需要檢閱此草稿。",
		      ...
		      review_required_any: "社群擁有者要求一個檢閱人員檢閱此草稿。",
		   ...
		   REPLIES: {
		      ...
		      MODERATION_QUARANTINED: "此文章已被主持人隔離。",
		      MODERATION_REMOVED: {
		   ...
		   COMMENTS: {
		      ...
		      COMMENT_DELETED: {
		         DAY: "評論由 ${user} 於 ${EEEE} ${time} 刪除",
		         MONTH: "評論由 ${user} 於 ${MMM} ${d} 刪除",
		         TODAY: "評論由 ${user} 於今天 ${time} 刪除",
		         YEAR: "評論由 ${user} 於 ${YYYY} ${MMM} ${d} 刪除",
		         YESTERDAY: "評論由 ${user} 於昨天 ${time} 刪除",
		   ...
		   DATE: {
		      ...
		      UPDATED: { DAY: "更新於${EEee} ${time}",
		         FULL: "${EEEE}，${date_long} ${time_long}",
		         MONTH: "於 ${date_long} 更新",
		         TODAY: "於今天 ${time} 更新",
		         YEAR: "於 ${date_long} 更新",
		         YESTERDAY: "於昨天 ${time} 更新"
		      }
		   ...
		   VERSIONS: {
		      ...
		      DELETE: {
		         ...
		         GENERIC_ERROR: "因為不明錯誤而無法刪除該版本。  請再按一下「刪除」以重試要求。",
		         FULL: "刪除",
		      ...
		      REVERT: {
		         ...
		         ERROR_TIMEOUT: "因為無法聯絡伺服器，所以未還原該版本。  請再按一下「還原」以重試要求。",
		         ERROR_CANCEL: "因為已取消要求，所以未還原該版本。  請再按一下「還原」以重試要求。",
		         ERROR_QUOTA_VIOLATION: "由於空間限制，無法還原該版本。",
		         ERROR_MAX_CONTENT_SIZE: "因為該版本大於所容許的檔案大小上限 ${0}，所以無法還原該版本。",
		         GENERIC_ERROR: "由於不明錯誤而無法還原該版本。  請再按一下「還原」以重試要求。"
		      }
		   },
		   DOWNLOAD_INFO: {
		   ...
		   EE_DIALOG: {
		      ...
		      CONFIRM_CLOSE_MESSAGE: "確定要放棄變更嗎？ 按「確定」繼續或按「取消」返回",
		      OK: "確定",
		      CANCEL: "取消"
		   },
		   MESSAGE: {
		   ...
		   login: {
		      error: "您的使用者名稱及（或）密碼不符合任何現有的帳號。 請重試。",
		      logIn: "登入",
		      password: "密碼：",
		      user: "使用者名稱：",
		   ...
		   FILE_SHARE_INFO: {
		      ...
		      OWNER_LABEL: "擁有者：\u00a0",
		      ERROR: "無法載入共用資訊",
		      ERROR_NOT_FOUND: "已刪除或移動您所要求的檔案。 如果某人傳送此鏈結給您，請檢查它是否正確。",
		      ERROR_ACCESS_DENIED: "您沒有檢視此檔案的權限。  該檔案非公用，且未與您共用。",
		      SHARE: "共用",
		      CANCEL: "取消",
		      SHARE_WITH: "共用對象：",
		      PERSON: "人員",
		      COMMUNITY: "社群",
		      PLACEHOLDER: "人員姓名或電子郵件...",
		      MESSAGE: "訊息：",
		      MESSAGE_TXT: "新增選用訊息",
		      ...
		      VISIBILITY_RESTRICTION_ERROR_SHARE: "受限的檔案不能設成公用檔案。",
		   ...
		   UNSAVEDCHANGES: {
		      CANCEL: "取消",
		      CONFIRM: "確定要放棄變更嗎？  按「確定」繼續或按「取消」返回。",
		      DIALOG_TITLE: "確認",
		      NAME: "確認",
		      OK: "確定",
		      TOOLTIP: "確認"
