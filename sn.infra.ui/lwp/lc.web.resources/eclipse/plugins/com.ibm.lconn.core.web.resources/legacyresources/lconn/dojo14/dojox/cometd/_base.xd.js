...
return {depends: [["provide", "dojox.cometd._base"],
["require", "dojo.AdapterRegistry"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.cometd._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
