...
define([
      ...
      "dojo/_base/declare",
      "dojo/cache",
      "dojo/text!./templates/DummyRTE.html",
   ...
   function(dojo, declare, cache, template, IMentionsSupportRTE, url, services, coreText, string, domConstruct, query, array, entities, has) {

      /**
       * Jasmine spec for {@link ic-core.lcTextArea.mixins.IMentionsSupportRTE}
       * 
       * @module ic-test.lcTextArea.IMentionsSupportRTESpec
       */
      /**
       * Dummy test class that mixes in
       * core.lcTextArea.mixins.IMentionsSupportRTE
       * 
       * @class ic-test.lcTextArea._DummyRTE
       * @extends ic-core.lcTextArea.mixins.IMentionsSupportRTE
       * @private
       */
      var DummyRTE = declare(IMentionsSupportRTE,
      /** @lends ic-test.lcTextArea.DummyRTE.prototype */
      {
       ...
       * Mock RTE
       * 
       * @class ic-test.lcTextArea._MockRTE
       * @private
       */
      var MockRTE = declare(null,
      /** @lends ic-test.lcTextArea._MockRTE.prototype */
      {
         constructor : function(text) {
            this.callbacks = [];
            dojo.safeMixin(this, text);
            this.text = text;
      ...
      var HTML = template, TRACKED_MENTIONS = {
         textData : [
               {
                  type : 'text',
                  value : '\n    Hello world! I feel like mentioning someone in my team. First of all,\n    '
               },
               {
               ...
               {
                  type : 'text',
                  value : '\n    for her countless hours spent debugging customer problems, then cheers to\n    '
               },
               {
               ...
               {
                  type : 'text',
                  value : '\n    for resolving once for all the issues by writing an extensive suite of unit\n    tests.\n    Finally, I\'d like to spend a word to commend the efforts by \n    '
               },
               {
               ...
               {
                  type : 'text',
                  value : ' \n    who, by the way, cannot be notified of this mention cause she left the team\n    in anger.\n'
               }
         ]
      };
      ...
      describe("the ic-core/lcTextArea/mixins/IMentionsSupportRTE mixin", function() {
                  ...
                  document : {
                     $ : {
                        querySelectorAll : function(val) {
                           return query(val, domConstruct.toDom(textbox._editor.html));
                        }
                     },
                     getBody : function() {
                        return {
         ...
         describe("the ic-core/lcTextArea/mixins/IMentionsSupportRTE.cancelActiveMentions() method", function() {
         ...
         describe("the ic-core/lcTextArea/mixins/IMentionsSupportRTE.formatForPlaintext() method", function() {
         ...
         describe("the ic-core/lcTextArea/mixins/IMentionsSupportRTE.getTrackedMentions() method", function() {
            it("returns the expected value", function() {
               expect(b(textbox.getTrackedMentions())).toEqual(b(TRACKED_MENTIONS));
            });
            ...
            it("returns null if the mixed in class doesn't have mentions plugged in", function() {
               expect(function() {
