...
return {depends: [["provide", "dojox.drawing.library.icons"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.library.icons"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
