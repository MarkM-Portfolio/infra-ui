...
package com.ibm.ic.personcard.web.resources.internal;
...
public class CardImplementationBinding
{
  ...
  private static final Key MODULE_ENABLER = new Key(JavaScriptResource.TYPE, "ic-core.people"); //$NON-NLS-1$

  private static final Dependency BINDING_LEGACY = new ExtensionDependency(JavaScriptResource.TYPE, "ic-personcard.legacy"); //$NON-NLS-1$

  private static final Dependency BINDING_STANDARD = new ExtensionDependency(JavaScriptResource.TYPE, "ic-personcard.standard"); //$NON-NLS-1$
