...
define([
   ...
   "dojo/dom",
   "dojo/dom-style",
   "dojo/i18n!./html5_video_player/nls/html5VideoPlayerStrings",
   "dojo/dom-attr",
   "dojo/has",
   "dojo/dom-construct",
   "dojo/dom-geometry",
   ...
   "dojo/Evented",
   "../config/globals"
], function (dojo, dom, domStyle, i18nhtml5VideoPlayerStrings, domAttr, has, domConstruct, domGeometry, domClass, windowModule, declare, _Widget, on, lang, Evented, globals) {
   ...
   */
   ...
   var HTML5VideoPlayer = declare([ _Widget, Evented ], {
      isA11y: false,
      ...
      constructor:function(){
         ...
         this.removeAccessibility = globals.isVerse;
      },
      /*
      ...
      playVideo: function (node, videoUrl, mediaImage, videoWidth, videoHeight, prevId, nextId, allowFullScreen) {
         ...
         on(this.handles.html5vid, "error", lang.hitch(this, function (error) {
         ...
         on(source, "error", lang.hitch(this, function (error) {
           this.emit("error", error);
         }));
         ...
         //remove all accessibility for verse
         if (this.removeAccessibility) {
           ...
           domAttr.set(this.handles.focusOnSeekContainer, "aria-label", "video slider");
           domAttr.set(this.handles.volume, "aria-label", "Mute");
           domAttr.set(this.handles.mute, "aria-label", "Unmute");
           domAttr.set(this.handles.focusOnVolume, "aria-label", "volume slider");
