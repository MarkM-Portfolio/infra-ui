...
define([
  ...
  // just in time tour definitions
  './jit/homepageOrigJIT',
  './jit/homepageMyPageJIT',
  './jit/homepageGettingStartedJIT',
  './jit/filesJIT',
  './jit/metricsJIT',
  './jit/communitiesJIT'
], function(declare,
  ...
  var TourControllerClass = declare(null, {
    ...
    init: function(){
        this._toursManager = new ToursManagerClass({isRtl: document.documentElement.dir == 'rtl', locale: dojo.locale});
    },
    ...
    registerTours: function() {
      ...
      homepageMyPageJIT && tours.push(homepageMyPageJIT);
      homepageGettingStartedJIT && tours.push(homepageGettingStartedJIT);
      filesJIT && tours.push(filesJIT);
	  metricsJIT && tours.push(metricsJIT);
      communitiesJIT && tours.push(communitiesJIT);
      this.addTours(tours);
    },
