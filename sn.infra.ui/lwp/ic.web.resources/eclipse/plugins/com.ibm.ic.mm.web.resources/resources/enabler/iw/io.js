...
], function (dojo, declare, debug, utilities) {

	var io = declare("com.ibm.mm.enabler.iw.io",null,
	{
		...
		constructor:function (/*String*/id) {
	        ...
	        this.widgetBaseUriXhr = utilities.rewriteURL(this.widgetBaseUri);
	        ...
	        if ( this.widgetBaseUri.indexOf("://") != -1) {
	            ...
	            this.serverRootXhr = utilities.rewriteURL(this.serverRoot);
	        }
	    },
	    rewriteURI:function(/*String*/uri,isXhr){ 
	         debug.entry("com.ibm.mm.enabler.iw.io.rewriteURI",uri+" isXhr:"+isXhr);
	         ...
	         if (isXhr) {
	             if (uri.indexOf("://")!= -1 ) {
	                 returnUri =  utilities.rewriteURL(uri);
	             }
	             else{
	                 if (uri.indexOf("/") == 0 ) {
	         ...
	         debug.exit("com.ibm.mm.enabler.iw.io.rewriteURI",returnUri);
