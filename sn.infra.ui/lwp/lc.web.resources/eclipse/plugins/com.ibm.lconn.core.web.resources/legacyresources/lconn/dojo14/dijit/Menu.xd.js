...
return {depends: [["provide", "dijit.Menu"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.Menu"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
