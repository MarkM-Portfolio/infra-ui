...
dojo.provide("com.ibm.social.test.ee.ds.TestDsTotalKnown");

dojo.declare("com.ibm.social.test.ee.ds.TestDsTotalKnown", null, {
   ...
   fetch: function(/* Object */ keywordArgs){
      ...
      if (request.onBegin) {
         request.onBegin.call(scope, this.data.length, request);
      }    
