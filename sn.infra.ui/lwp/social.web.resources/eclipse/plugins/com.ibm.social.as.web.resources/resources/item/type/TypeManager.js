...
dojo.provide("com.ibm.social.as.item.type.TypeManager");

dojo.require("com.ibm.social.as.item.type.types");
...
dojo.declare("com.ibm.social.as.item.type.TypeManager", null,
{
	...
	typesArr: com.ibm.social.as.item.type.types,
	...
	constructor: function(){
		...
		for(var t = 0; t < typesArr.length; t++){
			...
			try{
				...
				var typeCls = dojo.getObject(type);
