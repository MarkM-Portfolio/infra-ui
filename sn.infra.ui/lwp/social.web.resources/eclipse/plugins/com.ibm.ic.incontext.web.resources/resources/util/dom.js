...
define([
	...
	"ic-incontext/util/_dom"
], function (array, domConstruct, declare, has, _dom) {
	   ...
	   dom.newXMLDocument = function(rootTagName, namespace, namespaces) {
	      ...
	      if (document.implementation && document.implementation.createDocument && !has("ie")) {
	...
	//               prefix = "xmlns"; // What Firefox uses
	   ...
	   dom.getElementByLanguage = function(nodes, language) {
	      ...
	      if (array.indexOf(languages, "en-us") == -1)
	         languages.push("en-us");
	      if (array.indexOf(languages, "en") == -1)
	         languages.push("en");
	      if (array.indexOf(languages, "") == -1)
	         languages.push("");
	
	      for (i = 0; i < languages.length; i++) {
	         for (j = 0; c = nodes[j]; j++) {
	            lang = (has("ie")) ? c.getAttribute(dom.XML_NAMESPACE.SHORT+":lang") : c.getAttributeNS(dom.XML_NAMESPACE.LONG,"lang");
	   ...
	   dom.getChildElementAttribute = function(entry, elementName, attr) {
	      if (!entry)
	         return null;
	      if (attr == "class" && has("ie")) attr = "className";
	   ...
	   dom.getChildElementAttributeMatching = function(entry, elementName, attrTest, attributeValue, attrRet) {
	      if (!entry)
	         return null;
	      if (attrTest == "class" && has("ie")) attrTest = "className";
	   ...
	   dom.setTextNode = function(d, loc, value) {
	      if (loc.firstChild) {
	         domConstruct.destroy(loc.firstChild);
	      }
