...
return {depends: [["provide", "dojox.xmpp.xmppSession"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.xmppSession"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
