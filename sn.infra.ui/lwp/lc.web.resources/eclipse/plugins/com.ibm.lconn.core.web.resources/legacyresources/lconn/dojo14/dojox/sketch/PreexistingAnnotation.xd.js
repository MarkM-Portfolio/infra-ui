...
return {depends: [["provide", "dojox.sketch.PreexistingAnnotation"],
["require", "dojox.sketch.Annotation"],
["require", "dojox.sketch.Anchor"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.sketch.PreexistingAnnotation"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
