...
invalidASConfig: "Dogodila se greška konfiguracije za tok ažuriranja. Molim, kontaktirajte vašeg administratora.",
...
tagsText: "Oznake: ${0}",
// ${0}  :  Number of likes for a news item
likesText: "${0} se sviđa",
likeText: "1 sviđanje",
imageNotAvailable: "Pregled trenutno nije dostupan",
likeError: "Dogodila se greška kod označavanja da vam se ova stavka sviđa.",
unLikeError: "Dogodila se greška kod označavanja da vam se ova stavka ne sviđa.",
// ${0} author name
fromText: "Od: ${0}",
...
linkToPersonText: "Ovo je veza na profil od ${0}",
...
ariaVideoArea: "Područje videa, pritisnite ENTER za pristup video kontrolerima",

// News Item Actions - Comment
commentText: "Komentar",
logInText: "Prijava",
logInCommentText: "Prijavite se za komentiranje",
...
commentNotPermittedText: "Niste ovlašteni da komentirate ovu poruku.",
commentFailureText: "Pokušaj dodavanja teksta komentara nije uspio. Molim, osvježite stranicu i pokušajte ponovno.",
commentSessionTimedOut: "Automatski ste odjavljeni s poslužitelja zbog neaktivnosti. Kopirajte tekst koji ste upisali u vašu memoriju za isječke da ju ne izgubite, a zatim se <a href : ''${0}''>prijavite</a> da počnete ponovo.",
commentPostText: "Pošalji",
commentCancelText: "Opoziv",




// Defect 59368 - String to say comment length exceeded.
commentLengthExceeded: "Komentar je predugačak za objavljivanje. Molimo ispravite komentar i pokušajte ponovno.",
...
commentAriaLabel: "${0} je napisao komentar ${1}",
...
commentAriaLabelSameDay: "${0} je napisao komentar u ${1}",
// same as above, but for replies
replyAriaLabelSameDay: "${0} je napisao odgovor u ${1}",
...
// News Feed Error
feedErrorText: "Dogodila se greška kod dohvata vaših tekućih informacija.",
itemErrorText: "Dogodila se greška prikaza stavke u vašim tekućim informacijama.",
errorAlt : "Greška:",
errorShowMore: "Pokaži više",
errorShowLess: "Pokaži manje",

// Paging Handler
backToTopText: "Natrag na vrh",
ariaShowMore: "Pokaži više stavaka toka aktivnosti",
ariaShowLess: "Pokaži manje stavaka toka aktivnosti",
ariaBackToTop: "Natrag na vrh stavaka toka aktivnosti",
...
moreCommentsAriaLabel: "Komentari za ${0} . Koristite više detalja da prikažete sve ${1} komentare.",
...
statusRemoveCancelText: "Opoziv",
statusRemoveConfirmationMsg:  "Poruka je uspješno izbrisana.",
statusRemoveErrorMsg: "Poruka nije mogla biti izbrisana u ovom trenutku. Pokušajte ponovno ili kontaktirajte administratora.",
...
commentRemoveCancelText: "Opoziv",
commentRemoveConfirmationMsg: "Komentar je uspješno izbrisan.",
commentRemoveErrorMsg: "Komentar u ovom trenutku nije mogao biti izbrisan. Pokušajte ponovno ili kontaktirajte administratora.",
...
ariaShowMoreLabel: "Ovaj gumb se koristi za prikazivanje sadržaja skrivenog u prikazu. Nije važan za korisnike s omogućenim pomoćnim tehnologijama.",
...
collapseTrend: "Skupi filter trendova",
trendTitle: "Trend",
relatedTrendTitle: "Dodajte trend ''${0}''",
trendHelp: "Pomoć za trend",
closeTrendHelp: "Zatvori pomoć za trend",
trendDescription: "Trend je ključna riječ koju generira sistem radi lakšeg izvođenja pretraživanja u Ažuriranjima statusa. Kliknite trend za prikaz rezultata pretraživanja koji imaju ovu ključnu riječ.",
...
removeTrend: "Uklonitetrend ''${0}'' iz izabranog filtera trendova",
removeGeneric: "Ukloni",
removeHashtag: "Uklonitehashtag ${0} s izabranog filtera oznaka.",
...
asSearchBarCancel: "Opoziv pretraživanja i povratak na glavni pogled",
asSearch: "Traži",
...
ariaMultipleMentions: "${0} je bio spomenut",
...
filterBlogs: "Blogovi",
filterBookmarks: "Knjiške oznake",
...
showPreviousComments: "Pokaži prethodne komentare...",
hideAdditionalComments: "Sakrij dodatne komentare...",
// Used to display current shown comments. e.g. "2 of 10"
commentsCounter: "${0} od ${1}",
errorRetrieveComments: "Dogodila se greška kod dohvaćanja prethodnih komentara.",
errorRetrieveCommentsDeleted: "Dogodila se greška kod dohvaćanja prethodnih komentara. Stavka je možda izbrisana.",

// News Item Actions - Repost
repostText: "Ponovi objavu",
logInRepostText: "Prijavite se za ponovnu objavu",
repostMsgSuccess: "Ažuriranje je uspješno ponovno objavljeno vašim sljedbenicima.",
repostMsgFail: "Dogodila se greška kod ponovnog objavljivanja ove poruke.",
repostMsgErrorResGeneric: "Nemate ovlaštenje za ponovno objavljivanje ove poruke.",
repostMsgErrorRestricted: "Ova se poruka ne može ponovo postati jer je sada ${0} zajednica Ograničena zajednica.",
...
opensInNewWindow: "Ova veza će se otvoriti u novom prozoru.",
...
newNotifications: "${0} nove obavijesti",
loadingNotifications: "Učitavanje...",
noNewNotifications: "Niste primili nikakvu obavijest prošli tjedan.",
markRead: "Označite kao pročitanu",
markUnread: "Označite kao nepročitanu",
markAllRead: "Označite sve kao pročitano",
markAllReadDetails: "Kliknite ovdje da označite sve napomene kao pročitane.",
notificationPopupSingleGeneric: "Imate 1 novu napomenu",
notificationPopupGeneric: "Imate ${0} novih napomena"
});
