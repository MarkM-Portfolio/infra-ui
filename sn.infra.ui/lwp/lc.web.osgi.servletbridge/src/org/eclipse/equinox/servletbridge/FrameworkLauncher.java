...
public class FrameworkLauncher {
     ...
     */
    // MODIFIED: changed visibility
    protected void deployExtensionBundle(File plugins) {
    ...
    public synchronized void start() {
        ...
        try {
            ...
            //ADDED: release the classloader when a failure occurs during startup
            if (frameworkClassLoader != null)
     ...
     */
    protected static void clearPrefixedSystemProperties(String prefix, Map targetPropertyMap) {
