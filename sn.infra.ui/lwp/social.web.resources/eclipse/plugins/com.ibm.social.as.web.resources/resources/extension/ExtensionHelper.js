...
dojo.provide("com.ibm.social.as.extension.ExtensionHelper");

dojo.require("com.ibm.social.as.extension.ExtensionManager");
...
dojo.declare("com.ibm.social.as.extension.ExtensionHelper", null,
{
	...
	constructor: function(){
		...
		this.extensionManager = new com.ibm.social.as.extension.ExtensionManager();
	...
	removeExtensionDuplicates: function(extensionsArray){
		...
		for(var e = extensionsArray.length-1; e >= 0 ; e--){
			...
			if(dojo.indexOf(extensionsArray, extensionsArray[e]) !== e){
