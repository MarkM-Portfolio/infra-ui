...
return {depends: [["provide", "dojox.form.FileInputAuto"],
["require", "dojox.form.FileInput"],
["require", "dojo.io.iframe"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.FileInputAuto"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
