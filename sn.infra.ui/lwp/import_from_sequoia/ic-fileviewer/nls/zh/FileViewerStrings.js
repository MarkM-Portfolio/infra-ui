  ...
  root: {
     ...
     ACTION: {
       ...
       ROUNDTRIP_EDIT: {
         ...
         TOOLTIP: "编辑此文档",
         A11Y: "此按钮可打开文件在本地编辑。",
         PROMPT: "此功能允许您在本地编辑文件。",
         IMPORTANT: "要点：",
         REMINDER: "完成编辑后，必须使用桌面文件连接器来发布草稿。 如果无法打开文件，可能需要安装桌面插件。",
         SKIP_DIALOG: "不再显示此消息。",
         OK: "确定",
         CANCEL: "取消"
       },
       ...
       UPLOAD_VERSION: {
         ...
         TOOLTIP: "上传此文件的新版本",
         A11Y: "此按钮用于打开可上传此文件的新版本的对话框。"
       },
       LOG_IN: {
    	   NAME: "登录",
    	   TOOLTIP: "登录以上载和共享文件、评论以及创建文件夹"
       },
       LOCK: {
          NAME: "锁定文件",
          TITLE: "锁定此文件",
     ...
     SECTION: {
      ABOUT: {
       ...
       A11Y: "激活此链接将关闭文件查看器，并将您定向到该文件的文件详细信息页面。"
      }
     },
     PREVIEW: {
      ICON: {
     ...
     DOCS_STATUS_MESSAGE: {
       NO_ENTITLEMENT: "仅当您已购买 Docs 权利时，才可以在线编辑此文件。",
      ...
      SHARE_OPTIONS: {
	   ...
	   PANEL: {
	     ...
	     ABOUT: {
	       ...
	       DOWNLOADS_HEADER: "下载次数",
	       DOWNLOADS_HEADER_MORE: "下载 (${0})",
	       DOWNLOADS_EXPAND_ICON: "展开此图标以查看已下载文件的人员",
	       DOWNLOADS_COUNT: "${downloads}",
	       DOWNLOADS_COUNT_FULL: "${downloads} - ${anonymousDownloads}（匿名）",
	       DOWNLOADS_LATEST_VERSION: "您具有此文件的最新版本",
	       DOWNLOADS_LAST_VERSION: "您上次下载的是此文件的版本 ${0}",
	       TAGS_HEADER: "标签",
