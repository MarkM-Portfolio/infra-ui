...
define([ "ic-core/lcTextArea/mixins/Mentions",
         "ic-core/url",
         "ic-core/config/services"
], function(mentions, url, services) {
   ...
   describe("the ic-core/lcTextArea/widgets/Mentions class", function() {
      ...
      describe('the method lconn.core.lcTextArea.mixins.Mentions.formatSetValue()', function() {
         var serviceURL = url.getServiceUrl(services.profiles);
      ...
      describe("the method lconn.core.lcTextArea.mixins.Mentions.getDataMentions()", function() {
         ...
         it("retruns hasSymbol = false when the user has no '@' symbol", function() {
