...
return {depends: [["provide", "dojox.date.islamic"],
["require", "dojox.date.islamic.Date"],
["require", "dojo.date"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.islamic"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
