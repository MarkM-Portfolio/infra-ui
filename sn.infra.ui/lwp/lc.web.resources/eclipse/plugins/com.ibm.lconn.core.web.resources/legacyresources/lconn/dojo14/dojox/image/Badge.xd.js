...
return {depends: [["provide", "dojox.image.Badge"],
["require", "dijit._Widget"],
["require", "dijit._Templated"],
["require", "dojo.fx.easing"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.image.Badge"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
