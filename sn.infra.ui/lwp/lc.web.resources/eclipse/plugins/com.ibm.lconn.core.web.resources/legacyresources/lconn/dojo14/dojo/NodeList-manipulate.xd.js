...
return {depends: [["provide", "dojo.NodeList-manipulate"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.NodeList-manipulate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
