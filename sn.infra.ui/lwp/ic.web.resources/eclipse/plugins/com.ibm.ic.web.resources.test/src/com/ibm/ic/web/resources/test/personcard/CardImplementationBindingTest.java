...
package com.ibm.ic.web.resources.test.personcard;
...
import com.ibm.ic.personcard.web.resources.internal.CardImplementationBinding;
import com.ibm.ic.personcard.web.resources.internal.CardImplementationBinding.BindingType;

@SuppressWarnings("nls")
public class CardImplementationBindingTest extends AbstractTest
{

  private final static String MODULE_ENABLER = "ic-core.people";

  private static final String BINDING_LEGACY_ID = "ic-personcard.legacy";

  private static final String BINDING_LEGACY_PROVIDE = "define(\"" + BINDING_LEGACY_ID.replace('.', '/') + "\",";

  private static Resource BINDING_LEGACY = Resource.resolve(BINDING_LEGACY_ID);

  private static final String BINDING_STANDARD_ID = "ic-personcard.standard";

  private static final String BINDING_STANDARD_PROVIDE = "define(\"" + BINDING_STANDARD_ID.replace('.', '/') + "\",";

  private static Resource BINDING_STANDARD = Resource.resolve(BINDING_STANDARD_ID);
  ...
  public final void ensureNoBinding()
  {
    try
    {
      Resource.deleteBinding(new Key(JavaScriptModule.TYPE, MODULE_ENABLER), new ExtensionDependency(JavaScriptModule.TYPE,
          BINDING_LEGACY_ID));
      Resource.deleteBinding(new Key(JavaScriptModule.TYPE, MODULE_ENABLER), new ExtensionDependency(JavaScriptModule.TYPE,
          BINDING_STANDARD_ID));
    }
