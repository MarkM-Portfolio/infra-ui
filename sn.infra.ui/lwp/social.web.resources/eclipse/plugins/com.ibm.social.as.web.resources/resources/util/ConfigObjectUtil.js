...
dojo.provide("com.ibm.social.as.util.ConfigObjectUtil");
...
dojo.setObject("com.ibm.social.as.util.ConfigObjectUtil", 
{
	/**
	...
	triggerRefreshInNextTick: function(){
		...
		window.setTimeout(dojo.hitch(dojo, "publish", com.ibm.social.as.constants.events.UPDATESTATE, [[]]), 0);
	},
