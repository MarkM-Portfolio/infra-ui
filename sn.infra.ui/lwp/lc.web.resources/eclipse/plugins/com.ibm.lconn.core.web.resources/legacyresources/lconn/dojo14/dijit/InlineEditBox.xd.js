...
return {depends: [["provide", "dijit.InlineEditBox"],
["require", "dojo.i18n"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.InlineEditBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
