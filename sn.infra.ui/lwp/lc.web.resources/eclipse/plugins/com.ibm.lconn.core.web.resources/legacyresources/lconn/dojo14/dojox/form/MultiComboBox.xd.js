...
return {depends: [["provide", "dojox.form.MultiComboBox"],
["require", "dijit.form.ComboBox"],
["require", "dijit.form.ValidationTextBox"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.MultiComboBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
