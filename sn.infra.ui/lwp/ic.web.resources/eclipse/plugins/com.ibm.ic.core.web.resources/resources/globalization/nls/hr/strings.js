...
define({
      "globalization" : {
         ...
         "details" : "Navedite preferirani jezik, kalendar i smjer korisnički definiranog teksta.",
         "error" : "Postavke globalizacije nisu dohvaćene zbog greške.",
         "titlebar" : {
         ...
         "details_nolanguage" : "Navedite preferirani kalendar i smjer korisnički definiranog teksta.",
         "a11y" : {
      ...
      "restore_defaults" : {
         ...
         "success" : "Vaše postavke globalizacije vraćene su na izvorne default vrijednosti."
      },
      "help" : {
         "help" : "Pomoć",
         "close" : "Zatvori"
      ...
      "preferences" : {
         ...
         "bidi" : {
            ...
            "tooltip" : "Omogućuje prikaz ulančanog i strukturiranog teksta poput staza datoteka za određeni jezik.  Također omogućuje definiranje smjera teksta neovisno o vašem odabranom jeziku."
         },
         "error" : "Greška",
         "save" : {
            "label" : "Spremi"
         ...
         "direction" : {
            "label" : "Smjer korisnički-definiranog teksta:",
            "tooltip" : "Smjer teksta izvedenog iz korisničkog unosa, poput naziva sadržaja i breadcrumbs navigaciju.  Ovo se po defaultu određuje na temelju vašeg odabranog jezika (slijeva nadesno u većini slučajeva).  Ako odaberete opciju kontekstualno, sistem može utvrditi smjer na temelju analize znakova (podržava tekst u više smjerova).",
            "options" : {
               ...
               "default_rtl" : "Koristi default za jezik (zdesna nalijevo)"
            }
         },
         "cancel" : {
            "label" : "Opoziv"
         ...
         "language" : {
            "selected" : "${0} (trenutno)",
            "label" : "Jezik:",
            "tooltip" : "Navedite jezik u kojem će se prikazivati tekst aplikacije.  Ova postavka nema utjecaja na korisnički generirani tekst."
         },
         "calendar" : {
            "label" : "Kalendar:",
            "options" : {
