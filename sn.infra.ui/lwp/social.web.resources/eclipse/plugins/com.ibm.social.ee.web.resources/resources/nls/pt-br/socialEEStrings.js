...
({
  	  ...
  	  vote: {
  		  INLINE: {
  				...
  				RECOMMENDED: {
  					...
  					TEXT: 		"<span class='lotusLikeDescription'>Votado</span> <span class='lotusDivider' role='presentation'>-</span> <a class='lotusLikeActions' role='button' aria-label='Votado - Desfazer' href='javascript:;' id='TOGGLE_${id}'>Desfazer</a>",
   ...
   COMMENTS_SHORTEN: {
      CANCEL: "Cancelar",
      CONFIRM: "O encurtamento removerá o texto além do limite de comentário.  Clique em 'OK' para reduzir ou em 'Cancelar' para que você mesmo edite o comentário.",
      DIALOG_TITLE: "Reduzir Comentário",
      NAME: "Reduzir Comentário",
      OK: "OK",
      TOOLTIP: "Reduzir Comentário"
   ...
   VERSIONS: {
      ...
      DELETE: {
         ...
         FULL: "Excluir",
         A11Y: "Este botão abre um diálogo que permite que o usuário confirme a exclusão desta versão. Confirmar essa ação resultará em uma atualização do conteúdo na página."
      },
   ...
   login: {
      error: "O nome de usuário e/ou senha não correspondem a nenhuma conta existente. Tente novamente.",
      logIn: "Efetuar login",
      password: "Senha:",
   ...
   FILE_SHARE_INFO: {
      ...
      ERROR_ACCESS_DENIED: "Você não tem permissão para visualizar este arquivo.  O arquivo não é público e não é compartilhado com você.",
      SHARE: "Compartilhar",
      CANCEL: "Cancelar",
