...
define([
      ...
      "ic-ui/_base"
], function(declare, array, kernel, lang, domAttr, query, simpleFetch, ItemFileReadStore, _base) {

   var ImageDataStore = declare("lconn.test.ImageDataStore", [
         _base,
         ItemFileReadStore
   ], {
      constructor : function(keywordParameters) {
         ...
         if (!!keywordParameters.source) {
            query("img", keywordParameters.source).forEach(function(imgTag) {
               var sLink = null;
               ...
               if (!!pNode) {
                  if (pNode.tagName.toUpperCase() == "A") {
                     sLink = domAttr(pNode, "href");
                  }
               }

               sourceData.items.push({
                  "large" : imgTag.src,
                  "thumb" : domAttr(imgTag, "thumb") || imgTag.src,
            ...
            if (!!this._jsonData && lang.isArray(this._jsonData.items)) {
         ...
         if (lang.isObject(this._jsonData) && lang.isArray(this._jsonData.items)) {
            array.forEach(this._jsonData.items, function(itm, idx) {
      ...
      fetchAllItems : function() {
         if (!this.data && !this._jsonData) {
            if (this._jsonFileUrl !== this._ccUrl) {
               kernel.deprecated("dojo.data.ItemFileReadStore: ", "To change the url, set the url property of the store,"
