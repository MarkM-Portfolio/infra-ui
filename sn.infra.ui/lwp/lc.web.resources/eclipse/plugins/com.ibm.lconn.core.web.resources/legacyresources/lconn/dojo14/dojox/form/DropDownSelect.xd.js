...
return {depends: [["provide", "dojox.form.DropDownSelect"],
["require", "dijit.form.Select"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.DropDownSelect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
