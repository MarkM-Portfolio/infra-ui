...
return {depends: [["provide", "dojox.drawing.tools.Line"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.tools.Line"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
