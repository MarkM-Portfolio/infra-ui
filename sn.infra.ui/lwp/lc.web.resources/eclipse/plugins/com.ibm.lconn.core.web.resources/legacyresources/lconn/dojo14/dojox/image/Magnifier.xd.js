...
return {depends: [["provide", "dojox.image.Magnifier"],
["require", "dojox.gfx"],
["require", "dojox.image.MagnifierLite"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.image.Magnifier"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
