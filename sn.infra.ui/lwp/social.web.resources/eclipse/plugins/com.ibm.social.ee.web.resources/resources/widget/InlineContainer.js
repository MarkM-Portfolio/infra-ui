   ...
   [dijit._Widget],
	{
      ...
      renderItem: function(div, item) {
         ...
         var a = d.createElement("a");
            ...
            a.appendChild(d.createTextNode(com.ibm.social.incontext.util.text.trimToLength(item.name, this.maxLength)));
            a.title = item.name;
            a.href = "javascript:;";
      ...
      removeAll: function() {
         ...
         this.itemsById = {};
         this.items = [];
         com.ibm.social.incontext.util.html.removeChildren(itemNode);
         this.onEmpty();
      },
