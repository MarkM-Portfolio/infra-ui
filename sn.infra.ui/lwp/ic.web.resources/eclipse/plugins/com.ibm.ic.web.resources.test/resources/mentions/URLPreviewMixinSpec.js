...
define([
   ...
   function(dojo, lang, windowModule, URLPreviewMixin) {

      describe("the URLPreviewMixin mixin", function() {
         var m = new URLPreviewMixin();
         it("implements the expected methods", function() {
            expect(lang.isFunction(m.detectURL)).toBeTruthy();
            expect(lang.isFunction(m.removeURLPreview)).toBeTruthy();
         });
      });

      describe("a module implementing the URLPreviewMixin mixin",
         function() {
            var m, t;
            beforeEach(function() {
               m = new URLPreviewMixin();
               t = windowModule.doc
            ...
            it("can detect URLs in a text node correctly if disableURLPreview is false", function() {
               ...
               m.textAreaNode = windowModule.doc.createElement('div', {
                  contentEditable : true
               });
               m.textAreaNode.appendChild(t);
               // FIXME: this method has a side effect of incrementing the value
               // of _idx
               m._idx = 0;
               // FIXME: this method assumes there's a member array
               // _trackedMentions
               m._trackedMentions = [];
