...
return {depends: [["provide", "dijit._editor.plugins.ToggleDir"],
["require", "dijit._editor._Plugin"],
["require", "dijit.form.ToggleButton"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._editor.plugins.ToggleDir"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
