...
return {depends: [["provide", "dojox.drawing.plugins.drawing.Silverlight"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.plugins.drawing.Silverlight"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
