...
define([
	...
	declare("com.ibm.mm.enabler.iw.parser.WidgetParserFactory",null,  {
	     ...
	     _isLegacy: function(responseText){
	         ...
	         debug.log("parser._isLegacy", isLegacy);
	         return isLegacy;
	     }
	});    
	...
	return com.ibm.mm.enabler.iw.parser;
});
