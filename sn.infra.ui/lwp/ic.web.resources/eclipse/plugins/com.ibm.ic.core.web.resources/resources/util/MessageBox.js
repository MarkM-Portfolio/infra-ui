...
define([
      ...
      "ic-ui/MessageBox",
      "ic-core/Res"
], function(lang, dom, domConstruct, registry, MessageBox, Res) {

   /**
    * A utility to render message boxes
    * <p>
    * The need for this utility is questionable. Please instantiate the
    * {@see ic-ui.MessageBox} widget directly.
    * 
    * @namespace ic-core.util.MessageBox
    */
   var MessageBoxUtil = lang.getObject("lconn.core.util.MessageBox", true);
   ...
   /**
    * @memberof ic-core.util.MessageBox
