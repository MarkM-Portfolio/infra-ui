...
define([
	...
	"dojo/dom-attr",
	"dojo/i18n",
	"dojo/i18n!../../nls/iframeDialogStrings",
	"dojo/on",
	"dijit/Dialog"
], function (dojo, declare, lang, domAttr, i18n, i18niframeDialogStrings, on, Dialog) {

	var IframeDialog = declare("com.ibm.lconn.gadget.services.dialog.IframeDialog",
		null,
		/** @lends com.ibm.lconn.gadget.services.dialog.IframeDialog# */
		{	 
			nls : i18niframeDialogStrings,
		   _w : 500,
		   _h : 500,
		   _url : "",
		   _ifElement : null,
	...
	//			   ifElementSource += " src='" + this._url + "'";
				   ...
				   if(iframeContainerId) {
					   domAttr.set(dialog.containerNode, "id", iframeContainerId);
				   }
				   
				   domAttr.set(ifElement, "src", this._url);
				   ...
				   dialog.set("content", ifElement);
				   
				   on(dialog, "Hide", lang.hitch(this, "onClose"));
			   }
		   },
