 ...
 *
 * @class lconn.core.PeopleTypeAheadOpenSocialConverter
 * @author Jim Antill
 */
dojo.provide("lconn.core.PeopleTypeAheadOpenSocialConverter");

dojo.declare("lconn.core.PeopleTypeAheadOpenSocialConverter", null, /** @lends lconn.core.PeopleTypeAheadOpenSocialConverter.prototype */ {
   /**
   ...
   convertOpenSocialPeopleTypeAheadFeed: function(osFeed) {
      ...
      wrapper.items = dojo.map(osFeed.list, function(osItem) {
   ...
   _getEmail: function(emails) {
      ...
      if (emails && emails.length > 0) {
         ...
         if (emails.length == 1) {
            ...
            var primaryMails = dojo.filter(emails, function(email) { return email.type == "primary"} );
