  ...
  root: {
     ...
     ACTION: {
       ...
       ROUNDTRIP_EDIT: {
         ...
         PROMPT: "This feature allows you to edit the file locally.",
         IMPORTANT: "Important:",
         REMINDER: "Once you complete editing, you must publish a draft using the desktop file connectors. If the file fails to open, you might need to install the desktop plugins.",
     ...
     TYPEAHEAD_BOX: {
       ...
       COMMUNITY: "Community",
       SHARE: "Share",
       SHARE_ALT: "Share with this user",
     ...
     DOCS_STATUS_MESSAGE: {
       NO_ENTITLEMENT: "This file is available for online editing only if you have purchased Docs entitlement.",
      ...
      SHARE_OPTIONS: {
	   ...
	   PANEL: {
	     ...
	     ABOUT: {
	       ...
	       DOWNLOADS_EXPAND_ICON: "Expand this icon to see who has downloaded the file",
	       ...
	       DOWNLOADS_LAST_VERSION: "You last downloaded version ${0} of this file",
	       TAGS_HEADER: "Tags",
