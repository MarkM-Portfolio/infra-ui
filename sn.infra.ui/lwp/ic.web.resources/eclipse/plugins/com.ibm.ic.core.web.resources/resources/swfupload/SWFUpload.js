define([
      ...
      "../config/properties",
      "../config/services",
], function(lang, config, properties, services) {

   /**
    * SWFUpload: http://www.swfupload.org, http://swfupload.googlecode.com
    * mmSWFUpload 1.0: Flash upload dialog - http://profandesign.se/swfupload/,
    * http://www.vinterwebb.se/ SWFUpload is (c) 2006-2007 Lars Huring, Olov
    * Nilzén and Mammon Media and is released under the MIT License:
   ...
   // has to be global because of the flash code
   ...
   SWFUpload.prototype.initSettings = function() {
      ...
      // Flash Settings
      if (properties["lconn.core.swfuploadUpgrade"] == "false" || properties["lconn.core.swfuploadUpgrade"] == undefined) {
         this.ensureDefault("flash_url", require.toUrl("ic-core/swfupload/resources/swfupload_2.2.swf").toString());
      }
      else {
         this.ensureDefault("flash_url", require.toUrl("ic-core/swfupload/resources/swfupload.swf").toString());
      }
   ...
   SWFUpload.prototype.loadFlash = function() {
      ...
      // in IE (and maybe other
      // browsers)

      this.movieElement = tempParent.firstChild;
   ...
   SWFUpload.prototype.callFlash = function(functionName, argumentArray) {
      ...
      // from MooTools).
      try {
         returnString = movieElement.CallFunction('<invoke name="' + functionName + '" returntype="javascript">' + __flash__argumentsToXML(argumentArray, 0)
               + '</invoke>');
   ...
   // Public: cancelUpload cancels any queued file. The fileID parameter may
   // be the file ID or index.
   ...
   // Public: requeueUpload requeues any file. If the file is requeued or
   // already queued true is returned.
   // If the file is not found or is currently uploading false is returned.
   // Requeuing a file bypasses the
   // file size, queue size, upload limit and other queue checks. Certain
   // files can't be requeued (e.g, invalid or zero bytes files).
   ...
   // Public: setStats changes the SWFUpload statistics. You shouldn't need
   // to
   ...
   SWFUpload.prototype.addFileParam = function(fileID, name, value) {
      // do not pass null/undefined values to flash, as they should not be
      // sent to the server
      if (value != null)
   ...
   SWFUpload.prototype.cleanUp = function(movieElement) {
      ...
      try {
         if (this.movieElement && typeof (movieElement.CallFunction) === "unknown") { // We
            // only
            // want
            // to
            // do
   ...
   SWFUpload.prototype.keyPressed = function(event) {
      this.queueEvent("key_pressed", event);
   };
   ...
   lang.setObject("lconn.core.swfupload.SWFUpload", SWFUpload);
