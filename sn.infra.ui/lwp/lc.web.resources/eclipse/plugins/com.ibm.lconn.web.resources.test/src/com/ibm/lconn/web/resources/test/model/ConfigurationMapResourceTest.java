...
package com.ibm.lconn.web.resources.test.model;
...
public class ConfigurationMapResourceTest extends AbstractTest
{
  ...
  {
    r = new ConfigurationMapResource("lconn.test.map")
    {
      @Override
  ...
  public final void testResolve()
  {
    ...
    s = Resource.resolve("lconn.test.map");
  ...
  public final void testSerialize() throws Exception
  {
    ...
    String expected = readFile(getClass().getResource("/com/ibm/lconn/web/resources/test/resources/configurationmap.txt"));
  ...
  public final void testCreateConfigurationMap() throws Exception
  {
    ...
    map.put("b", "c");
    r = new TestConfigurationMapResource("lconn.test.map", map).register();
    ...
    String template = readFile(getClass().getResource("/com/ibm/lconn/web/resources/test/resources/lconn.test.map.compressed.js"));
    ...
    expected = readFile(getClass().getResource("/com/ibm/lconn/web/resources/test/resources/lconn.test.map.minified.js"));
