...
define([
	...
	***/
	...
	var FeedConverter = declare("lconn.core.CommonTags.FeedConverter", null,{
	...
	parseFeed: function(feedObject){
		...
		if (has('ie') || xpath.isIE11()) {
			...
			// this code is parsing two different search response formats RTC #191582
			var categoryNodes = xpath.selectNodes('/app:categories/atom:category', feedObject, this.PREFIXES, null);
			if (categoryNodes.length > 0) {
				...
				var facetNodes = xpath.selectNodes('/atom:feed/ibmsc:facets/ibmsc:facet/ibmsc:facetValue', feedObject, this.PREFIXES, null);
