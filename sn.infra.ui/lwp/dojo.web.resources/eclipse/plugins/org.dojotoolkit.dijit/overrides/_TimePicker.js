...
define([
	...
	var TimePicker = declare("dijit._TimePicker", [_WidgetBase, _ListMouseMixin], {
		...
		_showText: function(){
			...
			// Begin patch for https://bugs.dojotoolkit.org/ticket/9107 and https://bugs.dojotoolkit.org/ticket/12021 
			var defaultDate = new Date(1970, 0, 2);
			this._clickableIncrementDate = fromIso(this.clickableIncrement, defaultDate);
			this._visibleIncrementDate = fromIso(this.visibleIncrement, defaultDate);
			// End patch for https://bugs.dojotoolkit.org/ticket/9107 and https://bugs.dojotoolkit.org/ticket/12021
