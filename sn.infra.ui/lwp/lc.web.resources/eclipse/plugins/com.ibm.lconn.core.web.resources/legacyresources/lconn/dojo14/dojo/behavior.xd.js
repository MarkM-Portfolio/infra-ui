...
return {depends: [["provide", "dojo.behavior"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.behavior"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
