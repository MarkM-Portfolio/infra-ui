...
return {depends: [["provide", "dijit._Widget"],
["require",  "dijit._base" ]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._Widget"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
