...
return {depends: [["provide", "dojo._base.window"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo._base.window"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
