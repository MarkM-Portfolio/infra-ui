...
return {depends: [["provide", "dojox.help.console"],
["require", "dojox.help._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.help.console"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
