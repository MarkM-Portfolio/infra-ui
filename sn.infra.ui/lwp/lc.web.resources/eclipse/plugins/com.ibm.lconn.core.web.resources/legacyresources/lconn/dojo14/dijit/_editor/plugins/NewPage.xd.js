...
return {depends: [["provide", "dijit._editor.plugins.NewPage"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._editor.plugins.NewPage"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
