...
return {depends: [["provide", "dojox.uuid._base"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.uuid._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
