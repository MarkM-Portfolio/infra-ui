...
return {depends: [["provide", "dojox.layout.RotatorContainer"],
["require", "dojo.fx"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.RotatorContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
