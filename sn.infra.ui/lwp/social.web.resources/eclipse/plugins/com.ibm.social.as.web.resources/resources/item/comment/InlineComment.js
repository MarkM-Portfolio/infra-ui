...
dojo.provide("com.ibm.social.as.item.comment.InlineComment");
...
dojo.require("com.ibm.social.as.item.liking.ASCommentLikeDataStore");
...
dojo.declare("com.ibm.social.as.item.comment.InlineComment", 
[dijit._Widget, dijit._Templated,
 ...
 com.ibm.social.as.item.interfaces.IItem], {
	...
	templatePath: dojo.moduleUrl("com.ibm.social.as", "item/comment/templates/inlineComment.html"),
	...
	postMixInProperties: function(){
		...
		this.photoOfText = dojo.string.substitute(this.strings.photoOfText, [commentAuthor.displayName]);
		...
		this.commentAriaLabel = dojo.string.substitute(ariaString, [this.comment.author.displayName, ariaTimestampStr]);
	...
	uninitialize: function() {		
		...
		try{
            var isInAdditionalComments = dojo.hasClass(this.domNode.parentElement.parentElement, "additionalComments");
	...
	postCreate : function() {
        ...
        this.initAttachment();
		new lconn.core.ext.timeago.Timeago({}, this.timeagoNode);
	},
    ...
    initAttachment: function(){
        if (this.comment.attachments && this.comment.attachments.length != 0){
            ...
            this.fileDetails = new com.ibm.social.as.item.comment.FileAttached(fileDetails,this.commentFileAttachedDetails);
        }
    },
	...
	createLikeControl: function(readonly) {
		if ( this.shouldShowLikeControl(readonly) ) {
			var ds = this.likeDataStore = this.likeDataStore || new com.ibm.social.as.item.liking.ASCommentLikeDataStore(this.newsItem, this);
