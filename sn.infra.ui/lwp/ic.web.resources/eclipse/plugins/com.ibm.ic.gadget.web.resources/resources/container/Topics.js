...
define([ 'dojo/_base/lang'
   ...
   var topics = lang.getObject("com.ibm.lconn.gadget.container.Topics", true);
    ...
    * @function
    * @param {String}
    *           siteId siteId for topic, equal to the id of the DOM element
    *           containing the gadget iframe
    * @param {String}
    *           topic topic to retrieve, should be member of
    ...
    * @function
    * @param {String}
    *           eventType The name of the lifecycleEvent to get a topic for
