...
], function (dojo, declare, lang, array, domClass, i18n, i18nResultDropDown, topic, TooltipDialog/*, PersonWidget*/) {

   /**
    * This class will manage the rendering of People Finder results using a drop down tooltip.
    * 
    * @class ic-core.peopleFinder.ResultDropDown
    * @author Andrea Paolucci <andreapa@ie.ibm.com>
    */
   var ResultDropDown = declare(
      "lconn.core.peopleFinder.ResultDropDown",
      TooltipDialog, /** @lends ic-core.peopleFinder.ResultDropDown.prototype */
   {
      /**
      ...
      postMixInProperties: function(){
         var strings = i18nResultDropDown;
      ...
      buildRendering: function() {
         ...
         domClass.add(this.resultContainer, "pfDirectoryResults");
         domClass.add(this.resultContainer, "lconnSearchHighlight");
...
//          domClass.add(entryWidget.domNode, "pfEntry");
//          this.connect(entryWidget.domNode, "onclick", lang.hitch(this, "entrySelected", entryWidget));
//          this.connect(entryWidget.domNode, "onmouseover", lang.hitch(this, "onMouseOver", entryWidget.domNode));
...
//       }
      ...
      selectNextElement: function() {
         ...
         var index = array.indexOf(this.selectionArray, this.selectedElement);
