...
define ({
  root: {
     ...
     SPLIT_ACTION: {
       MENU: {
         TITLE: "Flere valg",
         A11Y: "Denne knappen åpner en meny med flere alternativer."
       },
       BUTTON: {
         EDIT: {
           TITLE: "Rediger"
     ...
     ACTION: {
       ...
       ROUNDTRIP_EDIT: {
         ...
         PROMPT: "Denne funksjonen gjør det mulig for deg å redigere filen lokalt.",
         IMPORTANT: "Viktig:",
         REMINDER: "Når du har fullført redigeringen, må du publisere et utkast ved hjelp av filforbindelsene på skrivebordet. Hvis filen ikke blir åpnet, må du kanskje installere Desktop Plugins.",
     ...
     TYPEAHEAD_BOX: {
       ...
       SHARE: "Del",
       SHARE_ALT: "Del med denne brukeren",
     ...
     DOCS_STATUS_MESSAGE: {
       NO_ENTITLEMENT: "Denne filen er tilgjengelig for online-redigering bare hvis du har kjøpt Docs-lisens.",
     ...
     COMMENTS: {
       ...
       MODERATED: "Kommentaren er sendt til godkjennelse og vil bli tilgjengelig når den er godkjent.",
       ERROR: {
         SAVE: {
      ...
      SHARE_OPTIONS: {
	   ...
	   PANEL: {
	     ...
	     ABOUT: {
	       ...
	       DOWNLOADS_HEADER: "Nedlastinger",
	       DOWNLOADS_HEADER_MORE: "Nedlastinger (${0})",
	       DOWNLOADS_EXPAND_ICON: "Utvid dette ikonet for å se hvem som har lastet ned filen",
	       ...
	       DOWNLOADS_LAST_VERSION: "Du lastet sist ned versjon ${0} av denne filen",
	       TAGS_HEADER: "Tagger",
