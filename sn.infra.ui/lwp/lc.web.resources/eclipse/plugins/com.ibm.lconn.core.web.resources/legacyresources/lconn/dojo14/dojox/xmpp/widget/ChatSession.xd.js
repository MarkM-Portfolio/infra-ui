...
return {depends: [["provide", "dojox.xmpp.widget.ChatSession"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.widget.ChatSession"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
