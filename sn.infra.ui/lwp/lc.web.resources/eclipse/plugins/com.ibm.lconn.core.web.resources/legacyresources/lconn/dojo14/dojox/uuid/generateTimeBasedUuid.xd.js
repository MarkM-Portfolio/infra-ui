...
return {depends: [["provide", "dojox.uuid.generateTimeBasedUuid"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.uuid.generateTimeBasedUuid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
