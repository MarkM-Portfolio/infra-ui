...
return {depends: [["provide", "dojox.date.hebrew.Date"],
["require", "dojox.date.hebrew.numerals"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.hebrew.Date"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
