...
dojo.i18n.getLocalization = function(packageName, bundleName, locale)
{
   try {
      if (!bundleName && packageName) {
         dojo.deprecated("lconn.core.i18nOverrider", "Accessing dojo.i18n.getLocalization with an empty bundle name for '"+packageName+"' is deprecated and should be replaced with proper calls to dojo.i18n.getLocalization.", "3.5");
      ...
      return lconn.core.i18nOverrider.originalFunction(packageName, bundleName, locale);
   } catch (e) {
...
*/
lconn.core.i18nOverrider.getResourceString = function(resourceId)
{
   throw "Use dojo.i18n.getLocalization(...) instead";
   //return dojo.i18n.getLocalization("lc_default",resourceId);
};

lconn.core.i18nOverrider.loadResourceStringsInParams = function(params, resourceBundleKeys)
{   
   throw "Use dojo.i18n.getLocalization(...) instead";
   /*if(params == null)   
      params = new Array;
...
*/
lconn.core.i18nOverrider.replaceParams = function(inputString, paramsMap)
{
   ...
   if(openBracket != -1)
   {
      ...
      return inputString.substring(0, openBracket) +  currentParamValue + lconn.core.i18nOverrider.replaceParams(inputString.substring(closeBracket+1), paramsMap);
   }
   else    
      return inputString;
};
