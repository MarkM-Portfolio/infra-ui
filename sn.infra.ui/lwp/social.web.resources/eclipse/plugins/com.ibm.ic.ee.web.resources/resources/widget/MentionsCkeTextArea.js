...
// module: ic-ee/widget/MentionsCkeTextArea
...
define([
...
], function(declare, IcCoreUrl, IcCoreAuth, IncontextUrl, IncontextUrn, BasicTextBox, MentionsWarningMessage, ExternalUserAccessChecker, SmartCloudVisibilityChecker, MentionsCommunityMemberChecker){

    var _MentionsCommunityMemberChecker = declare(MentionsCommunityMemberChecker, {
        ...
        _networkGet: function (opts) {
            ...
            if (opts.url && opts.content) { // put parameters in Url
                opts.url = IncontextUrn.rewrite(opts.url, opts.content);
            }
    ...
    return declare(BasicTextBox, {
        ...
        _initOrganizationId: function(){
           ...
           if (user){
              this.organizationId = IncontextUrn.getOrganizationIdFromURN(user.orgId);
           }
        },
        ...
        _setupVisibilityChecker: function () {
            // Callbacks that hook into the BasicTextBox, firing when mentions are added or removed.
            var onCreateMention =
                dojo.hitch(this,
                    function (user) {
        ...
        _setupAccessChecker: function () {
            ...
            this._communityChecker = new _MentionsCommunityMemberChecker({ network: this.network });
