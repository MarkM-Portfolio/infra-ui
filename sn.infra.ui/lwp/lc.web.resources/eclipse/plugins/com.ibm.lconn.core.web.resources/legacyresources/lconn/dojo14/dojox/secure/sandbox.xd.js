...
return {depends: [["provide", "dojox.secure.sandbox"],
["require", "dojox.secure.DOM"],
["require", "dojox.secure.capability"],
["require", "dojo.NodeList-fx"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.secure.sandbox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
