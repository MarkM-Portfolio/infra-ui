  ...
  root: {
     ...
     ACTION: {
       ...
       ROUNDTRIP_EDIT: {
         ...
         PROMPT: "此功能可讓您在本端編輯檔案。",
         IMPORTANT: "重要事項：",
         REMINDER: "完成編輯之後，就必須使用桌面檔案連接器來發佈草稿。 如果檔案無法開啟，則可能需要安裝桌面外掛程式。",
     ...
     SECTION: {
      ABOUT: {
       ...
       A11Y: "啟動此鏈結將關閉檔案檢視器，並將您引導至此檔案的檔案詳細資料頁面。"
      }
     },
     PREVIEW: {
      ICON: {
     ...
     TYPEAHEAD_BOX: {
       ...
       PERSON_FULL_SEARCH: "此人未列出，使用完整搜尋...",
     ...
     DOCS_STATUS_MESSAGE: {
       NO_ENTITLEMENT: "僅在您已購買 Docs 授權時，才能線上編輯此檔案。",
     ...
     COMMENTS: {
       EMPTY: "沒有任何評論。",
       MODERATED: "已提交評論以供檢閱，將於核准時顯示。",
       ERROR: {
         SAVE: {
           DEFAULT: "無法儲存您的評論。 請稍後重試。",
           UNAUTHENTICATED: "您的階段作業已逾時。 您必須重新登入，然後才能儲存您的評論。",
           NOT_FOUND: "因為檔案已刪除或不再與您共用，所以無法儲存您的評論。",
           ACCESS_DENIED: "因為檔案已刪除或不再與您共用，所以無法儲存您的評論。"
         },
         DELETE: {
           DEFAULT: "無法刪除您的評論。 請稍後重試。",
           UNAUTHENTICATED: "您的階段作業已逾時。 您必須重新登入，然後才能刪除您的評論。",
           NOT_FOUND: "因為檔案已刪除或不再與您共用，所以無法刪除您的評論。",
           ACCESS_DENIED: "因為檔案已刪除或不再與您共用，所以無法刪除您的評論。"
         }
       }
     },
     TAG_WIDGET: {
     ...
     SHARE: {
      ...
      SHARE_OPTIONS: {
         ...
         MAKE_PRIVATE_DIALOG: {
           DIALOG_TITLE: "停止共用檔案",
           PROMPT: "確定要停止共用此檔案嗎？",
           QUESTION_PUBLIC: "組織中每個人都再也看不見此檔案，或是不再與人員、資料夾或社群共用此檔案。 無法復原此作業。",
           QUESTION_PUBLIC_E: "組織中每個人都再也看不見此檔案，或是不再與人員或資料夾共用此檔案。 無法復原此作業。",
	   ...
	   PANEL: {
	     ...
	     ABOUT: {
	       ...
	       DOWNLOADS_HEADER: "下載次數",
	       DOWNLOADS_HEADER_MORE: "下載次數 (${0})",
	       DOWNLOADS_EXPAND_ICON: "展開此圖示以查看誰已下載此檔案",
	       DOWNLOADS_COUNT: "${downloads}",
	       DOWNLOADS_COUNT_FULL: "${downloads} - ${anonymousDownloads}（匿名方式）",
	       DOWNLOADS_LATEST_VERSION: "您具有此檔案的最新版本",
	       DOWNLOADS_LAST_VERSION: "您已下載此檔案的第 ${0} 版",
	       TAGS_HEADER: "標籤",
     ...
     OPEN_BY_ID_ERROR: {
       ...
       ACCESS_DENIED: "您無權檢視此檔案。 尚未與您共用此檔案。",
       ACCESS_DENIED_ANON: "您無權檢視此檔案。 如果這是您的檔案或它已與您共用，則您必須先登入。"
     },
     LOAD_ERROR: {
