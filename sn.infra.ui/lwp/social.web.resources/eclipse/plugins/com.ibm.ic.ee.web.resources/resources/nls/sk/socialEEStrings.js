		...
		*/
		   common: {
		      more: {
		       ...
		       ERROR_ALT: "Chyba",
		       PERSON_TITLE: "Otvoriť profil používateľa ${user}.",
		   ...
		   generic: {
		      ...
		      timestamp: {
		         ...
		         updated: {
		            ...
		            TODAY: "Odoslané dnes o ${time}",
		            YEAR: "Aktualizované ${MMM} ${d}, ${YYYY}",
		            YESTERDAY: "Odoslané včera o ${time}",
		   ...
		   network : {
		      ...
		      profile_a11y: "Aktivácia tohto odkazu otvorí profil používateľa ${user} v novom okne.",
		      ...
		      messages: {
		         success: {
		            accept: {
		            	...
		            	follow: "Teraz ste sieťové kontakty a sledujete používateľa ${user}."
		            },
		            ignore: {
		            	nofollow: "Ignorovali ste pozvanie.",
		            	follow: "Ignorovali ste pozvanie, ale teraz sledujete používateľa ${user}."
		            }
		         },
		         error: {
		   ...
		   file: {
		      ...
		      timestamp: {
		         ...
		         updatedOther: {
		            ...
		            TODAY: "${user} aktualizoval dnes o ${time}",
		            YEAR: "${user} aktualizované ${MMM} ${d}, ${YYYY}",
		            YESTERDAY: "${user} aktualizoval včera o ${time}",
		      ...
		      about: {
		         CREATE_TIMESTAMP: "${date_long} ${time_long} od používateľa ${user}",
		         UPDATE_TIMESTAMP: "${date_long} ${time_long} od používateľa ${user}",
		   ...
		   ecm_file: {
		      ...
		      checkedout_other: "Odhlásené používateľom ${user}",
		   ...
		   ecm_draft: {
		      ...
		      reivew_submitted_date: {
		         DAY: "Používateľ ${user} odoslal koncept na posúdenie ${EEEE} o ${time}.",
		         MONTH: "Používateľ ${user} odoslal koncept na posúdenie dňa ${MMM} ${d}.",
		         TODAY: "Používateľ ${user} odoslal koncept na posúdenie dnes o ${time}.",
		         YEAR: "Používateľ ${user} odoslal koncept na posúdenie ${MMM} ${d}, ${YYYY}.",
		         YESTERDAY: "Používateľ ${user} odoslal koncept na posúdenie včera o ${time}.",
		         TOMORROW: "Používateľ ${user} odoslal koncept na posúdenie ${MMM} ${d}, ${YYYY}."
		      },
		      pending: "Prebieha",
		   ...
		   authUser: {
		      error: "Nastala chyba pri získavaní aktuálneho používateľa.  ${again}.",
		      error_again: "Skúste to znova",
		      error_404: "Nenašiel sa autentifikovaný používateľ.",
		      error_403: "Nemáte oprávnenie získať informácie o používateľovi."
		   },
		   forum: {
		      error: "Nastala chyba.  ${again}.",
		      error_again: "Skúste to znova",
		   ...
		   REPLIES: {
		      ...
		      COMMENT_DELETED: {
		         DAY: "Odpoveď vymazal používateľ ${user} ${EEEE} o ${time}",
		         MONTH: "Odpoveď vymazal používateľ ${user} dňa ${MMM} ${d}",
		         TODAY: "Odpoveď vymazal používateľ ${user} dnes o ${time}",
		         YEAR: "Odpoveď vymazal používateľ ${user} dňa ${MMM} ${d}, ${YYYY}",
		         YESTERDAY: "Odpoveď vymazal používateľ ${user} včera o ${time}",
		         TOMORROW: "Odpoveď vymazal používateľ ${user} dňa ${MMM} ${d}, ${YYYY}"
		      },
		      ...
		      MODERATION_REMOVED: {
		         DAY: "Túto odpoveď odstránil používateľ ${user} ${EEEE} o ${time}.",
		         MONTH: "Túto odpoveď odstránil používateľ ${user} dňa ${MMM} ${d}.",
		         TODAY: "Túto odpoveď odstránil používateľ ${user} dnes o ${time}.",
		         YEAR: "Túto odpoveď odstránil používateľ ${user} dňa ${MMM} ${d}, ${YYYY}.",
		         YESTERDAY: "Túto odpoveď odstránil používateľ ${user} včera o ${time}.",
		         TOMORROW: "Túto odpoveď odstránil používateľ ${user} dňa ${MMM} ${d}, ${YYYY}."
		      },
		      MODERATION_REJECTED: {
		         DAY: "Túto odpoveď odmietol používateľ ${user} ${EEEE} o ${time}.",
		         MONTH: "Túto odpoveď odmietol používateľ ${user} ${MMM} ${d}.",
		         TODAY: "Túto odpoveď odmietol používateľ ${user} dnes o ${time}.",
		         YEAR: "Túto odpoveď odmietol používateľ ${user} dňa ${MMM} ${d}, ${YYYY}.",
		         YESTERDAY: "Túto odpoveď odmietol používateľ ${user} včera o ${time}.",
		         TOMORROW: "Túto odpoveď odmietol používateľ ${user} dňa ${MMM} ${d}, ${YYYY}."
		      }
		   },
		   REPLIES_SUBMITTED: {
		   ...
		   COMMENTS: {
		      ...
		      MODERATION_REMOVED: {
		         DAY: "Tento komentár odstránil používateľ ${user} ${EEEE} o ${time}.",
		         MONTH: "Tento komentár odstránil používateľ ${user} ${MMM} ${d}.",
		         TODAY: "Tento komentár odstránil používateľ ${user} dnes o ${time}.",
		         YEAR: "Tento komentár odstránil používateľ ${user} dňa ${MMM} ${d}, ${YYYY}.",
		         YESTERDAY: "Tento komentár odstránil používateľ ${user} včera o ${time}.",
		         TOMORROW: "Tento komentár odstránil používateľ ${user} dňa ${MMM} ${d}, ${YYYY}."
		      },
		      MODERATION_REJECTED: {
		         DAY: "Tento komentár odmietol používateľ ${user} ${EEEE} o ${time}.",
		         MONTH: "Tento komentár odmietol používateľ ${user} ${MMM} ${d}.",
		         TODAY: "Tento komentár odmietol používateľ ${user} dnes o ${time}.",
		         YEAR: "Tento komentár odmietol používateľ ${user} dňa ${MMM} ${d}, ${YYYY}.",
		         YESTERDAY: "Tento komentár odmietol používateľ ${user} včera o ${time}.",
		         TOMORROW: "Tento komentár odmietol používateľ ${user} dňa ${MMM} ${d}, ${YYYY}."
		      },
		      ...
		      ERROR_AGAIN: "Skúste to znova.",
		      ERROR_AGAIN_TITLE: "Zopakujte požiadavku na ďalšie komentáre.",
		      COMMENT_CREATED: {
		      ...
		      COMMENT_DELETED: {
		         DAY: "Komentár bol vymazaný používateľom ${user} dňa ${EEEE} o ${time}",
		         MONTH: "Komentár bol vymazaný používateľom ${user} dňa ${MMM} ${d}",
		         TODAY: "Komentár bol vymazaný používateľom ${user} dnes o ${time}",
		         YEAR: "Komentár vymazal používateľ ${user} dňa ${MMM} ${d}, ${YYYY}",
		         YESTERDAY: "Komentár bol vymazaný používateľom ${user} včera o ${time}",
		         TOMORROW: "Komentár vymazal používateľ ${user} dňa ${MMM} ${d}, ${YYYY}"
		      },
		      COMMENT_EDITED: {
		      ...
		      FLAG_ITEM: {
		         ...
		         COMMENT: {
		            ...
		            A11Y: "Toto tlačidlo otvorí dialógové okno, ktoré umožňuje používateľovi označiť tento komentár ako nevhodný."
		         }
		      }
		   },
		   COMMENTS_DELETE: {
		   ...
		   VERSIONS: {
		      ...
		      INFO: "Verzia ${0} vytvorené ${1} používateľom ",
