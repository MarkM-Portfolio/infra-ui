...
/**
 * OneUI utilities
 * @namespace com.ibm.oneui.util
 */
/**
 * {@link http://www.w3.org/TR/wai-aria|ARIA} utilities
 * @namespace com.ibm.oneui.util.aria
 */
dojo.provide("com.ibm.oneui.util.aria._Helper");

dojo.declare("com.ibm.oneui.util.aria._Helper", null, /** @lends com.ibm.oneui.util.aria._Helper.prototype */ {
    ...
    * @param {String|Node} srcNodeRef Node or id of source node
    ...
    * @private
    * @param {Boolean} fwd True if direction is forward
    */
    ...
    * @private
    * @param {Object} item The item to move out
    ...
    * @private
    * @param {Object} item The item to move in
    * @param {Number} [i] The index
    */
    ...
    * Returns -1 if no valid target has been found 
    * @private
    * @param {Event} e The event
    * @returns the index of target element in the allItems for the event, or -1 if no valid target has been found
    */
    ...
    * @private
    * @param {Number} sel Selected item
    ...
    * @private
    * @param {Number} selIdx Selected index
    * @returns previous selection index taking into account current DOM inversion, bidi and cycling settings
    */
