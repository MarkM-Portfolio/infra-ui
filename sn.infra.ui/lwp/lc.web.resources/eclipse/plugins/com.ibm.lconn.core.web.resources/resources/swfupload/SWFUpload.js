...
(function() {
	...
	SWFUpload.prototype.getFlashHTML = function () {
		...
		return ['<object tabindex="0" id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
	...
	*/
	...
	SWFUpload.prototype.addFileParam = function (fileID, name, value) {
	   // do not pass null/undefined values to flash, as they should not be sent to the server
	   if (value != null)	   
