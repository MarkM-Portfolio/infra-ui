...
({
   ...
   COMMUNITYUPLOADFILE: {
	   ...
	   SHARE_WITH_COMMUNITY: {
		   ...
		   ERROR: "Impossibile condividere il file.  Riprovare più tardi.",
		   ERROR_X: "Impossibile condividere i file.  Riprovare più tardi.",
	   ...
	   UPLOAD_TO_COMMUNITY: {
		   ...
		   ERROR: "Non è stato possibile caricare il file.  Riprovare più tardi.",
		   ERROR_X: "Impossibile caricare ${0}.  Riprovare più tardi.",
