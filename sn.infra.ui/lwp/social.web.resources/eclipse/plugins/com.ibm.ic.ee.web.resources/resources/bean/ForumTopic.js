define([
...
], function (array, declare, lang, AtomBean, User, _ForumRecommendationMixin, dom) {
	...
	(function(){
		var du = dom;
		var ForumTopic = declare("com.ibm.social.ee.bean.ForumTopic", [AtomBean, _ForumRecommendationMixin], {
	      ...
	      getPermissions: function() {
	         if (!("permissions" in this)) {
	            ...
	            var arr = str.split(",");
	            var perms = { };
	            for (var i = 0; i < arr.length; i++) perms[lang.trim(arr[i])] = true;
