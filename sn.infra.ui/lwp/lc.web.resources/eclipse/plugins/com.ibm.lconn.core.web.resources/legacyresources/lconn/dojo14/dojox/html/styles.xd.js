...
return {depends: [["provide", "dojox.html.styles"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.html.styles"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
