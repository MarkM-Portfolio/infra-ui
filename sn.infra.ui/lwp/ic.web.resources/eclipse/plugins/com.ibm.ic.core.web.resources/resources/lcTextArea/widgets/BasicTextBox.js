...
define([
      ...
      "dojo/dom-class",
      "dojo/dom-attr",
      "dojo/i18n!ic-core/lcTextArea/widgets/nls/BasicTextBox",
      "dojo/topic",
      "dojo/query",
      "dijit/_Templated",
      "dijit/_Widget",
   ...
   function(lang, domConstruct, declare, i18n, array, has, domStyle, domClass, domAttr, i18nBasicTextBox, topic, query, _Templated, _Widget, ckeditor, bidiUtil, IMentionsSupport, IMentionsSupportRTE, ITextBoxControl, ITextBoxUtils, textModule) {

      /**
       * @namespace ic-core.lcTextArea.widgets
       */
      ...
      function stripHTML(html, mentionsEnabled) {
         ...
         if (mentionsEnabled) {
            ...
            var listOfIgnores = query(".x-lconn-userid", dummy);
      ...
      function removeMention(args) {
         ...
         if (args && lang.isFunction(args.remove)) {
            args.remove();
         }
      }

      /**
       * BasicTextBox widget MentionsHelper is NOT supported by AMD code so this
       * module will only work with CKEditor Mentions
       * 
       * @class ic-core.lcTextArea.widgets.BasicTextBox
       ...
       */
      var BasicTextBox = declare("lconn.core.lcTextArea.widgets.BasicTextBox",
         [
               _Widget,
               _Templated,
               ITextBoxUtils,
         ...
         /** @lends ic-core.lcTextArea.widgets.BasicTextBox.prototype */
         {
            // Mapping "onkeypress", "oninput" and "onpropertychange" events to
            // a same
            // method
            // this method likely to be called multiple times when user
            // inputting
            // something
            // but this is necessary, because different browsers support
            // different events
            // TODO: investgate it into detail, which browser support which
            // events, so
            // that we could minimize the registered events and method call
            templateString : "<div class=\"lotusFieldEmphasis\"><textarea class=\"lotusText bidiAware\" data-dojo-attach-point=\"textAreaNode\" autocomplete=\"off\">${shadowText}</textarea></div>",
            /**
            ...
            title: "",
            /**
             * XHR handler, behaves differently in case of OpenSocial gadgets or
             * normal widgets
             */
            xhrHandler : null,
            /**
            ...
            /**
             * A basic text entry widget that uses a normal HTML text area. It
             * mixes in the ITextBoxUtils and ITextBoxControl classes to give
            ...
            constructor : function(options, textNode) {
               this._strings = i18nBasicTextBox;
            ...
            destroy : function(preserveDom) {
               // Unsubscribe topics
               array.forEach(this._subs, function(subs) {
                  subs.remove();
               });
               this._subs = null;
               this._mentions = null;
            ...
            /**
             * Overridden method that instantiates a rich text editor if
             * {@link #useRTE} is set to true
             */
            buildRendering : function() {
               // Bypasses the {@link dijit._Templated#buildRendering} logic if
               // we are
               ...
               if (useRTE(this)) {
                  ...
                  if (self.onLoadCallback && lang.isFunction(self.onLoadCallback)) {
                     self.onRTELoadFn.push(self.onLoadCallback);
                  }

                  ckeditor.appendTo(this.domNode, {
                     ...
                     on : {
                        instanceReady : function(ev) {
                           ...
                           array.forEach(self.onRTELoadFn, function(fn) {
                              fn.call(self);
                           });
                  ...
                  domClass.add(this.domNode, "lconnRTE");
               }
               else {
                  this.inherited(arguments);
               }
            ...
            postCreate : function() {
               ...
               if (!useRTE(this)) {
                  ...
                  domAttr.set(this.textAreaNode, "title", this.shadowText);

                  // Construct an array of event callbacks that we want to send
                  // to the
                  // mentionshelper.
                  var eventCallbacks = {};
                  ...
                  if (this.mentionsEnabled) {
                     ...
                     // Replace the current input field with the helper's input
                     // field.
                     this.textAreaNode = this._mentionsHelper.textAreaNode;
                     domClass.add(this.textAreaNode, "bidiAware");

                     this._subs.push(topic.subscribe("ic-core/mentions/url/entered", lang.hitch(this, this.handleURLInput)));
                  }

                  // Bidi enablement
                  bidiUtil.enforceTextDirectionOnPage(this.textAreaNode);
               }
               ...
               if (useRTE(this)) {
                  ...
                  // Handle topic emitted when a URL is entered in the rich text
                  // editor
                  this._subs.push(topic.subscribe("ic-core/ckeditor/url/entered", lang.hitch(this, this.handleURLInput)));
                  if (this.mentionsEnabled) {
                     // Handle topic emitted when a mention is completed
                     this._subs.push(topic.subscribe("lconn/microblogging/mention/completed", lang.hitch(this, this.handleMention)));
                     this._subs.push(topic.subscribe("lconn/microblogging/mention/removed", lang.hitch(this, this.handleRemoveMention)));
                  }
               }
               else {
                  this.onLoad();
            ...
            _mixInSupport : function() {
               if (this.mentionsEnabled) {
                  declare.safeMixin(this, useRTE(this) ? new IMentionsSupportRTE() : new IMentionsSupport());
               }
            },
            ...
            _showShadowText : function() {
               if (useRTE(this)) {
                  ...
                  // IE doesn't use the placeholder attribute so use the basic
                  // method to
                  // set shadow text.
                  domAttr.set(this.textAreaNode, "placeholder", this.shadowText);

                  if (has("ie")) {
                     domStyle.set(this.textAreaNode, "color", "#666");
                     this.inherited(arguments);
                  }
                  else {
                     this.setText("");
            ...
            /**
             * Remove the placeholder attribute that is showing the shadow text
             * if available.
             */
            _hideShadowText : function() {
               ...
               if (useRTE(this)) {
                  ...
                  domAttr.remove(this.textAreaNode, "placeholder");
                  // IE doesn't use the placeholder attribute so use the basic
                  // method for
                  // shadow text.
                  if (has("ie")) {
            ...
            setRows : function(rows) {
               if (useRTE(this)) {
                  addOnRTELoad.call(this, function() {
                     // FIXME: CKEDITOR.editor.resize bug: units are not
                     // accepted for
                     // height
            ...
            collapseTextBox : function() {
               if (useRTE(this)) {
                  ...
                  domClass.add(this.textAreaNode, "lotusTextCollapsed");
               }
            },
            ...
            expandTextBox : function() {
               if (useRTE(this)) {
                  ...
                  domClass.remove(this.textAreaNode, "lotusTextCollapsed");
               }
            },
            ...
            setReadOnly : function() {
               useRTE(this) ? this._editor.setReadOnly(true) : domAttr.set(this.textAreaNode, "readonly", "readonly");
            },
            ...
            setEditable : function() {
               useRTE(this) ? this._editor.setReadOnly(false) : domAttr.remove(this.textAreaNode, "readonly");
            },
            ...
            /**
             * Returns an array of mentions. Throws an exception if the mentions
            ...
            /**
             * Handles subscription to the topic emitted when a URL is entered
             * This handles the wiring between the different internal
             * implementations that detect URLs, and sends a consistent topic to
             * consumers.
             * 
             * @param {Object}
             *           args Contains the details about the URL and the editor
            ...
            handleURLInput : function(args) {
               if (args.mentionsHelper === this._mentionsHelper || args.editor && args.editor === this._editor)
                  topic.publish("lconn/microblogging/url/entered", {
                     textbox : this,
                     url : args.url
                  });
            },
             ...
             * 
             * @param {Object}
             *           args Contains the details about the mention, the node,
             *           and the editor where it was entered
             */
            handleMention : function(args) {
               ...
               if (!notify)
                  ...
                  // Promise
                  notify.then(function() {}, lang.partial(removeMention, args));
            },
            ...
            handleRemoveMention: function(args) {
               ...
               if (args.editor === this._editor) {
                  ...
                  this._mentions = array.filter(this._mentions, function(mention){
            ...
            /**
             * Callback for whether a mention should trigger a notification.
             * Callers can mixin a method that either returns a boolean value,
             * if the answer is immediately available, or a promise that will be
             * resolved or rejected at a later stage. The default implementation
             * always returns true.
             * 
             * @param {Object}
             *           mention Object containing details about the mention
             * @return {boolean|Promise} True, or a promise that will be
             *         resolved if the user should be notified
             */
            ...
            /**
             * Callers can connect to this method to be notified when the text
             * box has finished initialization
             */
            onLoad : function() {
               topic.publish('ic-core/lcTextArea/BasicTextBox/loaded', this);
            }
         });
