...
return {depends: [["provide", "dojox.wire.ml.Transfer"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.ml.Transfer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
