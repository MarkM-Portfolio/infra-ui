...
define([
	...
	"ic-ee/bean/Bean",
	"ic-ee/bean/User"
], function (array, declare, lang, Bean, User) {

	(function () {
	var util = com.ibm.social.incontext.util;
	var AtomBean = declare("com.ibm.social.ee.bean.AtomBean", Bean, {
	   ...
	   getAuthor: function() {
	      if (!this.author)
	         this.author = new User(util.dom.getElementsByTagNameNS(this.e, "author", util.dom.ATOM_NAMESPACE)[0]);
	      return this.author;
	   },
	   getOwner: function() {
	   ...
	   getModifier: function() {
	      if (!this.modifier)
	         this.modifier = new User(util.dom.getElementsByTagNameNS(this.e, "modifier", util.dom.DOCUMENTS_ATOM_NAMESPACE)[0]);
	   ...
	   _getPermissions: function(permElemName) {
	      ...
	      if (s) {
	         s = util.text.trim(s);
	         array.forEach(s.split(/\s*,\s*/), function(a) {if (a && a.length > 0) p[a] = true;});
	      }
	      return p;
	   },
