  ...
  /* The placeholders for date formatting strings are as follows:
		...
		*/
		   ...
		   file: {
		      ...
		      share: {
		         label: "Partager",
		         title: "Donner à d'autres personnes l'accès à ce fichier"
		      },
		      timestamp: {
		         created: {
		            DAY: "Créé : ${EEEE} à ${time}",
		         ...
		         updatedOther: {
		            ...
		            TODAY: "${user} a été mis à jour aujourd'hui à ${time}",
		   ...
		   ecm_draft: {
		      ...
		      reject_error: "Un erreur s'est produite lors du rejet de ce brouillon. Recommencez.",
		   ...
		   COMMENTS: {
		      ...
		      COMMENT_DELETED: {
		         DAY: "Commentaire supprimé par ${user} le ${EEEE} à ${time}",
		      ...
		      FLAG_ITEM: {
		         ...
		         DESCRIPTION_LABEL: "Fournissez la raison pour laquelle vous avez marqué cet élément (facultatif)",
		   ...
		   DATE: {
		      ...
		      ADDED: { DAY: "Ajouté ${EEee} à ${time}",
		         FULL: "${EEEE}, ${date_long} ${time_long}",
		         MONTH: "Ajouté ${date_long}",
		         TODAY: "Ajouté aujourd'hui à ${time}",
		         YEAR: "Ajouté ${date_long}",
		      ...
		      UPDATED: { DAY: "Mis à jour le ${EEee} à ${time}",
		         FULL: "${EEEE}, ${date_long} ${time_long}",
		         MONTH: "Mis à jour le ${date_long}",
		         TODAY: "Mis à jour aujourd'hui à ${time}",
		         YEAR: "Mis à jour le ${date_long}",
		         YESTERDAY: "Mis à jour hier à ${time}"
		      }
		   },
		   VERSIONS: {
		      ...
		      REVERT_DESCRIPTION: "Restaurée à partir de la version ${0}",
		      PREVIOUS: "Précédent",
		      ...
		      DATE: {
		        ...
		        UPDATED: { DAY: "Mis à jour le ${EEee} à ${time}",
		            YEAR: "Mis à jour le ${date_short}",
		            FULL: "${EEEE}, ${date_long} ${time_long}",
		            MONTH: "Mis à jour le ${date_short}",
		            TODAY: "Mis à jour aujourd'hui à ${time}",
		            YESTERDAY: "Mis à jour hier à ${time}"
		        }
		      },
		      ...
		      REVERT: {
		         ...
		         ERROR_TIMEOUT: "La version n'a pas été restaurée car le serveur n'a pas pu être contacté.  Cliquez à nouveau sur Restaurer pour renouveler votre demande.",
		         ERROR_CANCEL: "La version n'a pas été restaurée, car la demande a été annulée.  Cliquez à nouveau sur Restaurer pour renouveler votre demande.",
		         ERROR_QUOTA_VIOLATION: "La version n'a pas été restaurée en raison de restrictions d'espace.",
		         ERROR_MAX_CONTENT_SIZE: "La version n'a pas été restaurée car sa taille est supérieure à la taille de fichier maximale autorisée de ${0}",
		         GENERIC_ERROR: "La version n'a pas été restaurée en raison d'une erreur inconnue.  Cliquez à nouveau sur Restaurer pour renouveler votre demande."
		      }
		   },
		   DOWNLOAD_INFO: {
		   ...
		   EE_DIALOG: {
		      ...
		      CONFIRM_CLOSE_TITLE: "Confirmation",
		      CONFIRM_CLOSE_MESSAGE: "Etes-vous sûr de vouloir abandonner vos modifications ? Cliquez sur OK pour continuer ou sur Annuler pour revenir en arrière",
		      OK: "OK",
		      CANCEL: "Annuler"
		   },
		   MESSAGE: {
		   ...
		   FILE_SHARE_INFO: {
		      ...
		      TOOLTIP: "Donner à d'autres personnes l'accès à ce fichier"
		   },
		   HISTORY: {
		   ...
		   UNSAVEDCHANGES: {
		      CANCEL: "Annuler",
		      CONFIRM: "Etes-vous sûr de vouloir abandonner vos modifications ?  Cliquez sur OK pour continuer ou sur Annuler pour revenir en arrière.",
