...
/**
 * This class copies various methods from the URIUtil class in org.eclipse.equinox.common. Unless otherwise noted the implementations here
...
public class URIUtil
{
   ...
   * 
   * @param base
   *          The base URI to append to
   * @param extension
   *          The path extension to be added
  ...
  /**
   * Special case of appending to an opaque URI. Since opaque URIs have no path segment the best we can do is append to the scheme-specific
   * part
   */
  ...
  /**
   * Returns a string representation of the given URI that doesn't have illegal characters encoded. This string is suitable for later
   * passing to {@link #fromString(String)}.
   * 
   * @param uri
   *          The URI to convert to string format
  ...
  /**
   * Returns the URL as a URI. This method will handle broken URLs that are not properly encoded (for example they contain unencoded space
   * characters).
   */
