...
return {depends: [["provide", "dojo.io.script"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.io.script"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
