...
dojo.provide("com.ibm.social.as.filter.FilterListAriaHelper");
 ...
 */
dojo.declare("com.ibm.social.as.filter.FilterListAriaHelper", lconn.core.aria.Toolbar, {
   ...
   _isSelected: function(item) {
	   return dojo.hasClass(item, "filterSelected");
   }
});
