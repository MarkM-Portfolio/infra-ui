...
dojo.provide('com.ibm.lconn.gadget.support.WidgetAdapter');
dojo.provide('com.ibm.lconn.gadget.support.WidgetAdapter.IWidget');
dojo.provide('com.ibm.lconn.gadget.support.WidgetAdapter.Gadget');
...
(function (dojo, _Widget, _Contained, Site, iContainer) {
	 ...
	 * @class
	 */
	var WidgetAdapter_ = dojo.declare('com.ibm.lconn.gadget.support.WidgetAdapter', [_Widget, _Contained], {
		/**
		 * Handle object
		 * 
	 ...
	 * @public
	 */
	WidgetAdapter_.IWidget = dojo.declare('', [WidgetAdapter_], {
		// TODO
	});
	 ...
	 * @public
	 */
	WidgetAdapter_.Gadget = dojo.declare('', [WidgetAdapter_], {
		// TODO
	});
