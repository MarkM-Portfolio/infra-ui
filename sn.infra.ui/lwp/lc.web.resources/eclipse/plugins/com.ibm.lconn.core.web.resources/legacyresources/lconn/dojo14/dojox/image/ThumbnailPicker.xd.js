...
return {depends: [["provide", "dojox.image.ThumbnailPicker"],
["require", "dojox.fx.scroll"],
["require", "dojo.fx.easing"],
["require", "dojo.fx"],
["require", "dijit._Widget"],
["require", "dijit._Templated"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.image.ThumbnailPicker"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
