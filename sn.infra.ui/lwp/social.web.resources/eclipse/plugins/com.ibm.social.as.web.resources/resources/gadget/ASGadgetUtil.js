...
dojo.provide("com.ibm.social.as.gadget.ASGadgetUtil");
...
dojo.declare("com.ibm.social.as.gadget.ASGadgetUtil", null, {
	strings: null,
	...
	initAS: function() {
		...
		dojo.subscribe(com.ibm.social.as.constants.events.FEEDRENDERED, dojo.hitch(this, "asResize"));
		dojo.subscribe("widgetBlur", dojo.hitch(this, "asResize"));
		window.onresize = dojo.hitch(this, "asResize");
		...
		if(gadgets.util.hasFeature("smartcloud3")) {
     	...
     	if (gadgets.actions) {
            var showASAction = {
             	id: "showAS",
               	callback: dojo.hitch(this, "doAction")
            };
