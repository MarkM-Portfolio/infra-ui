...
return {depends: [["provide", "dijit._Calendar"],
["require", "dijit.Calendar"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._Calendar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
