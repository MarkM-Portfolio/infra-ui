...
return {depends: [["provide", "dojo.jaxer"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.jaxer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
