...
return {depends: [["provide", "dojox.charting.widget.Chart2D"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.charting.widget.Chart2D"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
