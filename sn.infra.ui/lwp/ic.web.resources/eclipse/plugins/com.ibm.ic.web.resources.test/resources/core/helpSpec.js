...
/**
 * Jasmine spec for ic-core/help
 *
 * @module ic-test.core.helpSpec
...
define([
   ...
   describe('the interface of ic-core/help', function() {
      it('implements the expected methods', function() {
         expect(dojo.isFunction(help.launchHelp)).toBeTruthy();
         expect(dojo.isFunction(help.launchDemo)).toBeTruthy();
         expect(dojo.isFunction(help.getProductHelpUrl)).toBeTruthy();
         expect(dojo.isFunction(help.createHelpLink)).toBeTruthy();
      });
   });

   describe('the method ic-core/help.launchHelp()', function() {
      var _ibmConfig;
      beforeEach(function() {
   ...
   describe('the method ic-core/help.getProductHelpUrl()', function() {
      var _ibmConfig;
      beforeEach(function() {
         _ibmConfig = window.ibmConfig;
         window.ibmConfig = {};
   ...
   describe('the method ic-core/help.launchDemo()', function() {
      beforeEach(function() {
         mock(window);
      });
      afterEach(function() {
   ...
   describe('the method ic.core.help.createHelpLink()', function() {
