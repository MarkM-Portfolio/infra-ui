/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	...
	define([
	...
	], function (declare, lang, domClass, topic, events, Subscriber) {
		...
		Subscriber,
		{
			...
			setupSubscribes: function(){
				...
				//this.own(dojo.subscribe(this.startComment, dojo.hitch(this, "closeCurrentEE")));
			...
			onCloseEE: function(newsItem, result) {
				...
				if(newsItem.newsItemNode && com.ibm.social.as.comment.commentInputManager &&
					...
					domClass.remove(newsItem.newsItemNode, "lotusPostHover");
					
					//deselect the item when closing the EE - skip when commenting in process
					topic.publish(events.ITEMDESELECTED, newsItem);				
				}
			...
			onItemPreview: function(item){
				...
				gadgets.views.openEmbeddedExperience(
					lang.hitch(this, "onCloseEE", this.newsItem),
					lang.hitch(this, "onOpenEE"),
					embedObj,
					params
				);
			},
