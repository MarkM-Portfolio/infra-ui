...
dojo.provide("lconn.test.jasmine.core.urlSpec");

dojo.require("lconn.core.url");
dojo.require("lconn.core.config.services");

(function(lang, services, url) {
   describe("the interface of lconn.core.url", function() {
   ...
   describe("the method canonicalize()", function() {
      it("canonicalizes the URL argument correctly", function() {
         ...
         // Files
         var u = url.canonicalize('http://www.ibm.com/files/app/#/file/abcdef', 'files');
         // Note the // is intended, as RFC 3986 doesn't mandate to collapse it
         expect(u).toBe('http://www.ibm.com/files/app//file/abcdef');
         // Other
         var w = 'http://www.ibm.com/communities/community/connuidev?a=1', u = url.canonicalize(w, 'communities');
         expect(u).toBe(w);
      });
   });
   ...
   describe("the method getServiceUrl()", function() {
      ...
      /* copy David Bell's change to comment out getting insecure urls
...
}(dojo, lconn.core.config.services, lconn.core.url));
