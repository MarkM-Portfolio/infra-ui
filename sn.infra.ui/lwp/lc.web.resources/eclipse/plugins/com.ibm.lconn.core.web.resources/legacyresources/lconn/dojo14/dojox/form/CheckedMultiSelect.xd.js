...
return {depends: [["provide", "dojox.form.CheckedMultiSelect"],
["require", "dijit.form.CheckBox"],
["require", "dijit.form._FormSelectWidget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.CheckedMultiSelect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
