...
return {depends: [["provide", "dojox.wire.ml.Service"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.ml.Service"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
