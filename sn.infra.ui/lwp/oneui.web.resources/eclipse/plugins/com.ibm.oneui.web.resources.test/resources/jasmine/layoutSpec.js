...
dojo.provide('com.ibm.oneui.test.jasmine.layoutSpec');
...
(function(layout, lang, domConstruct, df) {
   ...
   /**
    * Jasmine spec for OneUI layout util
    * 
    * @module com.ibm.oneui.test.jasmine.layoutSpec
    * @author Claudio Procida <procidac@ie.ibm.com>
    */
   describe("the com.ibm.oneui.layout util", function() {
...
}(com.ibm.oneui.layout, dojo, dojo, dojox.lang.functional));
