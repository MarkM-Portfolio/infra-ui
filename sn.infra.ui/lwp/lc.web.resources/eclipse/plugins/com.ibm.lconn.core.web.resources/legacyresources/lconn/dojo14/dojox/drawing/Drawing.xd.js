...
return {depends: [["provide", "dojox.drawing.Drawing"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.Drawing"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
