...
return {depends: [["provide", "dojox.gfx"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.gfx"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
