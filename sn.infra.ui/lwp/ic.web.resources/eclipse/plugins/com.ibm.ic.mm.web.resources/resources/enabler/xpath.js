...
define([], function() {
   ...
   // generic impl
   xpath.evaluateXPath = function(/* String */xpathExpr, /* DOMDocument */doc, /* Object{prefix:ns,prefix2:ns2,...} */namespaces) {
      if (navigator.userAgent.toLowerCase().indexOf("safari") != -1) {
         return xpath.safari.evaluateXPath(xpathExpr, doc, namespaces);
      }
      else if (typeof ActiveXObject != "undefined") {
         return xpath.ie.evaluateXPath(xpathExpr, doc, namespaces);
      }
      else {
         return xpath.gecko.evaluateXPath(xpathExpr, doc, namespaces);
      }
   };

   // Safari implementation
   xpath.safari = {
      evaluateXPath : function(/* String */xpathExpr, /* DOMDocument */doc, /* Object{prefix:ns,prefix2:ns2,...} */namespaces) {
         var result;
         if (typeof XPathResult != "undefined") {
            // use build in xpath support for Safari 3.0
            var results = document.evaluate(xpathExpr, doc, function(prefix) {
   ...
   xpath.gecko = {
      evaluateXPath : function(/* String */xpathExpr, /* DOMDocument */doc, /* Object{prefix:ns,prefix2:ns2,...} */namespaces) {
         ...
         try {
            ...
            result = xmlDocument.evaluate(xpathExpr, doc, function(prefix) {
               return namespaces[prefix] || null;
            }, XPathResult.ANY_TYPE, null);
         }
         catch (exc) {
