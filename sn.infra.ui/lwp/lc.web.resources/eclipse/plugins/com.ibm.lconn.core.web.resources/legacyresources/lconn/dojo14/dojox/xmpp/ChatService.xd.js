...
return {depends: [["provide", "dojox.xmpp.ChatService"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.ChatService"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
