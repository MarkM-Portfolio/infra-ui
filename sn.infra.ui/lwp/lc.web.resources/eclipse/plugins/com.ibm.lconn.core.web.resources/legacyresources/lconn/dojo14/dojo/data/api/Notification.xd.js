...
return {depends: [["provide", "dojo.data.api.Notification"],
["require", "dojo.data.api.Read"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.data.api.Notification"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
