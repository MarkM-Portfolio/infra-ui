...
return {depends: [["provide", "dijit.layout.TabController"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.TabController"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
