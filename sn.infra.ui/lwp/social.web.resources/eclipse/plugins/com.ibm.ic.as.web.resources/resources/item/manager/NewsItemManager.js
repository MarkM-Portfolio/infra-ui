/* Copyright IBM Corp. 2011, 2015  All Rights Reserved.              */
	...
	define([
		...
		"ic-as/item/type/TypeManager"
	], function (dojo, declare, domClass, domConstruct, NewsDataAccessor, TypeManager) {
		...
		var NewsItemManager = declare("com.ibm.social.as.item.manager.NewsItemManager", [],
		{
			...
			createNewsItems: function(newsItems, insertAtTop){
				...
				for(var i = 0; i < newsItemsLength; i++){
					...
					declare.safeMixin(newsData, new NewsDataAccessor());
					...
					if(newsData.isAllMandatorySupplied()){
						...
						if(i == newsItemsLength-1){
							...
							domClass.add(newsItemWidget.domNode, "lastNewsItem");
						}
