...
return {depends: [["provide", "dojo._firebug.firebug"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo._firebug.firebug"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
