...
return {depends: [["provide", "dojox.io.httpParse"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.io.httpParse"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
