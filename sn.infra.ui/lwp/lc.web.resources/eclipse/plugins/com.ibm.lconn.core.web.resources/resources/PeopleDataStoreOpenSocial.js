 ...
 * 
 * @class lconn.core.PeopleDataStoreOpenSocial
 * @extends lconn.core.PeopleDataStore
 * @author Jim Antill
 */
...
dojo.declare("lconn.core.PeopleDataStoreOpenSocial", lconn.core.PeopleDataStore, /** @lends lconn.core.PeopleDataStoreOpenSocial.prototype */ {
    ...
    */
    fetch: function(keywordArgs) {
        ...
        this.networkGet({
            ...
            load: dojo.hitch(this, function(osData) {
...
/**
 * FIXME: this class has substantial portions copied from {@link lconn.core.PeopleDataStoreOpenSocial}. Refactor by subclassing.
 * @class lconn.core.HybridPeopleDataStoreOpenSocial
 * @extends lconn.core.PeopleDataStore
 */
dojo.declare("lconn.core.HybridPeopleDataStoreOpenSocial", lconn.core.PeopleFinderDataStore, /** @lends lconn.core.HybridPeopleDataStoreOpenSocial.prototype */ {
    ...
    */
    fetch: function(keywordArgs) {
        ...
        if(!this.searchDirectory){
            ...
            /* If there are any openSocial feed parameters include these. */
            if (this._openSocialParameters) {
               dojo.mixin(params, this._openSocialParameters);
            }
            ...
            this.networkGet({
               ...
               load: dojo.hitch(this, function(osData) {
                  ...
                  var data;
                  if(osData.list){
                     data = this._openSocialDataConverter.convertOpenSocialPeopleTypeAheadFeed(osData);
                  }else if (osData.items){
                     data = cache;
                     data.items = this.convertPeopleFinderResults(osData.items);
                  }
