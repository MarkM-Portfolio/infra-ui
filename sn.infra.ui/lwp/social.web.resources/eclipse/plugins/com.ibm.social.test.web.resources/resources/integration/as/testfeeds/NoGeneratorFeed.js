...
/*                                                                   */
/* ***************************************************************** */
dojo.provide("com.ibm.social.test.integration.as.testfeeds.NoGeneratorFeed");

/**
 * Feed that doesn't contain a generator element. Otherwise the same as a Connections feed.
 */
dojo.declare("com.ibm.social.test.integration.as.testfeeds.NoGeneratorFeed",
				com.ibm.social.test.integration.as.testfeeds.BaseTestFeed,
				{
					name: "NoGeneratorFeed",
					expectedFragments: 1,
