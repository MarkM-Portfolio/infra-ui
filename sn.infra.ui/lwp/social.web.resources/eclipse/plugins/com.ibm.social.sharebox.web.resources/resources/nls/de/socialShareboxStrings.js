...
({
   ...
   UNSAVEDCHANGES: {
	   CANCEL: "Abbrechen",
	   CONFIRM_OTHER_TAB: "Die Informationen, die Sie auf den anderen Registerkarten eingegeben haben, gehen verloren, wenn Sie mit der laufenden Aktion fortfahren. Klicken Sie auf 'OK', um die Änderungen zu verwerfen, oder auf 'Abbrechen', um zurückzukehren.",
	   CONFIRM_CURRENT_TAB: "Die Informationen, die Sie auf der Registerkarte ${0} eingegeben haben, gehen verloren, wenn Sie mit der aktuellen Aktion fortfahren. Klicken Sie auf 'OK', um die Änderungen zu verwerfen, oder auf 'Abbrechen', um zurückzukehren.",
