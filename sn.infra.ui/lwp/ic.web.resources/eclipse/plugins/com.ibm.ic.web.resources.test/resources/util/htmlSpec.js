...
define([
   ...
   function(domGeometry, htmlUtil) {

      describe("the interface of ic-core/util/html", function() {
      ...
      describe("the method ic-core/util/html::getDirectionCode()", function() {
         var _isBodyLtr;
         beforeEach(function() {
            _isBodyLtr = domGeometry.isBodyLtr;
         });
         afterEach(function() {
            domGeometry.isBodyLtr = _isBodyLtr;
         });
         it("returns empty string in LTR", function() {
            expect(htmlUtil.getDirectionCode()).toBe("");
         });
         it("returns \\u200F in RTL", function() {
            domGeometry.isBodyLtr = function() {
               return false;
            };
            expect(htmlUtil.getDirectionCode()).toBe("\u200F");
         });
      ...
      describe("the method ic-core/util/html::isEvent()", function() {
      ...
      describe("the method ic-core/util/html::encodeSpaces()", function() {
      ...
      describe("the method ic-core/util/html::encodeMultiSpaces()", function() {
         it("encodes plain and unicode spaces", function() {
      ...
      describe("the method ic-core/util/html::highlight()", function() {
      ...
      describe("the method ic-core/util/html::decodeHtml()", function() {
      ...
      describe("the method ic-core/util/html::encodeHtml()", function() {
      ...
      describe("the method ic-core/util/html::encodeHtmlAttribute()", function() {
      ...
      describe("the method ic-core/util/html::createTextNode()",
         function() {
            var el;
            beforeEach(function() {
               el = dojo.create('div');
      ...
      describe("the method ic-core/util/html::alert()", function() {
      ...
      describe("the method ic-core/util/html::confirm()", function() {
      ...
      describe("the method ic-core/util/html::substitute()", function() {
         var formatter = {
         ...
         it("correctly substitutes one placeholder", function() {
            ...
            expect(el.childNodes).not.toBeNull();
            // Presence of placeholders causes several text nodes to be appended
            // to
            // <code>el</code>.
