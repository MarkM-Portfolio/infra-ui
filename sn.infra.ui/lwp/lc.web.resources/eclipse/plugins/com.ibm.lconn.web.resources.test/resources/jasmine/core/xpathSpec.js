...
dojo.provide("lconn.test.jasmine.core.xpathSpec");
...
(function(xpath, xslt) {
   // This is necessary to inline templates using dojo.cache with the jazz framework
   var TEMPLATES = [{
     templatePath: dojo.moduleUrl('lconn.test', 'jasmine/core/templates/1.xml')
   }, {
     templatePath: dojo.moduleUrl('lconn.test', 'jasmine/core/templates/2.xml')
   }],
   PREFIXES = [ {
      prefix : 'atom',
   ...
   describe('the interface of lconn.core.xpath', function() {
      it('implements the expected methods', function() {
         expect(dojo.isFunction(xpath.selectNodes)).toBeTruthy();
         expect(dojo.isFunction(xpath.selectSingleNode)).toBeTruthy();
         expect(dojo.isFunction(xpath.selectText)).toBeTruthy();
         expect(dojo.isFunction(xpath.setNodeValue)).toBeTruthy();
         expect(dojo.isFunction(xpath.isIE11)).toBeTruthy();
         expect(dojo.isFunction(xpath.loadDOMIE11)).toBeTruthy();
      });
   });

   describe('the method lconn.core.xpath.selectNodes()', function() {
      var nodes, oXML;
      beforeEach(function(){
         oXML = xslt.loadXmlString(dojo.cache(dojo.moduleUrl('lconn.test', 'jasmine/core/templates/1.xml')));
      });
   ...
   describe('the method lconn.core.xpath.selectSingleNode()', function() {
      var node, oXML;
      beforeEach(function(){
         oXML = xslt.loadXmlString(dojo.cache(dojo.moduleUrl('lconn.test', 'jasmine/core/templates/1.xml')));
      });
   ...
   describe('the method lconn.core.xpath.selectText()', function() {
      var str, oXML;
      beforeEach(function(){
         oXML = xslt.loadXmlString(dojo.cache(dojo.moduleUrl('lconn.test', 'jasmine/core/templates/1.xml')));
      }); 
   ...
   describe('the method lconn.core.xpath.setNodeValue()', function() {
      var node, oXML;
      beforeEach(function(){
         oXML = xslt.loadXmlString(dojo.cache(dojo.moduleUrl('lconn.test', 'jasmine/core/templates/1.xml')));
      });
...
}(lconn.core.xpath, lconn.core.xslt));
