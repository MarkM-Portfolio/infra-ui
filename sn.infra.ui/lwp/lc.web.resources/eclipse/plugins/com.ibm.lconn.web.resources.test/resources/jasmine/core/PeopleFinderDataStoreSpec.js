...
dojo.provide("lconn.test.jasmine.core.PeopleFinderDataStoreSpec");
...
(function(PeopleDataStore, PeopleFinderDataStore) {
   ...
   describe('the lconn.core.PeopleFinderDataStore class', function() {
      var store;
      beforeEach(function() {
      ...
      describe('the method convertPeopleFinderResults()', function() {
         ...
         it('converts an array of the new format results into the old format people type ahead results', function() {
            var res = store.convertPeopleFinderResults(NEW_RESULTS);
...
}(lconn.core.PeopleDataStore, lconn.core.PeopleFinderDataStore));
