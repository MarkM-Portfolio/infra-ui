...
define([
      "dojo",
      "dojo/query",
      "dojo/i18n!../enabler/nls/iwMessages",
      "dojo/dom-class",
      "dojo/dom-style",
      "dojo/i18n!../enabler/nls/iwStr",
      "dojo/_base/lang",
      "dojo/_base/declare",
      "dojo/i18n",
      "dojo/json",
      ...
      "dojo/topic",
      "dojo/_base/config",
      "../enabler/iw/eventImpl",
      "../enabler/aggregation/javascript",
      "../enabler/debug",
      "../enabler/iw/ItemSet",
      "../enabler/iw/ItemSetImpl",
      "../enabler/iw/iContextImpl",
      "../enabler/iw/internalservices",
      "../enabler/iw/payloadDef",
      "../enabler/iw/services",
      "../enabler/iw/utils",
      "../enabler/utilities"
],
   function(dojo, query, i18niwMessages, domClass, domStyle, i18niwStr, lang, declare, i18n, JSON, string, topic, dojoConfig, eventImpl, javascript, debug, ItemSet, ItemSetImpl, iContextImpl, internalservices, payloadDef, services, utils, utilities) {

      /*
       * This code works around a design flaw of this module, which assumes
       * there's a <code>serviceManager</code> object in the scope.
       */
      ...
      declare("com.ibm.mm.enabler.iWidgetWrapperDefaultImpl", null, {
         constructor : function(widgetSpan, id) {
            this._internalIbmModes = ItemSet._internalIbmModes;
            ...
            this.widgetItemSets = null; // defer creation to getWidgetItemSet
            // or getItemSets
            this.xmlRetrievedHandler = topic.subscribe("/enabler/widgetXmlRetrieved/" + this.id, lang.hitch(this, "handleWidgetInfoRetrieved"));
            this.eventServiceHandler = topic.subscribe("/enabler/eventService/" + this.id, lang.hitch(this, "handleEvent"));
            this.ns = widgetSpan.className.substr(0, 3);
            this.inlineMessageHandler = topic.subscribe("/enabler/inlineMessage/" + this.id, lang.hitch(this, "_handleInlineMessage"));
            this.windowManager = {}; // an associative array of window
            // entities, key is windowid(for
            // release1,it's mode);
            // value is simple json object:
            // {id:"edit",root:rootElement,active:false}
            this.iwStr = i18niwStr;
            this.iwMessages = i18niwMessages;
         },
         ...
         _jsHandler : javascript.JAVASCRIPT_HANDLER,
         _setLoading : function() {
            ...
            if (ibmConfig && ibmConfig.loadingHTML) {
               ...
               tempDiv.innerHTML = "<img src='" + dojoConfig.blankGif + "'" + " class='lotusLoading' alt='" + this.iwStr.LOAD + "' />&nbsp;" + this.iwStr.LOAD;
            }
            this.rootElement.appendChild(tempDiv);
         },
         _handleInlineMessage : function(type, message, details) {
            var nodes = [];
            utils.findElementByAttribute("class", this.ns + "content", this.rootElement, nodes, false);
            var aNode = nodes[0];
            aNode.innerHTML = "";
            debug.logInlineMessage(aNode, type, message, details);
         },
         loadWidgetDefinition : function() {
            debug.entry("iWidget.loadWidgetDefinition");
            ...
            if (this.getWidgetInstance().widgetXMLUrl !== null) {
               var iWidgetService = new services.widgetLoadService();
               iWidgetService.getWidgetXML(this.getWidgetInstance().widgetXMLUrl, this.id);
            }
            else {
               return false;
            } // no io is involved
            debug.entry("iWidget.loadWidgetDefinition", true);
            return true;
         },
         render : function() {
            debug.entry("iWidget.render");
            this.prepare();
            this.loadWidgetDefinition();
            debug.exit("iWidget.render");
         },
         prepare : function() {
            debug.entry("iWidget.prepare");
            variableName = "_" + this.id + "_" + "iContext";
            dojo.global[variableName] = new iContextImpl(this.id, this.ns);
            debug.exit("iWidget.prepare");
         },
         _updateMarkup : function(mode, contentDiv) {
            debug.entry("iWidget._updateMarkup");
            ...
            if (typeof markup == "undefined" || markup === null) {
               var error = string.substitute(this.iwMessages.E_IWIDGETDEF_CONTENTNOTAVAILABLE_1, [ mode
               ]);
               debug.info("iWidget._updateMarkup", error);
               return false;
            }
            ...
            if (scriptElems !== null) {
               ...
               // this is necessary so if there's document.write, it got over
               // written
            ...
            domClass.add(contentDiv, mode);
            contentDiv.innerHTML = tempDIV.innerHTML;

            // destroy tempDiv
            com.ibm.mm.enabler.dom.destroyNode(tempDIV);

            debug.exit("iWidget._updateMarkup");
            return true;
         },
         _prepareMarkup : function(markup) {
            debug.entry("iWidget._prepareMarkup");
            ...
            debug.exit("iWidget._updateMarkup", finalMarkup);
            return finalMarkup;
         },
         destroy : function() {
            this.xmlRetrievedHandler.remove();
            this.eventServiceHandler.remove();
            this.inlineMessageHandler.remove();
            // delete dojo.global["_"+this.id+"_"+"iContext"]; //doesn't work on
            // IE7, can't delete from global context
         ...
         handleWidgetInfoRetrieved : function(/* {} */wInfo) {
            debug.entry("iWidget.handleWidgetInfoRetrieved");
            ...
            debug.exit("iWidget.handleWidgetInfoRetrieved", this.id);
         },
         update : function() {
            this._initialize();
         ...
         _initialize : function() {
            debug.entry("iWidget._initialize");
            ...
            // register wires
            this.getWires();
            debug.exit("iWidget._initialize");
         },
         ...
         onLoad : function() {
            ...
            this.loaded = true;
            topic.publish("/enabler/widgetLoaded/" + this.id);
         },
         _getSimpleEventHandler : function(/* String */eventName) {
            debug.entry("iWidget._getSimpleEventHandler", eventName);
            if (this.simpleWidgetEvents && this.simpleWidgetEvents[eventName])
            ...
            var handlerObj = null;
            if (scope != null) {
               handlerObj = lang.hitch(scope, handler);
               ...
               if (newhandler != handler) {
                  ...
                  if (scope != null) {
                     handlerObj = lang.hitch(scope, newhandler);
                     this.simpleWidgetEvents[eventName] = handlerObj;
                  }
               }
            }
            debug.exit("iWidget._getSimpleEventHandler", handlerObj);
            return handlerObj;
         },
         _getHandlerScope : function(/* fn */handler) {
            debug.entry("iWidget._getHandlerScope", handler);
            ...
            if (typeof fn == "undefined" || fn == null)
               ...
               debug.exit("iWidget._getHandlerScope", fn);
               return fn;
            }
         },
         ...
         _handleNewWire : function(iEvent) {
            ...
            var eventName = payload.sourceEvent; // check if there's onNewWire
            // defined in
            // iEventDescription
            ...
            if (typeof event != "undefined" && event != null) {
               ...
               if (handler != null) {
                  var scope = this._getHandlerScope(handler);
                  if (scope != null && lang.isFunction(scope)) {
                     scope(iEvent);
                  }
                  else if (scope != null && lang.isObject(scope)) {
         ...
         _handleRemoveWire : function(iEvent) {
            var payload = iEvent.payload;
            var eventName = payload.targetEvent; // check if there's
            // onRemoveWire defined in
            // iEventDescription
         ...
         _handleModeChange : function(iEvent) {
            ...
            if (typeof oldWindow != "undefined" && oldWindow !== null) {
               ...
               if (!oldWindow.external && oldRoot != null && newRoot === null) {
                  ...
                  // turn on this window
                  domStyle.set(oldRoot, "display", "");

                  // this.currentMode = newMode;
                  // this._handleOnModeEvent(newMode); //so iWidget could
                  // refresh data
                  // isHandled = true;
               }
            }
            ...
            if (isHandled) {
               ...
               if (currentWindow.external) {
                  domStyle.set(currentRoot, "display", "none");// todo, destroy
                  // external
                  // window?
                  this.windowManager[this.currentMode] = null;
               }
               else if (newRoot != null) { // if the newRoot is provided,
                  // don't hide current window. leave
                  // builder to do this.
                  currentWindow.active = false;
               }
               else {
                  currentWindow.active = false;
                  domStyle.set(currentRoot, "display", "none");
               }
            ...
            if (isHandled) {
               serviceManager.getService("eventService").publishEvent(com.ibm.mm.enabler.iw.iEvents.Constants.modeChanged, [
                     this.id,
                     oldMode,
                     newMode
               ]);
         ...
         _handleEventInternal : function(/* String */eventName, iEvent) {
            debug.entry("iWidget._handleEventInternal", eventName, iEvent);
            if (typeof eventName == "undefined" || eventName === null)
               return false;
            ...
            if (handlerFn !== null) {
               debug.log("iWidget._handleEventInternal", "handlerFn:", handlerFn);
               if (iEvent != "undefined" && iEvent !== null)
                  handlerFn(iEvent);
               else
                  handlerFn();
               isHandled = true;
            }
            debug.exit("iWidget._handleEventInternal", isHandled);
            return isHandled;
         },
         getPublicEventHandler : function(/* String */eventName) {
            debug.entry("iWidget.getPublicEventHandler", eventName);
            ...
            if (handlerFn != null) {
               ...
               var handlerObj = null;
               if (scope != null) {
                  handlerObj = lang.hitch(scope, handlerFn);
               }
            }
            debug.exit("iWidget._getPublicEventHandler", handlerObj);
            return handlerObj;
         },
         getParent : function() {
            if (!this.parent)
               this.parent = utils.getWidgetParent(this.id);
            return this.parent;
         },
         getWidgetAttributes : function() {
            // Summary: returns an ManagedItemSet which provides access to the
            // iWidget's customization attributes.
            // The returned ManagedItemSet will be teh same as
            // getItemSet(iContext.constants.itemset.ATTRIBUTES).
            // returns empty set if there's no ItemSet.Return null if iWidget
            // customization attributes is not
            // supported
         ...
         _loadDefWidgetAttributes : function() {
            ...
            // <(iw-|mm_)item name="" type="" value="" description=""
            // readOnly="false"/>
            // </(iw-|mm_)itemSet>
            debug.entry("iWidget:_loadDefWidgetAttributes");
            ...
            debug.exit("iWidget:_loadDefWidgetAttributes");
         },
         /*
          * this can be used to support <span id="" zipcode="27511"
          * contentURI="foo">
          */
         _loadWidgetInstanceAttributesFromRootElement : function() {
            debug.entry("iWidget._loadWidgetInstanceAttributesFromRootElement");
            ...
            for (var i = 0; i < attributes.length; i++) {
               ...
               if (typeof value != "undefined" && value != null && value != "") {
                  ...
                  debug.log("iWidget._loadWidgetInstanceAttributesFromRootElement", "name:" + att.name + " value:" + value);
               }
            }
            debug.exit("iWidget._loadWidgetInstanceAttributesFromRootElement");
         },
         ...
         _loadWidgetDefItemSets : function() {
            debug.entry("iWidget._loadWidgetDefItemSets");
            if (typeof (this.widgetDef) != "undefined") {
               var names = this.widgetDef.getAllItemSetNames();
               for (var i = 0; i < names.length; i++) {
                  var name = names[i];
                  var itemSetWrapper = this.widgetDef.getItemSet(name);
                  var anItemSet = new com.ibm.mm.enabler.iw.DefaultItemSetImpl(parent,
                        itemSetWrapper.name,
                        itemSetWrapper.onItemSetChanged,
                        null,
                        itemSetWrapper.isPrivate);
            ...
            debug.exit("iWidget._loadWidgetDefItemSets");
         },
         _loadWidgetSharedResource : function() {
            var resources = this.widgetDef.getResources();
            debug.entry("iWidget._loadWidgetSharedResource", resources);
            ...
            debug.exit("iWidget._loadWidgetSharedResource");
         },
         _createiScope : function() {
            // create scope object
            var iScope = this.widgetDef.getIScope();
            debug.entry("iWidget._createiScope", iScope);
            ...
            if (typeof iScope != undefined && iScope != null) {
               try {
                  ...
                  debug.log("iWidget._createiScope", "iScope" + iScope, "Error", err);
               }
            }
         ...
         getPublishedEvents : function() {
            debug.entry("com.ibm.mm.enabler.iWidgetWrapperStandardImpl.getPublishedEvents");
            if (!this.publishedEvents) {
               this.publishedEvents = this.widgetDef.getPublishedEvents();
            }
            debug.exit("iWidget.getPublishedEvents", this.publishedEvents);
            return this.publishedEvents;
         },
         getHandledEvents : function() { // return an array of event handler
            // for this event
            // for each event, getEventDescription from widgetDef and
            // widgetInstance
            debug.entry("iWidget.getHandledEvents");
            if (!this.handledEvents) {
               this.handledEvents = this.widgetDef.getHandledEvents();
            }
            debug.exit("iWidget.getHandledEvents", this.handledEvents);
            return this.handledEvents;
         },
         _loadWidgetAttributes : function() {
            debug.entry("iWidget:_loadWidgetAttributes");
            ...
            debug.exit("iWidget:_loadWidgetAttributes");
         },
         _loadItemSets : function() {
            // load only once
            debug.entry("iWidget._loadItemSets");
            this.widgetItemSets = {};
            ...
            debug.exit("iWidget._loadItemSets");
         },
      ...
      declare("com.ibm.mm.enabler.iWidgetContainer", null, {
         constructor : function() {
            // subscribe to page changed event, thus it can got notified once
            // a page is updated
            this.widgetArr = {}; // associate array since it provides direct
            // access
            this.eventService = serviceManager.getService("eventService");
            this.queryService = serviceManager.getService("queryService");
            // deprecated
            topic.subscribe("/enabler/pageChanged", lang.hitch(this, "_unloadWidgets"));
            topic.subscribe("/enabler/widgetDeleted", lang.hitch(this, "_unloadWidgets"));
            topic.subscribe("/enabler/unloadWidget", lang.hitch(this, "_unloadWidgets"));

            var img = document.createElement("img");
            img.src = dojoConfig.blankGif;
            img.className = "lotusLoading";
            this.processAnim = img;
         },
         createWidget : function(/* DomElment */widgetSpan) {
            debug.entry("iWidgetContainer.createWidget", widgetSpan);
            /*
             * if (widgetSpan.getAttribute("widgetStatus") !== null) { return; }
             */
            ...
            // each fragment is uniquely identified by the widget id, thus we
            // don't support different fragment that shares the same id
            ...
            debug.exit("iWidgetContainer.createWidget", aWidget);
            return aWidget;
         },
         ...
         getWidgetById : function(/* String */id) {
            debug.entry("iWidgetContainer.getWidgetById", id);

            var widget = this.widgetArr[id];
            if (typeof widget != "undefined") {
               debug.exit("iWidgetContainer.getWidgetById", widget);
               return widget;
            }
            return null;
         },
         _unloadWidgets : function(/* [] */arr) {
            debug.entry("iWidgetContainer._unloadWidgets");
            var aWidget;
            if (typeof arr != "undefined" || arr !== null) {
               if (langModule.isArray(arr)) {
                  for ( var i in arr) {
                     aWidget = arr[i];
                     this._unloadWidget(aWidget);
                  }
                  topic.publish("/enabler/widgetsUnloaded");
               }
               else if (langModule.isString(arr)) {
      ...
      declare("com.ibm.mm.enabler.iWidgetInstanceStandard", null, {
         constructor : function(/* RootElement */widgetSpan,/* String */id) {
            ...
            utils.findElementByAttribute("class", className, this.rootElement, nodes, false);
         ...
         getDefaultViewContent : function() {
            ...
            var nodeList = query("span." + className, this.rootElement);
         ...
         getWidgetEvents : function() {
            // simple events including all the predefined events and onSth.
            // event
            ...
            for (var i = 0; i < attributes.length; i++) {
               ...
               if (attribute.name !== null && attribute.name.indexOf("on") === 0) {
                  ...
                  if (typeof handler != "undefined" && handler !== null) {
                     ...
                     debug.log("iWidgetInstance.getWidgetEvents", "eventName:" + attribute.name + " handler:" + widgetEvents[attribute.name]);
                  }
               }
            }
         ...
         getWires : function() {
            ...
            var nodes = [];
            utils.findElementByAttribute("class", ns + className, this.rootElement, nodes, true);
            var names = [
                  "SourceWidget",
                  "SourceEvent",
                  "TargetEvent"
            ...
            for (var i = 0; i < nodes.length; i++) {
               ...
               for (var j = 0; j < 2; j++) {
                  var element = [];
                  utils.findElementByAttribute("class", ns + classes[j], aNode, element, false);
                  if (element.length == 0) {
                     isValid = false;
                  }
                  else {
         ...
         loadItemSets : function() {
            ...
            this.itemSets = {};
            var itemSetChildren = [];
            utils.findElementByAttribute("class", this.ns + "ItemSet", this.rootElement, itemSetChildren, true);
            if (itemSetChildren.length > 0) {
               for (var i = 0; i < itemSetChildren.length; i++) {
                  ...
                  if (typeof (itemSetName) != "undefined") {
                     ...
                     var itemChildren = [];
                     utils.findElementByAttribute("class", this.ns + "Item", elem, itemChildren, true);
         ...
         _loadLocalizedItem : function(/* element */elem1) {
            ...
            // get default value, support text only, "value" will be the default
            // value
            ...
            /*
             * var childNodes = elem1.childNodes; for (var i=0;i<childNodes.length;i++) {
             * var child = childNodes[i]; if (child.nodeType == 1 &&
             * child.className = "iw-Value") {//break when element is found
             * break; } if (child.nodeType == 3 || child.nodeType == 4 ){ var
             * tempStr = child.nodeValue; tempStr =
             * tempStr.replace(/^\s+|\s+$/g, '') ; if (tempStr.length != 0) {
             * var defaultValue = tempStr; } break; } }
             */
            ...
            /*
             * var localizedValue = {}; var empty = true; var nodeList =
             * dojo.query("span."+"iw-Value",elem1); for (var j=0; j<nodeList.length;
             * j++){ var aNode = nodeList[j]; var aLang =
             * aNode.getAttribute("lang"); if (typeof aLang != "undefined" &&
             * aLang != null){ var value = aNode.innerHTML;
             * localizedValue[aLang]=value; empty = false; if (aLang ==
             * item.defaultLang) item.defaultValue = value; } } if (!empty)
             * item.localizedValue = localizedValue;
             */

            debug.exit("com.ibm.mm.enabler.iWidgetInstanceStandard._loadLocalizedItem", "item:" + item);
            return item;
         }
      });
