...
(function(lang, df, htmlClass) {
    ...
    * 
    * @namespace lconn.core.config.htmlClass
    * @deprecated This legacy module is deprecated. Use the AMD module
    *             {@see ic-core.config.htmlClass} instead
    ...
    * 
    * @method get
    * @memberof lconn.core.config.htmlClass
   ...
   lang.mixin(htmlClass, /** @lends lconn.core.config.htmlClass */
   {
      /**
       * Returns a space separated list of class names for enabled feature flags
       * 
   ...
   dojo.addOnLoad(function() {
      dojo.addClass(document.getElementsByTagName('html')[0], htmlClass.get());
   });
