...
return {depends: [["provide", "dojox.color.Palette"],
["require", "dojox.color"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.color.Palette"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
