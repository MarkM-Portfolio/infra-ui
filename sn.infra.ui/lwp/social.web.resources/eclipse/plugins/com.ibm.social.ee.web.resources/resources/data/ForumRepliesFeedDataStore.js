...
dojo.require("com.ibm.social.ee.bean.ForumReply");
...
dojo.declare("com.ibm.social.ee.data.ForumRepliesFeedDataStore", [com.ibm.social.ee.data.FeedDataStore], {
	...
	itemFromDocEl: function(el, base) {
		return new com.ibm.social.ee.bean.ForumReply(el, base);
	},
