...
return {depends: [["provide", "dojox.uuid.generateRandomUuid"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.uuid.generateRandomUuid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
