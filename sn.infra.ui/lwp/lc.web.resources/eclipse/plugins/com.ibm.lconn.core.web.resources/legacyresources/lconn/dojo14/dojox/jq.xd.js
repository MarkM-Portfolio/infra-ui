...
return {depends: [["provide", "dojox.jq"],
["require", "dojo.NodeList-traverse"],
["require", "dojo.NodeList-manipulate"],
["require", "dojo.io.script"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.jq"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
