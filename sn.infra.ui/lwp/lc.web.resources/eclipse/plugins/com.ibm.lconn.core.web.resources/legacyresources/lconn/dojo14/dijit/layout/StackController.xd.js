...
return {depends: [["provide", "dijit.layout.StackController"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.StackController"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
