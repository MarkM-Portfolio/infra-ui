...
define([
	...
	"dojo/_base/lang",
	"dojo/dom-construct",
	"dojo/text!ic-ee/gadget/templates/ECMGadgetLoader.html",
	"ic-ee/config",
	"ic-ee/gadget/ECMDraftEntry",
	"ic-ee/gadget/ECMDraftReviewEntry",
	"ic-ee/gadget/ECMPublishedDocEntry",
	"ic-ee/gadget/_ECMEEGadgetWidget",
	"ic-incontext/util/html"
], function (array, declare, lang, domConstruct, template, config, ECMDraftEntry, ECMDraftReviewEntry, ECMPublishedDocEntry, _ECMEEGadgetWidget, html) {

	var ECMGadgetLoader = declare("com.ibm.social.ee.gadget.ECMGadgetLoader", _ECMEEGadgetWidget, {
	   ...
	   getAddtlParams: function() {
	      return this.shouldLoadDraft() ? config.ecm.draftParams : config.ecm.publishedParams;    
	   },
	   ...
	   initializeUI: function() {
	      if (this.shouldLoadDraft()) {
	         ...
	         if(array.indexOf(this.draftType, this.data.category) != -1) {
	   ...
	   loadDraftWidget: function() {
	      ...
	      if (!this.ecmDraftGadget) {
	         var gadgetDiv = domConstruct.create("div", { }, this.draftNode); 
	         var addtlParams = {
	            loadPublishedDocWidget: lang.hitch(this, this.loadPublishedDocWidget),
	            initComplete: lang.hitch(this, this.initComplete),
	            showLoading: lang.hitch(this, this.showLoading),
	            hideLoading: lang.hitch(this, this.hideLoading),
	         ...
	         var params = lang.mixin(this.params, addtlParams);
	         var isReview = this.value("approvalState");
	         var gadget = this.ecmDraftGadget = isReview ? new ECMDraftReviewEntry(params, gadgetDiv) : new ECMDraftEntry(params, gadgetDiv);
	   ...
	   loadPublishedDocWidget: function() {
	      ...
	      if (!this.ecmPublishedGadget) {
	         var gadgetDiv = domConstruct.create("div", { }, this.publishedNode); 
	         var addtlParams = {
	            loadDraftWidget: lang.hitch(this, this.loadDraftWidget),
	            initComplete: lang.hitch(this, this.initComplete),
	         ...
	         var params = lang.mixin(this.params, addtlParams);
	         var gadget = this.ecmPublishedGadget = new ECMPublishedDocEntry(params, gadgetDiv);
	   ...
	   showLoading: function() { 
	      ...
	      html.showLoading(this.loadingNode);
