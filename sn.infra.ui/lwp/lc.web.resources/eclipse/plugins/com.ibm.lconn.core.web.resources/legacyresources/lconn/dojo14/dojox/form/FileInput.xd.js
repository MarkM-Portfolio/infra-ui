...
return {depends: [["provide", "dojox.form.FileInput"],
["require", "dijit.form._FormWidget"],
["require", "dijit._Templated"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form.FileInput"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
