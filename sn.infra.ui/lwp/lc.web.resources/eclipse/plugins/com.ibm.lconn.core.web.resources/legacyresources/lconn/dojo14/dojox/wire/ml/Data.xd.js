...
return {depends: [["provide", "dojox.wire.ml.Data"],
["provide", "dojox.wire.ml.DataProperty"],
["require", "dijit._Widget"],
["require", "dijit._Container"],
["require", "dojox.wire.ml.util"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.ml.Data"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
