...
public class LayersConfig
{
  ...
  private final static String BUNDLE_NAME = "com.ibm.lconn.core.web.resources.config.layers";
  ...
  public static Map<String, String> loadLayers()
  {
    ...
    {
      logger.entering(CLASS_NAME, "loadLayers");
    }
    ...
    if (logger.isLoggable(Level.FINER))
    {
      logger.exiting(CLASS_NAME, "loadLayers", layers);
    }
