...
return {depends: [["provide", "dojox.lang.observable"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.lang.observable"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
