...
return {depends: [["provide", "dojox.drawing.stencil.Rect"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.stencil.Rect"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
