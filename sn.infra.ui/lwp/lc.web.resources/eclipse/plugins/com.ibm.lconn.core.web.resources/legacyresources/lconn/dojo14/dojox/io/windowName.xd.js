...
return {depends: [["provide", "dojox.io.windowName"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.io.windowName"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
