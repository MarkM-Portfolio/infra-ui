...
define([
   ...
   var ConfigService = declare("com.ibm.mm.enabler.services.ConfigService", null, {
      ...
      getValue : function( /* string */name) {
         ...
         debug.entry("ConfigService.getValue", name);

         var value = ibmConfig[name];

         debug.exit("ConfigService.getValue", value);
         return value;
      }
   });
