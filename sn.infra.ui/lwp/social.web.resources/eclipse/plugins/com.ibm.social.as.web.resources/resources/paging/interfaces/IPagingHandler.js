...
dojo.provide("com.ibm.social.as.paging.interfaces.IPagingHandler");
...
dojo.declare("com.ibm.social.as.paging.interfaces.IPagingHandler", 
[dijit._Widget, dijit._Templated],
{
	templatePath: dojo.moduleUrl("com.ibm.social.as", "paging/interfaces/templates/iPagingHandler.html"),
	...
	postCreate: function(){
		...
		if(this.targetTopScrollerNode){
			...
			dojo.place(this.targetTopScrollerNode, this.topScrollerNode, "replace");
		}
		
		// If there is a bottom scroller node passed in
		if(this.targetBottomScrollerNode){
			// Replace the current node (from the template HTML) with it
			dojo.place(this.bottomScrollerNode, this.targetBottomScrollerNode, "replace");
		}
	},
	...
	showNextPage: function(){
		...
		dojo.publish(this.pagingEventName, [this.page]);
	},
