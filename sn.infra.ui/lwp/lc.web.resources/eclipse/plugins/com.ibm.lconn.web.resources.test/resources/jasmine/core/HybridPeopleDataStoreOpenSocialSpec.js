...
dojo.provide("lconn.test.jasmine.core.HybridPeopleDataStoreOpenSocialSpec");
dojo.require("lconn.core.PeopleDataStoreOpenSocial");

(function(HybridPeopleDataStoreOpenSocial) {
   var networkSpec = {
      get : function() {
         return true
      }
   ...
   describe('the lconn.core.HybridPeopleDataStoreOpenSocial class', function() {
   ...
   describe('the lconn.core.HybridPeopleDataStoreOpenSocial constructor', function() {
   ...
   describe('the method lconn.core.HybridPeopleDataStoreOpenSocial.setOpenSocialParameters', function() {
   ...
   describe('the method lconn.core.HybridPeopleDataStoreOpenSocial.fetch', function() {
      var keywordArgs;
      beforeEach(function() {
         keywordArgs = {
            queryOptions : {},
      ...
      it('calls lconn.core.PeopleDataStore.fetch (!searchDirectory)', function() {
...
}(lconn.core.HybridPeopleDataStoreOpenSocial));
