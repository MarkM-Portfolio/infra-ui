...
define([ "ic-core/paletteOneUI/PaletteDataStoreBuilder"
],
   function(builder) {

      var JSON = "{\"categories\":[{\"id\":\"0\",\"name\":\"Activities\",\"css\":\"http://xyz.com/activitiesLogo.png\",\"widgets\":[{\"id\":\"1\",\"name\":\"Todos widget\",\"desc\":\"Display todos\",\"xmlDefUrl\":\"http://xyz.com/activities_todos.xml\",\"previewImgUrl\":\"http://xyz.com/todosWidgetSnapshot.png\",\"widgetType\":\"primary\"},{\"id\":\"2\",\"name\":\"Calendar widget\",\"desc\":\"Display calendar\",\"xmlDefUrl\":\"http://xyz.com/activities_calendar.xml\",\"previewImgUrl\":\"http://xyz.com/calendarWidgetSnapshot.png\",\"widgetType\":\"primary\"}]}]}", JSON_FILE = "./widget/palette/widgets.json", JSON_FILE_MALFORMED = "./widget/palette/malformed.json";
      var b;
