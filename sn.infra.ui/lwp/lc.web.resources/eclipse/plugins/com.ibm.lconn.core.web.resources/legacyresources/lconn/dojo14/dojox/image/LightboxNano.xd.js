...
return {depends: [["provide", "dojox.image.LightboxNano"],
["require", "dojo.fx"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.image.LightboxNano"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
