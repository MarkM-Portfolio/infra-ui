...
return {depends: [["provide", "dojox.date.php"],
["require", "dojo.date"],
["require", "dojox.string.tokenize"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.php"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
