...
return {depends: [["provide", "dijit.layout.AccordionContainer"],
["require", "dojo.fx"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit.layout.AccordionContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
