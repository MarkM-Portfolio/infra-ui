   ...
   root: ({
      ...
      ACTION: {
         ...
         CLOSE: {
            ...
            WARNING_DIALOG: {
              ...
              PROMPT: "Filen blir fremdeles lastet opp. Hvis du lukker før den er ferdig, vil opplastingen bli avbrutt.",
              OK: "Lukk likevel",
         ...
         TEAR_OFF: {
           ...
           UNSAVED_CHANGES_WARNING: "Du har endringer som ikke er lagret, og som vil gå tapt. Vil du åpne i et nytt vindu likevel?",
           OK: "Ja",
           CANCEL: "Nei",
           OPEN: "Åpne",
         ...
         CREATE_FROM_TEMPLATE: {
            ...
            EXTERNAL_DESC: "Ekstern tilgang gjør at filer kan deles med eksterne brukere (personer utenfor organisasjonen eller firmaet ditt), mapper kan deles med eksterne brukere og fellesskap kan ha eksterne personer som medlemmer. Du må definere ekstern tilgang når du laster opp en fil. Det kan ikke gjøres senere.",
            ...
            ERRORS: {
               ...
               DUPLICATE_NAME: "Et duplisert filnavn ble funnet. Angi et nytt navn.",
         ...
         DOWNLOAD_AS_PDF: {
            ...
            ERROR: {
               ...
               UNAUTHENTICATED: "Sesjonen ble tidsavbrutt. Du må logge på igjen før du kan laste ned filen som en PDF.",
            ...
            DOCS_ERRORS: {
               NO_PUBLISHED_OR_EMPTY: "Det finnes ingen publisert versjon av denne filen å laste ned. Versjoner kan publiseres fra Docs-redigeringsprogrammet."
            }
         },
         DOWNLOAD_DOCS_FILE: {
            EMPTY_FILE_EDITOR: {
         ...
         TOGGLE_PANEL: {
            ...
            SHOW_A11Y: "Denne knappen veksler mellom åpent og lukket sidepanel. Sidepanelet er for øyeblikket lukket.",
            HIDE_A11Y: "Denne knappen veksler mellom åpent og lukket sidepanel. Sidepanelet er for øyeblikket åpent.",
            RESET_A11Y: "Denne knappen stiller sidepanelet tilbake til standardstørrelse. Sidepanelet er for øyeblikket utvidet."
         },
         VIEW_DOC: {
         ...
         ROUNDTRIP_EDIT: {
            ...
            INSTALL: "Før du fortsetter, må du ${startLink}installere filforbindelser på skrivebordet${endLink}.",
         ...
         STOP_SHARING: {
            ...
            REMOVE_USER: "Er du sikker på at du vil avslutte delingen med ${user}? Hvis du avslutter delingen, vil ${user} bare få tilgang til denne filen via mapper eller hvis den deles med alle i organisasjonen.",
         ...
         DELETE_COMMENT: {
            ...
            ERROR: "Det oppstod en feil under sletting av kommentaren. Prøv igjen senere.",
         ...
         EDIT_DESCRIPTION: {
            ...
            ERROR: {
               ...
               UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan oppdatere beskrivelsen.",
         ...
         TOGGLE_FOLLOW: {
            ERROR: {
               FOLLOW: {
                  DEFAULT: "Det oppstod en feil under følging av denne filen. Prøv igjen senere.",
                  UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan følge denne filen.",
               ...
               UNFOLLOW: {
                  ...
                  UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan slutte å følge denne filen.",
         ...
         TOGGLE_SYNC: {
            SYNC: {
               ...
               ERROR: {
                  DEFAULT: "Det oppstod en feil da denne filen skulle legges til i synkronisering. Prøv igjen senere.",
                  UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan legge til denne filen i synkronisering.",
            ...
            STOP_SYNC: {
               ...
               ERROR: {
                  DEFAULT: "Det oppstod en feil under fjerning av denne filen fra synkronisering. Prøv igjen senere.",
                  UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan fjerne denne filen fra synkronisering.",
            ...
            MYDRIVE: {
                ...
                ERROR: {
                   DEFAULT: "Det oppstod en feil da denne filen skulle legges til i Min stasjon. Prøv igjen senere.",
                   UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan legge til denne filen i Min stasjon.",
             ...
             REMOVE_MYDRIVE: {
                ...
                ERROR: {
                   DEFAULT: "Det oppstod en feil under fjerning av filen fra Min stasjon. Prøv igjen senere.",
                   UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan fjerne denne filen fra Min stasjon.",
         ...
         TRASH: {
            ...
            DIALOG_TITLE: "Bekreft",
            PROMPT: "Er du sikker på at du vil flytte denne filen til papirkurven? Hvis du flytter denne filen til papirkurven, blir den utilgjengelig for alle den er delt med nå.",
            ERROR: "Det oppstod en feil under sletting av filen. Prøv igjen senere.",
         ...
         REFRESH: {
            NAME: "Oppdater",
            ERROR: "Det oppstod en feil under oppdatering av filviseren. Prøv igjen senere.",
         ...
         COPY_FILE: {
            ...
            DIALOG_TITLE: "Bekreft",
            ERROR: "Det oppstod en feil under kopiering av filen. Prøv igjen senere.",
            ...
            SUCCESS_MSG: "${file} har blitt kopiert til ${community}."
         },
         TRANSFER_FILE: {
            NAME: "Overfør eierskap...",
            DIALOG_TITLE: "Overfør eierskap",
            TOOLTIP: "Overfør denne filen til en ny eier",
            A11Y: "Denne knappen åpner en dialogboks som lar deg overføre denne filen til en ny eier.",
            EMPTY: "Tom"
         },
         UPLOAD_VERSION: {
         ...
         MODERATION: {
            DIALOG_TITLE: "Vellykket",
            PROMPT: "Endringene har blitt sendt inn til gjennomgang. Denne filen er ikke tilgjengelig før endringene har blitt godkjent.",
            CANCEL: "OK"
         },
      ...
      PREVIEW: {
         ...
         VIEWER: {
            ...
            AUTOPUBLISH_TIMEOUT: "Det tar for lang tid før serveren svarer. De nyeste endringene har kanskje ikke blitt publisert."
         },
         VIDEO: {
            UNSAFE_PREVIEW: "Denne filen kan ikke forhåndsvises fordi den ikke er undersøkt for virus."
         }
      ...
      FILE_STATE: {
         ...
         LOCKED_BY_OTHER: {
            ...
            DAY: "Låst ${date} av ${user}.",
            MONTH: "Låst ${date} av ${user}.",
            YEAR: "Låst ${date_long} av ${user}."
         }
      },
      VALIDATION: {
      ...
      DOCS_STATUS_MESSAGE: {
         ...
         NO_ENTITLEMENT_LINK: "Denne filen kan redigeres online av personer som har ${startLink}HCL Docs${endLink}.",
		 // When configured, "HCL Docs" will be a link to more information about the product
         CURRENT_EDITORS: "Denne filen blir for øyeblikket redigert på Internett av ${users}.",
         ...
         AUTOPUBLISH: {
            ...
            GENERIC: "Du må kanskje oppdatere siden for å se de siste endringene.  ${startLink}Oppdater${endLink}"
         }
      },
      COMMENTS: {
         ...
         ERROR: {
            SAVE: {
               ...
               UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan lagre kommentaren.",
               NOT_FOUND: "Kommentaren kunne ikke lagres fordi filen er slettet eller ikke lenger delt med deg.",
               ACCESS_DENIED: "Kommentaren kunne ikke lagres fordi filen er slettet eller ikke lenger delt med deg."
            },
            DELETE: {
               DEFAULT: "Kommentaren kunne ikke slettes. Prøv igjen senere.",
               UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan slette kommentaren.",
               NOT_FOUND: "Kommentaren kunne ikke slettes fordi filen er slettet eller ikke lenger delt med deg.",
               ACCESS_DENIED: "Kommentaren kunne ikke slettes fordi filen er slettet eller ikke lenger delt med deg."
            }
         }
      },
      TAG_WIDGET: {
      ...
      SHARE: {
         ...
         PROVISION_EXTERNAL_USER_DIALOG: {
            SINGULAR: {
               ...
               CANCEL: "Avbryt",
               ERROR: "Det oppstod en feil under klargjøring av kontoen.Prøv igjen senere.",
            ...
            PLURAL: {
               ...
               CANCEL: "Avbryt",
               ERROR: "Det oppstod en feil under klargjøring av kontoer. Prøv igjen senere.",
      ...
      SHARE_OPTIONS: {
         ...
         MAKE_INTERNAL_DIALOG: {
            ...
            "Eventuelle delinger med eksterne personer, fellesskap eller mapper vil bli fjernet.${br}${br}Hvis du gjør en fil intern, er det en permanent handling som ikke kan angres.",
            EFSS: {
               DIALOG_TITLE: "Gjøre intern?",
               PROMPT: "Hvis du gjør denne filen intern, kan den ikke lenger deles med personer utenfor organisasjonen din. ${br}${br}" +
               "Eventuelle delinger med eksterne personer eller mapper vil bli fjernet.${br}${br}Hvis du gjør en fil intern, er det en permanent handling som ikke kan angres."
            }
         },
         MAKE_PRIVATE_DIALOG: {
            ...
            QUESTION_PUBLIC_E: "Denne filen vil ikke lenger være synlig for alle i organisasjonen din, eller delt med personer, mapper eller fellesskap. Denne operasjonen kan ikke angres.",
      ...
      CONFIRMATION_DIALOG: {
         ...
         ERROR: "Det oppstod en feil under utføring av handlingen. Prøv igjen senere.",
      ...
      UPLOAD_VERSION: {
         ...
         PROGRESS_BAR_TITLE: "Laster opp ny versjon (${uploaded} av ${total} fullført)",
         CANCEL_UPLOAD: "Avbryt opplasting"
      },
      OPEN_BY_ID_ERROR: {
         DEFAULT: "Det oppstod en feil under forsøk på å få tilgang til filen. Prøv igjen senere.",
         UNAUTHENTICATED: "Sesjonen er tidsavbrutt. Du må logge på igjen før du kan vise filen.",
         ...
         ACCESS_DENIED: "Du har ikke tillatelse til å vise denne filen. Filen er ikke delt med deg.",
         ACCESS_DENIED_ANON: "Du har ikke tillatelse til å vise denne filen. Hvis dette er din fil eller den er delt med deg, må du logge deg på først."
      },
      ...
      LOST_AUTHENTICATION_DIALOG: {
        DIALOG_TITLE: "Bekreft",
        PROMPT: "HCL Connections-sesjonen er tidsavbrutt.${lineBreaks}Klikk på OK hvis du vil logge på igjen, eller på Avbryt hvis du vil lukke denne dialogboksen.",
        OK: "OK",
        CANCEL: "Avbryt"
      },
      ERROR_VALIDATING_FILES_FILE: {
        DIALOG_TITLE: "Ingen tilgang til kobling",
        PROMPT: "Noe gikk galt ved tilgang til koblingen.${lineBreaks}Klikk på OK for å bli omdirigert til siden.",
        OK: "OK",
        CANCEL: "Avbryt"
      },
      LOAD_ERROR: {
         DEFAULT: "Ops. Det oppstod en feil ved tilgang til koblingen.",
