...
return {depends: [["provide", "dojox.layout.dnd.PlottedDnd"],
["require", "dojo.dnd.Source"],
["require", "dojo.dnd.Manager"],
["require", "dojox.layout.dnd.Avatar"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.layout.dnd.PlottedDnd"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
