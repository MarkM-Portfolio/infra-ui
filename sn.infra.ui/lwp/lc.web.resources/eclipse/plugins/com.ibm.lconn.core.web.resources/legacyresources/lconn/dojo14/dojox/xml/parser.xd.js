...
return {depends: [["provide", "dojox.xml.parser"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xml.parser"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
