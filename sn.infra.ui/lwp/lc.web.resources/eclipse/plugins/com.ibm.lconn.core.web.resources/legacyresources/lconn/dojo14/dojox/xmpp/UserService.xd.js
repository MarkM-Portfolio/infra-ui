...
return {depends: [["provide", "dojox.xmpp.UserService"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xmpp.UserService"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
