define({
  ...
  // NLS_CHARSET=UTF-8
		   ...
		   "rs_jumpPageLabel" : "Ir para Página",
		   ...
		   'rs_docpicker_label' : "Link para Arquivos",
		   // '{0}' is a filename
		   'rs_docpicker_download_title' : "Fazer Download de ${0}",
		   'rs_docpicker_viewdetails_text' : "Visualizar Detalhes",
		   // '{0}' is a filename
		   ...
		   'rs_mobileBanner_view' : 'Visualização',
		   ...
		   'rs_vmvisitor'	 : "Visitante",
			...
			'rs_commpicker_logo_alt' : 'Clique aqui para copiar essa comunidade',
			'rs_commpicker' : ''
