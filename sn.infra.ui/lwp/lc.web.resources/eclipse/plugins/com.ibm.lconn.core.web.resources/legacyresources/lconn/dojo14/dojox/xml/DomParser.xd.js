...
return {depends: [["provide", "dojox.xml.DomParser"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.xml.DomParser"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
