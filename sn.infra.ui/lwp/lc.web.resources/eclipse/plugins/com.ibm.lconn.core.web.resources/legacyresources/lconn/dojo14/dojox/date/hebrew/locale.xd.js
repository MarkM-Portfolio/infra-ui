...
return {depends: [["provide", "dojox.date.hebrew.locale"],
["require", "dojox.date.hebrew.Date"],
["require", "dojox.date.hebrew.numerals"],
["require", "dojo.regexp"],
["require", "dojo.string"],
["require", "dojo.i18n"],
["requireLocalization", "dojo.cldr", "hebrew", null, "ROOT,ar,bg,de,el,fa,fi,fr,gsw,he,hu,iw,lv,nl,ru,sh,sr,sr-latn,sv,th,tr,uk", "ROOT,ar,bg,de,el,fa,fi,fr,gsw,he,hu,iw,lv,nl,ru,sh,sr,sr-latn,sv,th,tr,uk"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.hebrew.locale"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
