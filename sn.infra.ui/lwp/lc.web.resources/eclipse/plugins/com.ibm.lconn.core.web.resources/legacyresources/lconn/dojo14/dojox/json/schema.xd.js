...
return {depends: [["provide", "dojox.json.schema"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.schema"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
