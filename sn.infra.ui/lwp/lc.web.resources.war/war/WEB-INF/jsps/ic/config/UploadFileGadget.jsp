...
--%><% 
	...
	request.setAttribute("jsBundle", "com.ibm.social.sharebox.gadget.UploadFileBootstrap");
	request.setAttribute("cssBundles", java.util.Arrays.asList(
		...
		"/web/_style?include=com.ibm.lconn.core.styles/base/applications/files.css&version=oneui3{rtlTF}{etag}",
		"/web/_style?include=com.ibm.lconn.core.styles/base/applications/filepicker-lite.css&version=oneui3{rtlTF}{etag}"
		));
%>