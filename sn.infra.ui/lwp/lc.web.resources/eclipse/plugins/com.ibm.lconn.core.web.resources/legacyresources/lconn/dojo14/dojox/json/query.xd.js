...
return {depends: [["provide", "dojox.json.query"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.json.query"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
