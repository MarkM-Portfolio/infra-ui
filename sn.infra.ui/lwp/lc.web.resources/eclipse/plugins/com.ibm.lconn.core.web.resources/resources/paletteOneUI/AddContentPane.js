...
dojo.declare( // widget name and class
   ...
   [dijit._Widget, dijit._Templated, dijit._Container, dijit._Contained], // properties and methods
{
   ...
   templatePath: dojo.moduleUrl("lconn.core", "paletteOneUI/templates/AddContentPane.html"),
   ...
   postCreate: function() {
      ...
      this._contentArea = new lconn.core.paletteOneUI.PaletteContentPanel({
   ...
   setJsonData: function( /* String | Object */ jsonData) {
      ...
      this._jsonData = dojo.isString(jsonData) ? dojo.fromJson(jsonData) : jsonData;
   },
   ...
   populatePalette: function( /* Boolean */ isXhr) {
      ...
      deferred.addCallback(dojo.hitch(this, "_setupList"));
      deferred.addErrback(dojo.hitch(this, "_handleError"));
...
/*
   ...
   _loadList: function() {
      ...
      if (this._currentStore != null) {
         ...
         this._listWidget = new lconn.core.paletteOneUI.PaletteList({
            store: dataStore,
            query: {
               type: 'widgetCategory'
            },
   ...
   _updateContentArea: function() {
      ...
      if (catId != null) {
         this._currentStore.fetch({
            ...
            onComplete: function(items) {
               if (items.length == 1) {
                  dojo.publish("/lconn/core/palette/categorySelected", [items[0]]);
               } else {
   ...
   _registerDefaultLayoutImages: function() {
      ...
      var defaultUrl = dojo.moduleUrl("lconn.core.paletteOneUI", "images/primary_widget.png").toString();
   ...
   _populateContentArea: function( /* Boolean */ resetPager, /* String */ addedWidgetId) {
      ...
      if (this._contentAreaItems != null) {
         ...
         dojo.forEach(this._contentAreaItems, function(childItem) {
