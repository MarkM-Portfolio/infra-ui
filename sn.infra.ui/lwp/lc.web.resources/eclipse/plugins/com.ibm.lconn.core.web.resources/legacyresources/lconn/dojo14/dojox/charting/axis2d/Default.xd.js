...
return {depends: [["provide", "dojox.charting.axis2d.Default"],
...
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.charting.axis2d.Default"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
