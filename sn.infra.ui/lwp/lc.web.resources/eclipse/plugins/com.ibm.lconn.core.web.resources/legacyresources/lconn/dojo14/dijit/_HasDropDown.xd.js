...
return {depends: [["provide", "dijit._HasDropDown"],
["require", "dijit._base.place"],
["require", "dijit._Widget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._HasDropDown"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
