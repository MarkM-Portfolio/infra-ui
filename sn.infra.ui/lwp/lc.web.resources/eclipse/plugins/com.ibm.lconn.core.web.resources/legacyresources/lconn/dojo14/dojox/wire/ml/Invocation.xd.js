...
return {depends: [["provide", "dojox.wire.ml.Invocation"],
["require", "dojox.wire.ml.Action"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.ml.Invocation"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
