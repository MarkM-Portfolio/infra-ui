...
return {depends: [["provide", "dojox.grid.enhanced._Builder"],
["require", "dojox.grid._Builder"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.enhanced._Builder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
