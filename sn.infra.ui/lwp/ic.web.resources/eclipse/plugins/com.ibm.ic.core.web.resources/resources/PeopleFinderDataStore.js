...
], function(declare, lang, PeopleDataStore) {

   var PeopleFinderDataStore = declare("lconn.core.PeopleFinderDataStore", PeopleDataStore, {
      // {
      ...
      fetch : function(keywordArgs) {
         ...
         this.networkGet({
            ...
            load : lang.hitch(this, function(data) {
               ...
               cache[keywordArgs.query.toLowerCase()] = data.persons;
               if (keywordArgs.onComplete)
                  keywordArgs.onComplete(this.convertPeopleFinderResults(data.persons), keywordArgs);
            }),
