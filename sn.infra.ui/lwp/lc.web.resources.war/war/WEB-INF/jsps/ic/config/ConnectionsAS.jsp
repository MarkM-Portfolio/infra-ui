...
--%><%
	...
	request.setAttribute("jsBundle", "com.ibm.social.as.gadget.activityStreamGadgetModule");
	request.setAttribute("cssBundles", java.util.Arrays.asList(
		...
		"/web/_lconnappstyles/" + theme + "/activityStream.css?version=oneui3{rtlTF}{etag}",
		"/web/_lconnappstyles/" + theme + "/homepage.css?version=oneui3{rtlTF}{etag}",
		"/web/_style?include=com.ibm.social.as/gadget/css/gadgetOverride{rtl}.css{etag}"));
%>