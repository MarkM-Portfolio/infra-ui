...
ariaASViews: "Activity stream views",
...
ariaNewNotification : "New notification title. ${0}",
newNotifications: "${0} new notifications",
loadingNotifications: "Loading...",
noNewNotifications: "You haven't received any notifications in the past week.",
markRead: "Mark read",
markUnread: "Mark unread",
markAllRead: "Mark all read",
markAllReadDetails: "Click here to mark all notifications read.",
notificationPopupSingleGeneric: "You have 1 new notification",
notificationPopupGeneric: "You have ${0} new notifications"
}),
