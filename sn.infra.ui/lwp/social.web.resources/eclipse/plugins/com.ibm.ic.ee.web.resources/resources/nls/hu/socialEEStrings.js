		  	  ...
		  	  vote: {
		  		  INLINE: {
		  				...
		  				RECOMMENDED: {
		  					...
		  					TEXT: 		"<span class='lotusLikeDescription'>Szavazat</span> <span class='lotusDivider' role='presentation'>-</span> <a class='lotusLikeActions' role='button' aria-label='Voted - Undo' href='javascript:;' id='TOGGLE_${id}'>Visszavonás</a>",
