...
({
   ...
   network : {
      friendsInviteUpdatesDescription: "Recepţionaţi actualizări despre persoane pe care le urmăriţi pe pagina Acasaă şi într-un sumar e-mail.",
   ...
   file: {
      ...
      following: {
         ...
         title: "Comutaţi între a primii sau nu actualizări despre acest fişier"
      },
      share: {
         label: "Partajare",
      ...
      timestamp: {
         ...
         updatedOther: {
            ...
            TODAY: "${user} actualizat azi în ${time}",
            YEAR: "${user} actualizat pe ${MMM} ${d}, ${YYYY}",
            YESTERDAY: "${user} actualizat ieri la ${time}",
      ...
      about: {
         CREATE_TIMESTAMP: "${date_long} ${time_long} de către ${user}",
         UPDATE_TIMESTAMP: "${date_long} ${time_long} de către ${user}",
   ...
   ecm_draft: {
      ...
      review_required_any: "Proprietarii comunităţii cer ca un examinator să examineze această ciornă.",
      review_required_all: "Proprietarii comunităţii cer ca toţi examinatorii să examineze această ciornă.",
      review_required_generic: "Proprietarii comunităţii cre ca aceşti examinatori să examineze această ciornă.",
  	  ...
  	  vote: {
  		  INLINE: {
  				...
  				RECOMMENDED: {
  					...
  					TEXT: 		"<span class='lotusLikeDescription'>Votat</span> <span class='lotusDivider' role='presentation'>-</span> <a class='lotusLikeActions' role='button' aria-label='Votat - Anulare acţiune' href='javascript:;' id='TOGGLE_${id}'>Anulare acţiune</a>",
   ...
   REPLIES: {
      ...
      ERROR_CREATE: "Răspunsul dumneavoastră nu a putut fi salvat.  Încercaţi din nou mai târziu.",
   ...
   COMMENTS: {
      ...
      ADD_COMMENT: "Adăugaţi un comentariu",
      ...
      ERROR_CREATE: "Comentariul dumneavoastră nu a putut fi salvat.  Încercaţi din nou mai târziu.",
      ...
      ERROR_CREATE_CANCEL: "Comentariul dumneavoastră nu a putut fi salvat deoarece cererea a fost anulată.  Faceţi clic pe 'Postare' pentru a încerca din nou.",
      ...
      ERROR_DELETE: "Comentariul dumneavoastră nu a putut fi şters.  Încercaţi din nou mai târziu.",
      ...
      ERROR_DELETE_CANCEL: "Comentariul dumneavoastră nu a putut fi şters deoarece cererea a fost anulată.  Faceţi clic pe 'Ştergere' pentru a încerca din nou.",
      ...
      ERROR_EDIT: "Comentariul dumneavoastră nu a putut fi actualizat.  Încercaţi din nou mai târziu.",
      ...
      ERROR_EDIT_CANCEL: "Comentariul dumneavoastră nu a putut fi actualizat deoarece cererea a fost anulată.  Faceţi clic pe 'Postare' pentru a încerca din nou.",
      ...
      OK: "OK",
      YES: "Da",
      TRIM_LONG_COMMENT: "Scurtare comentariu?",
      ...
      SUBSCRIBE_TO_COMMENTS: "Subscrieţi la aceste comentarii",
      ...
      COMMENT_DELETED: {
         DAY: "Comentariu şters de ${user} în ${EEEE} la ${time}",
         MONTH: "Comentariu şters de ${user} în ${MMM} ${d}",
         TODAY: "Comentariu şters de ${user} azi la ${time}",
      ...
      FLAG_ITEM: {
         ...
         OK: "Salvare",
         ERROR_SAVING: "A fost o eroare la procesarea cererii. Încercaţi din nou mai târziu.",
   ...
   COMMENTS_SUBMITTED: {
      ...
      CONFIRM: "Comentariul dumneavoastră a fost trimis pentru examinare şi va fi disponibil când va fi aprobat.",
      OK: "OK"
   },
   ...
   VERSIONS: {
      ...
      INFO: "Versiune ${0} creată de ${1} ",
      VERSION_NUMBER: "Versiunea ${0}",
      DELETED: "Şters",
      ...
      REVERT_DESCRIPTION: "Restaurat de la versiunea ${0}",
      PREVIOUS: "Anterior",
      PREVIOUS_TOOLTIP: "Pagină anterioară",
      ELLIPSIS: "...",
      NEXT: "Următor",
      NEXT_TOOLTIP: "Următoarea pagină",
      COUNT: "${0}-${1} din ${2}",
      COUNT_SHORT: "${0} - ${1}",
      PAGE: "Pagină",
      SHOW: "Afişare",
      ...
      CONTENT: {
         ...
         REVERT: {
            A11Y: "Acestr buton deschide un dialog ce permite utilizatorului să confirme restaurarea unui fişier dintr-o versiune anterioară. Confirmarea acestei acţiuni va rezulta într-o reîmprospătare a conţinuturilor de pe pagină.",
            FULL: "Restaurare",
      ...
      DELETE: {
         ...
         ERROR_ACCESS_DENIED: "Această versiune nu a putut fi ştearsă deoarece nu sunteţi un editor.",
         ...
         ERROR_NOT_LOGGED_IN: "Trebuie să fiţi logat pentru a şterge această versiune.  Faceţi clic pe 'Ştergere' pentru a  fi promptat să vă logaţi.",
         ...
         FULL: "Ştergere",
         A11Y: "Acest buton deschide un dialog ce permite utilizatorului să confirme ştergerea acestei versiuni. Confirmarea acestei acţiuni va rezulta într-o reîmprospătare a conţinuturilor de pe pagină."
      },
      ...
      REVERT: {
         ...
         ERROR_MAX_CONTENT_SIZE: "Versiunea nu a putut fi restaurată deoarece este mai mare decât dimensiunea maximă de fişier de ${0}",
   ...
   DOWNLOAD_INFO: {
      ...
      FILE: {
         V_LATEST: "Aţi descărcat cea mai recentă versiune a acestui fişier",
   ...
   FILE_SHARE_INFO: {
      ...
      SELF_REFERENCE_ERROR: "Nu puteţi să partajaţi cu dumneavoastră.",
      ...
      TRIM_LONG_MESSAGE: "Scurtare mesaj?",
