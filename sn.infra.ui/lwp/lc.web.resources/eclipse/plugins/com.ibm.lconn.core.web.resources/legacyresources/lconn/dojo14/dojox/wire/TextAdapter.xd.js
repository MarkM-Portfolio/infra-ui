...
return {depends: [["provide", "dojox.wire.TextAdapter"],
["require", "dojox.wire.CompositeWire"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.wire.TextAdapter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
