...
return {depends: [["provide", "dojo.back"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.back"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
