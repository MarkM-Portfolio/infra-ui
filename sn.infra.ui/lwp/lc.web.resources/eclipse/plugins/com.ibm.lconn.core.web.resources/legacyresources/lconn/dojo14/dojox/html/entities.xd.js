...
return {depends: [["provide", "dojox.html.entities"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.html.entities"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
