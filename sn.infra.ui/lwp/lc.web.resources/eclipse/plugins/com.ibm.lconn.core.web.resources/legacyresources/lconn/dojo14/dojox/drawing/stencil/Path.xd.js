...
return {depends: [["provide", "dojox.drawing.stencil.Path"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.drawing.stencil.Path"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
