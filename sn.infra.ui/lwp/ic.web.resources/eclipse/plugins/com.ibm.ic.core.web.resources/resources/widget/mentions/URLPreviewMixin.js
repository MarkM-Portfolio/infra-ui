...
define([
...
], function (declare, has, topic, MentionsNode, URLMentionsNode) {
    ...
    *
    * @mixin ic-core.widget.mentions.URLPreviewMixin
    * @author Claudio Procida <procidac@ie.ibm.com>
    */
   var URLPreviewMixin = declare("lconn.core.widget.mentions.URLPreviewMixin", null, /** @lends ic-core.widget.mentions.URLPreviewMixin.prototype */
   {
      /**
       ...
       * @fires ic-core/mentions/url/entered
       */
            ...
            if (curString) {
               ...
               if (matches && matches.length > 0) {
                  ...
                  for (i = 0; i < matches.length; i++) {
                     ...
                     urlMentionsNode = new URLMentionsNode({
                        idx : this._idx
                     }, span.id);
                  ...
                  for (i = 0; i < matches.length; i++) {
                     topic.publish("ic-core/mentions/url/entered", {
                        url : matches[i],
                        mentionsHelper : this
                     });
                  }
