...
return {depends: [["provide", "dijit._base.scroll"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dijit._base.scroll"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
