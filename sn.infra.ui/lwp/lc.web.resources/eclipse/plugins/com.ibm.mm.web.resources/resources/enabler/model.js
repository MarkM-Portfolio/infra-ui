...
//dojo.//require( "com.ibm.mashups.enabler.model" ); //FIXME: Not provided with this distribution?
...
dojo.requireLocalization( "com.ibm.mm.enabler","modelMessages", null, "en,ROOT", "en,ROOT", "en,ROOT", "en,ROOT" , "");
...
// deferred find
dojo.declare( "com.ibm.mm.enabler.DeferredFindImpl", com.ibm.mm.enabler.DeferredImpl,
    {
...
// deferred getParent
dojo.declare( "com.ibm.mm.enabler.DeferredGetParentImpl", com.ibm.mm.enabler.DeferredImpl,
    {
        constructor:function (model, uri) {
        this.model = model;
        this.uri = uri;
...
// deferred getRoot
dojo.declare( "com.ibm.mm.enabler.DeferredGetRootImpl", com.ibm.mm.enabler.DeferredImpl,
    {
...
dojo.declare( "com.ibm.mm.enabler.DeferredGetSharedRootImpl", com.ibm.mm.enabler.DeferredImpl,
    {
        constructor:function (model) {
            this.model = model;
        },
...
// deferred commit
dojo.declare( "com.ibm.mm.enabler.DeferredCommitImpl", [com.ibm.mashups.enabler.DeferredOperation, com.ibm.mm.enabler.DeferredImpl],
    {
        constructor:function (model) {
            this.model = model;
...
dojo.declare( "com.ibm.mm.enabler.IdentifiableImpl", com.ibm.mashups.enabler.Identifiable,
    {
        ...
        getID: function() {
            var result = null;
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(this.ATOM_ID, this.xmlData, this.ns );
...
dojo.declare( "com.ibm.mm.enabler.LocalizedImpl", com.ibm.mashups.enabler.Localized,
    {
        constructor:function (node) {
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.li_ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL, nsf.NS_BASE, nsf.NS_XML]);
        ...
        getLocales: function() {
            var result = [];
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(this.NLS_TITLE, this.xmlData, this.li_ns);
            if (nodes) {
                var i = nodes.length;
                if (nodes.length > 0) {
                    while (--i >= 0) {
        ...
        getTitle: function(locale) {
            var result = null;
            locale.replace(/-/g, "_");
            var titles = com.ibm.mm.enabler.xpath.evaluateXPath(this.NLS_TITLE, this.xmlData, this.li_ns);
            // iterate the localized titles (selecting the correct title via xpath doesnt seem to work)
            var i = titles.length;
            while (--i >= 0) {
        ...
        getDescription: function(locale) {
            var result = null;
            locale.replace(/-/g, "_");
            var descriptions = com.ibm.mm.enabler.xpath.evaluateXPath(this.NLS_DESCRIPTION, this.xmlData, this.li_ns);
            // iterate the localized titles (selecting the correct title via xpath doesnt seem to work)
        ...
        setTitle: function(title, locale) {
            ...
            // create locale
            if (!localeExists) {
                var titleBase = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/*/model:title", this.xmlData, this.li_ns);
                if (titleBase && titleBase.length>0) {
                    ...
                    throw new Error(dojo.string.substitute(me.modelMessages.E_ELEMENT_NOT_FOUND_2, ["atom:content/*/model:title", this.toString()]));
                }
            }
        },
        ...
        setDescription: function(descr, locale) {
            ...
            // create locale
            if (!localeExists) {
                var descriptionBase = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/*/model:description", this.xmlData, this.li_ns);
...
// iterator
dojo.declare( "com.ibm.mm.enabler.catalog.CatalogCategoryIteratorImpl", com.ibm.mm.enabler.DeferredIteratorImpl,
    {
        constructor:function (parentNode, model, baseUrl) {
            ...
            this._size = 9999; // assume a high size until we know the real size
...
// catalog entry model
dojo.declare( "com.ibm.mm.enabler.model.CatalogEntryModelImpl", [com.ibm.mashups.enabler.model.CatalogEntryModel, com.ibm.mashups.enabler.ListModel, com.ibm.mm.enabler.DeferredIteratorImpl],
    {
        constructor:function (category, parentModel, baseUrl) {
            ...
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.cemi_ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL, nsf.NS_APP]);
            this.cid = 0;
            if ((typeof(baseUrl)!= "undefined") && (baseUrl !== null)) {
                this.url = baseUrl + this.url;
            }
        ...
        _find: function (uri, deferred, sync) {
            ...
            if (uri in this.loadedNodes) {
                ...
                // prepare xhr
                var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                myUrl.addParameter("uri", "catalog:" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(uri) + "@" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(this.category.getID()));
                myUrl.addParameter("rep", "full");
                var serviceReq = new com.ibm.mm.enabler.services.ModelRestServiceRequest(myUrl, null, null, false, sync);
                var entry = null;
                var me = this;
                ...
                serviceReq.read(
                    function(type, data, xhr, args) {
                        // obtain node
                        var expr = "atom:feed/atom:entry";
                        var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, data, me.cemi_ns);
                        if (nodes && nodes.length > 0) {
                        ...
                        if (sync && type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                            // do not expose HTTP_NOT_FOUND; simply return null in this case
                ...
                if (result.status) {
                    throw new Error(dojo.string.substitute(me.modelMessages.E_CATNODE_NOTFOUND_1, [uri, result.status]));
                }
            }
        ...
        _loadAhead: function(deferred, sync) {
            ...
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
            myUrl.addParameter("uri", "catalog:collection@" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(this.category.getID()));
            myUrl.addParameter("rep", "full");
            if (this.strategy) {
            ...
            serviceReq.read(
                function (type, data, xhr, args) {
                    if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
                        ...
                        var count = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/app:collection", data, me.cemi_ns);
                        if (count && count.length>0) {
                            me.length = count[0].getAttribute("thr:count");
                        }
                        var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/atom:entry", data, me.cemi_ns);
                        if (nodes) {
        ...
        _commit: function (deferred, sync) {
            ...
            for (id in this.loadedNodes) {
                var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
                var entry = com.ibm.mm.enabler.model.Utils.createFeed("catalog:" + id,
                    "HCL Lotus Mashups Catalog Feed",
                    this.loadedNodes[id],
                    nsf.getNameSpaces([nsf.NS_ATOM]));
                myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);

                if (id in this.createdNodes) {
                    // handle created nodes
                    urlId = "collection@" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(this.category.getID());
                        ...
                        function (type, data, xhr, args) {
                            if (deferred) {
                                ...
                                if (deferred.operationCallback) {
                                    deferred.operationCallback(me.loadedNodes[id], com.ibm.mashups.enabler.DeferredOperation.OPERATION_CREATE, xhr.status, deferred.operationCallbackParameters);
                                }
                                // internal callback handling
                                if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                    if (deferred.errorCallback) {
                    ...
                    urlId = com.ibm.mm.enabler.utilities.encodeModelID4Uri(node.getID()) + "@" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(this.category.getID());
                    myUrl.addParameter("uri", "catalog:" + urlId);
            ...
            for (id in this.deletedNodes) {
                myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                myUrl.addParameter("uri", "catalog:" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(id) + "@" + "id:"+com.ibm.mm.enabler.utilities.encodeModelID4Uri(this.category.getID()));
                ...
                serviceReq.remove(
                    function (type, data, xhr, args) {
                        if (deferred) {
                            // public callback handling
                            if (deferred.operationCallback) {
                                deferred.operationCallback(id, com.ibm.mashups.enabler.DeferredOperation.OPERATION_CREATE, xhr.status, deferred.operationCallbackParameters);
                            }
                            if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                if (deferred.errorCallback) {
                                    deferred.errorCallback(xhr.status, deferred.errorCallbackParameters);
...
dojo.declare( "com.ibm.mm.enabler.model.CatalogCategoryModelImpl", com.ibm.mashups.enabler.model.CatalogCategoryModel,
    {
        constructor:function (baseUrl) {
            ...
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL]);
            if ((typeof(baseUrl)!= "undefined") && (baseUrl !== null)) {
                this.url = baseUrl + this.url;
        ...
        _find: function (uri, deferred, sync) {
            ...
            if (uri in this.loadedNodes) {
                ...
                myUrl.addParameter("uri", "catalog:" + com.ibm.mm.enabler.utilities.encodeModelID4Uri(uri));
                myUrl.addParameter("rep", "full");
                var serviceReq = new com.ibm.mm.enabler.services.ModelRestServiceRequest(myUrl, null, null, false, sync);
                var entry = null;
                var me = this;
                ...
                if (result.status) {
                    throw new Error(dojo.string.substitute(me.modelMessages.E_CCATNODE_NOTFOUND_1, [uri, result.status]));
                }
        ...
        _commit: function (deferred, sync) {
                    ...
                    serviceReq.update(entry,
                        function (type, data, xhr, args) {
                            if (deferred) {
                                // public callback handling
                                if (deferred.operationCallback) {
                                    deferred.operationCallback(me.loadedNodes[id], com.ibm.mashups.enabler.DeferredOperation.OPERATION_MODIFY, xhr.status, deferred.operationCallbackParameters);
                                }
                                // internal callback handling
                                if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                    if (deferred.errorCallback) {
                ...
                serviceReq.remove(
                    function (type, data, xhr, args) {
                        if (deferred) {
                            // public callback handling
                            if (deferred.operationCallback) {
                                deferred.operationCallback(id, com.ibm.mashups.enabler.DeferredOperation.OPERATION_DELETE, xhr.status, deferred.operationCallbackParameters);
                            }
                            // internal callback handling
                            if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                if (deferred.errorCallback) {
            ...
            // the finishedCallback must trigger only after releasing the initial 'acquire'
...
dojo.declare( "com.ibm.mm.enabler.catalog.CatalogCategoryNodeImpl", [com.ibm.mashups.enabler.catalog.CatalogCategoryNode, com.ibm.mm.enabler.IdentifiableImpl, com.ibm.mm.enabler.LocalizedImpl],
    {
        constructor:function (node) {
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL, nsf.NS_BASE, nsf.NS_XML]);
            this.xmlData = node;
...
dojo.declare( "com.ibm.mm.enabler.catalog.CatalogEntryNodeImpl", [com.ibm.mm.enabler.IdentifiableImpl, com.ibm.mm.enabler.LocalizedImpl],
 {
    constructor:function (node) {
        this.xmlData = node;
		var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
		this.ceni_ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_XML, nsf.NS_MODEL, nsf.NS_BASE]);
    },

        // still to be supported? may use getParent(node) instead...
        getCategory: function() {
            var expr = "atom:category";
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ceni_ns );
            var result = null;
            if (nodes && nodes.length > 0) {
        ...
        getMetadata: function(name) {
            ...
            if ((nodes === null) || (nodes.length <= 0)) {
                ...
                nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ceni_ns );
        ...
        setMetadata: function(name, value) {
            ...
            if (nodes && nodes.length > 0) {
                ...
                var content = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content", this.xmlData, this.ceni_ns );
...
dojo.declare("com.ibm.mm.enabler.navigation.NavigationModelIteratorImpl", [com.ibm.mashups.enabler.Iterator, com.ibm.mm.enabler.DeferredIteratorImpl],
    {
        constructor:function (parentNode, model, baseUrl) {
            this.parentNode = parentNode;
            this.model = model;
            ...
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_APP, nsf.NS_MODEL, nsf.NS_THR]);
            if ((typeof(baseUrl)!= "undefined") && (baseUrl !== null)) {
                this.url = baseUrl + this.url;
            }
        },
        ...
        _loadAhead: function(uri, deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.navigation.NavigationModelIteratorImpl._loadAhead", sync ? "sync" : "async");
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
            myUrl.addParameter("uri", "nm:" + "id:"+uri);
            myUrl.addParameter("levels", "2");
            if (this.strategy) {
                // assumes the first node is the addressed node itself and sets start to cursor+1
            ...
            serviceReq.read(
                function ( type, data, xhr, args ) {
                    if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
                        // info on retrieved chunk
                        me.startElem = me.getCursorPosition();
                        var count = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/app:collection", data, me.ns);
                        if (count && count.length>0) {
                            me.size = count[0].getAttribute("thr:count")-1; // node itself does not count towards children
                        }
                        // navigation node entries
                        var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/atom:entry/thr:in-reply-to[@ref='nm:" + "id:"+uri + "']/..", data, me.ns);
                        if (nodes) {
                            me.num = nodes.length;
                            for (var i=0; i<nodes.length; i++) {
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.navigation.NavigationModelIteratorImpl._loadAhead");
        }
    }
);

// navigation model
dojo.declare("com.ibm.mm.enabler.model.NavigationModelImpl", com.ibm.mashups.enabler.model.NavigationModel,
    {
        constructor:function (baseUrl) {
            this.root = null;
            ...
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_THR, nsf.NS_MODEL, nsf.NS_BASE, nsf.NS_XML, nsf.NS_PORTAL]);
        ...
        hasChildren: function (node) {
            ...
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:link[@rel='replies']", this.loadedNodes[nodeID].xmlData, this.ns );
            if (nodes && nodes.length > 0) {
        ...
        _getParent: function (nodeId, deferred, sync) {
            ...
            if (node !== null) {
                ...
                var refs = com.ibm.mm.enabler.xpath.evaluateXPath("thr:in-reply-to[@ref]", node.xmlData, this.ns);
        ...
        _setParent: function(node, parentNode) {
            if (node !== null && parentNode !== null) {
                var thr = com.ibm.mm.enabler.xpath.evaluateXPath("thr:in-reply-to", node.xmlData, this.ns);
                if (thr && thr.length > 0) {
        ...
        _setNext: function(node, nextNode) {
            if (node !== null) {
                var next = com.ibm.mm.enabler.xpath.evaluateXPath("atom:link[@rel='next']", node.xmlData, this.ns);
        ...
        _commit: function (deferred, sync) {
            ...
            for (id in this.loadedNodes) {
    			...
    			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
                if (id in this.createdNodes) {
                    var entry = com.ibm.mm.enabler.model.Utils.createFeed("nm:cid:" + id,
                        "HCL Lotus Mashups Navigation Feed",
                        this.loadedNodes[id],
                        nsf.getNameSpaces([nsf.NS_XHTML, nsf.NS_ATOM, nsf.NS_APP, nsf.NS_THR, nsf.NS_BASE, nsf.NS_MODEL, nsf.NS_NM]));
                    // HTTP POST created nodes
                    ...
                    serviceReq.create(entry,
                        function (type, data, xhr, args) {
                            ...
                            if (nodes) {
                                ...
                                var navNode = com.ibm.mm.enabler.xpath.evaluateXPath(navNodeExpr, nodes[0], me.ns);
                            ...
                            if (deferred) {
                                // public callback handling
                                if (deferred.operationCallback) {
                                    deferred.operationCallback(node, com.ibm.mashups.enabler.DeferredOperation.OPERATION_CREATE, xhr.status, deferred.operationCallbackParameters);
                                }
                                // internal callback handling
                                if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
                                    if (deferred.finishedCallback) {
                    ...
                    var entry = com.ibm.mm.enabler.model.Utils.createFeed("nm:id:" + id,
                        "HCL Lotus Mashups Navigation Feed",
                        this.loadedNodes[id],
                        nsf.getNameSpaces([nsf.NS_XHTML, nsf.NS_ATOM, nsf.NS_APP, nsf.NS_THR, nsf.NS_BASE, nsf.NS_MODEL, nsf.NS_NM]));
        ...
        _find: function (uri, deferred, sync) {
            ...
            serviceReq.read(
                function (type, data, xhr, args) {
                    ...
                    if (nodes) {
                        ...
                        throw new Error(dojo.string.substitute(me.modelMessages.E_LOAD_NAVNODE_1,[uri]));
                    }
                    // handle error in sync call
                    if (sync && type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                        // do not expose HTTP_NOT_FOUND; simply return null in this case
            ...
            if (result.status) {
                throw new Error(dojo.string.substitute(me.modelMessages.E_NAVNODE_NOTFOUND_1, [uri, result.status]));
            }
...
// layout model
dojo.declare( "com.ibm.mm.enabler.model.LayoutModelImpl", com.ibm.mashups.enabler.model.LayoutModel,
    {
        constructor:function (uri, baseUrl) {
			...
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_THR, nsf.NS_MODEL]);
            this.modelMessages = dojo.i18n.getLocalization("com.ibm.mm.enabler", "modelMessages");
            if ((typeof(baseUrl)!= "undefined") && (baseUrl !== null)) {
                this.url = baseUrl + this.url;
                this.baseUrl = baseUrl;
            ...
            serviceReq.read(
                function ( type, data, xhr, args ) {
                    if (type==com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
                        var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/atom:entry", data, me.ns );
                        if (nodes && nodes.length > 0) {
                            me.root = new com.ibm.mm.enabler.layout.LayoutFragmentImpl(nodes[0], this.baseUrl);

                            var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:feed/atom:entry/atom:link[@model:rel='media']", data, me.ns);
            ...
            if (this.root !== null) {
                ...
                if (!fragmentMediaLink) {
                    ...
                    myUrl2 = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                    myUrl2.addParameter("uri", fragmentMediaLink);
                } else {
                    myUrl2 = new com.ibm.mm.enabler.utilities.HttpUrl(fragmentMediaLink);
                }

                var serviceReq2 = new com.ibm.mm.enabler.services.ModelRestServiceRequest( myUrl2, null, null, true, true );
                var saveRoot = this.root;
                serviceReq2.read(
                    function ( type2, data2, xhr2, args2 ) {
                        if (type2==com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
                            if (saveRoot) {
        ...
        _commit: function (deferred, sync, parentModel) {
            ...
            if (this.root) {
    			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
                var entry = com.ibm.mm.enabler.model.Utils.createFeed("fragment:id:" + this.uri,
                    "HCL Lotus Mashups Fragment Feed",
                    this.root.toString(),
                    nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_XHTML, nsf.NS_MODEL, nsf.NS_XSI]));
                // prepare xhr
                var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                myUrl.addParameter("uri", "fragment:" + "id:"+this.uri);
                var serviceReq = new com.ibm.mm.enabler.services.ModelRestServiceRequest(myUrl, null, null, false, sync);
                var myUrl2 = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                myUrl2.addParameter("uri", "fragment-media:" + "id:"+this.uri + "/index.html");
                var serviceReq2 = new com.ibm.mm.enabler.services.ModelRestServiceRequest(myUrl2, null, null, false, sync);
                    ...
                    serviceReq.create(entry,
                        function (type, data, xhr, args) {
                            ...
                            if (deferred) {
                                // public callback handling
                                if (deferred.operationCallback) {
                                    deferred.operationCallback(this.root, com.ibm.mashups.enabler.DeferredOperation.OPERATION_CREATE, xhr.status, deferred.operationCallbackParameters);
                                }
                                // internal callback handling
                                if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                    if (deferred.errorCallback) {
	                    ...
	                    serviceReq.update(entry,
    	                    function (type, data, xhr, args) {
            	                ...
            	                if (deferred) {
                                    // public callback handling
                                    if (deferred.operationCallback) {
                                        deferred.operationCallback(this.root, com.ibm.mashups.enabler.DeferredOperation.OPERATION_MODIFY, xhr.status, deferred.operationCallbackParameters);
                                    }
                                    // internal callback handling
                	                if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                    	if (deferred.errorCallback) {
...
// meta data
dojo.declare( "com.ibm.mm.enabler.MetaDataImpl", com.ibm.mashups.enabler.MetaData,
    {
        constructor:function (node) {
            // TODO: handle the case where a node object instead of xml data is passed in
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.mdi_ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL]);
            this.metadata = {};
        },
        ...
        getMetaDataNames: function() {
            ...
            var md = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:metadata[@name]", this.xmlData, this.mdi_ns);
            if (md) {
        ...
        getMetaData: function(name) {
            ...
            result = null;
            var md = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/*/model:metadata[@name='" + name + "']/model:value", this.xmlData, this.mdi_ns);
            if (md && md.length > 0) {
        ...
        setMetaData: function(name, value) {
            ...
            return;
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/*/model:metadata",this.xmlData, this.mdi_ns);
            if (nodes && nodes.length > 0) {
                com.ibm.mm.enabler.dom.textContent(nodes[0],value);
            } else {
				var mdBase = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/*", this.xmlData, this.mdi_ns);
...
// navigation node
dojo.declare( "com.ibm.mm.enabler.navigation.NavigationNodeImpl", [com.ibm.mashups.enabler.navigation.NavigationNode, com.ibm.mm.enabler.IdentifiableImpl, com.ibm.mm.enabler.LocalizedImpl, com.ibm.mm.enabler.MetaDataImpl],
    {
        constructor:function (node) {
            this.xmlData = node;
        },
        ...
        getTheme: function() {
            var result = null;
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:link[@rel='theme']", this.xmlData, this.ns );
            if (nodes && nodes.length > 0) {
        ...
        getCommunity: function() {
            var result = null;
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:link[@rel='community']", this.xmlData, this.ns );
            if (nodes && nodes.length > 0) {
                result = nodes[0].getAttribute("title");
                //return "id:"+result;
                return result;
...
// layout node
dojo.declare( "com.ibm.mm.enabler.layout.LayoutNodeImpl", [com.ibm.mashups.enabler.layout.LayoutNode, com.ibm.mm.enabler.IdentifiableImpl],
    {
        constructor:function (node) {
            this.xmlData = node;
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL, nsf.NS_BASE, nsf.NS_XSI, nsf.NS_XML]);
        },
        ...
        getMetadataNames: function() {
            ...
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns );
        ...
        getMetaData: function(name) {
            ...
            if ((nodes === null) || (nodes.length <= 0)) {
                ...
                nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns );
                return (nodes && nodes.length > 0) ? com.ibm.mm.enabler.dom.textContent(nodes[0]) : null;
            }
        ...
        setMetaData: function(name, value) {
            var result = null;
            var content = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content", this.xmlData, this.ns );
            var fragment= null;

            if (content && content.length > 0) {
                var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:fragment", this.xmlData, this.ns );
                ...
                var metadata = null;
                nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:fragment/model:metadata[@name='" + name + "']", this.xmlData, this.ns );
                ...
                var valueNode = null;
                nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:fragment/model:metadata[@name='" + name + "']/model:value", this.xmlData, this.ns );
...
//layout fragment
dojo.declare( "com.ibm.mm.enabler.layout.LayoutFragmentImpl", [com.ibm.mm.enabler.layout.LayoutNodeImpl, com.ibm.mm.enabler.LocalizedImpl],
    {
        constructor:function () {
            this.fragment = "";
        },
...
//// preference model
//dojo.declare("com.ibm.mm.enabler.model.PreferenceModelImpl", com.ibm.mashups.enabler.model.PreferenceModel,
//    {
...
//                        "model": "http://www.ibm.com/xmlns/prod/lotus/mashups/v1.0/preference-model",
...
//            return new com.ibm.mm.enabler.model.PreferenceSetModelImpl(node, baseUrl);
//        },
//
...
//                var parent = com.ibm.mm.enabler.xpath.evaluateXPath("thr:in-reply-to[@ref]", current.xmlData, this.ns);
...
//            var aggregation = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:entry", this.ns.atom);
//            var content = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:content", this.ns.atom);
//            var preferenceSet = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-set", this.ns.model);
//            preferenceSet.setAttribute("level", node.getLevel());
//            aggregation.appendChild(content);
//            content.appendChild(preferenceSet);
//
//            // inject all the existing preference levels, starting with topmost level
//            var source;
//            for (var j=levels.length; j>0; j--) {
//                // beginning at topmost tag <model:preference-set>
//                if (callbackObject) {
//                    source = this._createPreferenceSetFromItems(callbackObject._preLevelItemsHook(levels[j-1].getLevel()));
//                    if (source) {
//                        this._merge(source.firstChild, preferenceSet);
//                    }
//                }
//                source = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:preference-set", levels[j-1].xmlData, this.ns);
...
//            var aggregationPS = new com.ibm.mm.enabler.preference.PreferenceSetImpl(aggregation);
//            return new com.ibm.mm.enabler.model.PreferenceSetModelImpl(aggregationPS, basUrl);
//        },
//
...
//            var value;
//            var xmlDom = com.ibm.mm.enabler.dom.createDocument();
//            var prefSet = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-set" , this.ns.model);
//            var entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-entry" , this.ns.model);
//            for (name in items) {
//                var item = items[name];
//                entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-entry" , this.ns.model);
//                entry.setAttribute("name", name);
//                entry.setAttribute("read-only", "" + item.readOnly);
//                prefSet.appendChild(entry);
//                value = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-value", this.ns.model);
...
//                        result = com.ibm.mm.enabler.xpath.evaluateXPath(tag + "[@name='" + name +  "']", targetXml, this.ns);
...
//                        result = com.ibm.mm.enabler.xpath.evaluateXPath(tag, targetXml, this.ns);
//                        if (result && result.length>0) {
//                            target = result[0];
//                        } else {
//                            entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-set" , this.ns.model);
//                            targetXml.appendChild(entry);
//                            target = entry;
//                        }
//                        this._merge(sourceXml.firstChild, target);
...
//                        result = com.ibm.mm.enabler.xpath.evaluateXPath(tag + "[@value='" + value +  "']", targetXml, this.ns);
//                        if (!(result && result.length > 0)) {
//                            entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-value", this.ns.model);
...
//
//        _getParent: function (node, deferred, sync) {
//            var id = (node instanceof com.ibm.mm.enabler.preference.PreferenceSetImpl) ? node.getID() : node;
//            var resolved = this._load(id, null, true); // deleted nodes are resolved to null in _load()
//            if (resolved) {
//                var reply = com.ibm.mm.enabler.xpath.evaluateXPath("thr:in-reply-to[@ref]", resolved.xmlData, this.ns);
//                var parent = null;
...
//            } else {
//                throw new Error(dojo.string.substitute(this.modelMessages.E_NODE_NOTFOUND_1,[id]));
//            }
//        },
//
...
//                            var i = nodes.length;
//                            while (i-->0) {
//                                var currentId = com.ibm.mm.enabler.xpath.evaluateXPath("atom:id", nodes[i], me.ns);
//                                if (currentId) {
...
//                                    }
//                                    me.loadedNodes[currentUri] = new com.ibm.mm.enabler.PreferenceSetImpl(nodes[i]);
//                                }
//                            }
//
//                            // handle callback
...
//                                 if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
//                                if (deferred && deferred.errorCallback) {
//                                    deferred.errorCallback(me.loadedNodes[id], deferred.errorCallbackParameters);
//                                }
//                            }
//                        }
//                    );
...
//        create: function (context) {
//            var xmlDom = com.ibm.mm.enabler.dom.createDocument();
//            var entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:entry" , this.ns.atom);
//            var id = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:id" , this.ns.atom);
//            com.ibm.mm.enabler.dom.textContent(id, "pref:" + context.id);
//            var title = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:title" , this.ns.atom);
//            com.ibm.mm.enabler.dom.textContent(title, "Preference Entry");
//            var updated = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:updated" , this.ns.atom);
//            var time = new Date();
//            com.ibm.mm.enabler.dom.textContent(updated, time.toGMTString());
//            var content = com.ibm.mm.enabler.dom.createElement(xmlDom, "atom:content" , this.ns.atom);
...
//            entry.appendChild(updated);
//            entry.appendChild(content);
//            var ps = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-set" , this.ns.model);
...
//                // parent
//                var xmlDom = com.ibm.mm.enabler.dom.createDocument();
//                var inreplyto = com.ibm.mm.enabler.dom.createElement(xmlDom, "thr:in-reply-to" , this.ns.thr);
...
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, node.xmlData, this.ns);
//            if (nodes && nodes.length>0) {
...
//dojo.declare("com.ibm.mm.enabler.model.PreferenceSetModelImpl", [com.ibm.mashups.enabler.model.PreferenceSetModel, com.ibm.mm.enabler.DeferredIteratorImpl],
//    {
...
//            var result = null;
//            var expr = "atom:content/model:preference-set/model:preference-entry[@name='" + name + "']";
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns);
//            if (nodes && nodes.length>0) {
//                var set = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set", nodes[0], this.ns);
//                if (set && set.length>0) {
//                    result = new com.ibm.mm.enabler.preference.PreferenceSetNodeImpl(nodes[0], name);
//                } else {
//                    result = new com.ibm.mm.enabler.preference.PreferenceNodeImpl(nodes[0], name);
//                }
//            }
//            return result;
//        },
...
//                if (context.name) {
//                    node = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-entry" , this.ns.model);
//                    node.setAttribute("name", context.name);
//                    // create set if applicable
//                    if (context.type) {
//                        if (context.type == "PreferenceSetNode") {
//                            set = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-set" , this.ns.model);
...
//                        } else {
//                            throw new Error(dojo.string.substitute(this.modelMessages.TYPE_NOTSUPPORT_1,[context.type]));
//                        }
//                    } else {
...
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:preference-set", this.xmlData, this.ns);
//            if (nodes && nodes.length>0) {
//                if (before) {
...
//
//        _loadAhead: function(deferred, sync) {
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:preference-set/model:preference-entry", this.xmlData, this.ns);
//            if (nodes) {
//                for (var i=0; i<nodes.length; i++) {
//                    var set = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set", nodes[i], this.ns);
//                    var pref = null;
//                    if (set && set.length>0) {
//                        pref = new com.ibm.mm.enabler.preference.PreferenceSetNodeImpl(nodes[i], nodes[i].getAttribute("name"));
//                    } else {
//                        pref = new com.ibm.mm.enabler.preference.PreferenceNodeImpl(nodes[i], nodes[i].getAttribute("name"));
//                    }
//                    this.entries[i] = pref;
//
//                    // callback handling
...
//
//// preference locator
//dojo.declare("com.ibm.mm.enabler.preference.PreferenceLocatorImpl", [com.ibm.mashups.enabler.preference.PreferenceLocator],
//    {
//        constructor:function (node) {
//            this.xmlData = node;
//			  this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
...
//
//// preference set
//dojo.declare("com.ibm.mm.enabler.preference.PreferenceSetImpl", [com.ibm.mashups.enabler.preference.PreferenceSet, com.ibm.mm.enabler.IdentifiableImpl],
//    {
//        constructor:function (node) {
//            this.xmlData = node;
//            this.ns = { "atom" : "http://www.w3.org/2005/Atom",
...
//        getLevel: function () {
//            var expr = "atom:content/model:preference-set";
//            var entry = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns);
//            return (entry && entry.length>0) ? entry[0].getAttribute("level") : null;
//        },
//
//        toString: function() {
//            return com.ibm.mm.enabler.dom.innerXML(this.xmlData);
...
//dojo.declare("com.ibm.mm.enabler.preference.GenericPreferenceNodeImpl", com.ibm.mashups.enabler.preference.GenericPreferenceNode,
//    {
...
//
//// preference set node
//dojo.declare("com.ibm.mm.enabler.preference.PreferenceSetNodeImpl", [com.ibm.mashups.enabler.preference.PreferenceSetNode, com.ibm.mm.enabler.preference.GenericPreferenceNodeImpl, com.ibm.mm.enabler.DeferredIteratorImpl],
//    {
//        constructor:function (node) {
//            this.xmlData = node;
//            this.entries = [];
...
//            this.ns = { "atom" : "http://www.w3.org/2005/Atom",
//                        "thr"  : "http://purl.org/syndication/thread/1.0",
//                        "model" : "http://www.ibm.com/xmlns/prod/lotus/mashups/v1.0/model-elements",
...
//                var set = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set", nodes[0], this.ns);
//                if (set && set.length>0) {
//                    result = new com.ibm.mm.enabler.preference.PreferenceSetNodeImpl(nodes[0], this.xpath + "/" + name);
//
//                } else {
//                    result = new com.ibm.mm.enabler.preference.PreferenceNodeImpl(nodes[0], this.xpath + "/" + name);
//                }
//            }
//            return result;
//        },
...
//
//        insert: function (node, before) {
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set", this.xmlData, this.ns);
//            if (nodes && nodes.length>0) {
//                if (before) {
//                    nodes[0].insertBefore(node.xmlData, before);
//                } else {
...
//
//        _loadAhead: function(deferred, sync) {
//            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set/model:preference-entry", this.xmlData, this.ns);
//            if (nodes) {
//                for (var i=0; i<nodes.length; i++) {
//                    var set = com.ibm.mm.enabler.xpath.evaluateXPath("model:preference-set", nodes[i], this.ns);
//                    var pref = null;
//                    if (set && set.length>0) {
//                        pref = new com.ibm.mm.enabler.preference.PreferenceSetNodeImpl(nodes[i], this.xpath + "/" + nodes[i].getAttribute("name"));
//                    } else {
//                        pref = new com.ibm.mm.enabler.preference.PreferenceNodeImpl(nodes[i], this.xpath + "/" + nodes[i].getAttribute("name"));
//                    }
//                    this.entries[i] = pref;
//
//                    // callback handling
...
//
//// preference node
//dojo.declare("com.ibm.mm.enabler.preference.PreferenceNodeImpl", [com.ibm.mashups.enabler.preference.PreferenceNode, com.ibm.mm.enabler.preference.GenericPreferenceNodeImpl],
//    {
//        constructor:function (node) {
//            this.xmlData = node;
//            this.ns = { "atom" : "http://www.w3.org/2005/Atom",
...
//                if (!nodes || nodes.length === 0) {
//                    var xmlDom = com.ibm.mm.enabler.dom.createDocument();
//                    var entry = com.ibm.mm.enabler.dom.createElement(xmlDom, "model:preference-value" , this.ns.model);
...
// theme model
dojo.declare("com.ibm.mm.enabler.model.ThemeModelImpl", [com.ibm.mashups.enabler.model.ThemeModel, com.ibm.mm.enabler.DeferredIteratorImpl],
    {
        constructor:function (baseUrl) {
            this.prefix = "theme:";
            this.loadedNodes = {};
            ...
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL, nsf.NS_APP, nsf.NS_THR]);
            if ((typeof(baseUrl)!= "undefined") && (baseUrl !== null)) {
                this.url = baseUrl + this.url;
                this.baseUrl = baseUrl;
            }
        ...
        getSkinModel: function(theme) {
            // either use input string as uri or input object to extract uri from
        ...
        _load: function(uri, deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.ThemeModelImpl._load", uri, sync ? "sync" : "async");
            if (uri in this.loadedNodes) {
                // fetch node from cache
                if (deferred) {
					// internal callback handling
        ...
        _loadAhead: function(deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.ThemeModelImpl._loadAhead", sync ? "sync" : "async");
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.ThemeModelImpl._loadAhead");
        }
    }
);

// skin model
dojo.declare("com.ibm.mm.enabler.model.SkinModelImpl", [com.ibm.mashups.enabler.model.SkinModel, com.ibm.mm.enabler.DeferredIteratorImpl],
    {
        constructor:function (uri, baseUrl) {
            this.prefix = "theme:";
            this.theme = uri;
        ...
        _loadAhead: function(deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.SkinModelImpl._loadAhead", sync ? "sync" : "async");
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.SkinModelImpl._loadAhead");
        }
    }
);

// theme
dojo.declare("com.ibm.mm.enabler.theme.ThemeImpl", [com.ibm.mashups.enabler.theme.Theme, com.ibm.mm.enabler.IdentifiableImpl, com.ibm.mm.enabler.LocalizedImpl],
    {
        constructor:function (node) {
            this.xmlData = node;
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
        ...
        getName: function() {
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:title", this.xmlData, this.ns);
            return (nodes && nodes.length > 0) ? com.ibm.mm.enabler.dom.textContent(nodes[0]) : null;
        },

        getBaseUrl: function() {
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:theme/model:link[@model:rel='baseUrl']", this.xmlData, this.ns);
...
// skin
dojo.declare( "com.ibm.mm.enabler.theme.SkinImpl", [com.ibm.mashups.enabler.theme.Skin, com.ibm.mm.enabler.IdentifiableImpl, com.ibm.mm.enabler.LocalizedImpl],
    {
        constructor:function (node) {
            this.xmlData = node;
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
        ...
        getBaseUrl: function() {
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:skin/model:link[@model:rel='baseUrl']", this.xmlData, this.ns);
            return (nodes && nodes.length > 0) ? nodes[0].getAttribute("model:href") : null;
        },

        getPreviewUrl: function() {
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:skin/model:link[@model:rel='previewUrl']", this.xmlData, this.ns);
            return (nodes && nodes.length > 0) ? nodes[0].getAttribute("model:href") : null;
        },
...
// community model
dojo.declare( "com.ibm.mm.enabler.model.CommunityModelImpl", [com.ibm.mashups.enabler.ListModel],
    {
        constructor:function (baseUrl) {
            this.root = null;
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            ...
            this.start = null;
            this.num = null;
            this.size = 9999; // assume a high size until we know the real size
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_MODEL]);
            this.modelMessages = dojo.i18n.getLocalization("com.ibm.mm.enabler", "modelMessages");
        ...
        _find: function (id, deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.CommunityModelImpl._find", id, sync ? "sync" : "async");
            if (id in this.deletedNodes) {
                // handle callback
                if (deferred) {
					// internal callback handling
            ...
            if (id in this.loadedNodes) {
                ...
                if (deferred) {
					...
					// public callback handling
					if (deferred.finishedCallback2) {
						deferred.finishedCallback2(this.loadedNodes[id], com.ibm.mm.enabler.model.HttpStatusCodes.HTTP_OK, deferred.finishedCallbackParameters2);
					}
                }
                return this.loadedNodes[id];
            }
            ...
            if (result.status) {
                throw new Error(dojo.string.substitute(me.modelMessages.E_COMNODE_NOTFOUND_1, [id, result.status]));
            }
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.CommunityModelImpl._find");
        ...
        commit: function () {
            return new com.ibm.mm.enabler.DeferredCommitImpl(this).start(); // TODO: make fully deferred
        },

        _commit: function (deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.CommunityModelImpl._commit", sync ? "sync" : "async");
			// initialize callback handling
            this.statusCode = com.ibm.mm.enabler.model.HttpStatusCodes.HTTP_OK;
            this.requestCount = 0;
            this._acquire();
             ...
             for (communityID in this.loadedNodes) {
                 ...
                 if (community.isModified()) {
                     ...
                     var userFeed = '<?xml version="1.0" encoding="UTF-8"?>\n' +
                                        ...
                                        '<atom:id>' + 'community:' + 'id:'+community.getID() + '</atom:id>\n' +
                                        '<atom:updated>' + time.toGMTString() + '</atom:updated>\n';
                     for (var i = 0; i < participants.length; i++) {
                         if (participants[i] !== undefined) {
                             userFeed += '<atom:entry>\n' +
                                 '<atom:content type="application/xml">\n' +
                                 '<model:participant id="'+participants[i].getUser().getID()+'" access-level="'+participants[i].getAccessLevelString()+'" entity-type="'+participants[i].getUser().getEntityType()+'"/>\n' +
                                 '</atom:content>\n' +
                                 '</atom:entry>\n';
                         }
                     }
                     ...
                     var categories = null;
                     this._acquire();
                     serviceReq.update(userFeed,
					 	function(type, data, xhr, args) {
                            // public callback handling
                            if (deferred && deferred.operationCallback) {
                                deferred.operationCallback(community, com.ibm.mashups.enabler.DeferredOperation.OPERATION_MODIFY, xhr.status, deferred.operationCallbackParameters);
                            }
                    		if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                // internal callback handling
	                     		if (deferred && deferred.errorCallback) {
            ...
            for (id in this.createdNodes) {
                ...
                var entry = '<atom:entry>\n' +
                            ...
                            '  <model:linked-resource ref="nm:id:' + pageId + '" href="?uri=nm:id:' + pageId + '" model:type="page"/>\n' +
                            '</atom:entry>\n';
    			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
                var communityEntry = com.ibm.mm.enabler.model.Utils.createFeed("community:cid:unused",
                    "HCL Lotus Mashups Community Feed",
                    entry,
                    nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_XHTML, nsf.NS_COMMUNITY, nsf.NS_THR, nsf.NS_MODEL, nsf.NS_APP]));
                var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
                ...
                var categories = null;
                this._acquire();
                serviceReq.create(communityEntry,
					function(type, data, xhr, args) {
                    	var expr = "atom:feed/atom:entry";
	   	                var nodes = com.ibm.mm.enabler.xpath.evaluateXPath(expr, data, me.ns);
    	   	            var newentry = new com.ibm.mm.enabler.community.CommunityImpl(nodes[0], me.um);
	                    ...
	                    if (deferred) {
                            // public callback handling
                            if (deferred.operationCallback) {
                                deferred.operationCallback(newentry, com.ibm.mashups.enabler.DeferredOperation.OPERATION_CREATE, xhr.status, deferred.operationCallbackParameters);
                            }
                            // internal callback handling
    	                    if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_LOAD) {
        	                    if (deferred.finishedCallback) {
                ...
                serviceReq.remove(
                    function ( type, data, xhr, args ) {
                        if (deferred) {
                            // public callback handling
                            if (deferred.operationCallback) {
                                deferred.operationCallback(newentry, com.ibm.mashups.enabler.DeferredOperation.OPERATION_DELETE, xhr.status, deferred.operationCallbackParameters);
                            }
                            // internal callback handling
                            if (type == com.ibm.mm.enabler.services.ModelRestServiceRequest.XHR_STATUS_ERROR) {
                                if (deferred.errorCallback) {
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.CommunityModelImpl._commit");
        },
        ...
        remove: function (node) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.CommunityModelImpl.remove", node.getID());
            var id = node.getID();
            // mark node as deleted
            if (!(id in this.deletedNodes)) {
                this.deletedNodes[id] = null;
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.CommunityModelImpl.remove", node.getID());
        },
        ...
        _loadAhead: function(deferred, sync) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.CommunityModelImpl._loadAhead", sync ? "sync" : "async");
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.CommunityModelImpl._loadAhead");
        }
    }
);

// Community
dojo.declare( "com.ibm.mm.enabler.community.CommunityImpl", [com.ibm.mm.enabler.IdentifiableImpl],
    {
        constructor:function (data, usermodel, baseUrl) {
			var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
			this.ns = nsf.getNameSpaces([nsf.NS_ATOM, nsf.NS_THR, nsf.NS_NM, nsf.NS_MODEL, nsf.NS_BASE, nsf.NS_APP, nsf.NS_XML]);
            this.baseUrl = "";
            this.url = com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTEXT_ROOT_MAIN) +
            	com.ibm.mm.enabler.services.CONFIG_SERVICE.getValue(com.ibm.mm.enabler.services.CONFIG_SERVICE.CONTENTHANDLER_PRIVATE);
            this.modified = false;
            ...
            this.entries = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/model:community/model:participant", this.xmlData, this.ns );
            this.um = usermodel;
            ...
            var results = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns );
...
dojo.declare( "com.ibm.mm.enabler.community.ParticipantImpl", com.ibm.mashups.enabler.community.Participant,
    {
        constructor:function () {
        },
...
com.ibm.mm.enabler.model.UserModel.iConfig = {
   ...
   /* optionally we can provide getID or any other method here to override things - this is a temporary solution */
};
// User Model
dojo.declare( "com.ibm.mm.enabler.model.UserModelImpl", [com.ibm.mashups.enabler.ListModel],
    {
        constructor:function (baseUrl) {
            this.root = null;
            var nsf = com.ibm.mm.enabler.model.NameSpaceFactory;
            ...
            //merge the configuration parameters defined in 'iConfig' with this class.
            dojo.mixin(this,com.ibm.mm.enabler.model.UserModel.iConfig);
        ...
        find: function (/*String*/ id) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.UserModelImpl.find", id);
             ...
             serviceReq.read(
                 function (type, data, xhr, args) {
                     var userXmls = com.ibm.mm.enabler.xpath.evaluateXPath(me.xpathSingleEntry, data, me.ns);
                     if (userXmls[0] !== null) {
 			 ...
 			 com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.UserModelImpl.find");
             return me.entry;
        },

        findUsersByAttribute: function (/*String*/ attributeName, /*String*/ attributeValue) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.UserModelImpl.findUsersByAttribute", attributeName, attributeValue);
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
            ...
            serviceReq.read(
                function (type, data, xhr, args) {
                    var userXmls = com.ibm.mm.enabler.xpath.evaluateXPath(me.xpathMultipleEntry, data, me.ns);
                    var users = [];
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.UserModelImpl.findUsersByAttribute");
            return me.entry;
        },

        findGroupByID: function (/*String*/ id) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.UserModelImpl.findGroupByID", id);
             var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
            myUrl.addParameter("uri", this.groupUri+":"+id+"&expandRefs=true");
             ...
             serviceReq.read(
                 function (type, data, xhr, args) {
                     var groupXmls = com.ibm.mm.enabler.xpath.evaluateXPath(me.xpathSingleEntry, data, me.ns);
                     if (groupXmls[0] !== null) {
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.UserModelImpl.findGroupByID");
             return me.entry;
        },

        findGroupsByAttribute: function (/*String*/ attributeName, /*String*/ attributeValue) {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.UserModelImpl.findGroupByID", attributeName, attributeValue);
            var myUrl = new com.ibm.mm.enabler.utilities.HttpUrl(this.url);
            ...
            serviceReq.read(
                function (type, data, xhr, args) {
                    var groupXmls = com.ibm.mm.enabler.xpath.evaluateXPath(me.xpathMultipleEntry, data, me.ns);
                    var groups = [];
        ...
        findCurrentUser: function () {
			com.ibm.mm.enabler.debug.entry("com.ibm.mm.enabler.model.UserModelImpl.findCurrentUser");
			...
			com.ibm.mm.enabler.debug.exit("com.ibm.mm.enabler.model.UserModelImpl.findCurrentUser");
    ...
    findGroupAttributes: function() {
            ...
            serviceReq.read(
                function (type, data, xhr, args) {
                    var attributeXmls = com.ibm.mm.enabler.xpath.evaluateXPath(me.xpathMultipleEntry, data, me.ns);
                    var attributes = [];
...
dojo.declare( "com.ibm.mm.enabler.user.EntityImpl", [com.ibm.mm.enabler.IdentifiableImpl],
    {
        // UserImpl and GroupImpl provide their own getLoginName(), getCN(), and getID()
    }
);
...
dojo.declare( "com.ibm.mm.enabler.user.UserImpl", [com.ibm.mm.enabler.user.EntityImpl],
    {
		...
		var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath(expr, this.xmlData, this.ns );
		...
		if (typeof this.attNames != "undefined" && this.attNames !== null ) {return this.attNames;}
                 var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute", this.xmlData, this.ns );
		 if (xmlResult.length ===0){
			return null;
		}
		this.attNames = [];
        ...
        getID:function () {
            var nodes = com.ibm.mm.enabler.xpath.evaluateXPath("atom:id", this.xmlData, this.ns );
            if ((nodes === null) || (nodes.length === 0)) {
                return null;
            }
        ...
        getLoginName:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='principalName']/um:attributeValue", this.xmlData, this.ns );
        ...
        getSN:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='sn']/um:attributeValue", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 return null;
             }
        ...
        getCN:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='cn']/um:attributeValue", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 return null;
             }
        ...
        getEmail:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='email']/um:attributeValue", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='mail']/um:attributeValue", this.xmlData, this.ns );
                 if ((xmlResult === null) || (xmlResult.length === 0)) {
                     return null;
                 }
             }
        ...
        getDisplayName:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:profile/um:attribute[@name='displayName']/um:attributeValue", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 return this.getCN();
             }
...
dojo.declare( "com.ibm.mm.enabler.user.AttributeImpl", null,
    {
        ...
        getName:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:title", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 return null;
             }
        ...
        getType:function () {
             var xmlResult = com.ibm.mm.enabler.xpath.evaluateXPath("atom:content/um:attribute", this.xmlData, this.ns );
             if ((xmlResult === null) || (xmlResult.length === 0)) {
                 return null;
             }
...
// public factory; all getters create a new instance of the respective model
...
// internal factory
dojo.declare( "com.ibm.mm.enabler.model.ExtendedFactoryImpl", null,
    {
        constructor:function () {
        },
...
//            return new com.ibm.mm.enabler.model.PreferenceModelImpl(user, baseUrl);
//        },
...
dojo.declare( "com.ibm.mm.enabler.model.NavigationNodeFactoryImpl", null,
    {
        ...
        createNavigationNode: function(xmlData) {
            var result = null;
            var navNodeExpr = "atom:content/model:navigation-node";
            var navNode = com.ibm.mm.enabler.xpath.evaluateXPath(navNodeExpr, xmlData, this.ns);
            var type;
