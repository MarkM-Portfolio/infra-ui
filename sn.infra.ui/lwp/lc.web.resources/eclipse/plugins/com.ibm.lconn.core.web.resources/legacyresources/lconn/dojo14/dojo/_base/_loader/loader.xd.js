...
return {
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.foo"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
