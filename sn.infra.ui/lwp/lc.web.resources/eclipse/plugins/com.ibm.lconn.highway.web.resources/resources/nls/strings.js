...
({
	...
	configTitleSystem: "System status and health checker",
	...
	configTitleGatekeeper: "Configuring HCL Connections Gatekeeper for feature enablement",

	configDescSystem: "You can view the current system configuration and perform health checks from this page.",
	configDescDefinitions: "You can define settings below that influence how Connections will appear and function. This is typically used for development and should not be required by administrators.",
	configDescDefaults: "You can use the settings below to define how Connections appears and functions by default, for all organizations, unless explicitly set for a given organization.",
	configDescSettings: "You can use the settings below to define how Connections appears and functions for the current organization. Please note, the id '00000000-0000-0000-0000-000000000001' is the default on-premises organization id. The id '00000000-0000-0000-0000-000000000000' is the global default and will affect all organizations.",
	configDescGatekeeper: "You can use the settings below to enable or disable Connections features. Note : Settings saved here will not be reflected on cloud at the moment.",

	organizationTitle: "Organization",
	organizationUserOrg: "[Current Users Organization]",

	createSettingTitle: "Create Setting",
	createSettingDescription: "Create a completely new Setting Definition",

	populateSettingsTitle: "Populate Settings",
	populateSettingsDescription: "Create highway settings for gatekeeper settings",

	orgEditActionName: "Edit",
	orgUpdateActionName: "Update",
	orgCancelActionName: "Cancel",
	orgEditActionDescription: "Edit the currently selected organization",
	orgUpdateActionDescription: "Update the currently selected organization",
	orgCancelActionDescription: "Abandon changes",
	...
	roleSingleOnlyDescription: "This setting does not support role specific values. A single value is applied to all users",
	...
	helpSystemTitle: "System status and health",
	helpSystemMessage1: "Details regarding the current system configuration are shown.",
	helpSystemMessage2: "You can choose to perform tests to ensure that the system is operating correctly from a base services level.",
	...
	helpGatekeeperTitle: "Managing Gatekeeper Settings",
	helpGatekeeperMessage1: "Gatekeeper settings can be enabled or disabled individually to expose or hide new features.",
	helpGatekeeperMessage2: "Those items that appear in blue have been modified from the default. If you change them back they will return to gray (though still be present in the Database)",

	helpSettingName: "Setting Name",
	helpSettingTitle: "Setting Title",
	...
	helpSettingIsDefault: "Currently set to default value",
	helpSettingIsGlobal: "Global only setting",
	helpSettingJavascriptName: "Javascript Name",
	...
	sourceLocal: "Local",
	role: "Role",
	orgReceived: "Organization in view",
