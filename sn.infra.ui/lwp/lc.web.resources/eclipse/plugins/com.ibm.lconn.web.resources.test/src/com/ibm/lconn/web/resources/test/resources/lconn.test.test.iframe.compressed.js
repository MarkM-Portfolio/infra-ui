...
;define("lconn.test/test/iframe",[
   ...
   function iframe(url, options, returnDeferred){
      ...
      dfd._callNext = function _callNext_$0(){
         if(!this._calledNext){
   ...
   iframe.get = function get_$1(url, options){
      // summary:
   ...
   iframe.post = function post_$2(url, options){
      // summary:
   ...
   iframe._notifyStart = function _notifyStart_$3(){};
   iframe._dfdQueue = [];
   iframe._currentDfd = null;
