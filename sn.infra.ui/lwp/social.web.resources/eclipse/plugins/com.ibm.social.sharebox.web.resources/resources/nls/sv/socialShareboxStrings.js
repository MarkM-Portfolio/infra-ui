...
({
   ...
   MESSAGE: {
	      ...
	      INFO: "Information",
	      WARNING: "Varning",
	      DISMISS: "Dölj det här meddelandet",
   ...
   COMMUNITYUPLOADFILE: {
	   ...
	   SHARE_WITH_COMMUNITY: {
           ...
           TIMEOUT_ERROR_X: "Det gick inte att ansluta till servern. Det gick inte att dela filerna. Klicka på Dela om du vill försöka igen.",
           CANCEL_ERROR: "Begäran avbröts. Det gick inte att dela filen. Klicka på Dela om du vill försöka igen.",
           CANCEL_ERROR_X: "Begäran avbröts. Det gick inte att dela filerna. Klicka på Dela om du vill försöka igen.",
	   ...
	   UPLOAD_TO_COMMUNITY: {
		   SUCCESS_ONE: "Du laddade upp ${0} till ${1}.",
		   SUCCESS_PLURAL: "Du laddade upp ${0} filer till ${1}.",
		   ERROR: "Det gick inte att ladda upp filen. Försök igen senare.",
		   ERROR_X: "Det gick inte att ladda upp ${0}. Försök igen senare.",
		   INFO_SUCCESS_PRE_MODERATION: "Filen ${0} har skickats in för granskning och kommer att vara tillgänglig när den har godkänts.",
		   MULTI_INFO_SUCCESS_PRE_MODERATION: "${0} filer har skickats in för granskning och kommer att vara tillgängliga när de har godkänts."
	   }
      },
   UPLOADFILE: {
      DESCRIPTION: "Ladda upp och dela filer"
   },
   UNSAVEDCHANGES: {
	   CANCEL: "Avbryt",
