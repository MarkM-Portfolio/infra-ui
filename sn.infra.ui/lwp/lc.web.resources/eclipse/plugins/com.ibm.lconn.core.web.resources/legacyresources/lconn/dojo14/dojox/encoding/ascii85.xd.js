...
return {depends: [["provide", "dojox.encoding.ascii85"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.encoding.ascii85"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
