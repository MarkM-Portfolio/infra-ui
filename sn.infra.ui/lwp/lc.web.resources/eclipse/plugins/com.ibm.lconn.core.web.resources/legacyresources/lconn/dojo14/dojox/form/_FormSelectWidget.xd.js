...
return {depends: [["provide", "dojox.form._FormSelectWidget"],
["require", "dijit.form._FormSelectWidget"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form._FormSelectWidget"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
