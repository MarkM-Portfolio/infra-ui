...
return {depends: [["provide", "dojox.date.hebrew"],
["require", "dojox.date.hebrew.Date"],
["require", "dojo.date"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.date.hebrew"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
