...
({
   POPUP : {
      RECOMMENDED_ME_ONLY : {
          ...
          */
         TEXT : "<span class='lotusLikeDescription'>Toto sa vám páči</span><span class='lotusDivider' role='separator'>-</span><a class='lotusLikeAction' role='button' aria-label='You like this' href='javascript:;' id='TOGGLE_${id}'>Zrušiť Páči sa mi</a>",
         TOOLTIP : "Zrušiť Páči sa mi"
      },
      RECOMMENDED_ME_ONE : {
         /* For translator: translate "You like this" in this HTML string */
         READONLYTEXT : "<span class='lotusLikeDescription'>Toto sa vám páči</span>",
      ...
      RECOMMENDED_NOTME_ONE : {
         ...
         TEXT : "<a class='lotusLikeAction' role='button' href='javascript:;' id='TOGGLE_${id}'>Páči sa mi</a>",
         TOOLTIP : "Páči sa mi"
      },
      ...
      RECOMMENDED_HEADER_SHOWING_SOME : "Ľudia, ktorým sa páči toto... (zoradení podľa mena)",
