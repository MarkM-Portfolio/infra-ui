...
return {depends: [["provide", "dojo.NodeList-traverse"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojo.NodeList-traverse"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
