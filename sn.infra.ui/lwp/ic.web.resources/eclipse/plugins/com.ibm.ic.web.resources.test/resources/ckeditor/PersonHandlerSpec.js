...
define([
   ...
   function(lang, windowModule, domConstruct, JSON, domGeom, services, PersonHandler, HybridPeopleDataStoreOpenSocial, PeopleDataStoreOpenSocial, mocks, inject) {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler handler', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getStore() method', function() {
         var _services, _search;
         beforeEach(function() {
            // Store original reference
            _services = inject("ic-core/config/services");
            _search = services.search;
            PersonHandler.setStore(null);
         });
         afterEach(function() {
            // Restore
            inject("ic-core/config/services", _services);
            services.search = _search;
            _search = undefined;
         });
         it('returns an instance of HybridPeopleDataStoreOpenSocial when Search is installed', function() {
            ...
            expect(PersonHandler.getStore() instanceof HybridPeopleDataStoreOpenSocial).toBeTruthy();
         });
         it('returns an instance of PeopleDataStoreOpenSocial when Search is not installed', function() {
            delete services.search;
            expect(PersonHandler.getStore()).not.toBeNull();
            expect(PersonHandler.getStore() instanceof PeopleDataStoreOpenSocial).toBeTruthy();
         });
      });

      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getTextFromItem() method', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.formatData() method', function() {
         it('returns a well formed JSON object', function() {
            expect(PersonHandler.formatData(ITEM)).not.toBeNull();
            expect(PersonHandler.formatData(ITEM)).toBe(JSON.stringify(ITEM_JSON));
         });
      });

      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.addMicroFormat() method', function() {
         var _CKEDITOR;
         beforeEach(function() {
            _CKEDITOR = lang.getObject('CKEDITOR');
            lang.setObject('CKEDITOR', mocks.CKEDITOR);
            PersonHandler._node = {
               $ : domConstruct.create('a', {}, windowModule.body())
            };
         ...
         it('creates the expected microformat (user name with HTML tags)', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.remove() method', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getNameFromNode() method', function() {
         var testNode = {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getIdFromNode() method', function() {
         var testNode = {
            $ : domConstruct.create('span', {
               innerHTML : '<a class="fn" href="">@Amy Jones1</a><span class="x-lconn-userid">523cc6c0</span>',
               className : 'vcard'
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.isMentionNode() method', function() {
         var testNode = {
            $ : domConstruct.create('span', {
               innerHTML : '<a class="fn" href="">@Amy Jones1</a><span class="x-lconn-userid">523cc6c0</span>',
               className : 'vcard'
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.hasBizCard() method', function() {
         var testNode = domConstruct.create('span', {
            innerHTML : '<a class="fn" href="">@Amy Jones1</a><span class="x-lconn-userid">523cc6c0</span>',
            className : 'vcard'
         });
         it('will return true in the case that a mentionsNode is passed in', function() {
         ...
         var badNode = domConstruct.create('span', {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getMentionsAtRange() method', function() {
         ...
         beforeEach(function() {
            ...
            // this range is collapsed because the endContainer and
            // startContainer are the same
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.isExternal() method', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getUserId() method', function() {
      ...
      describe('the ic-ui/ckeditor/plugins/mentions/PersonHandler.getUserOrgId() method', function() {
