  ...
  /* The placeholders for date formatting strings are as follows:
		...
		*/
		   ...
		   generic: {
		      ...
		      timestamp: {
		         ...
		         updated: {
		            ...
		            YESTERDAY: "อัพเดตเมื่อวานนี้เมื่อ ${time}",
		            TOMORROW: "อัพเดตเมื่อ ${MMM} ${d}, ${YYYY}"
		         }
		      },
		      visibility: {
		         pub: "ชื่อพับลิกโฟลเดอร์",
		         priv: "ไพรเวต"
		      },
		      action: {
		         created: "สร้าง",
		   ...
		   network : {
		      ...
		      timestamp: {
		          created: {
		              DAY: "${EEEE} เวลา ${time}",
		              MONTH: "${MMM} ${d}",
		              TODAY: "วันนี้ เวลา ${time}",
		              YEAR: "${MMM} ${d}, ${YYYY}",
		              YESTERDAY: "เมื่อวาน เวลา ${time}",
		              TOMORROW: "${MMM} ${d}, ${YYYY}"
		           }
		      }
		   },
		   ...
		   COMMENTS: {
		      ...
		      OK: "ปกติ",
		      YES: "ใช่",
		      TRIM_LONG_COMMENT: "ตัดข้อคิดเห็นให้สั้นลง?",
		      ...
		      COMMENT_DELETED: {
		         DAY: "ข้อคิดเห็นที่ลบโดย ${user} บน ${EEEE} เมื่อ ${time}",
		      ...
		      DELETE_CONFIRM: "คุณแน่ใจว่าต้องการลบข้อคิดเห็นนี้หรือ?",
		      FLAG_ITEM: {
		         BUSY: "กำลังบันทึก...",
		         CANCEL: "การยกเลิก",
		   ...
		   EE_DIALOG: {
		      ...
		      CONFIRM_CLOSE_MESSAGE: "คุณแน่ใจว่าคุณต้องการยกเลิกการเปลี่ยนแปลง? กด ตกลง เพื่อทำต่อไป หรือ ยกเลิก เพื่อกลับไป",
		      OK: "ปกติ",
		      CANCEL: "การยกเลิก"
		   },
		   MESSAGE: {
		   ...
		   login: {
		      error: "ชื่อผู้ใช้และ/หรือรหัสผ่านของคุณไม่ตรงกับแอคเคาต์ที่มีอยู่แล้วใดๆ โปรดลองใหม่",
		      logIn: "ล็อกอิน",
		      password: "รหัสผ่าน:",
		      user: "ชื่อผู้ใช้:",
		   ...
		   UNSAVEDCHANGES: {
		      CANCEL: "การยกเลิก",
		      CONFIRM: "คุณแน่ใจว่าคุณต้องการยกเลิกการเปลี่ยนแปลง?  กด ตกลง เพื่อทำต่อไป หรือกด ยกเลิก เพื่อกลับไป",
		      DIALOG_TITLE: "ยืนยัน",
		      NAME: "ยืนยัน",
		      OK: "ปกติ",
		      TOOLTIP: "ยืนยัน"
