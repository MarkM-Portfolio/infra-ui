...
dojo.require("com.ibm.social.incontext.typeahead.legacy.PeopleTypeAhead");
dojo.require("com.ibm.social.incontext.util.html");

dojo.declare("com.ibm.social.incontext.typeahead.widget.PeopleTypeAhead", [com.ibm.social.incontext.typeahead.legacy.PeopleTypeAhead], {
   ...
   formatItem: function(item) {
      ...
      if ( item.email ){
         var dirChar = com.ibm.social.incontext.util.html.getDirectionCode();
