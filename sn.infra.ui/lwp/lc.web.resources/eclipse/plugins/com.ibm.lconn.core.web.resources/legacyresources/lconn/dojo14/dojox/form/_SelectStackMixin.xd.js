...
return {depends: [["provide", "dojox.form._SelectStackMixin"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.form._SelectStackMixin"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
