...
(function() {
	...
	var SWFUpload = lconn.core.swfupload.SWFUpload;
	...
	if (typeof (SWFUpload) === "function") {
		...
		SWFUpload.speed.fileQueuedHandler = function(file) {
			if (typeof this.speedSettings.user_file_queued_handler === "function") {
				...
				return this.speedSettings.user_file_queued_handler.call(this,
						file);
			}
		};
		...
		SWFUpload.speed.fileQueueErrorHandler = function(file, errorCode,
			...
			if (typeof this.speedSettings.user_file_queue_error_handler === "function") {
				...
				return this.speedSettings.user_file_queue_error_handler.call(
		...
		SWFUpload.speed.uploadStartHandler = function(file) {
			if (typeof this.speedSettings.user_upload_start_handler === "function") {
				...
				return this.speedSettings.user_upload_start_handler.call(this,
						file);
			}
		};
		...
		SWFUpload.speed.uploadErrorHandler = function(file, errorCode, message) {
			...
			if (typeof this.speedSettings.user_upload_error_handler === "function") {
				return this.speedSettings.user_upload_error_handler.call(this,
		...
		SWFUpload.speed.uploadProgressHandler = function(file, bytesComplete,
			...
			if (typeof this.speedSettings.user_upload_progress_handler === "function") {
				return this.speedSettings.user_upload_progress_handler.call(
		...
		SWFUpload.speed.uploadSuccessHandler = function(file, serverData) {
			if (typeof this.speedSettings.user_upload_success_handler === "function") {
				file = SWFUpload.speed.extendFile(file, this.fileSpeedStats);
				return this.speedSettings.user_upload_success_handler.call(
		...
		SWFUpload.speed.uploadCompleteHandler = function(file) {
			...
			if (typeof this.speedSettings.user_upload_complete_handler === "function") {
				return this.speedSettings.user_upload_complete_handler.call(
						this, file);
			}
		};
		...
		SWFUpload.prototype.updateTracking = function(file, bytesUploaded) {
			...
			if (!tracking.startTime) {
				...
				tracking.movingAverageSpeed = SWFUpload.speed
						.calculateMovingAverage(tracking.movingAverageHistory);

				// Update times
				tracking.timeRemaining = (file.size - tracking.bytesUploaded)
						* 8 / tracking.movingAverageSpeed;
