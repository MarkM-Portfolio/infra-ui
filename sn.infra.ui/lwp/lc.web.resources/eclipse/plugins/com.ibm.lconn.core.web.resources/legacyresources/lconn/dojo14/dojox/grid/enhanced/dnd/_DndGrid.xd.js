...
return {depends: [["provide", "dojox.grid.enhanced.dnd._DndGrid"],
["require", "dojox.grid.enhanced.dnd._DndEvents"]],
defineResource: function(dojo, dijit, dojox){if(!dojo._hasResource["dojox.grid.enhanced.dnd._DndGrid"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
